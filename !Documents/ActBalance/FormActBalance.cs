...
namespace Legal.Forms.Document
{
    public partial class FormActBalance : FormLbr.FormBase
    {
        ...
        {
            FormAbnAkt frmAktRBP = new FormAbnAkt(this.SqlSettings, 1, IDLIST, true);
        ...
        public void CreateActRbp(string AbnName, string fullFileName)
        {
            if (dgvListAct.SelectedRows != null && dgvListAct.SelectedRows.Count > 0)
            {
                ...
                {
                    SelectSqlData(dsAbnObjAkt1, dsAbnObjAkt1.tTC_Doc, true, String.Format("WHERE id = {0}", dsAbnObjAkt1.tAbnObjDoc_AktRBP.First().idActTehConnection));
                    ...
                    SelectSqlData(dsAbnObjAkt1, dsAbnObjAkt1.tTC_ActTC, true, String.Format("WHERE id = {0}", dsAbnObjAkt1.tAbnObjDoc_AktRBP.First().idActTehConnection));
                    ...
                    SelectSqlData(dsAbnObjAkt1, dsAbnObjAkt1.vTC_TUPointAttach, true, String.Format("WHERE idTU = {0}", dsAbnObjAkt1.tAbnObjDoc_AktRBP.First().idActTehConnection));
                }
                #endregion
        ...
        private void tssbAddActBalance_Click(object sender, EventArgs e)
        {
            ...
            {
                FormAbnAkt frmAktRBP = new FormAbnAkt(this.SqlSettings, true, true, ABNSELECT, OBJSELECT, TypeDocValue.ActBalance);
        ...
        private void tssbAddActLiability_Click(object sender, EventArgs e)
        {
            ...
            if (f.ShowDialog() == DialogResult.OK)
            {
                FormAbnAkt frmAktRBP = new FormAbnAkt(this.SqlSettings, true, true, ABNSELECT, OBJSELECT, TypeDocValue.ActLiability);
                frmAktRBP.Owner = this;
                frmAktRBP.FormClosed += new FormClosedEventHandler(frmAktRBP_FormClosed);
                frmAktRBP.MdiParent = this.MdiParent;
                frmAktRBP.Show();
        ...
        void frmAktRBP_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                ActListLoad();
                dgvFind(sender is FormAbnAkt ? ((FormAbnAkt)sender).IdList : -1);
                //LoadActsByAbn();
            }
        }
        ...
        private void tsbEdit_Click(object sender, EventArgs e)
        {
            if (dgvListAct.SelectedRows != null && dgvListAct.SelectedRows.Count > 0 && IDLIST != -1)
            {
                ...
                FormAbnAkt frmAktRBP = new FormAbnAkt(this.SqlSettings, idObj, IDLIST);
                frmAktRBP.MdiParent = this.MdiParent;
                frmAktRBP.FormClosed += new FormClosedEventHandler(frmAktRBP_FormClosed);
                frmAktRBP.Show();
            }
        ...
        private void tsbCopy_Click(object sender, EventArgs e)
        {
            if (dgvListAct.SelectedRows != null && dgvListAct.SelectedRows.Count > 0)
            {
                ...
                if (f.ShowDialog() == DialogResult.OK)
                {
                    ...
                    FormAbnAkt frmAktRBP = new FormAbnAkt(this.SqlSettings, OBJSELECT, IDLIST, ABNSELECT);
                    frmAktRBP.Owner = this;
                    frmAktRBP.MdiParent = this.MdiParent;
                    frmAktRBP.FormClosed += new FormClosedEventHandler(frmAktRBP_FormClosed);
                    frmAktRBP.Show();
        ...
        private void tssbAddActBalanceAbn_Click(object sender, EventArgs e)
        {
            ...
            if (f.ShowDialog() == DialogResult.OK)
            {
                FormAbnAkt frmAktRBP = new FormAbnAkt(this.SqlSettings, true, ABNSELECT, TypeDocValue.ActBalance);
                frmAktRBP.Owner = this;
                frmAktRBP.MdiParent = this.MdiParent;
                frmAktRBP.FormClosed += new FormClosedEventHandler(frmAktRBP_FormClosed);
                frmAktRBP.Show();
        ...
        private void tssbAddActLiabilityAbn_Click(object sender, EventArgs e)
        {
            ...
            if (f.ShowDialog() == DialogResult.OK)
            {
                FormAbnAkt frmAktRBP = new FormAbnAkt(this.SqlSettings, true, ABNSELECT, TypeDocValue.ActLiability);
                frmAktRBP.Owner = this;
                frmAktRBP.MdiParent = this.MdiParent;
                frmAktRBP.FormClosed += new FormClosedEventHandler(frmAktRBP_FormClosed);
                frmAktRBP.Show();
