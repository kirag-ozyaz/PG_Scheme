    ...
    public partial class FormAddEditRequest : FormLbr.FormBase
    {
        ...
        private void FormAddEditRequest_Load(object sender, EventArgs e)
        {
            ...
            switch (actionRequest)
            {
                ...
                case eActionRequest.Edit:
                    ...
                    if (dsGES.tJ_Request.Rows[0]["TextTaskBin"] != DBNull.Value)
                        richTextBoxTextTask.Rtf = GetString((byte[])dsGES.tJ_Request.Rows[0]["TextTaskBin"]);
        ...
        private void FormAddEditRequest_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (DialogResult == System.Windows.Forms.DialogResult.OK)
            {
                ...
                if (!string.IsNullOrEmpty(richTextBoxTextTask.Rtf))
                    dsGES.tJ_Request.Rows[0]["TextTaskBin"] = GetBytes(richTextBoxTextTask.Rtf);
                else
                    dsGES.tJ_Request.Rows[0]["TextTaskBin"] = DBNull.Value;
