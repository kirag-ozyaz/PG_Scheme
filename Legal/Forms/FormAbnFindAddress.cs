...
{
    public partial class FormAbnFindAddress : FormLbr.FormBase
    {
        private int selectedAbn = -1;
        ...
        public FormAbnFindAddress()
        {
            InitializeComponent();
        }

        private void FormAbnFindAddress_Load(object sender, EventArgs e)
        {
            LoadDirectory();
        }

        private void FormAbnFindAddress_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void LoadDirectory()
        {
           ...
           //     "where ParentKey = ';SKUEE;TypeAbn;' order by name");
        ...
        private void dgvFind_KeyDown(object sender, KeyEventArgs e)
        {
            if (Control.ModifierKeys == Keys.None)
            {
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    {
                        selectedAbn = Convert.ToInt32(dgvFind.CurrentRow.Cells["codeAbonentDgvTxtColumn"].Value);
                        selectedType= Convert.ToInt32(dgvFind.CurrentRow.Cells["typeAbnDgvTxtColumn"].Value);
