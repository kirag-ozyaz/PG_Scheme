...
{
    public partial class FormAbnStat : FormLbr.FormBase
    {
        private int ID = -1;
        ...
        private void FormAbnStat_Load(object sender, EventArgs e)
        {
            ...
            this.SelectSqlData(dsAbn, dsAbn.tR_Classifier, true, " where ParentId = " + (int)StatusAbnLegal.Parent + " order by Name");
            this.SelectSqlData(dsAbn, dsAbn.vG_AbnStatusReason, true, " where idAbn = " + ID.ToString() + "order by DateChange desc");
