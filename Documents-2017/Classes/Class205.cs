...
[DataObject(true), DesignerCategory("code"), HelpKeyword("vs.data.TableAdapter"), ToolboxItem(true), Designer("Microsoft.VSDesigner.DataSource.Design.TableAdapterDesigner, Microsoft.VSDesigner, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
internal class Class205 : Component
{
    private bool bool_0;
    ...
    public virtual int vmethod_0(OrgDataSet.tblAbnObjDataTable tblAbnObjDataTable_0, int? nullable_0)
    {
        ...
        if (this.method_6())
        {
            tblAbnObjDataTable_0.Clear();
        }
        return this.method_0().Fill(tblAbnObjDataTable_0);
    }
    ...
    public virtual OrgDataSet.tblAbnObjDataTable vmethod_1(int? nullable_0)
    {
        this.method_0().SelectCommand = this.method_5()[0];
        if (nullable_0.HasValue)
        {
        ...
        OrgDataSet.tblAbnObjDataTable dataTable = new OrgDataSet.tblAbnObjDataTable();
