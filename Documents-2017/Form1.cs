...
internal class Form1 : FormBase
{
            ...
            using (SqlConnection connection = new SqlConnection(this.get_SqlSettings().GetConnectionString() + ";Connection Timeout=1000"))
            {
                ...
                try
                {
                    using (SqlCommand command = new SqlCommand(ResourceReader.GetStringAssembly("Service.MoveAbnObj.sql"), connection))
                    {
                        ...
                        command.Parameters.Add("idAbnObj", SqlDbType.Int).Value = Convert.ToInt32(this.dataGridViewExcelFilter_2.CurrentRow.Cells[this.dataGridViewTextBoxColumn_2.Name].Value);
                        command.Parameters.Add("idMoveAbn", SqlDbType.Int).Value = Convert.ToInt32(this.dataGridViewExcelFilter_1.CurrentRow.Cells[this.dataGridViewTextBoxColumn_1.Name].Value);
    ...
    private void method_4()
    {
        ...
        this.button_0.Location = new Point(12, 0x1a2);
        ...
        DataGridViewColumn[] columnArray4 = new DataGridViewColumn[] { this.dataGridViewFilterTextBoxColumn_6, this.dataGridViewTextBoxColumn_2, this.dataGridViewTextBoxColumn_3, this.dataGridViewTextBoxColumn_4, this.dataGridViewFilterTextBoxColumn_7, this.dataGridViewFilterTextBoxColumn_8 };
        ...
        DataGridViewColumn[] columnArray5 = new DataGridViewColumn[] { this.dataGridViewFilterTextBoxColumn_3, this.dataGridViewTextBoxColumn_1, this.dataGridViewFilterTextBoxColumn_4, this.dataGridViewFilterTextBoxColumn_5 };
