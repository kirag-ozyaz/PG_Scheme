namespace Documents.Forms.TechnologicalConnection.ActTC
{
    ...
    public class FormTCAddEdit : FormBase
    {
        ...
        {
            e.Row.Cells[this.dataGridViewTextBoxColumn_64.Name].Value = this.int_0;
            e.Row.Cells[this.dataGridViewTextBoxColumn_66.Name].Value = 1;
            e.Row.Cells[this.dataGridViewTextBoxColumn_65.Name].Value = e.Row.Index + 1;
        }
        ...
        {
            if ((this.bool_0 && (MessageBox.Show("Сохранить внесенные изменения?", "Сохранение", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)) && !this.method_13())
            {
                e.Cancel = true;
            }
            else
        ...
        private void FormTCAddEdit_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                base.SelectSqlData(this.dataSetTechConnection_0, this.dataSetTechConnection_0.tTC_ActTC, true, "where id = " + this.int_0.ToString());
                base.SelectSqlData(this.dataSetTechConnection_0.tTC_TUTypeWork, true, "where idtu = " + this.int_0.ToString() + " order by num ", false);
                this.method_2();
                this.method_29(this.int_0);
            }
            this.method_20();
            this.method_32();
            this.method_33();
        ...
        private void method_0()
        {
            ...
            string[] textArray1 = new string[] { " where idTU = ", this.int_0.ToString(), " and (typeDoc is null or typeDoc = ", 0x4d8.ToString(), ")   order by num" };
        ...
        {
            this.dataGridView_0.Rows.Clear();
            string[] textArray1 = new string[] { " where idTU = ", this.int_1.ToString(), " and (typeDoc is null or typeDoc = ", 0x463.ToString(), ")  order by num" };
        ...
        private void method_14()
        {
            ...
            row["typeDoc"] = 0x4d8;
            row["idParent"] = this.comboBox_0.SelectedValue;
        ...
        {
            if (this.dataSetTechConnection_0.tTC_ActTC.Rows.Count > 0)
            {
                if (this.nullableNumericUpDown_0.get_Value().HasValue)
                {
                    this.dataSetTechConnection_0.tTC_ActTC.Rows[0]["PowerCurrent"] = this.nullableNumericUpDown_0.get_Value();
                }
                else
                {
                    this.dataSetTechConnection_0.tTC_ActTC.Rows[0]["PowerCurrent"] = DBNull.Value;
                }
                if (this.nullableNumericUpDown_1.get_Value().HasValue)
                {
                    this.dataSetTechConnection_0.tTC_ActTC.Rows[0]["PowerAdd"] = this.nullableNumericUpDown_1.get_Value();
                }
                else
                {
                    this.dataSetTechConnection_0.tTC_ActTC.Rows[0]["PowerAdd"] = DBNull.Value;
                }
                if (this.nullableNumericUpDown_2.get_Value().HasValue)
                {
                    this.dataSetTechConnection_0.tTC_ActTC.Rows[0]["PowerSum"] = this.nullableNumericUpDown_2.get_Value();
                }
                else
                {
                    this.dataSetTechConnection_0.tTC_ActTC.Rows[0]["PowerSum"] = DBNull.Value;
                }
                this.dataSetTechConnection_0.tTC_ActTC.Rows[0].EndEdit();
                return base.UpdateSqlData(this.dataSetTechConnection_0, this.dataSetTechConnection_0.tTC_ActTC);
            }
            if (this.int_0 <= 0)
            {
                return true;
            }
            DataRow row = this.dataSetTechConnection_0.tTC_ActTC.NewRow();
            row["id"] = this.int_0;
            if (this.nullableNumericUpDown_0.get_Value().HasValue)
            {
                row["PowerCurrent"] = this.nullableNumericUpDown_0.get_Value();
            }
            if (this.nullableNumericUpDown_1.get_Value().HasValue)
            {
            ...
            this.dataSetTechConnection_0.tTC_ActTC.Rows.Add(row);
            if (base.InsertSqlData(this.dataSetTechConnection_0, this.dataSetTechConnection_0.tTC_ActTC))
            {
                this.dataSetTechConnection_0.tTC_ActTC.AcceptChanges();
                return true;
            }
            this.dataSetTechConnection_0.tTC_ActTC.Clear();
            return false;
        }
        ...
        private bool method_18()
        {
            foreach (DataGridViewRow row in (IEnumerable) this.dataGridView_0.Rows)
            {
                ...
                {
                    if ((this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idTU"] == DBNull.Value) || (Convert.ToInt32(this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idTU"]) != this.int_0))
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idTU"] = this.int_0;
                    }
                    if ((this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["num"] == DBNull.Value) || (Convert.ToInt32(this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["num"]) != (row.Index + 1)))
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["num"] = row.Index + 1;
                    }
                    object obj2 = (row.Cells[this.dataGridViewTextBoxColumn_47.Name].Value != null) ? row.Cells[this.dataGridViewTextBoxColumn_47.Name].Value : DBNull.Value;
                    object obj3 = this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idSubPoint"];
                    ...
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idSubPoint"] = obj2;
                    }
                    obj2 = (row.Cells[this.dataGridViewTextBoxColumn_49.Name].Value != null) ? row.Cells[this.dataGridViewTextBoxColumn_49.Name].Value : DBNull.Value;
                    obj3 = this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idBusPoint"];
                    if (((obj2 != DBNull.Value) || (obj3 != DBNull.Value)) && ((((obj2 == DBNull.Value) && (obj3 != DBNull.Value)) || ((obj2 != DBNull.Value) && (obj3 == DBNull.Value))) || (Convert.ToInt32(obj2) != Convert.ToInt32(obj3))))
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idBusPoint"] = obj2;
                    }
                    obj2 = (row.Cells[this.dataGridViewTextBoxColumn_51.Name].Value != null) ? row.Cells[this.dataGridViewTextBoxColumn_51.Name].Value : DBNull.Value;
                    obj3 = this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idCellPoint"];
                    if (((obj2 != DBNull.Value) || (obj3 != DBNull.Value)) && ((((obj2 == DBNull.Value) && (this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idCellPoint"] != DBNull.Value)) || ((obj2 != DBNull.Value) && (this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idCellPoint"] == DBNull.Value))) || (Convert.ToInt32(obj2) != Convert.ToInt32(this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idCellPoint"]))))
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idCellPoint"] = obj2;
                    }
                    obj2 = (row.Cells[this.dataGridViewTextBoxColumn_53.Name].Value != null) ? row.Cells[this.dataGridViewTextBoxColumn_53.Name].Value : DBNull.Value;
                    obj3 = this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idSubCP"];
                    if (((obj2 != DBNull.Value) || (obj3 != DBNull.Value)) && ((((obj2 == DBNull.Value) && (obj3 != DBNull.Value)) || ((obj2 != DBNull.Value) && (obj3 == DBNull.Value))) || (Convert.ToInt32(obj2) != Convert.ToInt32(obj3))))
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idSubCP"] = obj2;
                    }
                    obj2 = (row.Cells[this.dataGridViewTextBoxColumn_55.Name].Value != null) ? row.Cells[this.dataGridViewTextBoxColumn_55.Name].Value : DBNull.Value;
                    obj3 = this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idBusCP"];
                    if (((obj2 != DBNull.Value) || (obj3 != DBNull.Value)) && ((((obj2 == DBNull.Value) && (this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idBusCP"] != DBNull.Value)) || ((obj2 != DBNull.Value) && (this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idBusCP"] == DBNull.Value))) || (Convert.ToInt32(obj2) != Convert.ToInt32(this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idBusCP"]))))
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idBusCP"] = obj2;
                    }
                    obj2 = (row.Cells[this.dataGridViewTextBoxColumn_57.Name].Value != null) ? row.Cells[this.dataGridViewTextBoxColumn_57.Name].Value : DBNull.Value;
                    obj3 = this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idCellCP"];
                    if (((obj2 != DBNull.Value) || (obj3 != DBNull.Value)) && ((((obj2 == DBNull.Value) && (this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idCellCP"] != DBNull.Value)) || ((obj2 != DBNull.Value) && (this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idCellCP"] == DBNull.Value))) || (Convert.ToInt32(obj2) != Convert.ToInt32(this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idCellCP"]))))
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["idCellCP"] = obj2;
                    }
                    obj2 = (row.Cells[this.dataGridViewTextBoxColumn_59.Name].Value != null) ? row.Cells[this.dataGridViewTextBoxColumn_59.Name].Value : DBNull.Value;
                    obj3 = this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["voltageLevel"];
                    if (((obj2 != DBNull.Value) || (obj3 != DBNull.Value)) && ((((obj2 == DBNull.Value) && (this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["voltageLevel"] != DBNull.Value)) || ((obj2 != DBNull.Value) && (this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["voltageLevel"] == DBNull.Value))) || (Convert.ToInt32(obj2) != Convert.ToInt32(this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["voltageLevel"]))))
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["voltageLevel"] = obj2;
                    }
                    obj2 = (row.Cells[this.dataGridViewTextBoxColumn_61.Name].Value != null) ? row.Cells[this.dataGridViewTextBoxColumn_61.Name].Value : DBNull.Value;
                    obj3 = this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["PowerSum"];
                    if (((obj2 != DBNull.Value) || (obj3 != DBNull.Value)) && ((((obj2 == DBNull.Value) && (this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["PowerSum"] != DBNull.Value)) || ((obj2 != DBNull.Value) && (this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["PowerSum"] == DBNull.Value))) || (Convert.ToInt32(obj2) != Convert.ToInt32(this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["PowerSum"]))))
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["PowerSum"] = obj2;
                    }
                    if ((this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["TypeDoc"] == DBNull.Value) || (Convert.ToInt32(this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["TypeDoc"]) != 0x4d8))
                    {
                        this.dataSetTechConnection_0.tTC_TUPointAttach.Rows[row.Index]["TypeDoc"] = 0x4d8;
                    }
                ...
                else
                {
                    ...
                    if (row.Cells[this.dataGridViewTextBoxColumn_47.Name].Value != null)
                    {
                        row2["idSubPoint"] = row.Cells[this.dataGridViewTextBoxColumn_47.Name].Value;
                    }
                    if (row.Cells[this.dataGridViewTextBoxColumn_49.Name].Value != null)
                    {
                        row2["idBusPoint"] = row.Cells[this.dataGridViewTextBoxColumn_49.Name].Value;
                    }
                    if (row.Cells[this.dataGridViewTextBoxColumn_51.Name].Value != null)
                    {
                        row2["idCellPoint"] = row.Cells[this.dataGridViewTextBoxColumn_51.Name].Value;
                    }
                    if (row.Cells[this.dataGridViewTextBoxColumn_53.Name].Value != null)
                    {
                        row2["idSubCP"] = row.Cells[this.dataGridViewTextBoxColumn_53.Name].Value;
                    }
                    if (row.Cells[this.dataGridViewTextBoxColumn_55.Name].Value != null)
                    {
                        row2["idBusCP"] = row.Cells[this.dataGridViewTextBoxColumn_55.Name].Value;
                    }
                    if (row.Cells[this.dataGridViewTextBoxColumn_57.Name].Value != null)
                    {
                        row2["idCellCP"] = row.Cells[this.dataGridViewTextBoxColumn_57.Name].Value;
                    }
                    if (row.Cells[this.dataGridViewTextBoxColumn_59.Name].Value != null)
                    {
                        row2["voltageLevel"] = row.Cells[this.dataGridViewTextBoxColumn_59.Name].Value;
                    }
                    if (row.Cells[this.dataGridViewTextBoxColumn_61.Name].Value != null)
                    {
                        row2["PowerSum"] = row.Cells[this.dataGridViewTextBoxColumn_61.Name].Value;
                    }
                    row2["TypeDoc"] = 0x4d8;
        ...
        private bool method_19()
        {
            ...
            base.SelectSqlData(table, true, " where idDoc = " + this.int_0.ToString() + " and typeDoc = " + 0x4d8.ToString(), false);
            ...
            foreach (DataRow row in this.dataSetTechConnection_0.tTC_TUPointAttach)
            {
                ...
                if (num2 != -1)
                {
                    ...
                    {
                        source[0]["idAbn"] = this.int_2;
                        source[0]["idAbnObj"] = this.int_3;
                        source[0]["idPoint"] = DBNull.Value;
                        source[0]["idDoc"] = this.int_0;
                        source[0]["typeDoc"] = 0x4d8;
                        source[0].EndEdit();
                    ...
                    else
                    {
                        ...
                        row2["idSchmObj"] = num2;
                        row2["idAbn"] = this.int_2;
                        row2["idAbnObj"] = this.int_3;
                        row2["idPoint"] = DBNull.Value;
                        row2["idDoc"] = this.int_0;
                        row2["typeDoc"] = 0x4d8;
                        table.Rows.Add(row2);
                    }
                }
        ...
        {
            int num = 0x1f1;
            DataTable table = base.SelectSqlData("tAbnObjDoc_AktRBP", true, " left join tAbnObjDoc_List l on l.id = tAbnObjDoc_AktRBP.idList  where idTU = " + this.int_1.ToString() + " and l.idDocType = " + num.ToString());
            if ((this.int_0 > 0) && ((table == null) || (table.Rows.Count == 0)))
            {
                num = 0x1f1;
                table = base.SelectSqlData("tAbnObjDoc_AktRBP", true, " left join tAbnObjDoc_List l on l.id = tAbnObjDoc_AktRBP.idList  where idActTehConnection = " + this.int_1.ToString() + " and l.idDocType = " + num.ToString());
            }
            if ((table != null) && (table.Rows.Count > 0))
            {
                this.dataGridView_0.Rows.Clear();
                string[] textArray1 = new string[5];
                textArray1[0] = " where idTU = ";
                textArray1[1] = table.Rows[0]["idList"].ToString();
                textArray1[2] = " and typeDoc = ";
                num = 0x1f1;
                textArray1[3] = num.ToString();
                textArray1[4] = " order by num";
                base.SelectSqlData(this.dataSetTechConnection_0, this.dataSetTechConnection_0.vTC_TUPointAttach, true, string.Concat(textArray1));
                foreach (DataRow row in this.dataSetTechConnection_0.vTC_TUPointAttach)
                {
                    object[] values = new object[] { 
                ...
                if (this.int_0 > 0)
                {
                    string[] textArray2 = new string[] { " where idTU = ", this.int_0.ToString(), " and (typeDoc is null or typeDoc = ", 0x4d8.ToString(), ")   order by num" };
        ...
        private void method_20()
        {
            foreach (DataRow row in new SqlDataCommand(this.get_SqlSettings()).SelectSqlData(" SELECT doc.id, doc.FileName  FROM tR_DocTemplate AS doc  INNER JOIN [tR_Classifier] AS c ON doc.idTypeDoc = c.id  WHERE c.ParentKey = ';TypeDoc;tR_DocTemplate;' AND c.Deleted = ((0)) AND c.isGroup = ((0)) AND c.Value = 1 and doc.deleted = 0").Rows)
            {
                ...
                item.Click += new EventHandler(this.method_22);
                this.toolStripDropDownButton_0.DropDownItems.Add(item);
                ToolStripMenuItem item2 = new ToolStripMenuItem {
                    Text = row["FileName"].ToString(),
                    Tag = row["id"]
                };
                item2.Click += new EventHandler(this.method_22);
                this.toolStripMenuItem_1.DropDownItems.Add(item2);
            }
        }

        private string method_21(string string_2, int? nullable_0 = new int?(), byte[] byte_0 = null)
        {
        ...
        Label_0162:
            ...
            string str5 = this.method_21(str, new int?(tag), buffer);
            if (!string.IsNullOrEmpty(str5))
            {
                ...
                else if (!this.method_23(str3 + @"\" + binary.get_Name()))
                {
                    Process.Start(str3 + @"\" + binary.get_Name());
                }
                if (this.dictionary_0.ContainsKey(str5))
                {
                    ...
                    watcher.add_AnyChanged(new FileSystemEventHandler(this.method_25));
                    watcher.Start();
        ...
        private bool method_23(string string_2)
        {
            ...
            try
            {
                ...
                {
                    int num = -1;
                    if ((this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_51.Name].Value != null) && (this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_51.Name].Value != DBNull.Value))
                    {
                        num = Convert.ToInt32(this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_51.Name].Value);
                    }
                    else if ((this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_49.Name].Value != null) && (this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_49.Name].Value != DBNull.Value))
                    {
                ...
                if (bookmarks.Exists("CP"))
                {
                    ...
                    {
                        int num2 = -1;
                        if ((this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_57.Name].Value != null) && (this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_57.Name].Value != DBNull.Value))
                        {
                            num2 = Convert.ToInt32(this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_57.Name].Value);
                        }
                        else if ((this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_55.Name].Value != null) && (this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_55.Name].Value != DBNull.Value))
                        {
                            num2 = Convert.ToInt32(this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_55.Name].Value);
                        }
                        else if ((this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_53.Name].Value != null) && (this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_53.Name].Value != DBNull.Value))
                        {
                            num2 = Convert.ToInt32(this.dataGridView_0.Rows[0].Cells[this.dataGridViewTextBoxColumn_53.Name].Value);
                        }
                        if (num2 > 0)
                        {
                ...
                if (bookmarks.Exists("CP2"))
                {
                    ...
                    {
                        int num3 = -1;
                        if ((this.dataGridView_0.Rows[1].Cells[this.dataGridViewTextBoxColumn_57.Name].Value != null) && (this.dataGridView_0.Rows[1].Cells[this.dataGridViewTextBoxColumn_57.Name].Value != DBNull.Value))
                        {
                            num3 = Convert.ToInt32(this.dataGridView_0.Rows[1].Cells[this.dataGridViewTextBoxColumn_57.Name].Value);
                        }
                        else if ((this.dataGridView_0.Rows[1].Cells[this.dataGridViewTextBoxColumn_55.Name].Value != null) && (this.dataGridView_0.Rows[1].Cells[this.dataGridViewTextBoxColumn_55.Name].Value != DBNull.Value))
                        {
                            num3 = Convert.ToInt32(this.dataGridView_0.Rows[1].Cells[this.dataGridViewTextBoxColumn_55.Name].Value);
                        }
                        else if ((this.dataGridView_0.Rows[1].Cells[this.dataGridViewTextBoxColumn_53.Name].Value != null) && (this.dataGridView_0.Rows[1].Cells[this.dataGridViewTextBoxColumn_53.Name].Value != DBNull.Value))
                        {
                            num3 = Convert.ToInt32(this.dataGridView_0.Rows[1].Cells[this.dataGridViewTextBoxColumn_53.Name].Value);
                        }
                        if (num3 > 0)
                        {
                ...
                if (bookmarks.Exists("NetWork"))
                {
                    ...
                    foreach (DataGridViewRow row in (IEnumerable) this.dataGridViewExcelFilter_2.Rows)
                    {
                        if (row.Cells[this.dataGridViewTextBoxColumn_62.Name].Value != null)
                        {
                            ...
                            {
                                str4 = str4 + row.Cells[this.dataGridViewTextBoxColumn_62.Name].Value + ";";
                            }
                            else
                            {
                                object[] objArray1 = new object[] { str4, "\r\n", row.Cells[this.dataGridViewTextBoxColumn_62.Name].Value, ";" };
        ...
        private void method_24(bool bool_1 = false)
        {
            if (this.bindingSource_0.Current != null)
            {
                ...
                if (bool_1)
                {
                    if (this.dictionary_0.ContainsKey(fileName))
                    {
                        ...
                        {
                            this.dictionary_0[fileName].get_Watcher().remove_AnyChanged(new FileSystemEventHandler(this.method_25));
                            this.dictionary_0[fileName].get_Watcher().Stop();
                            FileWatcher watcher2 = new FileWatcher(str2, str3);
                            watcher2.add_AnyChanged(new FileSystemEventHandler(this.method_25));
                            watcher2.Start();
                    ...
                    else
                    {
                        ...
                        watcher3.add_AnyChanged(new FileSystemEventHandler(this.method_25));
                        watcher3.Start();
        ...
        private void method_25(object sender, FileSystemEventArgs e)
        {
            Class288 class2 = new Class288 {
        ...
        private bool method_26(string string_2)
        {
            Class289 class2 = new Class289 {
                string_0 = string_2
            };
        ...
        private void method_29(int int_4)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(this.get_SqlSettings().GetConnectionString()))
        ...
        private bool method_31()
        {
            ...
            foreach (DataGridViewRow row in (IEnumerable) this.dataGridViewExcelFilter_2.Rows)
            {
                if ((row.Cells[this.dataGridViewTextBoxColumn_63.Name].Value != null) && (row.Cells[this.dataGridViewTextBoxColumn_63.Name].Value != DBNull.Value))
                {
                    DataSetTechConnection.Class255 class1 = this.dataSetTechConnection_0.tTC_TUTypeWork.method_2(Convert.ToInt32(row.Cells[this.dataGridViewTextBoxColumn_63.Name].Value));
        ...
        private void method_35()
        {
            ...
            ComponentResourceManager manager = new ComponentResourceManager(typeof(FormTCAddEdit));
            ...
            this.label_0.Size = new Size(0x7b, 13);
            ...
            this.label_1.Size = new Size(0x73, 13);
            ...
            this.comboBox_0.Size = new Size(0x209, 0x15);
            ...
            this.textBox_2.Size = new Size(0x209, 20);
            ...
            this.textBox_1.Size = new Size(0x209, 20);
            ...
            this.label_5.Location = new Point(0x10, 0x196);
            ...
            this.comboBox_1.DataBindings.Add(new Binding("SelectedValue", this.dataSetTechConnection_0, "tTC_ActTC.Category", true));
            this.comboBox_1.FormattingEnabled = true;
            this.comboBox_1.Location = new Point(0xb2, 0xa5);
            this.comboBox_1.Name = "cmbCategory";
            this.comboBox_1.Size = new Size(0x206, 0x15);
            ...
            this.nullableNumericUpDown_0.DataBindings.Add(new Binding("Value", this.dataSetTechConnection_0, "tTC_ActTC.PowerCurrent", true));
            this.nullableNumericUpDown_0.DecimalPlaces = 3;
            this.nullableNumericUpDown_0.Location = new Point(0xa5, 0xdb);
            int[] bits = new int[4];
            bits[0] = 0x186a0;
            this.nullableNumericUpDown_0.Maximum = new decimal(bits);
            this.nullableNumericUpDown_0.Name = "numPower";
            this.nullableNumericUpDown_0.Size = new Size(0x213, 20);
            ...
            this.label_7.Location = new Point(13, 0xdd);
            ...
            this.comboBox_2.DataBindings.Add(new Binding("SelectedValue", this.dataSetTechConnection_0, "tTC_ActTC.Performer", true));
            this.comboBox_2.FormattingEnabled = true;
            this.comboBox_2.Location = new Point(0x15f, 0x12);
            this.comboBox_2.Name = "cmbPerformer";
            this.comboBox_2.Size = new Size(0x15f, 0x15);
            ...
            this.label_9.Location = new Point(12, 0xc3);
            ...
            this.comboBox_3.DataBindings.Add(new Binding("SelectedValue", this.dataSetTechConnection_0, "tTC_ActTC.VoltageLevel", true));
            this.comboBox_3.FormattingEnabled = true;
            this.comboBox_3.Location = new Point(0xa5, 0xc0);
            this.comboBox_3.Name = "cmbVoltageLevel";
            this.comboBox_3.Size = new Size(0x213, 0x15);
            ...
            this.nullableNumericUpDown_1.DataBindings.Add(new Binding("Value", this.dataSetTechConnection_0, "tTC_ActTC.PowerAdd", true));
            this.nullableNumericUpDown_1.DecimalPlaces = 3;
            this.nullableNumericUpDown_1.Location = new Point(0xa5, 0xf5);
            int[] numArray2 = new int[4];
            numArray2[0] = 0x186a0;
            this.nullableNumericUpDown_1.Maximum = new decimal(numArray2);
            this.nullableNumericUpDown_1.Name = "numPowerAdd";
            this.nullableNumericUpDown_1.Size = new Size(0x213, 20);
            ...
            this.label_10.Location = new Point(13, 0xf7);
            ...
            this.nullableNumericUpDown_2.DataBindings.Add(new Binding("Value", this.dataSetTechConnection_0, "tTC_ActTC.PowerSum", true));
            this.nullableNumericUpDown_2.DecimalPlaces = 3;
            this.nullableNumericUpDown_2.Location = new Point(0xa5, 0x10f);
            int[] numArray3 = new int[4];
            numArray3[0] = 0x186a0;
            this.nullableNumericUpDown_2.Maximum = new decimal(numArray3);
            this.nullableNumericUpDown_2.Name = "numPowerSum";
            this.nullableNumericUpDown_2.Size = new Size(0x213, 20);
            ...
            this.label_11.Location = new Point(13, 0x111);
            ...
            this.label_12.Location = new Point(12, 0x12d);
            ...
            DataGridViewColumn[] dataGridViewColumns = new DataGridViewColumn[] { 
                this.dataGridViewTextBoxColumn_45, this.dataGridViewTextBoxColumn_46, this.dataGridViewTextBoxColumn_47, this.dataGridViewTextBoxColumn_48, this.dataGridViewTextBoxColumn_49, this.dataGridViewTextBoxColumn_50, this.dataGridViewTextBoxColumn_51, this.dataGridViewTextBoxColumn_52, this.dataGridViewTextBoxColumn_53, this.dataGridViewTextBoxColumn_54, this.dataGridViewTextBoxColumn_55, this.dataGridViewTextBoxColumn_56, this.dataGridViewTextBoxColumn_57, this.dataGridViewTextBoxColumn_58, this.dataGridViewTextBoxColumn_59, this.dataGridViewTextBoxColumn_60,
            ...
            this.dataGridView_0.Location = new Point(9, 0x13d);
            ...
            this.dataGridView_0.Size = new Size(0x2b5, 0x56);
            ...
            this.dataGridViewTextBoxColumn_45.Name = "idDataGridViewTextBoxColumn";
            this.dataGridViewTextBoxColumn_45.ReadOnly = true;
            this.dataGridViewTextBoxColumn_45.Visible = false;
            this.dataGridViewTextBoxColumn_46.HeaderText = "num";
            this.dataGridViewTextBoxColumn_46.Name = "numDataGridViewTextBoxColumn";
            this.dataGridViewTextBoxColumn_46.ReadOnly = true;
            this.dataGridViewTextBoxColumn_46.Visible = false;
            this.dataGridViewTextBoxColumn_47.HeaderText = "idSubPoint";
            this.dataGridViewTextBoxColumn_47.Name = "idSubPointColumn";
            ...
            this.dataGridViewTextBoxColumn_48.HeaderText = "ТП/РП";
            this.dataGridViewTextBoxColumn_48.Name = "subPointDgvColumn";
            ...
            this.dataGridViewTextBoxColumn_49.HeaderText = "idBusPoint";
            this.dataGridViewTextBoxColumn_49.Name = "idBusPointColumn";
            this.dataGridViewTextBoxColumn_49.ReadOnly = true;
            this.dataGridViewTextBoxColumn_49.Visible = false;
            this.dataGridViewTextBoxColumn_50.HeaderText = "Шина";
            this.dataGridViewTextBoxColumn_50.Name = "busPointDataGridViewTextBoxColumn";
            ...
            this.dataGridViewTextBoxColumn_51.HeaderText = "idCellPoint";
            this.dataGridViewTextBoxColumn_51.Name = "idCellPointColumn";
            this.dataGridViewTextBoxColumn_51.ReadOnly = true;
            this.dataGridViewTextBoxColumn_51.Visible = false;
            this.dataGridViewTextBoxColumn_52.HeaderText = "Ячейка";
            this.dataGridViewTextBoxColumn_52.Name = "cellPointDataGridViewTextBoxColumn";
            this.dataGridViewTextBoxColumn_52.ReadOnly = true;
            this.dataGridViewTextBoxColumn_52.SortMode = DataGridViewColumnSortMode.NotSortable;
            this.dataGridViewTextBoxColumn_52.Width = 50;
            this.dataGridViewTextBoxColumn_53.HeaderText = "idSubCP";
            this.dataGridViewTextBoxColumn_53.Name = "idSubCPColumn";
            ...
            this.dataGridViewTextBoxColumn_54.HeaderText = "ЦП";
            this.dataGridViewTextBoxColumn_54.Name = "subCPDataGridViewTextBoxColumn";
            ...
            this.dataGridViewTextBoxColumn_55.HeaderText = "idBusCP";
            this.dataGridViewTextBoxColumn_55.Name = "idBusCPColumn";
            this.dataGridViewTextBoxColumn_55.ReadOnly = true;
            this.dataGridViewTextBoxColumn_55.Visible = false;
            this.dataGridViewTextBoxColumn_56.HeaderText = "Шина";
            this.dataGridViewTextBoxColumn_56.Name = "busCPDataGridViewTextBoxColumn";
            this.dataGridViewTextBoxColumn_56.ReadOnly = true;
            this.dataGridViewTextBoxColumn_56.SortMode = DataGridViewColumnSortMode.NotSortable;
            this.dataGridViewTextBoxColumn_56.Width = 50;
            this.dataGridViewTextBoxColumn_57.HeaderText = "idCellCP";
            this.dataGridViewTextBoxColumn_57.Name = "idCellCPColumn";
            ...
            this.dataGridViewTextBoxColumn_58.Name = "cellCPDataGridViewTextBoxColumn";
            ...
            this.dataGridViewTextBoxColumn_58.Width = 50;
            this.dataGridViewTextBoxColumn_59.HeaderText = "VoltageLevel";
            this.dataGridViewTextBoxColumn_59.Name = "voltageLevelDgvColumn";
            this.dataGridViewTextBoxColumn_59.ReadOnly = true;
            this.dataGridViewTextBoxColumn_59.Visible = false;
            this.dataGridViewTextBoxColumn_60.HeaderText = "Напр-ние";
            this.dataGridViewTextBoxColumn_60.Name = "voltageLevelNameDgvColumn";
            this.dataGridViewTextBoxColumn_60.ReadOnly = true;
            this.dataGridViewTextBoxColumn_61.HeaderText = "Мощ-сть";
            this.dataGridViewTextBoxColumn_61.Name = "powerSumDgvColumn";
            ...
            this.toolStrip_0.Location = new Point(0x98, 0x123);
            ...
            this.button_0.Location = new Point(12, 0x229);
            ...
            this.button_1.Location = new Point(0x273, 0x229);
            ...
            this.tabControl_0.Size = new Size(0x2cc, 0x223);
            ...
            this.tabPage_0.Size = new Size(0x2c4, 0x209);
            ...
            this.tabControl_1.Size = new Size(0x2a9, 0x71);
            ...
            this.tabPage_2.Size = new Size(0x2a1, 0x57);
            ...
            this.tabPage_3.Size = new Size(0x2a1, 0x57);
            ...
            this.dataGridViewExcelFilter_1.Size = new Size(0x29b, 0x51);
            ...
            this.tabPage_4.Size = new Size(0x2c4, 0x209);
            ...
            this.splitContainer_0.Size = new Size(0x2c4, 0x209);
            this.splitContainer_0.SplitterDistance = 0x107;
            ...
            DataGridViewColumn[] columnArray3 = new DataGridViewColumn[] { this.dataGridViewTextBoxColumn_62, this.dataGridViewTextBoxColumn_63, this.dataGridViewTextBoxColumn_64, this.dataGridViewTextBoxColumn_65, this.dataGridViewTextBoxColumn_66 };
            ...
            this.dataGridViewExcelFilter_2.Size = new Size(0x2c4, 0xee);
            ...
            this.dataGridViewTextBoxColumn_62.DataPropertyName = "Work";
            style6.WrapMode = DataGridViewTriState.True;
            this.dataGridViewTextBoxColumn_62.DefaultCellStyle = style6;
            this.dataGridViewTextBoxColumn_62.HeaderText = "Работы";
            this.dataGridViewTextBoxColumn_62.Name = "netWorkDgvColumn";
            ...
            this.dataGridViewTextBoxColumn_63.DataPropertyName = "id";
            this.dataGridViewTextBoxColumn_63.HeaderText = "id";
            this.dataGridViewTextBoxColumn_63.Name = "idNetWorkDgvColumn";
            this.dataGridViewTextBoxColumn_63.ReadOnly = true;
            this.dataGridViewTextBoxColumn_63.Visible = false;
            this.dataGridViewTextBoxColumn_64.DataPropertyName = "idTU";
            this.dataGridViewTextBoxColumn_64.HeaderText = "idTU";
            this.dataGridViewTextBoxColumn_64.Name = "idTUNetWorkDgvColumn";
            this.dataGridViewTextBoxColumn_64.Visible = false;
            this.dataGridViewTextBoxColumn_65.DataPropertyName = "num";
            this.dataGridViewTextBoxColumn_65.HeaderText = "num";
            this.dataGridViewTextBoxColumn_65.Name = "numNetWorkDgvColumn";
            this.dataGridViewTextBoxColumn_65.Visible = false;
            this.dataGridViewTextBoxColumn_66.DataPropertyName = "TypeWork";
            this.dataGridViewTextBoxColumn_66.HeaderText = "TypeWork";
            this.dataGridViewTextBoxColumn_66.Name = "typeWorkNetWorkDgvColumn";
            ...
            ToolStripItem[] itemArray2 = new ToolStripItem[] { this.toolStripLabel_0, this.toolStripButton_10, this.toolStripButton_11, this.toolStripSeparator_5, this.toolStripComboBox_0, this.toolStripButton_14 };
            this.toolStrip_2.Items.AddRange(itemArray2);
            this.toolStrip_2.Location = new Point(0, 0);
            this.toolStrip_2.Name = "toolStripNetWork";
            this.toolStrip_2.Size = new Size(0x2c4, 0x19);
            ...
            this.dataGridViewExcelFilter_3.Size = new Size(0x2c4, 0xe5);
            ...
            ToolStripItem[] itemArray3 = new ToolStripItem[] { this.toolStripLabel_1, this.toolStripButton_12, this.toolStripButton_13, this.toolStripSeparator_6, this.toolStripComboBox_1, this.toolStripButton_15 };
            ...
            this.toolStrip_3.Size = new Size(0x2c4, 0x19);
            ...
            this.tabPage_1.Size = new Size(0x2c4, 0x209);
            ...
            this.dataGridViewExcelFilter_0.Size = new Size(0x2be, 490);
            ...
            this.toolStrip_1.Size = new Size(0x2be, 0x19);
            ...
            base.ClientSize = new Size(0x2ca, 0x24c);
            base.Controls.Add(this.tabControl_0);
            base.Controls.Add(this.button_1);
            base.Controls.Add(this.button_0);
            base.Name = "FormTCAddEdit";
            this.Text = "FormTCAddEdit";
            base.FormClosing += new FormClosingEventHandler(this.FormTCAddEdit_FormClosing);
            base.Load += new EventHandler(this.FormTCAddEdit_Load);
            ...
            else
            {
                ...
                if (num2 != -1)
                {
                    ...
                    if ((table4.Rows.Count > 0) && (table4.Rows[0]["idAbn"] != DBNull.Value))
                    {
                        ...
                        {
                            this.textBox_1.Text = table5.Rows[0]["name"].ToString();
        ...
        private void method_7(object object_0, object object_1)
        {
            if (object_0 != DBNull.Value)
            {
                ...
                if (table.Rows.Count > 0)
                {
                    this.textBox_1.Text = table.Rows[0]["name"].ToString();
        ...
        private void method_8()
        {
            ...
            {
                base.SelectSqlData(this.dataSetTechConnection_0, this.dataSetTechConnection_0.tTC_TU, true, "where id = " + this.int_1.ToString());
                if (this.dataSetTechConnection_0.tTC_TU.Rows.Count > 0)
                {
                    decimal? nullable;
                    this.comboBox_1.SelectedValue = this.dataSetTechConnection_0.tTC_TU.Rows[0]["category"];
                    this.comboBox_3.SelectedValue = this.dataSetTechConnection_0.tTC_TU.Rows[0]["voltagelevel"];
                    if (this.dataSetTechConnection_0.tTC_TU.Rows[0]["Power"] != DBNull.Value)
                    {
                        this.nullableNumericUpDown_0.set_Value(new decimal?(Convert.ToDecimal(this.dataSetTechConnection_0.tTC_TU.Rows[0]["Power"])));
                    }
                    else
                    {
                        nullable = null;
                    ...
                    if (this.dataSetTechConnection_0.tTC_TU.Rows[0]["PowerAdd"] != DBNull.Value)
                    {
                        this.nullableNumericUpDown_1.set_Value(new decimal?(Convert.ToDecimal(this.dataSetTechConnection_0.tTC_TU.Rows[0]["PowerAdd"])));
                    }
                    else
                    {
                        nullable = null;
                    ...
                    if (this.dataSetTechConnection_0.tTC_TU.Rows[0]["PowerSum"] != DBNull.Value)
                    {
                        this.nullableNumericUpDown_2.set_Value(new decimal?(Convert.ToDecimal(this.dataSetTechConnection_0.tTC_TU.Rows[0]["PowerSum"])));
                    }
                    else
                    {
                        this.nullableNumericUpDown_2.set_Value(null);
        ...
        private void toolStripButton_1_Click(object sender, EventArgs e)
        {
            if (this.dataGridView_0.CurrentRow != null)
            {
                ...
                if (obj2.ShowDialog() == DialogResult.OK)
                {
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_47.Name].Value = obj2.idSubPoint;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_48.Name].Value = obj2.SubPoint;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_49.Name].Value = obj2.idBusPoint;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_50.Name].Value = obj2.BusPoint;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_51.Name].Value = obj2.idCellPoint;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_52.Name].Value = obj2.CellPoint;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_53.Name].Value = obj2.idSubCP;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_54.Name].Value = obj2.SubCP;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_55.Name].Value = obj2.idBusCP;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_56.Name].Value = obj2.BusCP;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_57.Name].Value = obj2.idCellCP;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_58.Name].Value = obj2.CellCP;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_59.Name].Value = obj2.idVoltagelevel;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_60.Name].Value = obj2.VoltageLevel;
                    this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_61.Name].Value = obj2.PowerSum;
                    this.bool_0 = true;
                }
            }
        }
        ...
        {
            if (((this.dataGridViewExcelFilter_2.CurrentRow != null) && (this.dataGridViewExcelFilter_2.CurrentRow.Index > 0)) && ((this.dataGridViewExcelFilter_2.CurrentRow.Cells[this.dataGridViewTextBoxColumn_63.Name].Value != null) && (this.dataGridViewExcelFilter_2.CurrentRow.Cells[this.dataGridViewTextBoxColumn_63.Name].Value != DBNull.Value)))
            {
                DataRow row = this.dataSetTechConnection_0.tTC_TUTypeWork.method_2(Convert.ToInt32(this.dataGridViewExcelFilter_2.CurrentRow.Cells[this.dataGridViewTextBoxColumn_63.Name].Value));
                DataSetTechConnection.Class255 class1 = this.dataSetTechConnection_0.tTC_TUTypeWork.method_2(Convert.ToInt32(this.dataGridViewExcelFilter_2.Rows[this.dataGridViewExcelFilter_2.CurrentRow.Index - 1].Cells[this.dataGridViewTextBoxColumn_63.Name].Value));
        ...
        private void toolStripButton_11_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRow row = this.dataSetTechConnection_0.tTC_TUTypeWork.method_2(Convert.ToInt32(this.dataGridViewExcelFilter_2.CurrentRow.Cells[this.dataGridViewTextBoxColumn_63.Name].Value));
                DataRow row2 = this.dataSetTechConnection_0.tTC_TUTypeWork.method_2(Convert.ToInt32(this.dataGridViewExcelFilter_2.Rows[this.dataGridViewExcelFilter_2.CurrentRow.Index + 1].Cells[this.dataGridViewTextBoxColumn_63.Name].Value));
        ...
        private void toolStripButton_3_Click(object sender, EventArgs e)
        {
            if ((this.dataGridView_0.CurrentRow != null) && (this.dataGridView_0.CurrentRow.Index > 0))
            {
                ...
                this.dataGridView_0[this.dataGridViewTextBoxColumn_48.Name, index - 1].Selected = true;
                this.dataGridView_0.CurrentCell = this.dataGridView_0[this.dataGridViewTextBoxColumn_48.Name, index - 1];
                this.bool_0 = true;
            }
        }
        ...
        private void toolStripMenuItem_2_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    int? nullable = null;
                    if (!string.IsNullOrEmpty(this.method_21(str, nullable, null)))
                    {
                        this.bool_0 = true;
                    }
                }
