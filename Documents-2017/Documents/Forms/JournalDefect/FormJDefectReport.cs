namespace Documents.Forms.JournalDefect
{
    ...
    public class FormJDefectReport : FormBase
    {
        ...
        private void FormJDefectReport_Load(object sender, EventArgs e)
        {
        ...
        private void method_1()
        {
            ...
            base.Load += new EventHandler(this.FormJDefectReport_Load);
