...
namespace Documents.Forms.Measurement
{
    public partial class FormAddEditMeasHighVoltage : FormBase
    {
        ...
        //private Documents.DataSets.DataSetGES.Class94 rowMeas;
        ...
        //private int IdMeasAmperageTransf;
        ...
        //private StateFormCreate StateCreate;
        ...
        //internal void method_1(StateFormCreate stateFormCreate)
        //{
        //    this.StateCreate = stateFormCreate;
        //}
        ...
        //{
        //    return this.IdMeasAmperageTransf;
        //}

        
        //internal void method_17(int id)
        //{
        //    this.IdMeasAmperageTransf = id;
        //}
        ...
        //{
        //    public static readonly FormAddEditMeasHighVoltage.<>c<>9 = new FormAddEditMeasHighVoltage.C__1();
        //public static Func<DataSetGES.Class50, bool> <>9__51_0;
        //public static Func<DataSetGES.Class50, int> <>9__51_1;
        //public static Func<DataSetGES.Class121, Class6<int, string, int, string, string>> <>9__56_0;
        //public static Func<DataSetGES.Class122, Class6<int, string, int, string, string>> <>9__56_1;
        //public static Func<DataSetGES.Class122, Class6<int, string, int, string, string>> <>9__56_2;
        //public static Func<DataSetGES.Class118, string> <>9__63_0;
        //public static Func<DataSetGES.Class118, Class7<int, string, int, string>> <>9__63_3;
        //public static Func<KeyValuePair<string, DataSetGES.tJ_MeasAmperageTransfDataTable>, DataSetGES.tJ_MeasAmperageTransfDataTable> C_9__63_5;
        //    public static Func<DataSetGES.Class118, Class7<int, string, int, string>> <>9__64_2;

        //internal bool method_0(DataSetGES.Class50 class50_0)
        //    {
        //        return ((class50_0.ParentKey == ";Measurement;Type;") && (class50_0.Value == 2M));
        //    }

        //    internal int method_1(DataSetGES.Class50 class50_0)
        //    {
        //        return class50_0.Id;
        //    }

        //    internal Class6<int, string, int, string, string> method_2(DataSetGES.Class121 class121_0)
        //    {
        ...
        //    internal Class6<int, string, int, string, string> method_3(DataSetGES.Class122 class122_0)
        //    {
        //        return new Class6<int, string, int, string, string>(class122_0.idBus, class122_0.method_6(), (class122_0["idTransf"] == DBNull.Value) ? -1 : class122_0.idTransf, (class122_0["nameTransf"] == DBNull.Value) ? "" : class122_0.method_8(), class122_0.Name);
        //    }

        //    internal Class6<int, string, int, string, string> method_4(DataSetGES.Class122 class122_0)
        //    {
        //        return new Class6<int, string, int, string, string>(class122_0.idBus, class122_0.method_6(), (class122_0["idTransf"] == DBNull.Value) ? -1 : class122_0.idTransf, (class122_0["nameTransf"] == DBNull.Value) ? "" : class122_0.method_8(), class122_0.Name);
        //    }

        //    internal string method_5(DataSetGES.Class118 class118_0)
        //    {
        //        return class118_0.Int32_0.ToString();
        //    }

        //    internal Class7<int, string, int, string> method_6(DataSetGES.Class118 class118_0)
        //    {
        //        return new Class7<int, string, int, string>((class118_0["idBus"] != null) ? ((int)class118_0["idBus"]) : -1, (class118_0["NameBus"] != null) ? class118_0["NameBus"].ToString() : "", (class118_0["id"] != null) ? ((int)class118_0["id"]) : -1, (class118_0["Name"] != null) ? class118_0["Name"].ToString() : "");
        //    }

        //    internal DataSetGES.tJ_MeasAmperageTransfDataTable method_7(KeyValuePair<string, DataSetGES.tJ_MeasAmperageTransfDataTable> keyValuePair_0)
        //    {
        //        return keyValuePair_0.Value;
        //    }

        //    internal Class7<int, string, int, string> method_8(DataSetGES.Class118 class118_0)
        //    {
        //        return new Class7<int, string, int, string>((class118_0["idBus"] != null) ? ((int)class118_0["idBus"]) : -1, (class118_0["NameBus"] != null) ? class118_0["NameBus"].ToString() : "", (class118_0["id"] != null) ? ((int)class118_0["id"]) : -1, (class118_0["Name"] != null) ? class118_0["Name"].ToString() : "");
        //    }
        //}
        ...
        //{
        //    public DataSetGES.Class118 class118_0;

        //    internal bool method_0(DataSetGES.Class107 class107_0)
        //    {
        //        return (class107_0.idCell == this.class118_0.Int32_0);
        //    }
        //}
