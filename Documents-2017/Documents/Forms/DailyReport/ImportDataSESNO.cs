...
internal class ImportDataSESNO
{
    internal static void ImportDailyReport(SQLSettings sqlsettings)
    {
        ...
        try
        {
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                {
                    TimeSpan span;
                    DataSetDamage.tJ_DamageDataTable table7 = new DataSetDamage.tJ_DamageDataTable();
            ...
            foreach (DataRow row3 in table6.Rows)
            {
                ...
                {
                    TimeSpan span2;
                    DataSetDamage.tJ_DamageDataTable table10 = new DataSetDamage.tJ_DamageDataTable();
    ...
    private static void GetTableDamageCharacte(int p0, DataRow dataRow, int flag, SQLSettings sqlsettings)
    {
        if ((flag != 9) && (flag != 0))
        {
            ...
            DataSetDamage.tJ_DamageDataTable table2 = new DataSetDamage.tJ_DamageDataTable();
