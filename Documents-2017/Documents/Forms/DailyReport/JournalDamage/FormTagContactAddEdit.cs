...
internal class FormTagContactAddEdit : FormBase
{
    ...
    private EditMode enum15_0;
    private SelectTypeFieldContact enum16_0;
    ...
    private void FormTagContactAddEdit_FormClosing(object sender, FormClosingEventArgs e)
    {
        if (base.DialogResult == DialogResult.OK)
        {
            ...
            else if ((this.enum16_0 == SelectTypeFieldContact.Division) && (this.cmbDivision.SelectedIndex < 0))
            {
                MessageBox.Show("Не выбрано подразделение", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                e.Cancel = true;
            }
            else if (this.enum16_0 == SelectTypeFieldContact.Contact)
            {
    ...
    private void FormTagContactAddEdit_Load(object sender, EventArgs e)
    {
        ...
        if (node != null)
        {
            ...
            {
                if (((node2.Cells[1].Value != null) && (((this.enum15_0 != EditMode.Edit) || (this.enum16_0 != SelectTypeFieldContact.Division)) || (this.treeDataGridViewNode_0.Cells[1].Value != node2.Cells[1].Value))) && (this.enum16_0 != SelectTypeFieldContact.Contact))
                {
