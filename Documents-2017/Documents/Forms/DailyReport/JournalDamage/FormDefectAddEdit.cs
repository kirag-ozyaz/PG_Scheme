...
////Дефект
/// </summary>
internal class FormDefectAddEdit : FormBase
{
    private bool bool_0;
    private bool bool_1;
    ...
    internal FormDefectAddEdit(int int_2 = -1, int int_3 = 0x57b)
    {
    ...
    {
        if ((this.dataSetDamage_0.tJ_Damage.Rows.Count > 0) && (this.dataSetDamage_0.tJ_Damage.Rows[0]["idParent"] != DBNull.Value))
        {
            DataTable table = new DataTable("tJ_Damage");
            table.Columns.Add("TypeDoc", typeof(int));
            base.SelectSqlData(table, true, "where id = " + this.dataSetDamage_0.tJ_Damage.Rows[0]["idParent"].ToString(), null, false, 0);
            if (table.Rows.Count > 0)
            {
                switch (Convert.ToInt32(table.Rows[0]["TYpeDoc"]))
                {
                    case 0x579://1401
                        {
                        FormDamageLVAddEdit form2 = new FormDamageLVAddEdit(Convert.ToInt32(this.dataSetDamage_0.tJ_Damage.Rows[0]["idParent"]));
                    ...
                    case 0x57a:
                    {
                        FormDamageHVAddEdit form1 = new FormDamageHVAddEdit(Convert.ToInt32(this.dataSetDamage_0.tJ_Damage.Rows[0]["idParent"]));
    ...
    {
        this.bool_0 = true;
        if ((this.int_1 == 0x57b) && (this.cmbCompletedWork.SelectedIndex >= 0))
        {
        ...
        if ((e.ColumnIndex == this.ColumnBtn.Index) && (e.RowIndex >= 0))
        {
            ...
            else
            {
                ...
                if (table.Rows.Count != 0)
                {
                    ...
                    {
                        this.dgvCharacterDamage[this.ColumnSchmObj.Name, e.RowIndex].Value = form.method_0().string_0;
                        this.dgvCharacterDamage[this.ColumnIdSchmObj.Name, e.RowIndex].Value = form.method_0().int_0;
                        ...
                        else
                        {
                            ...
                            base.SelectSqlData(table2, true, "where idObjList = " + form.method_0().int_0.ToString() + " order by number", null, false, 0);
    ...
    private void FormDefectAddEdit_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            base.SelectSqlData(table, true, "where id = " + this.int_0.ToString(), null, false, 0);
            if ((table.Rows.Count > 0) && (table.Rows[0]["dateDoc"] != DBNull.Value))
            {
                this.dtpDateDoc.Value = (Convert.ToDateTime(table.Rows[0]["dateDoc"]));
            }
            base.SelectSqlData(this.dataSetDamage_0.tJ_Damage, true, "where id = " + this.int_0.ToString(), null, false, 0);
            if (this.dataSetDamage_0.tJ_Damage.Rows.Count > 0)
            {
                if (this.dataSetDamage_0.tJ_Damage.Rows[0]["typeDoc"] != DBNull.Value)
                {
                    this.int_1 = Convert.ToInt32(this.dataSetDamage_0.tJ_Damage.Rows[0]["typeDoc"]);
                    if (this.int_1 == 0x57b)
                    {
    ...
    private bool method_18()
    {
        ...
        if ((nullable.GetValueOrDefault() == 0x57a) ? !nullable.HasValue : true)
        {
            if ((this.cmbStreet.SelectedIndex >= 0) && !string.IsNullOrEmpty(this.txtHouse.Text))
            {
                ...
                this.dataSetDamage_0.tJ_Damage.Rows[0]["idMap"] = num;
            }
            else
            {
        ...
        if (this.int_0 == -1)
        {
            this.int_0 = base.InsertSqlDataOneRow(this.dataSetDamage_0, this.dataSetDamage_0.tJ_Damage);
            if (this.int_0 == -1)
            {
                return false;
            }
    ...
    {
        base.SelectSqlData(this.dataSetDamage_0.tJ_DamageCharacter, true, "where idDamage = " + this.int_0.ToString(), null, false, 0);
        ...
        for (int j = 0; j < (this.dgvCharacterDamage.Rows.Count - 1); j++)
        {
            ...
            {
                this.dataSetDamage_0.tJ_DamageCharacter.Rows[j]["idDamage"] = this.int_0;
                if (this.dgvCharacterDamage.Rows[j].Cells[this.dataGridViewComboBoxColumn_4.Name].Value != null)
                {
                    this.dataSetDamage_0.tJ_DamageCharacter.Rows[j]["col1"] = this.dgvCharacterDamage.Rows[j].Cells[this.dataGridViewComboBoxColumn_4.Name].Value;
                }
                else
                {
                ...
                {
                    this.dataSetDamage_0.tJ_DamageCharacter.Rows[j]["col2"] = this.dgvCharacterDamage.Rows[j].Cells[this.dataGridViewComboBoxColumn_6.Name].Value;
                }
                else
                {
                ...
                {
                    this.dataSetDamage_0.tJ_DamageCharacter.Rows[j]["col3"] = this.dgvCharacterDamage.Rows[j].Cells[this.dataGridViewComboBoxColumn_7.Name].Value;
                }
                else
                {
    ...
    private bool method_20()
    {
        ...
        {
            this.dataSetDamage_0.tJ_DamageLV.Rows[0]["idDamage"] = this.int_0;
            this.dataSetDamage_0.tJ_DamageLV.Rows[0].EndEdit();
            if (!base.InsertSqlData(this.dataSetDamage_0.tJ_DamageLV))
            {
                return false;
            }
            if (!base.UpdateSqlData(this.dataSetDamage_0.tJ_DamageLV))
            {
                return false;
            }
            base.SelectSqlData(this.dataSetDamage_0.tJ_DamageLV, true, "where idDamage = " + this.int_0.ToString(), null, false, 0);
        }
        return true;
    }
    ...
    private int method_21()
    {
        ...
        {
            return Convert.ToInt32(this.dataSetDamage_0.tMapObj.Rows[0]["idMap"]);
        }
        ...
        return base.InsertSqlDataOneRow(this.dataSetDamage_0, this.dataSetDamage_0.tMapObj);
    }
    ...
    {
        if (!this.method_1() && (this.checkBoxApply.Checked || (this.dataSetDamage_0.tJ_Damage.Rows[0]["idParent"] != DBNull.Value)))
        {
    ...
    private void InitializeComponent()
    {
        ...
        this.cmbDivisionApply.DataBindings.Add(new Binding("SelectedValue", this.dataSetDamage_0, "tJ_Damage.idDivisionApply", true));
        ...
        this.cmbComplWorkODS.DataBindings.Add(new Binding("SelectedValue", this.dataSetDamage_0, "tJ_Damage.idCompletedWorkODS", true));
        ...
        this.txtComplWorkODS.DataBindings.Add(new Binding("Text", this.dataSetDamage_0, "tJ_Damage.CompletedWorkTextODS", true));
        ...
        this.txtInstruction.DataBindings.Add(new Binding("Text", this.dataSetDamage_0, "tJ_Damage.DivisionInstruction", true));
        ...
        this.checkBoxLaboratory.DataBindings.Add(new Binding("Checked", this.dataSetDamage_0, "tJ_Damage.isLaboratory", true));
        ...
        this.dtpDatePlanApply.DataBindings.Add(new Binding("Value", this.dataSetDamage_0, "tJ_Damage.DatePlanApply", true, DataSourceUpdateMode.OnPropertyChanged));
        ...
        this.checkBoxApply.DataBindings.Add(new Binding("Checked", this.dataSetDamage_0, "tJ_Damage.isApply", true));
        ...
        this.dtpDateOwner.DataBindings.Add(new Binding("Value", this.dataSetDamage_0, "tJ_Damage.DateOwner", true, DataSourceUpdateMode.OnPropertyChanged));
    ...
    private void method_3()
    {
        ...
        this.cmbCompletedWork.Enabled = !this.method_1();
        this.txtCompletedWork.ReadOnly = this.method_1();
        this.checkBoxApply.Enabled = !this.method_1();
        this.cmbWorkerApply.Enabled = this.dtpDataApply.Enabled = this.dtpDatePlanApply.Enabled = !this.method_1();
    ...
    private void method_5()
    {
        if (this.int_0 > 0)
        {
            ...
            base.SelectSqlData(this.tJ_DamageDataTable_0, true, "where id = " + this.int_0.ToString(), null, false, 0);
            this.tJ_DamageCharacterDataTable_0 = new DataSetDamage.tJ_DamageCharacterDataTable();
            base.SelectSqlData(this.tJ_DamageCharacterDataTable_0, true, "where idDamage = " + this.int_0.ToString(), null, false, 0);
        }
    }
        ...
        if (this.int_0 == -1)
        {
            ...
            if (table.Rows.Count > 0)
            {
                ...
                if (table.Rows[0]["idWorker"] != DBNull.Value)
                {
                    ...
                    if (((source.Count<DataRow>() > 0) && (this.int_0 == -1)) && (this.dataSetDamage_0.tJ_Damage.Rows.Count > 0))
                    {
    ...
    {
        this.bool_0 = true;
        if ((this.int_1 == 0x734) && !string.IsNullOrEmpty(this.txtCompletedWork.Text))
        {
            this.labelCompletedWork.ForeColor = Color.Black;
        }
    }
