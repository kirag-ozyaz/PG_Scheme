...
/// c0000b1
/// </summary>
internal class FormDamageLVAddEdit : FormBase
{
    ...
    private DataSetDamage dataSetDamage_1;
    ...
    internal FormDamageLVAddEdit(int mode = -1)// добавить тип документа для уличного освещения
    {
        this.InitializeComponent();
        this.dtpDateDoc.Value = (DateTime.Now);
        this.dtpDataApply.Value = (DateTime.Now.Date);
        this.modeUseDoc = mode;
        this.Text = (mode == -1) ? "Добавить аварийное отключение 0,4 кВ" : (this.method_1() ? "Просмотр документа аварийное отключение 0,4 кВ" : "Редактировать аварийное отключение 0,4 кВ");
    }
    ...
    private void backgroundWorker_0_DoWork(object sender, DoWorkEventArgs e)
    {
        ...
        model1.PoweringReportForDrawObject(Convert.ToInt32(this.dataSetDamage_0.tJ_Damage.Rows[0]["idSchmObj"]), true);
    ...
    {
        CreateReferenceTables.Get_SelectSchmObj(this.SqlSettings, this.dataSetDamage_0.tJ_Damage.Rows[0], this.txtSchmObj, ref this.bool_0);
        this.toolRefreshAbn();
    }
    ...
    {
        if ((base.DialogResult != DialogResult.OK) && ((!this.bool_0 || this.method_1()) || (MessageBox.Show("Сохранить внесенные изменения", "Сохранение", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)))
        {
    ...
    private void FormDamageLVAddEdit_Load(object sender, EventArgs e)
    {
        ...
        {
            DataSetDamage.tJ_DamageDataTable table = new DataSetDamage.tJ_DamageDataTable();
            base.SelectSqlData(table, true, "where id = " + this.modeUseDoc.ToString(), null, false, 0);
            if ((table.Rows.Count > 0) && (table.Rows[0]["dateDoc"] != DBNull.Value))
            {
                this.dtpDateDoc.Value = (Convert.ToDateTime(table.Rows[0]["dateDoc"]));
            }
            base.SelectSqlData(this.dataSetDamage_0.tJ_Damage, true, "where id = " + this.modeUseDoc.ToString(), null, false, 0);
            if (this.dataSetDamage_0.tJ_Damage.Rows.Count > 0)
            {
            ...
            this.method_4();
            this.method_38();
            base.SelectSqlData(this.dataSetDamage_0.tJ_DamageLV, true, "where idDamage = " + this.modeUseDoc.ToString(), null, false, 0);
            if (this.dataSetDamage_0.tJ_DamageLV.Rows.Count == 0)
            {
                this.method_6();
            }
            CreateReferenceTables.Load_TableDamageAbnFull(this.dataSetDamage_0.tJ_DamageLV, this.table_vl_SchmAbnFull, this.SqlSettings);
        }
        this.method_10();
        this.method_35();
        this.bool_0 = false;
        ...
        if (this.modeUseDoc == -1)
        {
            ...
            if (table.Rows.Count > 0)
            {
                ...
                if (table.Rows[0]["idWorker"] != DBNull.Value)
                {
                    ...
                    if (((source.Count<DataRow>() > 0) && (this.modeUseDoc == -1)) && (this.dataSetDamage_0.tJ_Damage.Rows.Count > 0))
                    {
    ...
    private void method_20(object sender, FormClosedEventArgs e)
    {
        ...
        if (form.DialogResult == DialogResult.OK)
        {
            ...
            {
                this.dataSetDamage_0.tJ_Damage.Rows[0]["idSchmObj"] = form.method_0().First<KeyValuePair<int, string>>().Key;
                this.txtSchmObj.Text = form.method_0().First<KeyValuePair<int, string>>().Value;
            }
            else
            {
                this.dataSetDamage_0.tJ_Damage.Rows[0]["idSchmObj"] = DBNull.Value;
    ...
    private bool method_23()
    {
        ...
        {
            this.dataSetDamage_0.tJ_Damage.Rows[0]["idMap"] = DBNull.Value;
        }
        else
        {
            this.dataSetDamage_0.tJ_Damage.Rows[0]["idMap"] = nullable;
        }
        this.dataSetDamage_0.tJ_Damage.Rows[0].EndEdit();
        if (this.modeUseDoc == -1)
        {
            this.modeUseDoc = base.InsertSqlDataOneRow(this.dataSetDamage_0, this.dataSetDamage_0.tJ_Damage);
            if (this.modeUseDoc == -1)
            {
                return false;
            }
    ...
    {
        base.SelectSqlData(this.dataSetDamage_0.tJ_DamageCharacter, true, "where idDamage = " + this.modeUseDoc.ToString(), null, false, 0);
        ...
        for (int j = 0; j < (this.dgvCharacterDamage.Rows.Count - 1); j++)
        {
            ...
            {
                this.dataSetDamage_0.tJ_DamageCharacter.Rows[j]["idDamage"] = this.modeUseDoc;
                if (this.dgvCharacterDamage.Rows[j].Cells[this.dataGridViewComboBoxColumn_3.Name].Value != null)
                {
                    this.dataSetDamage_0.tJ_DamageCharacter.Rows[j]["col1"] = this.dgvCharacterDamage.Rows[j].Cells[this.dataGridViewComboBoxColumn_3.Name].Value;
                }
                else
                {
                ...
                {
                    this.dataSetDamage_0.tJ_DamageCharacter.Rows[j]["col2"] = this.dgvCharacterDamage.Rows[j].Cells[this.dataGridViewComboBoxColumn_4.Name].Value;
                }
                else
                {
                ...
                {
                    this.dataSetDamage_0.tJ_DamageCharacter.Rows[j]["col3"] = this.dgvCharacterDamage.Rows[j].Cells[this.dataGridViewComboBoxColumn_5.Name].Value;
                }
                else
                {
    ...
    private bool method_25()
    {
        if (this.dataSetDamage_0.tJ_DamageLV.Rows.Count > 0)
        {
            this.dataSetDamage_0.tJ_DamageLV.Rows[0]["idDamage"] = this.modeUseDoc;
            this.dataSetDamage_0.tJ_DamageLV.Rows[0]["AbnOff"] = CreateReferenceTables.CreateXmlAbnOff(this.table_vl_SchmAbnFull).InnerXml;
            this.dataSetDamage_0.tJ_DamageLV.Rows[0].EndEdit();
            if (!base.InsertSqlData(this.dataSetDamage_0.tJ_DamageLV))
            {
                return false;
            }
            if (!base.UpdateSqlDataOnlyChange(this.dataSetDamage_0.tJ_DamageLV))
            {
                return false;
            }
            base.SelectSqlData(this.dataSetDamage_0.tJ_DamageLV, true, "where idDamage = " + this.modeUseDoc.ToString(), null, false, 0);
    ...
    private bool method_26()
    {
        ...
        DataSetDamage.tJ_DamageDataTable table = new DataSetDamage.tJ_DamageDataTable();
        base.SelectSqlData(table, true, string.Format("where idParent = {0} and TypeDoc = {1} and idDivisionApply is not null", this.modeUseDoc, 1403), null, false, 0);
        if (this.cmbDivisionApply.SelectedIndex >= 0)
        {
            ...
            if (table.Rows.Count > 0)
            {
                CreateReferenceTables.Set_TableDamage(table.Rows[0], this.dataSetDamage_0, this.modeUseDoc, 1403, true, false);
            ...
            else
            {
                ...
                CreateReferenceTables.Set_TableDamage(row, this.dataSetDamage_0, this.modeUseDoc, 1403, true, false);
                table.Rows.Add(row);
                num = base.InsertSqlDataOneRow(row);
                if (num <= 0)
                {
                    return false;
                }
                if (!this.method_27(num))
                {
                    return false;
                }
            }
            Class198.smethod_0(num, this.SqlSettings);
        }
        else
        {
        ...
        base.SelectSqlData(table, true, string.Format("where idParent = {0} and TypeDoc = {1} and isLaboratory is not null", this.modeUseDoc, 1403), null, false, 0);
        if (this.checkBoxLaboratory.Checked)
        {
            ...
            if (table.Rows.Count > 0)
            {
                CreateReferenceTables.Set_TableDamage(table.Rows[0], this.dataSetDamage_0, this.modeUseDoc, 1403, false, true);
                table.Rows[0].EndEdit();
                if (!base.UpdateSqlData(table))
                {
                    return false;
                ...
                num3 = Convert.ToInt32(table.Rows[0]["id"]);
            }
            else
            {
                DataRow row2 = table.NewRow();
                CreateReferenceTables.Set_TableDamage(row2, this.dataSetDamage_0, this.modeUseDoc, 1403, false, true);
                table.Rows.Add(row2);
                num3 = base.InsertSqlDataOneRow(row2);
                if (num3 <= 0)
                {
                    return false;
                }
                if (!this.method_27(num3))
                {
                    return false;
                }
            }
            Class198.smethod_0(num3, this.SqlSettings);
        }
        else
        {
            //using (enumerator = table.Rows.GetEnumerator())
    ...
    private bool method_27(int int_1)
    {
        DataSetDamage.tJ_DamageCharacterDataTable table = new DataSetDamage.tJ_DamageCharacterDataTable();
        base.SelectSqlData(table, true, "where idDamage = " + int_1.ToString(), null, false, 0);
    ...
    private int? method_28()
    {
        ...
        base.SelectSqlData(this.dataSetDamage_0.tMapObj, true, "where Street = " + this.cmbStreet.SelectedValue.ToString() + " and House = " + this.txtHouse.Text + str + " and IsHouse = 1 and Name is null", null, false, 0);
        if (this.dataSetDamage_0.tMapObj.Rows.Count > 0)
        {
            return new int?(Convert.ToInt32(this.dataSetDamage_0.tMapObj.Rows[0]["idMap"]));
        }
        DataRow row = this.dataSetDamage_0.tMapObj.NewRow();
        ...
        row["IsHouse"] = true;
        row["Deleted"] = 0;
        this.dataSetDamage_0.tMapObj.Rows.Add(row);
        this.dataSetDamage_0.tMapObj.Rows[0].EndEdit();
        int num = base.InsertSqlDataOneRow(this.dataSetDamage_0, this.dataSetDamage_0.tMapObj);
        if (num == -1)
        {
            return null;
        }
    ...
    private void method_3()
    {
        ...
        this.txtNumRequest.ReadOnly = this.method_1();
        this.dtpDateDoc.Enabled = !this.method_1();
        this.cmbCompiler.ReadOnly = (this.method_1());
        this.cmbDivision.ReadOnly = (this.method_1());
        this.txtDeclarer.ReadOnly = this.method_1();
        this.txtDeclarerTel.ReadOnly = this.method_1();
        this.txtDeclarerAddress.ReadOnly = this.method_1();
        this.btnChoiceSchmObj.Enabled = !this.method_1();
        this.txtLocation.ReadOnly = this.method_1();
        this.cmbStreet.ReadOnly = (flag3 = this.method_1());
        this.cmbCity.ReadOnly = (flag2 = flag3);
        this.cmbRaionObl.ReadOnly = (flag = flag2);
        this.cmbObl.ReadOnly = (flag);
        this.txtHouse.ReadOnly = this.txtHousePrefix.ReadOnly = this.method_1();
        this.cmbReason.ReadOnly = (this.method_1());
        this.dgvCharacterDamage.ReadOnly = this.method_1();
        this.cmbCompletedWork.ReadOnly = (this.method_1());
        this.txtCompletedWork.ReadOnly = this.method_1();
        this.checkBoxApply.Enabled = !this.method_1();
        this.cmbWorkerApply.ReadOnly = (this.method_1());
        this.dtpDataApply.Enabled = !this.method_1();
        this.chbDefect.Enabled = !this.method_1();
        this.cmbDivisionApply.ReadOnly = (this.method_1());
        this.checkBoxLaboratory.Enabled = !this.method_1();
        this.txtLaboratoryInstruction.ReadOnly = this.txtDivisionInstruction.ReadOnly = !this.chbDefect.Checked && this.method_1();
        this.cmbReasonPTS.ReadOnly = (this.method_1());
        this.toolBtnRefreshAbn.Enabled = this.toolBrnDelAbn.Enabled = !this.method_1();
        this.buttonSave.Visible = !this.method_1();
    }

    private void method_30()
    {
        if (this.dataSetDamage_0.tJ_Damage.Rows[0]["idmap"] != DBNull.Value)
        {
            base.SelectSqlData(this.dataSetDamage_0.tMapObj, true, " where idMap = " + this.dataSetDamage_0.tJ_Damage.Rows[0]["idmap"].ToString(), null, false, 0);
            this.txtHouse.Text = this.dataSetDamage_0.tMapObj.Rows[0]["House"].ToString();
            this.txtHousePrefix.Text = this.dataSetDamage_0.tMapObj.Rows[0]["HousePrefix"].ToString();
            DataTable table = CreateReferenceTables.CreateTableKladrStreet();
            base.SelectSqlData(table, true, " where id = " + this.dataSetDamage_0.tMapObj.Rows[0]["Street"].ToString(), null, false, 0);
            int num = 0x18;
            if (table.Rows.Count > 0)
            {
            ...
            this.method_32(list);
            if (this.dataSetDamage_0.tMapObj.Rows[0]["Street"] != DBNull.Value)
            {
                this.cmbStreet.SelectedValue = this.dataSetDamage_0.tMapObj.Rows[0]["Street"];
            }
        }
    }
    ...
    {
        if (!this.method_1() && this.checkBoxApply.Checked)
        {
    ...
    {
        if (this.modeUseDoc > 0)
        {
            DataSetDamage.tJ_DamageDataTable table = new DataSetDamage.tJ_DamageDataTable();
            base.SelectSqlData(table, true, string.Format("where idParent = {0} and TypeDoc = {1} and idDivisionApply is not null and isApply = 1 ", this.modeUseDoc, 1403), null, false, 0);
            if (table.Rows.Count > 0)
            {
            ...
            base.SelectSqlData(table, true, string.Format("where idParent = {0} and TypeDoc = {1} and isLaboratory is not null and isApply = 1 ", this.modeUseDoc, 1403), null, false, 0);
            if (table.Rows.Count > 0)
            {
                this.chbDefect.Enabled = false;
    ...
    private void InitializeComponent()
    {
        ...
        this.dataSetDamage_1 = new DataSetDamage();
        ...
        this.dtpDataApply.DataBindings.Add(new Binding("Value", this.dataSetDamage_0, "tJ_Damage.DateApply", true, DataSourceUpdateMode.OnPropertyChanged));
        ...
        this.txtDeclarerAddress.DataBindings.Add(new Binding("Text", this.dataSetDamage_0, "tJ_DamageLV.DeclarerAddress", true));
        ...
        this.txtDeclarerTel.DataBindings.Add(new Binding("Text", this.dataSetDamage_0, "tJ_DamageLV.DeclarerTel", true));
        ...
        this.txtDeclarer.DataBindings.Add(new Binding("Text", this.dataSetDamage_0, "tJ_DamageLV.Declarer", true));
        ...
        this.dtpDateDoc.DataBindings.Add(new Binding("Value", this.dataSetDamage_0, "tJ_Damage.DateDoc", true, DataSourceUpdateMode.OnPropertyChanged));
        ...
        this.cmbReasonPTS.DataBindings.Add(new Binding("SelectedValue", this.dataSetDamage_0, "tJ_Damage.idReasonPTS", true));
    ...
    private void method_5()
    {
        if (this.modeUseDoc > 0)
        {
            this.tJ_DamageDataTable_0 = new DataSetDamage.tJ_DamageDataTable();
            base.SelectSqlData(this.tJ_DamageDataTable_0, true, "where id = " + this.modeUseDoc.ToString(), null, false, 0);
            this.tJ_DamageCharacterDataTable_0 = new DataSetDamage.tJ_DamageCharacterDataTable();
            base.SelectSqlData(this.tJ_DamageCharacterDataTable_0, true, "where idDamage = " + this.modeUseDoc.ToString(), null, false, 0);
        }
    }

    private void method_6()
    {
        DataRow row = this.dataSetDamage_0.tJ_DamageLV.NewRow();
        row["idDamage"] = this.modeUseDoc;
        this.dataSetDamage_0.tJ_DamageLV.Rows.Add(row);
    }
