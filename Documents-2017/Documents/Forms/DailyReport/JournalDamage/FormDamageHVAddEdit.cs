...
internal class FormDamageHVAddEdit : FormBase
{
    ...
    internal FormDamageHVAddEdit(int int_1 = -1)
    {
                ...
                if (table.Rows.Count != 0)
                {
                    ...
                    if (form.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        else
                        {
                            ...
                            base.SelectSqlData(table2, true, "where idObjList = " + form.method_0().int_0.ToString() + " order by number");
    ...
    private void dgvOn_CellValueChanged(object sender, DataGridViewCellEventArgs e)
    {
        if (e.RowIndex >= 0)
        {
            if ((this.dgvOn[this.idDamageDataGridViewTextBoxColumn1.Name, e.RowIndex].Value == DBNull.Value) || (Convert.ToInt32(this.dgvOn[this.idDamageDataGridViewTextBoxColumn1.Name, e.RowIndex].Value) != this.int_0))
            {
                this.dgvOn[this.idDamageDataGridViewTextBoxColumn1.Name, e.RowIndex].Value = this.int_0;
            }
    ...
    private void FormDamageHVAddEdit_FormClosing(object sender, FormClosingEventArgs e)
    {
        ...
        else if ((base.DialogResult != DialogResult.OK) && ((!this.bool_0 || this.method_1()) || (MessageBox.Show("Сохранить внесенные изменения", "Сохранение", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)))
        {
    ...
    private void FormDamageHVAddEdit_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            base.SelectSqlData(this.dataSetDamage_0.tJ_Damage, true, "where id = " + this.int_0.ToString());
            this.dtpDateDoc.ValueChanged += new EventHandler(this.dtpDateDoc_ValueChanged);
            if (this.dataSetDamage_0.tJ_Damage.Rows.Count > 0)
            {
            ...
            this.method_32();
            this.method_4();
            base.SelectSqlData(this.dataSetDamage_0.tJ_DamageHV, true, "where idDamage = " + this.int_0.ToString());
            ...
            base.SelectSqlData(this.dataSetDamage_0.tJ_DamageOn, true, "where idDamage = " + this.int_0.ToString());
            if (this.dataSetDamage_0.tJ_DamageHV.Rows.Count > 0)
            {
    ...
    {
        base.SelectSqlData(this.dataSetDamage_0.tJ_DamageCharacter, true, "where idDamage = " + this.int_0.ToString());
    ...
    private bool method_26()
    {
        if (this.dataSetDamage_0.tJ_DamageHV.Rows.Count > 0)
        {
            this.dataSetDamage_0.tJ_DamageHV.Rows[0]["idDamage"] = this.int_0;
    ...
    private bool method_27()
    {
        ...
        else
        {
            ...
            {
                table = this.tJ_DamageOnDataTable_0.AsEnumerable<DataSetDamage.Class332>().OrderBy<DataSetDamage.Class332, DateTime>((C_1.C_9__51_0 ?? (C_1.C_9__51_0 = new Func<DataSetDamage.Class332, DateTime>(C_1.C_9.method_0)))).CopyToDataTable<DataSetDamage.Class332>();
            }
            else
            {
    ...
    private bool method_28()
    {
        ...
        base.SelectSqlData(table, true, string.Format("where idParent = {0} and TypeDoc = {1} and idDivisionApply is not null", this.int_0, 0x734));
        if (this.chbDefect.Checked && (this.cmbDivisionApply.SelectedIndex >= 0))
        {
            ...
            if (table.Rows.Count <= 0)
            {
                ...
                CreateReferenceTables.Set_TableDamage(row, this.dataSetDamage_0, this.int_0, 0x734, true, false);
                table.Rows.Add(row);
            ...
            {
                CreateReferenceTables.Set_TableDamage(table.Rows[0], this.dataSetDamage_0, this.int_0, 0x734, true, false);
        ...
        base.SelectSqlData(table, true, string.Format("where idParent = {0} and TypeDoc = {1} and isLaboratory is not null", this.int_0, 0x734));
        if (this.chbDefect.Checked && this.checkBoxLaboratory.Checked)
        {
            ...
            if (table.Rows.Count <= 0)
            {
                ...
                CreateReferenceTables.Set_TableDamage(row2, this.dataSetDamage_0, this.int_0, 0x734, false, true);
                table.Rows.Add(row2);
            ...
            {
                CreateReferenceTables.Set_TableDamage(table.Rows[0], this.dataSetDamage_0, this.int_0, 0x734, false, true);
                table.Rows[0].EndEdit();
                if (!base.UpdateSqlData(table))
                {
                    return false;
    ...
    private void method_3()
    {
        ...
        this.ColumnBtn.Visible = !this.method_1();
        this.cmbTypeRZA.ReadOnly=(this.method_1());
        this.txtCountSchmObj.ReadOnly = this.method_1();
        this.txtKWT.ReadOnly = this.method_1();
        this.txtA.ReadOnly = this.method_1();
        this.txtV.ReadOnly = this.method_1();
        this.txtCoefSeason.ReadOnly = this.method_1();
        this.txtCosFi.ReadOnly = this.method_1();
        this.cmbAVR.Enabled = !this.method_1();
        this.cmbAPV.Enabled = !this.method_1();
        this.cmbCompletedWork.ReadOnly=(this.method_1());
        this.dgvOn.ReadOnly = this.method_1();
        this.dgvOn.AllowUserToDeleteRows = false;
        this.rbOnAverage.Enabled = this.rbOnFact.Enabled = !this.method_1();
        ...
        this.toolBtnRefreshAbn.Enabled = this.toolBtnRefreshTrans.Enabled = !this.method_1();
        this.buttonSave.Visible = !this.method_1();
        this.buttonLoadTextBoxSum.Visible = !this.method_1();
    }
    ...
    private void method_4()
    {
        ...
        {
            DataSetDamage.tJ_DamageDataTable table = new DataSetDamage.tJ_DamageDataTable();
            base.SelectSqlData(table, true, string.Format("where idParent = {0} and TypeDoc = {1} and idDivisionApply is not null and isApply = 1 ", this.int_0, 0x734));
            if (table.Rows.Count > 0)
            {
            ...
            base.SelectSqlData(table, true, string.Format("where idParent = {0} and TypeDoc = {1} and isLaboratory is not null and isApply = 1 ", this.int_0, 0x734));
            if (table.Rows.Count > 0)
            {
                this.chbDefect.Enabled = false;
    ...
    private void method_5()
    {
        if (this.int_0 > 0)
        {
            ...
            base.SelectSqlData(this.tJ_DamageDataTable_0, true, "where id = " + this.int_0.ToString());
            this.tJ_DamageCharacterDataTable_0 = new DataSetDamage.tJ_DamageCharacterDataTable();
            base.SelectSqlData(this.tJ_DamageCharacterDataTable_0, true, "where idDamage = " + this.int_0.ToString());
        }
    }
    ...
    private void method_55(TreeDataGridViewNode treeDataGridViewNode_0, TreeNodeObj treeNodeObj_0)
    {
        if (treeNodeObj_0.Tag != null)
        {
            ...
            {
                ElectricLine tag = (ElectricLine) treeNodeObj_0.Tag;
                if (tag.IsCell())
                {
                    ...
                    if (bus != null)
                    {
                        if (treeDataGridViewNode_0 == null)
                        {
                            ...
                            treeDataGridViewNode_0 = this.method_54(this.dgvTree.Nodes, objArray1);
                        }
                        else
                        {
                            object[] objArray2 = new object[] { bus.Parent.ToString(), bus.Parent.Id, bus.ToString(), bus.Id, tag.ToString(), tag.Id };
                            treeDataGridViewNode_0 = this.method_54(treeDataGridViewNode_0.Nodes, objArray2);
                        }
                    }
                }
                using (List<ElectricRelation>.Enumerator enumerator2 = ((ElectricLine) treeNodeObj_0.Tag).Relations.GetEnumerator())
                {
                    while (enumerator2.MoveNext())
                    {
                        ...
                        {
                            if (((obj2 is ElectricSwitch) && (((ElectricSwitch) obj2).TypeSwitch == TypeSwitch.TransformerTool/*0x22c*/)) && (treeDataGridViewNode_0 != null))
                            {
                                int num;
                                int? nullable3;
                                int? nullable4;
                                if ((treeDataGridViewNode_0.Cells[this.idTrColumn.Index].Value != null) && !string.IsNullOrEmpty(treeDataGridViewNode_0.Cells[this.idTrColumn.Index].Value.ToString()))
                                {
                                    object[] objArray3 = new object[] { treeDataGridViewNode_0.Cells[this.subNameColumn.Index].Value, treeDataGridViewNode_0.Cells[this.idSubColumn.Index].Value, treeDataGridViewNode_0.Cells[this.busNameColumn.Index].Value, treeDataGridViewNode_0.Cells[this.idBusColumn.Index].Value, treeDataGridViewNode_0.Cells[this.cellNameColumn.Index].Value, treeDataGridViewNode_0.Cells[this.idCellColumn.Index].Value };
                                    treeDataGridViewNode_0 = treeDataGridViewNode_0.Parent.Nodes.Add(objArray3);
                                }
                                ...
                                if (rowArray.Length != 0)
                                {
                                    ...
                                    {
                                        nullable = new int?(Convert.ToInt32(rowArray[0]["power"]));
                                    }
                                    if (rowArray[0]["load"] != DBNull.Value)
                                    {
                                        nullable2 = new int?(Convert.ToInt32(rowArray[0]["load"]));
                                    }
                                }
                                ...
                                if (nullable2.HasValue)
                                {
                                    ...
                                    {
                                        num = Convert.ToInt32(treeDataGridViewNode_0.Cells[9].Value);
                                        nullable3 = nullable2;
                                        treeDataGridViewNode_0.Cells[9].Value = nullable3.HasValue ? new int?(num + nullable3.GetValueOrDefault()) : (nullable4 = null);
                                    }
                                    else
                                    {
                                        treeDataGridViewNode_0.Cells[9].Value = nullable2;
                                    }
                                }
                                if ((treeDataGridViewNode_0.Cells[6].Value != null) && !string.IsNullOrEmpty(treeDataGridViewNode_0.Cells[6].Value.ToString()))
                                {
                                    DataGridViewCell cell1 = treeDataGridViewNode_0.Cells[6];
                                    cell1.Value = cell1.Value + ";" + obj2.ToString();
                                    DataGridViewCell cell2 = treeDataGridViewNode_0.Cells[7];
                                    cell2.Value = cell2.Value + ";" + obj2.Id;
                                }
                                else
                                {
                                    treeDataGridViewNode_0.Cells[6].Value = obj2.ToString();
                                    treeDataGridViewNode_0.Cells[7].Value = obj2.Id;
                                }
                            }
                        }
                    }
        ...
        foreach (TreeNodeObj obj3 in treeNodeObj_0.Nodes)
        {
            this.method_55(treeDataGridViewNode_0, obj3);
        }
    }
    ...
    private void method_63()
    {
        ...
        {
            this.tJ_DamageOnDataTable_0 = new DataSetDamage.tJ_DamageOnDataTable();
    ...
    {
        if ((((e.RowIndex >= 0) && (e.ColumnIndex >= 0)) && ((e.Button == MouseButtons.Right) && !this.method_1())) && !this.checkBoxApply.Checked)
        {
