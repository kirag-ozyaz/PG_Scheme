    ...
    public partial class FormJournalRequestForRepair : FormBase
    {
        ...
        public FormJournalRequestForRepair(bool isCrash = false)
        {
            ...
            if (isCrash)
            {
                ...
                this.Icon = (Icon)global::Properties.Resources.repair_Crash1;
            }
            else
            {
                // this.Icon = ((System.Drawing.Icon)(resources.GetObject("repair")));
                this.Icon = (Icon)global::Properties.Resources.repair;
            }
        }
        ...
        private void backgroundWorker_0_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            foreach (object obj2 in this.checkedListBoxDivision.CheckedItems)
            {
                ...
                str5 = str5 + struct2.int_0.ToString() + ",";
            }
            if (str5.Length > 0)
            {
        ...
        {
            RequestsClient.Forms.JournalRequestForRepair.FormJournalRequestForRepairAddEdit edit1 = new RequestsClient.Forms.JournalRequestForRepair.FormJournalRequestForRepairAddEdit(-1, Convert.ToInt32(((ToolStripMenuItem)sender).Tag), RequestsClient.Forms.JournalRequestForRepair.eActionRequestRepair.Add, this.isCrash);//0
        ...
        private void toolSplitBtnAddRequestRepair_Click(object sender, EventArgs e)
        {
            ...
            {
                FormJournalRequestForRepairAddEdit form1 = new FormJournalRequestForRepairAddEdit(-1, Convert.ToInt32(((ToolStripMenuItem)sender).Tag), eActionRequestRepair.Add, this.isCrash);
        ...
        {
            RequestsClient.Forms.JournalRequestForRepair.FormJournalRequestForRepairAddEdit edit1 = new RequestsClient.Forms.JournalRequestForRepair.FormJournalRequestForRepairAddEdit(Convert.ToInt32(this.dgv.CurrentRow.Cells[this.idDataGridViewTextBoxColumn.Name].Value), -1, RequestsClient.Forms.JournalRequestForRepair.eActionRequestRepair.Edit, this.isCrash);//1
            edit1.GoToSchema += (new GoToSchemaEventHandler(this.f_GoToSchema));
            edit1.SqlSettings = (this.SqlSettings);
            edit1.MdiParent = base.MdiParent;
            edit1.FormClosed += new FormClosedEventHandler(this.method_5);
        ...
        {
            RequestsClient.Forms.JournalRequestForRepair.FormJournalRequestForRepairAddEdit edit1 = new RequestsClient.Forms.JournalRequestForRepair.FormJournalRequestForRepairAddEdit(Convert.ToInt32(this.dgv.CurrentRow.Cells[this.idDataGridViewTextBoxColumn.Name].Value), -1, RequestsClient.Forms.JournalRequestForRepair.eActionRequestRepair.Read, false);//2
            edit1.GoToSchema += (new GoToSchemaEventHandler(this.f_GoToSchema));
            edit1.SqlSettings = (this.SqlSettings);
            edit1.MdiParent = base.MdiParent;
            edit1.Show();
        ...
        private void toolBtnRequestCopy_Click(object sender, EventArgs e)
        {
            if ((this.dgv.CurrentRow != null) && (((ToolStripMenuItem)sender).Tag != null))
            {
                ...
                if (this.dataSetGES_0.tJ_RequestForRepair.Rows.Count > 0)
                {
                    ...
                    {
                        FormJournalRequestForRepairAddEdit form1 = new FormJournalRequestForRepairAddEdit(row);
                        form1.GoToSchema += (new GoToSchemaEventHandler(this.f_GoToSchema));
                        form1.SqlSettings = (this.SqlSettings);
                        form1.MdiParent = base.MdiParent;
                        form1.FormClosed += new FormClosedEventHandler(this.method_5);
        ...
        {
            RequestsClient.Forms.JournalRequestForRepair.FormJournalRequestForRepairAddEdit edit1 = new RequestsClient.Forms.JournalRequestForRepair.FormJournalRequestForRepairAddEdit(dataRow_0);
            edit1.GoToSchema += (new GoToSchemaEventHandler(this.f_GoToSchema));
            edit1.SqlSettings = (this.SqlSettings);
            edit1.MdiParent = base.MdiParent;
            edit1.FormClosed += new FormClosedEventHandler(this.method_5);
        ...
        private void method_9(int int_3)
        {
            ...
            int? nullable = null;
            DataTable table = command1.SelectSqlData("DH55388", false, "", nullable);
            nullable = null;
            DataTable table2 = command1.SelectSqlData("_1SJOURN", false, "", nullable);
        ...
        private void toolStripButton_0_Click(object sender, EventArgs e)
        {
            if (this.dgv.CurrentRow != null)
            {
                ...
                {
                    FormJournalRequestForRepairAddEdit form1 = new FormJournalRequestForRepairAddEdit(Convert.ToInt32(this.dgv.CurrentRow.Cells[this.idDataGridViewTextBoxColumn.Name].Value), -1, eActionRequestRepair.Edit, false);
                    form1.GoToSchema += (new GoToSchemaEventHandler(this.f_GoToSchema));
                    form1.SqlSettings = (this.SqlSettings);
                    form1.MdiParent = base.MdiParent;
                    form1.FormClosed += new FormClosedEventHandler(this.method_5);
        ...
        private void toolStripButton_2_Click(object sender, EventArgs e)
        {
            if (this.dgv.CurrentRow != null)
            {
                ...
                {
                    FormJournalRequestForRepairAddEdit form1 = new FormJournalRequestForRepairAddEdit(Convert.ToInt32(this.dgv.CurrentRow.Cells[this.idDataGridViewTextBoxColumn.Name].Value), -1, eActionRequestRepair.Read, false);
                    form1.GoToSchema += (new GoToSchemaEventHandler(this.f_GoToSchema));
                    form1.SqlSettings = (this.SqlSettings);
                    form1.MdiParent = base.MdiParent;
                    form1.Show();
        ...
        {
            FormReportRequestForRepair form1 = new FormReportRequestForRepair(this.isCrash);
            form1.SqlSettings = (this.SqlSettings);
            form1.MdiParent = base.MdiParent;
            form1.Show();
        }
        ...
        {
            FormExportRequestForRepair form1 = new FormExportRequestForRepair(this.isCrash);
            form1.SqlSettings = (this.SqlSettings);
            form1.MdiParent = base.MdiParent;
            form1.Show();
        }
