...
namespace Documents.JournalRequestForRepair
{
    ...
    internal class FormReportReguestForRepairSettings : Form
    {
        ...
        {
            this.txtAppoveTitle.Text = string_0;
        }
        ...
        {
            this.txtSignatureTitle2.Text = string_0;
        }
        ...
        {
            this.txtSignatureFIO2.Text = string_0;
        }
        ...
        {
            this.txtAppoveOrg.Text = string_0;
        }
        ...
        {
            this.txtAppoveFIO.Text = string_0;
        }
        ...
        {
            this.txtSignatureTitle1.Text = string_0;
        }
        ...
        {
            this.txtSignatureFIO1.Text = string_0;
        }
    }
