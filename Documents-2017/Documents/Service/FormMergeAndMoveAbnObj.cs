namespace Documents.Service
{
    ...
    public class FormMergeAndMoveAbnObj : FormBase
    {
        ...
        private void button_0_Click(object sender, EventArgs e)
        {
            ...
            {
                string str = this.dataGridViewExcelFilter_0.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_7.Name].Value.ToString() + " (" + this.dataGridViewExcelFilter_0.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_6.Name].Value.ToString() + ")";
                string str2 = this.dataGridViewExcelFilter_1.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_10.Name].Value.ToString() + " (" + this.dataGridViewExcelFilter_1.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_9.Name].Value.ToString() + ")";
                string str3 = this.radioButton_1.Checked ? this.dataGridViewExcelFilter_2.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_2.Name].Value.ToString() : this.dataGridViewExcelFilter_2.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_1.Name].Value.ToString();
                string str4 = this.radioButton_3.Checked ? this.dataGridViewExcelFilter_3.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_5.Name].Value.ToString() : this.dataGridViewExcelFilter_3.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_4.Name].Value.ToString();
                ...
                {
                    string str5 = string.Format("\r\nВсе данные и документы объекта {2} абонента {3} переместяться в объект {0} абонента {1}.\r\nОбъект {2} абонента {3} удалится.", new object[] { str3, str, str4, str2 });
                    if (MessageBox.Show("Вы действительно хотите объединить выбранные объекты?" + str5, "Объединение", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        using (SqlConnection connection = new SqlConnection(this.get_SqlSettings().GetConnectionString() + ";Connection Timeout=1000"))
                        {
                            ...
                            try
                            {
                                using (SqlCommand command = new SqlCommand(ResourceReader.GetStringAssembly("Service.MergeAbnObj.sql"), connection))
                                {
                                    ...
                                    command.Parameters.Add("idParentAbnObj", SqlDbType.Int).Value = Convert.ToInt32(this.dataGridViewExcelFilter_2.CurrentRow.Cells[this.dataGridViewTextBoxColumn_0.Name].Value);
                                    command.Parameters.Add("idChildAbnObj", SqlDbType.Int).Value = Convert.ToInt32(this.dataGridViewExcelFilter_3.CurrentRow.Cells[this.dataGridViewTextBoxColumn_3.Name].Value);
        ...
        private void button_1_Click(object sender, EventArgs e)
        {
            if ((this.dataGridViewExcelFilter_0.CurrentRow != null) && (this.dataGridViewExcelFilter_1.CurrentRow != null))
            {
                ...
                {
                    string str3 = string.Format("\r\nВсе данные, объекты и документы абонента {1} переместяться в абонента {0}.\r\nАбонент {1} удалится.", str, str2);
                    if (MessageBox.Show("Вы действительно хотите объединить выбранных абонентов?" + str3, "Объединение", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        using (SqlConnection connection = new SqlConnection(this.get_SqlSettings().GetConnectionString() + ";Connection Timeout=0"))
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    command.Transaction = transaction;
                                    command.Parameters.Add("idParentAbn", SqlDbType.Int).Value = Convert.ToInt32(this.dataGridViewExcelFilter_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_4.Name].Value);
                                    command.Parameters.Add("idChildAbn", SqlDbType.Int).Value = Convert.ToInt32(this.dataGridViewExcelFilter_1.CurrentRow.Cells[this.dataGridViewTextBoxColumn_5.Name].Value);
                                    command.ExecuteNonQuery();
                                }
                                transaction.Commit();
        ...
        private void button_2_Click(object sender, EventArgs e)
        {
            if ((this.dataGridViewExcelFilter_3.CurrentRow != null) && (this.dataGridViewExcelFilter_0.CurrentRow != null))
            {
                string str = this.dataGridViewExcelFilter_0.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_7.Name].Value.ToString() + " (" + this.dataGridViewExcelFilter_0.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_6.Name].Value.ToString() + ")";
                string str2 = this.dataGridViewExcelFilter_1.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_10.Name].Value.ToString() + " (" + this.dataGridViewExcelFilter_1.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_9.Name].Value.ToString() + ")";
                string str3 = this.radioButton_3.Checked ? this.dataGridViewExcelFilter_3.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_5.Name].Value.ToString() : this.dataGridViewExcelFilter_3.CurrentRow.Cells[this.dataGridViewFilterTextBoxColumn_4.Name].Value.ToString();
                string str4 = string.Format("\r\nОбъект {0} абонента {1} переместиться в абонента {2}.", str3, str2, str);
                if (MessageBox.Show("Вы действительно хотите переместить выбранный объект?" + str4, "Перемещение", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    using (SqlConnection connection = new SqlConnection(this.get_SqlSettings().GetConnectionString() + ";Connection Timeout=1000"))
                    {
                        connection.Open();
                        ...
                        try
                        {
                            using (SqlCommand command = new SqlCommand(ResourceReader.GetStringAssembly("Service.MoveAbnObj.sql"), connection))
                            {
                                command.Transaction = transaction;
                                command.Parameters.Add("idAbnObj", SqlDbType.Int).Value = Convert.ToInt32(this.dataGridViewExcelFilter_3.CurrentRow.Cells[this.dataGridViewTextBoxColumn_3.Name].Value);
                                command.Parameters.Add("idMoveAbn", SqlDbType.Int).Value = Convert.ToInt32(this.dataGridViewExcelFilter_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_4.Name].Value);
                                command.ExecuteNonQuery();
                            }
                            transaction.Commit();
        ...
        private void button_3_Click(object sender, EventArgs e)
        {
            ...
            else if (this.dataGridViewExcelFilter_1.CurrentRow != null)
            {
                ...
                {
                    nullable = new int?(Convert.ToInt32(this.dataGridViewExcelFilter_3.CurrentRow.Cells[this.dataGridViewTextBoxColumn_3.Name].Value));
                }
                Form0 form = new Form0(Convert.ToInt32(this.dataGridViewExcelFilter_1.CurrentRow.Cells[this.dataGridViewTextBoxColumn_5.Name].Value), nullable);
                ...
                if (((form.ShowDialog() == DialogResult.OK) && (this.dataGridViewExcelFilter_0.CurrentRow != null)) && (this.dataGridViewExcelFilter_2.CurrentRow != null))
                {
                    ...
                    using (SqlConnection connection = new SqlConnection(this.get_SqlSettings().GetConnectionString() + ";Connection Timeout=0"))
                    {
                        ...
                        try
                        {
                            ...
                            {
                                command.Transaction = transaction;
                                command.Parameters.Add("id", SqlDbType.Int).Value = nullable2;
                                command.Parameters.Add("idAbn", SqlDbType.Int).Value = num;
                                command.Parameters.Add("idAbnObj", SqlDbType.Int).Value = num2;
                                command.ExecuteNonQuery();
                            }
                            transaction.Commit();
        ...
        private void method_4()
        {
            ...
            this.button_0.Location = new Point(0xa5, 0x1bd);
            ...
            this.splitContainer_0.Size = new Size(0x380, 440);
            this.splitContainer_0.SplitterDistance = 0x1ac;
            this.splitContainer_0.TabIndex = 1;
            this.pictureBox_0.Anchor = AnchorStyles.Right | AnchorStyles.Top;
            this.pictureBox_0.Image = Resources.arrow00211;
            this.pictureBox_0.Location = new Point(0x177, 3);
            ...
            this.splitContainer_1.Size = new Size(0x1ad, 320);
            this.splitContainer_1.SplitterDistance = 0x98;
            this.splitContainer_1.TabIndex = 9;
            this.dataGridViewExcelFilter_0.AllowUserToAddRows = false;
            this.dataGridViewExcelFilter_0.AllowUserToDeleteRows = false;
            this.dataGridViewExcelFilter_0.AutoGenerateColumns = false;
            this.dataGridViewExcelFilter_0.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            DataGridViewColumn[] dataGridViewColumns = new DataGridViewColumn[] { this.dataGridViewFilterTextBoxColumn_6, this.dataGridViewTextBoxColumn_4, this.dataGridViewFilterTextBoxColumn_7, this.dataGridViewFilterTextBoxColumn_8 };
            ...
            this.dataGridViewExcelFilter_0.Size = new Size(0x1ad, 0x98);
            ...
            DataColumn[] columnArray3 = new DataColumn[] { this.dataColumn_8, this.dataColumn_9, this.dataColumn_10, this.dataColumn_11 };
            ...
            DataGridViewColumn[] columnArray4 = new DataGridViewColumn[] { this.dataGridViewFilterTextBoxColumn_0, this.dataGridViewTextBoxColumn_0, this.dataGridViewTextBoxColumn_1, this.dataGridViewTextBoxColumn_2, this.dataGridViewFilterTextBoxColumn_1, this.dataGridViewFilterTextBoxColumn_2 };
            this.dataGridViewExcelFilter_2.Columns.AddRange(columnArray4);
            ...
            this.dataGridViewExcelFilter_2.Size = new Size(0x1ad, 0xa4);
            ...
            this.textBox_0.Size = new Size(0x142, 20);
            ...
            this.splitContainer_2.Size = new Size(0x1cd, 320);
            this.splitContainer_2.SplitterDistance = 0x98;
            ...
            DataGridViewColumn[] columnArray5 = new DataGridViewColumn[] { this.dataGridViewFilterTextBoxColumn_9, this.dataGridViewTextBoxColumn_5, this.dataGridViewFilterTextBoxColumn_10, this.dataGridViewFilterTextBoxColumn_11 };
            ...
            this.dataGridViewExcelFilter_1.Size = new Size(0x1cd, 0x98);
            ...
            DataColumn[] columnArray6 = new DataColumn[] { this.dataColumn_4, this.dataColumn_5, this.dataColumn_6, this.dataColumn_7 };
            this.dataTable_1.Columns.AddRange(columnArray6);
            ...
            DataGridViewColumn[] columnArray8 = new DataGridViewColumn[] { this.dataGridViewFilterTextBoxColumn_3, this.dataGridViewTextBoxColumn_3, this.dataGridViewFilterTextBoxColumn_4, this.dataGridViewFilterTextBoxColumn_5 };
            ...
            this.dataGridViewExcelFilter_3.Size = new Size(0x1cd, 0xa4);
            ...
            this.textBox_2.Size = new Size(0x149, 20);
            ...
            this.button_1.Location = new Point(12, 0x1bd);
            this.button_1.Name = "buttonMergeAbn";
            this.button_1.Size = new Size(0x93, 0x17);
            ...
            this.button_2.Location = new Point(0x141, 0x1bd);
            this.button_2.Name = "buttonMoveAbnObj";
            this.button_2.Size = new Size(0x93, 0x17);
            ...
            this.button_3.Location = new Point(0x1da, 0x1bd);
            this.button_3.Name = "buttonChangeAbnAbnAbnObjRequest";
            this.button_3.Size = new Size(0x93, 0x24);
            ...
            base.ClientSize = new Size(0x37f, 480);
            ...
            base.Load += new EventHandler(this.FormMergeAndMoveAbnObj_Load);
