...
namespace Documents.Temperature
{
    ...
    public class FormJournalTemperature : FormBase
    {
        ...
        public FormJournalTemperature()
        {
            ...
            this.dateTimePickerTo.Value = new DateTime(DateTime.Now.Year + 1, 1, 1).AddDays(-1.0);
            this.dateTimePickerTo.Size = new Size(100, 20);
            ToolStripControlHost host = new ToolStripControlHost(this.dateTimePickerTo) {
            ...
            this.dateTimePickerFrom.Size = new Size(100, 20);
            ToolStripControlHost host2 = new ToolStripControlHost(this.dateTimePickerFrom) {
                Alignment = ToolStripItemAlignment.Right
            };
        ...
        private void getTableWindDirect()
        {
        ...
        private void method_1(int? idTemperature = new int?())
        {
            this.getTableWindDirect();
            if (!idTemperature.HasValue && (this.bindingSource.Current != null))
            {
                idTemperature = new int?(Convert.ToInt32(((DataRowView) this.bindingSource.Current).Row["id"]));
            }
            base.SelectSqlData(this.dataSetDamage.tJ_Temperature, true, string.Format("where dateTemp >= '{0}' and dateTEmp <= '{1}' order by datetemp desc", this.dateTimePickerFrom.Value.ToString("yyyyMMdd"), this.dateTimePickerTo.Value.ToString("yyyyMMdd")), null, false, 0);
            if (idTemperature.HasValue)
            {
                this.dataGridViewExcelFilter_0.SearchGrid(this.idDataGridViewTextBoxColumn.Name, idTemperature.ToString(), true);
            }
        ...
        {
            this.method_1(((FormTemperatureAddEdit) sender).IdTemperature);
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.dataGridViewExcelFilter_0.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle2;
            ...
            // chartAbnObjPayment
            // 
            chartArea3.AxisX.LabelStyle.Format = "MM.yyyy";
            ...
            this.chartAbnObjPayment.ChartAreas.Add(chartArea3);
            this.chartAbnObjPayment.ChartAreas.Add(chartArea4);
            ...
            this.chartAbnObjPayment.Legends.Add(legend2);
            ...
            series4.LegendText = "t Ночью";
            series4.Name = "Night";
            series4.ToolTip = "#VALX \\n#VAL ℃";
            series4.XValueMember = "DateTemp";
            series4.YValueMembers = "NightDown, NightUp, DayDown, DayUp";
            series4.YValuesPerPoint = 4;
            series5.BorderWidth = 2;
            series5.ChartArea = "ChartArea1";
            series5.ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Line;
            series5.Legend = "Legend1";
            series5.LegendText = "t Днем";
            series5.Name = "Day";
            series5.ToolTip = "#VALX\\n#VAL℃";
            series5.XValueMember = "DateTemp";
            series5.XValueType = System.Windows.Forms.DataVisualization.Charting.ChartValueType.Date;
            series5.YValueMembers = "DayDown, DayUp";
            ...
            series6.LegendText = "Скорость ветра";
            series6.Name = "Speed";
            series6.ToolTip = "#VALX\\n#VALм/с";
            series6.XValueMember = "DateTemp";
            series6.XValueType = System.Windows.Forms.DataVisualization.Charting.ChartValueType.Date;
            series6.YValueMembers = "SpeedDown, SpeedUp";
            series6.YValuesPerPoint = 2;
            series6.YValueType = System.Windows.Forms.DataVisualization.Charting.ChartValueType.Int32;
            this.chartAbnObjPayment.Series.Add(series4);
            this.chartAbnObjPayment.Series.Add(series5);
            this.chartAbnObjPayment.Series.Add(series6);
