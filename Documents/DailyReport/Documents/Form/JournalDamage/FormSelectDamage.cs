...
internal class FormSelectDamage : FormBase
{
    ...
    {
        if ((base.DialogResult == DialogResult.OK) && (this.bindingSource.Current == null))
        {
    ...
    internal int? GetIdDamage()
    {
        if (this.bindingSource.Current != null)
        {
            return new int?(Convert.ToInt32(((DataRowView) this.bindingSource.Current).Row["id"]));
        }
        return null;
    }
    ...
    private void InitializeComponent()
    {
        ...
        this.btnApplyFilter.Image = global::DailyReport.Properties.Resources.filter;
        ...
        this.btnResetFilter.Image = global::DailyReport.Properties.Resources.filter_delete;
        ...
        this.bindingSource.DataSource = this.dataSetDamage_0;
