...
namespace DailyReport.JournalActDetection
{
    ...
    /// </summary>
    public class FormJournalActDetectionN : FormBase
    {
        ...
        public FormJournalActDetectionN()
        {
            this.InitializeComponent();
            this.toolBTnLoadOld.Visible = false;
        }

        public FormJournalActDetectionN(List<int> checkedSubstation)
        {
            this.InitializeComponent();
        ...
        {
            FormActDetectionAddEdit form = new FormActDetectionAddEdit(idDoc);
        ...
        private void FormActDetectionAddEdit_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                int IdDocument = -1;
                if ((sender is FormActDetectionAddEdit) && ((FormActDetectionAddEdit) sender).IdDocument.HasValue)
                {
                    IdDocument = ((FormActDetectionAddEdit) sender).IdDocument.Value;
                }
                this.method_4(IdDocument);
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            ComponentResourceManager resources = new ComponentResourceManager(typeof(JournalActDetection.FormJournalActDetectionN));
        ...
        {
            //Class197.smethod_0(this.SqlSettings, new SQLSettings("ulges-sql", "SR4", "WINDOWS", "", ""));
        ...
        {
            //Class195.smethod_0(this.SqlSettings);
                                    ...
                                    if (source.Count<ElectricObject>() > 0)
                                        {
                                            ...
                                            if (table3.Rows.Count == 0)
                                            {
                                                ...
                                                //row["abnOff"] = Class199.CreateXmlAbnOff(table).InnerXml;
                                            ...
                                            {
                                                //table3.Rows[0]["abnOff"] = Class199.CreateXmlAbnOff(table).InnerXml;
