...
internal class FormReportDailyDefect : FormBase
{
    ...
    private void method_1()
    {
        ...
        using (SqlConnection connection = new SqlConnection(this.SqlSettings.GetConnectionString() + ";Connection Timeout=1000"))
        {
            ...
            try
            {
                using (SqlCommand command = new SqlCommand(Library.ResourceReader.GetStringAssembly("Documents.Forms.DailyReport.SqlScripts.ReportDailyDefect.sql"), connection))
                {
