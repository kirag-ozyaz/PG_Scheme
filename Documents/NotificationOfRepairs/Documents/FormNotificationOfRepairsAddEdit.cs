...
/// <summary>
/// Документ аварийные заявки и на ремонт оборудования (N2)
/// без дерева абонентов
/// </summary>
public partial class FormNotificationOfRepairsAddEdit : FormBase
{
    private int IdDocument = -1;
    private int IdDivision = -1;
    private Library.Dokuments.eActionRequestRepair eAction = Library.Dokuments.eActionRequestRepair.Read;
    ...
    public FormNotificationOfRepairsAddEdit()
    {
        this.InitializeComponent();
        this.CmdDataBindingsAdd();
    }

    public FormNotificationOfRepairsAddEdit(int idDocument, int idDivision, Library.Dokuments.eActionRequestRepair action)
    {
        this.InitializeComponent();
        this.CmdDataBindingsAdd();
    ...
    public FormNotificationOfRepairsAddEdit(DataRow copy)
    {
        this.InitializeComponent();
        this.CmdDataBindingsAdd();
        this.IdDocument = -1;
        this.IdDivision = Convert.ToInt32(copy["idDivision"]);
        this.eAction = Library.Dokuments.eActionRequestRepair.Add;
    ...
    private void CmdDataBindingsAdd()
    {
        ...
        this.cmbSR.DataBindings.Add(new Binding("SelectedValue", this.DataSetNotifications, "tJ_NotificationOfRepairs.idSR", true, DataSourceUpdateMode.OnPropertyChanged));
        this.cmbRegion.DataBindings.Clear();
        this.cmbRegion.DataBindings.Add(new Binding("SelectedValue", this.DataSetNotifications, "tJ_NotificationOfRepairs.idRegion", true, DataSourceUpdateMode.OnPropertyChanged));
        //this.dateTimePickerFactEnd.DataBindings.Clear();
        //this.dateTimePickerFactEnd.DataBindings.Add(new Binding("Value", this.DataSetNotifications, "tJ_NotificationOfRepairs.DateFactEnd", true, DataSourceUpdateMode.OnPropertyChanged));
    }
    ...
    /// <summary>
    /// заполняем список статусов документа
    /// </summary>
    ...
    private void FormNotificationOfRepairsAddEdit_Load(object sender, EventArgs e)
    {
        //this.ConnectToFTPRIC();
        ...
        switch (this.eAction)
        {
            case Library.Dokuments.eActionRequestRepair.Add:
                if (this.DataRowCurrent != null)
                {
                    DataRow dataRow = this.DataSetNotifications.tJ_NotificationOfRepairs.NewRow();
                    dataRow["num"] = 0;
                    ...
                    this.DataSetNotifications.tJ_NotificationOfRepairs.Rows.Add(dataRow);
                }
                else
                {
                    DataRow dataRow2 = this.DataSetNotifications.tJ_NotificationOfRepairs.NewRow();
                    dataRow2["num"] = 0;
                    ...
                    this.DataSetNotifications.tJ_NotificationOfRepairs.Rows.Add(dataRow2);

                }
                break;
            case Library.Dokuments.eActionRequestRepair.Edit:
                if (this.IdDocument > 0)
                {
                    base.SelectSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairs, true, " where id = " + this.IdDocument.ToString());
                    if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows.Count > 0 && this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["DateCreate"] != DBNull.Value)
                    {
                        this.FillingOutTrippingDates(Convert.ToDateTime(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["DateCreate"]));
                    }
                    base.SelectSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairsDaily, true, " where idRequest = " + this.IdDocument.ToString());
                    base.SelectSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairsDoc, true, " where idRequest = " + this.IdDocument.ToString());
                    //base.SelectSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairsAddress, true, " where idRequest = " + this.IdDocument.ToString());
                    this.LoadTableSchmObjects(true);
                    this.FillTableRepairAddress();
                }
                break;
            case Library.Dokuments.eActionRequestRepair.Read:
                if (this.IdDocument > 0)
                {
                    base.SelectSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairs, true, " where id = " + this.IdDocument.ToString());
                    base.SelectSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairsDaily, true, " where idRequest = " + this.IdDocument.ToString());
        ...
        if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows.Count > 0)
        {
            if (this.eAction == Library.Dokuments.eActionRequestRepair.Edit && this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["Status"] != DBNull.Value)
            {
                this.IdStatus = Convert.ToInt32(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["Status"]);
            }
            //if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["Agreed"] != DBNull.Value)
            //{
            //    this.IsAgreed = Convert.ToBoolean(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["Agreed"]);
            //}
            if (this.IdDivision <= 0)
            {
                this.IdDivision = Convert.ToInt32(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["IdDivision"]);
            }
            //if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["Crash"] != DBNull.Value && Convert.ToBoolean(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["Crash"]))
            //{
        ...
        if (this.IdDocument != -1)
        {
            ...
            Reference.Tables.LoadTableDamageAbnFullKladr(this.DataSetNotifications.tJ_NotificationOfRepairs, this.tableSchmAbnFull, this.SqlSettings,  "dateCreate");
    ...
    private void FormNotificationOfRepairsAddEdit_FormClosing(object sender, FormClosingEventArgs e)
    {
        if (base.DialogResult == DialogResult.OK)
        {
            ...
            //    return;
            //}
            if (this.eAction != Library.Dokuments.eActionRequestRepair.Read && !this.CheckRequiredFields())
            {
            ...
            if (eAction != Library.Dokuments.eActionRequestRepair.Add)
            {
                if (eAction == Library.Dokuments.eActionRequestRepair.Edit)
                {
                    this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0].EndEdit();
                    base.UpdateSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairs);
                }
            }
            else
            {
                this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0].EndEdit();
                this.IdDocument = base.InsertSqlDataOneRow(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairs);
            }
            foreach (DataRow dataRow in this.DataSetNotifications.tJ_NotificationOfRepairsDaily)
            {
            ...
            base.InsertSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairsDaily);
            base.UpdateSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairsDaily);
            base.DeleteSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairsDaily);
    ...
    private void FormNotificationOfRepairsAddEdit_FormClosed(object sender, FormClosedEventArgs e)
    {
    ...
    private void CreateCaptionNames()
    {
        ...
        switch (this.eAction)
        {
            case Library.Dokuments.eActionRequestRepair.Add:
                ...
                //else
                    this.Text = "Создать новое уведомление" + str;
                break;
            case Library.Dokuments.eActionRequestRepair.Edit:
                //if (this.GetIsCrash())
                //    this.Text = "Редактирование аварийной заявки" + str;
                //else
                    this.Text = "Редактирование уведомления" + str;
                break;
            case Library.Dokuments.eActionRequestRepair.Read:
                //if (this.GetIsCrash())
                //    this.Text = "Просмотр аварийной заявки" + str;
                //else
                    this.Text = "Просмотр уведомления" + str;
                break;
            default:
                break;
        }
        this.Text = this.Text
            + "  №" + this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["num"].ToString()
            + " от " + Convert.ToDateTime(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["DateCreate"]).ToShortDateString();
    ...
    private void FillComboBoxs()
    {
        ...
        base.SelectSqlData(this.DataSetNotifications, this.DataSetNotifications.tR_Classifier, true, " where ParentKey = ';NetworkAreas;' and deleted = 0 and isGroup = 0 order by name ");
        this.cmbSR.DataSource = this.DataSetNotifications.tR_Classifier;
        ...
        //base.SelectSqlData(tableTypeDamage, true, string.Format(" where id in ({0}, {1})", (int)Library.Dokuments.eTypeDocuments.DamageHV, (int)Library.Dokuments.eTypeDocuments.DamageLV), null, false, 0);
    ...
    private bool CheckRequiredFields()
    {
        ...
        //    result = false;
        //}
        if (this.DataSetNotifications.tJ_NotificationOfRepairsDaily.Rows.Count <= 0)
        {
    ...
    #region Работа с датами отключения
    ...
    private void CreateMinimumRealDateСompletionRequest()
    {
        ...
        if ((from o in this.DataSetNotifications.tJ_NotificationOfRepairsDaily
             where o.RowState != DataRowState.Deleted && o.RowState != DataRowState.Detached
             select o).Count() > 0)
        {
            try
            {
                DataRow dataRow = (from o in this.DataSetNotifications.tJ_NotificationOfRepairsDaily
                                   where o.RowState != DataRowState.Deleted && o.RowState != DataRowState.Detached
                                   select o into a
                                   orderby a["DateBeg"]
                                   select a).First();
        ...
        if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows.Count > 0 && this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["DateCreate"] != DBNull.Value && dateTime < Convert.ToDateTime(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["DateCreate"]).AddDays(-1.0).Date)
        {
            dateTime = Convert.ToDateTime(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["DateCreate"]).AddDays(-1.0).Date;
        }
    ...
    {
        //if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows.Count > 0 && ((this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0].HasVersion(DataRowVersion.Original) && this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["dateFactEnd", DataRowVersion.Original] == DBNull.Value) || !this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0].HasVersion(DataRowVersion.Original)) && !this.GetIsCrash())
        //{
    ...
    private void buttonDaily_Click(object sender, EventArgs e)
    {
        ...
        if (this.checkBoxDaily.Checked)
        {
            for (int i = 0; i <= (this.dateTimePickerEnd.Value - this.dateTimePickerBeg.Value).Days; i++)
            {
                if (this.checkBoxWeekEnd.Checked || (this.dateTimePickerBeg.Value.AddDays((double)i).DayOfWeek != DayOfWeek.Saturday && this.dateTimePickerBeg.Value.AddDays((double)i).DayOfWeek != DayOfWeek.Sunday))
                {
                    try
                    {
                        DataRow dataRow = this.DataSetNotifications.tJ_NotificationOfRepairsDaily.NewRow();
                        dataRow["idRequest"] = this.IdDocument;
                        ...
                        this.DataSetNotifications.tJ_NotificationOfRepairsDaily.Rows.Add(dataRow);
                        flag = true;
        ...
        else
        {
            try
            {
                DataRow dataRow2 = this.DataSetNotifications.tJ_NotificationOfRepairsDaily.NewRow();
                ...
                this.DataSetNotifications.tJ_NotificationOfRepairsDaily.Rows.Add(dataRow2);
                flag = true;
                this.groupBoxDaily.ForeColor = SystemColors.ControlText;
            }
            catch (Exception ex2)
        ...
        if (flag)
        {
            DataRow dataRow3 = (from o in this.DataSetNotifications.tJ_NotificationOfRepairsDaily
                                where o.RowState != DataRowState.Deleted && o.RowState != DataRowState.Detached
                                select o into a
                                orderby a.dateEnd descending
                                select a).First();
    ...
    private void txtPurpose_TextChanged(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(this.txtNotification.Text))
        {
            this.txtNotification.ForeColor = SystemColors.ControlText;
        }
    }
    ...
    private void LoadTableLinkObjects(bool Load = false)
    {
        ...
        //if (this.DataSetNotifications.tL_RequestForRepairSchmObjList.Rows.Count > 0)
        //{
        //    //int num = 0;
        //    foreach (DataRow dataRow in this.DataSetNotifications.tL_RequestForRepairSchmObjList.Rows)
        //    {
    ...
    {
        return this.IdDocument != -1 && new SqlDataCommand(this.SqlSettings)
            .SelectSqlData(string.Format("with  tree (id, isApply, level) " +
    ...
    {
        //base.SelectSqlData(this.DataSetNotifications, this.DataSetNotifications.tL_RequestForRepairSchmObjList, true, " where idRequest = " + this.IdDocument.ToString());
    ...
    #region Работа с блоком прикрепленных файлов
    private void toolBtnAddDoc_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    DataRow dataRow = this.DataSetNotifications.tJ_NotificationOfRepairsDoc.NewRow();
                    dataRow["idRequest"] = this.IdDocument;
                    ...
                    this.DataSetNotifications.tJ_NotificationOfRepairsDoc.Rows.Add(dataRow);
                }
            }
        }
        catch (Exception ex)
    ...
    private void toolBtnViewDoc_Click(object sender, EventArgs e)
    {
        ...
        byte[] array = (byte[])this.DataSetNotifications.tJ_NotificationOfRepairsDoc.FindByid(num)["Document"];
        string text = Path.GetTempFileName();
        text = Path.ChangeExtension(text, Path.GetExtension(this.DataSetNotifications.tJ_NotificationOfRepairsDoc.FindByid(num)["FileName"].ToString()));
    ...
    private void dgvDocs_CellValueNeeded(object sender, DataGridViewCellValueEventArgs e)
    {
        ...
        {
            Icon icon = FormLbr.Classes.FileInfo.IconOfFile(this.dgvDocs[this.fileNameDataGridViewTextBoxColumn.Name, e.RowIndex].Value.ToString());
    ...
    {
        foreach (DataRow dataRow in this.DataSetNotifications.tJ_NotificationOfRepairsDoc)
        {
            if (dataRow.RowState != DataRowState.Detached && dataRow.RowState != DataRowState.Deleted)
            {
                dataRow["idRequest"] = this.IdDocument;
        ...
        this.InsertSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairsDoc);
        base.UpdateSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairsDoc);
        base.DeleteSqlData(this.DataSetNotifications, this.DataSetNotifications.tJ_NotificationOfRepairsDoc);
        this.DataSetNotifications.tJ_NotificationOfRepairsDoc.AcceptChanges();
    }
    #endregion
    ...
    private void buttonCopy_Click(object sender, EventArgs e)
    {
        ...
        DataTable dataTable = this.DataSetNotifications.tJ_NotificationOfRepairs.Copy();
        DataRow dataRow = dataTable.NewRow();
        dataRow.ItemArray = dataTable.Rows[0].ItemArray;
        this.DataSetNotifications.tJ_NotificationOfRepairs.Clear();
        this.DataSetNotifications.tJ_NotificationOfRepairsDoc.Clear();
        this.DataSetNotifications.tJ_NotificationOfRepairsDaily.Clear();
        DataRow dataRow2 = this.DataSetNotifications.tJ_NotificationOfRepairs.NewRow();
        dataRow2["num"] = 0;
        dataRow2["dateCreate"] = DateTime.Now;
    ...
    protected override XmlDocument CreateXmlConfig()
    {
        ...
        if (this.eAction == Library.Dokuments.eActionRequestRepair.Add && this.cmbSR.SelectedValue != null)
        {
    ...
    private void backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
    {
        ...
        using (SqlConnection sqlConnection = new SqlConnection(this.SqlSettings.GetConnectionString() + ";Connection Timeout=1000"))
        {
            try
            {
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(Library.ResourceReader.GetStringAssembly("RequestForRepairN.SchmCable.sql"), sqlConnection);
        ...
        //this.DataSetNotifications.tJ_RequestForRepairAddress.Clear(); // чистим таблицу улиц
        ...
        foreach (var obj in eLinkObjects)
        {
            ...
            DataTable table = FillTableTransOff(listTrans, this.SqlSettings);
        ...
        //    //this.tableKladrObjAddress.Columns.Add("idRequest", typeof(string));
    ...
    private void backgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
    {
        ...
        try
        {
            ...
            //    {
            //        if (row.Key.idStreet != DBNull.Value && row.Key.house != DBNull.Value && this.DataSetNotifications.tJ_RequestForRepairAddress.Select(string.Concat(new string[]
            //        {
            //            "idKladrStreet = ",
            ...
            //        })).Length == 0)
            //        {
            //            DataRow dataRow2 = this.DataSetNotifications.tJ_RequestForRepairAddress.NewRow();
            //            dataRow2["idRequest"] = this.IdDocument;
            //            dataRow2["idKladrObj"] = row.Key.KladrObjId;
            //            dataRow2["idKladrStreet"] = row.Key.idStreet;
            //            dataRow2["house"] = row.Key.house;
            //            this.DataSetNotifications.tJ_RequestForRepairAddress.Rows.Add(dataRow2);
            //        }
            //    }
        ...
        this.toolBrnDelAbn.Enabled = true;
    ...
    private void FillTableRepairAddress()
    {
        ...
        //    base.SelectSqlData(this.tableKladrObj, true, "where deleted = 0", null, false, 0);
        //}
        //foreach (DataRow dataRow in this.DataSetNotifications.tJ_RequestForRepairAddress)
        //{
    ...
    private void toolBtnDelAddress_Click(object sender, EventArgs e)
    {
        ...
        //        DataRow[] dr = this.DataSetNotifications.tJ_RequestForRepairAddress.Select("id = " + num.ToString());
        //        if (dr.Length != 0)
        //        {
        //            dr[0].Delete();
        //        }
    ...
    private void EnableIsSendToSite()
    {
        //if (!this.IsCrash)
        //{
        //    if (this.eAction != Library.Dokuments.eActionRequestRepair.Read)
        //    {
        //        if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows.Count <= 0)
        //        {
        ...
        //            return;
        //        }
        //        if (!Convert.ToBoolean(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["Agreed"]))
        //        {
        //            this.chkSendToSite.Enabled = false;
        //            return;
        //        }
        //        if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0].RowState != DataRowState.Modified)
        //        {
        //            if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0].RowState != DataRowState.Unchanged)
        //            {
        //                this.chkSendToSite.Enabled = true;
        //                return;
        //            }
        //        }
        //        if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["SendSite", DataRowVersion.Original] != DBNull.Value && Convert.ToBoolean(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["SendSite", DataRowVersion.Original]))
        //        {
        //            this.chkSendToSite.Enabled = false;
        //            return;
        //        }
    ...
    //        return;
    //    }
    //    if (new SqlDataCommand(this.SqlSettings).SelectSqlData(string.Format("" +
    //        " with  tree (id, isApply, level)" +
    //        " as (select id, isApply,  0 as level  from tj_damage " +
    ...
    {
        int idTypeDamage = Convert.ToInt32(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["idTypeDamage"]);
        ...
        //{
            DataTable dataTable_ = FillTableTransOff(listTrans, this.SqlSettings);
    ...
    //        List<int> listTrans = new List<int>();
    //        FillTreeNodeTrans(treeNodeObj_, listTrans);
    //        DataTable dataTable = FillTableTransOff(listTrans, this.SqlSettings);
    //        // коэффициенты
    ...
    //    {
    //        FillTreeNodeTrans(Obj, listTrans);
    //    }
    //}
    /// <summary>
    ...
    /// </summary>
    private static DataTable FillTableTransOff(List<int> listTrans, SQLSettings sqlsettings)
    {
        ...
        {
            sqlConnection.Open();
            using (SqlCommand sqlCommand = new SqlCommand(Library.ResourceReader.GetStringAssembly("GetTransformerSchmObj.sql"), sqlConnection))
            {
        ...
        try
        {
            ...
            if (table.Rows.Count > 0)
            {
                ...
                DataTable dataTable = new SqlDataCommand(this.SqlSettings).SelectSqlData(string.Format("select ao.id,    " +
                    ...
                    "  else case when a.typeAbn = 206 and r.category is null then 493 " +
                    "-- если у физика нет категории - ставим ему третью " +
                    ...
                    "    where ao.id in ({1})     " 
                    , Convert.ToDateTime(this.DataSetNotifications.tJ_NotificationOfRepairsDaily.Rows[0]["dateBeg"]).ToString("yyyyMMdd"), text));
    ...
    #region Работа с блоком логирования
    ...
    private void SelectLogFromTableRequestForRepairLog()
    {
        if (this.IdDocument > 0)
        {
            base.SelectSqlData(this.DataSetNotifications.tJ_NotificationOfRepairsLog, true, "where idRequest = " + this.IdDocument.ToString(), null, false, 0);
        }
    }
    /// <summary>
    ...
    private void InsertLogToTableRequestForRepairLog()
    {
        ...
        DataTable tJ_NotificationOfRepairsLog = this.DataSetNotifications.tJ_NotificationOfRepairsLog;
        DataRow[] array = tJ_NotificationOfRepairsLog.Select("idCommand = 108");
        if (array.Length != 0)
        {
            return;
        }
        DataTable dataTableUser = new DataTable("tUser");
        DataRow dataRow = this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0];
        ...
        {
            array = tJ_NotificationOfRepairsLog.Select("idCommand = 2");
            ...
            array = tJ_NotificationOfRepairsLog.Select("idCommand = 3");
            ...
            array = tJ_NotificationOfRepairsLog.Select("idCommand = 104");
            ...
            array = tJ_NotificationOfRepairsLog.Select("idCommand = 105");
            if (array.Length != 0)
            {
                ...
                array = tJ_NotificationOfRepairsLog.Select("idCommand in (105, 7)", "datelog desc, id desc");
        ...
        {
            bool flag = false;
            foreach (DataRow dataRow2 in this.DataSetNotifications.tJ_NotificationOfRepairsDaily)
            {
            ...
            if (flag)
            {
                DataRow[] array2 = tJ_NotificationOfRepairsLog.Select("isSite = true", "datelog desc, id desc");
                if (array2.Length != 0)
                {
        ...
        base.InsertSqlData(this.DataSetNotifications.tJ_NotificationOfRepairsLog);
        try
        {
            string cmdText = "declare @userlogId int       " +
                ...
                "                                   " +
                "  insert into tJ_NotificationOfRepairsLog(idRequest, datelog, userLogId, userLog, userLogName, idCommand, Command, isSite)   " +
                "                                 (select r.id, getdate(), @userlogId, @userLog, @userLogName, 108, 'Выполнена', 1       " +
                "                               from tJ_NotificationOfRepairs r " +
                "       left join tJ_NotificationOfRepairsDaily d on d.id = (select top 1 id  " +
                "              from tJ_NotificationOfRepairsDaily  " +
                "             where idRequest = r.id  " +
                "              order by dateEnd desc)  " +
                "          where r.agreed = 1 and r.SendSite = 1 " +
                "         and not exists(select id from tJ_NotificationOfRepairsLog where idRequest = r.id and idCommand = 108)  " +
    ...
    private void AddRowTableLogUser(DataTable dataTableUser, int idCommand)
    {
        ...
        DataRow dataRow = this.DataSetNotifications.tJ_NotificationOfRepairsLog.NewRow();
        dataRow["idRequest"] = this.IdDocument;
        ...
        this.DataSetNotifications.tJ_NotificationOfRepairsLog.Rows.Add(dataRow);
    }
    #endregion
    ...
    private void dgvTreeNodesClear()
    {
        ...
        {
            this.dgvTree.Invoke(new MethodInvoker(this.dgvTreeNodesClear));
            return;
        }
    ...
    /// </summary>
    private TreeDataGridViewNode AddTreeParametr(TreeDataGridViewNodeCollection treeDataGridViewNodeCollection, params object[] values)
    {
        if (this.dgvTree.InvokeRequired)
        {
            return (TreeDataGridViewNode)this.dgvTree.Invoke(new TreeParametr(this.AddTreeParametr), new object[]
            {
    ...
    private void FillTableSubOff(TreeDataGridViewNode SubNodeTree, TreeNodeObj RootNodeObj, string VoltageLine = "", List<string> ListSub = null)
    {
        if (RootNodeObj.Tag != null)
        {
            ...
            if (SubNodeTree == null)
            {
                ...
                {
                    SubNodeTree = this.AddTreeParametr(this.dgvTree.Nodes, new object[]
                    {
                ...
                else if (RootNodeObj.Tag is ElectricSubstation)
                {
                    ...
                    //VoltageLine = ((SchemeModel.ElectricObject)RootNodeObj.Tag).ChildObjects.Where(r => r is ElectricBus).Select(r=>  Convert.ToDouble(ReferenceTables.CreateReferenceTables.GetVoltageObject(((ElectricBus)r).TypeBus).Replace(",", "."))).Max().ToString();
                    var qBeg = ((SchemeModelN.ElectricObject)RootNodeObj.Tag).ChildObjects.Where(r => r is ElectricBus);
            ...
            if (RootNodeObj.Tag is ElectricLine)
            {
                ...
                if (electricLine.IsCell()) // если ячейка
                {
                    ...
                    if (electricBus != null)
                    {
                        ...
                        string electricBusName = Reference.Tables.GetTypeSubstation(((ElectricSubstation)((ElectricObject)RootNodeObj.Tag).Parent).TypeSubstation) + " " + VoltageLine + " кВ " + electricBus.Parent.ToString();
                        ...
                        if (electricBus.TypeBus != eTypeShinaTool.Shina_04 && electricBus.TypeBus != eTypeShinaTool.Shina_023)
                        {
                            ...
                            {
                                SubNodeTree = this.AddTreeParametr(SubNodeTree.Nodes, new object[]
                                {
    ...
    {
        if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows.Count > 0 && this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["CommentXml"] != DBNull.Value)
        {
            try
            {
                XmlDocument xmlDocument = new XmlDocument();
                xmlDocument.LoadXml(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["CommentXml"].ToString());
                XmlNode xmlNode = xmlDocument.SelectSingleNode("Doc");
                if (xmlNode != null)
                {
                    XmlNode xmlNode2 = xmlNode.SelectSingleNode("AbnOff");
    ...
    private void FormNotificationOfRepairsAddEdit_Shown(object sender, EventArgs e)
    {
        this.isChangedData = false;
    }
    ...
    {
        XmlDocument xmlDocument = new XmlDocument();
        if (this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["CommentXml"] != DBNull.Value)
        {
            try
            {
                xmlDocument.LoadXml(this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["CommentXml"].ToString());
        ...
        this.DataSetNotifications.tJ_NotificationOfRepairs.Rows[0]["CommentXml"] = xmlDocument.InnerXml;
    }
    /// <summary>
    ...
    private void AppendChildTransTree(XmlNode xml)
    {
        if (xml != null && xml.OwnerDocument != null)
        {
            ...
            if (xml != null)
            {
                ...
                xml.AppendChild(xmlNode);
                foreach (TreeDataGridViewNode treeDataGridViewNode_ in this.dgvTree.Nodes)
                {
    ...
    private void AppendChildNodeTransTree(TreeDataGridViewNode treeDataGridViewNode, XmlNode xmlNode)
    {
        ...
        xmlNode.AppendChild(xmlNodeDgv);
        foreach (DataGridViewColumn dataGridViewColumn in this.dgvTree.Columns)
        {
    ...
    private void FillDGVTree(XmlDocument xml)
    {
        ...
        {
            this.CreateTreeStructureDGVTree(xmlNode_, this.dgvTree.Nodes);
        }
    }
    /// <summary>
    ...
    private void groupBoxDaily_Enter(object sender, EventArgs e)
    {

    }

    private void toolBtnAddAbn_Click(object sender, EventArgs e)
    {
        //
    }
}