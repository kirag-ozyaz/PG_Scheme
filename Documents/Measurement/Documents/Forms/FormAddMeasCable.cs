...
namespace Documents.Measurement
{
    internal class FormAddMeasCable : FormBase
    {
        ...
        private int CreateNewCableRows(DataSetMeasurementN.tJ_MeasCableDataTable dt, int NumNameCell)
        {
            ...
            */
            ...
            var currene3 = current2.Where(row => (!this.dsMeasurementN.tJ_MeasCable.Cast<DataSetMeasurementN.tJ_MeasCableRow>()
                   ...
                   .Select(r => r.idCell)
                   .ToArray()
                   .Contains<int>(row.idCell) || !this.dsMeasurementN.tJ_MeasCable.Cast<DataSetMeasurementN.tJ_MeasCableRow>()
        ...
        private void InitializeComponent()
        {
            ...
            this.idMeasTrans = new System.Windows.Forms.DataGridViewTextBoxColumn();
            ...
            this.btnAccept.Location = new System.Drawing.Point(526, 3);
            ...
            // idMeasTrans
            // 
            this.idMeasTrans.DataPropertyName = "idTransf";
            this.idMeasTrans.HeaderText = "idMeasTrans";
            this.idMeasTrans.Name = "idMeasTrans";
            this.idMeasTrans.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.Programmatic;
            this.idMeasTrans.ToolTipText = "idMeasTrans";
            this.idMeasTrans.Visible = false;
            // 
            // dgvcIdCell
            // 
