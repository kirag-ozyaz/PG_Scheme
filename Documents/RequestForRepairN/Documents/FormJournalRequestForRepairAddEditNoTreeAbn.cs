...
/// </summary>
public partial class FormJournalRequestForRepairAddEditNoTreeAbn : FormBase
{
    ...
    public FormJournalRequestForRepairAddEditNoTreeAbn()
    {
        this.InitializeComponent();
        this.CmdDataBindingsAdd();
    }

    public FormJournalRequestForRepairAddEditNoTreeAbn(int idDocument, int idDivision, eActionRequestRepair action, bool isCrash = false)
    {
        this.InitializeComponent();
        this.CmdDataBindingsAdd();
    ...
    public FormJournalRequestForRepairAddEditNoTreeAbn(DataRow copy)
    {
        this.InitializeComponent();
        this.CmdDataBindingsAdd();
        this.IdDocument = -1;
...
#pragma warning restore CS0618 // Тип или член устарел
    ...
    private void FormJournalRequestForRepairAddEdit_Load(object sender, EventArgs e)
    {
        ...
        if (this.IdDocument != -1)
        {
            ...
            Reference.Tables.LoadTableDamageAbnFullKladr(this.dataSetDamage.tJ_RequestForRepair, this.tableSchmAbnFull, this.SqlSettings,  "dateCreate");
    ...
    private void backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
    {
        ...
        foreach (var obj in eLinkObjects)
        {
            ...
            DataTable table = FillTableTransOff(listTrans, new StaticFormData { Sqlsettings = this.SqlSettings, eForm = this });
    ...
    private void backgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
    {
        ...
        try
        {
            ...
            //DataRow[] dr = this.dataSetDamage.tJ_RequestForRepairAddress.Select();
            //if (dr.Length != 0)
            //{
            //    dr[0].Delete();
            //}
    ...
    private void FillSubTablesDocumentDamageForCommentXml(DataRow dataRowCureent, DateTime dateStatusOperational, int idSchmObj)
    {
        ...
        //{
            DataTable dataTable_ = FillTableTransOff(listTrans, new StaticFormData { Sqlsettings = this.SqlSettings, eForm = this });
    ...
    private void FillSubTablesDocumentDamage2(int idDamage, DateTime dateStatusOperational, int idSchmObj)
    {
        ...
        if (idTypeDamage == (int)eTypeDocuments.DamageHV)
        {
            ...
            List<int> listTrans = new List<int>();
            FillTreeNodeTrans(treeNodeObj_, listTrans);
            DataTable dataTable = FillTableTransOff(listTrans, new StaticFormData { Sqlsettings = this.SqlSettings, eForm = this });
            // коэффициенты
