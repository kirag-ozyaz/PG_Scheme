...
namespace Abonent
{
    ...
    /// </summary>
	public partial class FormJournalAbnN : DockContentBase
    {
		public FormJournalAbnN()
		{
		...
		private void FillTableClassifier()
		{
			...
			{
				this.chkTypeAbn.Items.Add(new TypeAbn(Convert.ToInt32(dataRow["id"]), dataRow["name"].ToString()), CheckState.Checked);
			}
		}
