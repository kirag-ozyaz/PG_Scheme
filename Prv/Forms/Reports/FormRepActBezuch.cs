...
{
    public partial class FormRepActBezuch : FormLbr.FormBase
    {
        private DateTime DateAct,DateActBeg,DateActEnd;


        public FormRepActBezuch()
        {
            InitializeComponent();
        ...
        private void buttonExec_Click(object sender, EventArgs e)
        {
            ...
            SelectSqlData(dsRep, dsRep.vDocActBezuch, true, "where idDocType = " + ((int)Constants.DocType.ActBezuch).ToString() +
        ...
        private void FormRepActBezuch_Load(object sender, EventArgs e)
        {
