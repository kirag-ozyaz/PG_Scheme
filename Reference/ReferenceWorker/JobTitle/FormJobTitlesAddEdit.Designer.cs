internal partial class FormJobTitlesAddEdit : FormLbr.FormBase
{
	...
	private void InitializeComponent()
	{
		...
		this.txtName.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsWorker, "tR_JobTitle.Description", true));
		...
		this.txtRating.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsWorker, "tR_JobTitle.RName", true));
		...
		this.numUpDownRate.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.dsWorker, "tR_JobTitle.Razrjad", true));
