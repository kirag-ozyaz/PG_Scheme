namespace Reference.Forms
{
	public partial class FormDivisionsAddEdit : FormLbr.FormBase
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtName.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.class48_0, "tR_Division.Description", true));
			...
			this.cbGroup.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.class48_0, "tR_Division.ParentID", true));
			...
			this.class48_0.DataSetName = "DataSetReference";
