namespace ReferenceMapObj
{
	public partial class FormMapObjParamAddEdit : FormLbr.FormBase
	{
		...
		private void InitializeComponent()
		{
			...
			this.bindingSourceOtherType = new System.Windows.Forms.BindingSource(this.components);
			this.bindingSourceReasonClose = new System.Windows.Forms.BindingSource(this.components);
			...
			((System.ComponentModel.ISupportInitialize)this.bindingSourceOtherType).BeginInit();
			((System.ComponentModel.ISupportInitialize)this.bindingSourceReasonClose).BeginInit();
			base.SuspendLayout();
			...
			this.textBoxName.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "vMapObj.Name", true));
			...
			this.textBoxHousePrefix.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "vMapObj.HousePrefix", true));
			...
			this.textBoxHouse.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "vMapObj.House", true));
			...
			this.textBoxStreet.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "vMapObj.streetName", true));
			...
			this.textBoxYearBuilt.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "tMapObjParameter.YearBuilt", true));
			...
			this.textBoxApartment.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "tMapObjParameter.CountApartment", true));
			...
			this.textBoxPorch.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "tMapObjParameter.CountPorch", true));
			...
			this.textBoxFloor.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "tMapObjParameter.CountFloor", true));
			...
			this.cmbOtherType.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.dsKladr, "tMapObjParameter.OtherTypeObj", true));
			this.cmbOtherType.DataSource = this.bindingSourceOtherType;
			...
			this.cmbType.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.dsKladr, "tMapObjParameter.TypeObj", true));
			this.cmbType.DataSource = this.bindingSourceType;
			...
			this.dateTimePickerBegin.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "tMapObjParameter.dateBegin", true));
			...
			this.dateTimePickerEnd.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "tMapObjParameter.dateEnd", true));
			...
			this.cmbReason.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue", this.dsKladr, "tMapObjParameter.ReasonEnd", true));
			this.cmbReason.DataSource = this.bindingSourceReasonClose;
			...
			this.richTextBoxComment.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.dsKladr, "tMapObjParameter.Comment", true));
			...
			this.buttonOk.Location = new System.Drawing.Point(15, 337);
			...
			this.bindingSourceType.DataSource = this.dsKladr;
			this.bindingSourceType.Filter = "ParentKey = ';HouseParam;HouseType;'";
			this.bindingSourceOtherType.DataMember = "tR_Classifier";
			this.bindingSourceOtherType.DataSource = this.dsKladr;
			this.bindingSourceOtherType.Filter = "ParentKey = ';HouseParam;HouseOtherType;'";
			this.bindingSourceReasonClose.DataMember = "tR_Classifier";
			this.bindingSourceReasonClose.DataSource = this.dsKladr;
			this.bindingSourceReasonClose.Filter = "ParentKey = ';HouseParam;HouseReasonClose;'";
			...
			((System.ComponentModel.ISupportInitialize)this.bindingSourceOtherType).EndInit();
			((System.ComponentModel.ISupportInitialize)this.bindingSourceReasonClose).EndInit();
		...
		private System.Windows.Forms.BindingSource bindingSourceOtherType;

		private System.Windows.Forms.BindingSource bindingSourceReasonClose;
	}
}
