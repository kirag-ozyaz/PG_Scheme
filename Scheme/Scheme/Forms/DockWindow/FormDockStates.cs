...
internal class FormDockStates : DockContent
{
	...
	internal FormDockStates()
	{
		
		this.dictionary_0 = new Dictionary<LineToolState, FormDockStates.Struct1>();
		...
		GeneralFormSettings.FontSizeChanged(new EventHandler(this.method_4));
	}
	...
	internal void method_3()
	{
		...
		{
			FormDockStates.Struct1 @struct = this.dictionary_0[key];
	...
	internal void method_6(LineToolState lineToolState_0)
	{
		...
		if (dataGridView != null && dataGridViewRow != null)
		{
			...
			this.dictionary_0.Add(lineToolState_0, new FormDockStates.Struct1(dataGridViewRow, dataGridView));
		}
	}
	...
	private void method_7(DataGridView dataGridView_7, DataGridViewRow dataGridViewRow_0)
	{
		if (dataGridView_7.InvokeRequired)
		{
			try
			{
				FormDockStates.Delegate3 method = new FormDockStates.Delegate3(this.method_7);
	...
	internal void method_8(LineToolState lineToolState_0)
	{
		if (this.dictionary_0.ContainsKey(lineToolState_0))
		{
			FormDockStates.Struct1 @struct = this.dictionary_0[lineToolState_0];
	...
	protected override void Dispose(bool bool_0)
	{
		...
		FormDockStates.F4mSKnGBANoGjS3b9Pj(this, bool_0);
	}

	private void method_11()
	{
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(FormDockStates));
	...
	private Dictionary<LineToolState, FormDockStates.Struct1> dictionary_0;
