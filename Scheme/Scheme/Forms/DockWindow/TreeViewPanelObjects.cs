...
internal class TreeViewPanelObjects : DockContent
{
	[CompilerGenerated]
	...
	internal void method_3(DrawObjectBase drawObjectBase_1)
	{
	...
	private void toolStripButton_0_Click(object sender, EventArgs e)
	{
		...
		TreeNode treeNode = this.method_13(list_, this.treeView_0.SelectedNode, this.toolStripTextBox_0.Text, (TreeViewPanelObjects.Enum2)0);
		if (treeNode != null)
		{
	...
	private void toolStripButton_1_Click(object sender, EventArgs e)
	{
		List<TreeNode> list_ = new List<TreeNode>();
		list_ = this.method_12(this.treeView_0.Nodes, list_);
		TreeNode treeNode = this.method_13(list_, this.treeView_0.SelectedNode, this.toolStripTextBox_0.Text, (TreeViewPanelObjects.Enum2)2);
		if (treeNode != null)
		{
			this.treeView_0.SelectedNode = treeNode;
			this.treeView_0.SelectedNode.Expand();
	...
	private void toolStripButton_2_Click(object sender, EventArgs e)
	{
		List<TreeNode> list_ = new List<TreeNode>();
		list_ = this.method_12(this.treeView_0.Nodes, list_);
		TreeNode treeNode = this.method_13(list_, this.treeView_0.SelectedNode, this.toolStripTextBox_0.Text, (TreeViewPanelObjects.Enum2)1);
		if (treeNode != null)
		{
			this.treeView_0.SelectedNode = treeNode;
			this.treeView_0.SelectedNode.Expand();
	...
	private TreeNode method_13(List<TreeNode> list_0, TreeNode treeNode_0, string string_0, TreeViewPanelObjects.Enum2 enum2_0)
	{
		bool flag = enum2_0 == (TreeViewPanelObjects.Enum2)0;
		if (enum2_0 == (TreeViewPanelObjects.Enum2)2)
		{
			list_0.Reverse();
		}
	...
	{
		this.dataGridViewExcelFilter_1.SearchGrid(DataGridViewExcelFilter.TypeFind.Begin, this.toolStripTextBox_1.Text);
	}
	...
	private void toolStripTextBox_1_KeyDown(object sender, KeyEventArgs e)
	{
		if (e.KeyCode == Keys.Return)
		{
			...
			{
				this.dataGridViewExcelFilter_1.SearchGrid(DataGridViewExcelFilter.TypeFind.Next, this.toolStripTextBox_1.Text);
			}
			if (e.Modifiers == Keys.Shift)
			{
				this.dataGridViewExcelFilter_1.SearchGrid(DataGridViewExcelFilter.TypeFind.Prev, this.toolStripTextBox_1.Text);
			}
		}
	}
	...
	private void method_17()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(TreeViewPanelObjects));
