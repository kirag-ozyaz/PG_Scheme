...
internal class Class17 : DockContent
{
	internal Class17()
	{
	...
	internal void VtnUlqUaJQ(DrawObjectBase obj)
	{
		...
		if (obj.GetType() == typeof(RectangleTool) || obj.GetType() == typeof(ShinaTool))
		{
			this.selectedObject = obj;
			if (obj.GetType() == typeof(RectangleTool))
			{
				this.Text = this.selectedObject.ToString();
			}
			else
			{
				this.Text = this.selectedObject.Parent + " - " + this.selectedObject.ToString();
			}
			this.reloadPowering();
		}
	}

	private void reloadPowering()
	{
		this.treeView_0.Nodes.Clear();
		this.treeView_1.Nodes.Clear();
	}
	...
	protected override void Dispose(bool bool_0)
	{
		...
		Class17.pmuJtuk7HFPKRVH5lTf(this, bool_0);
	}
	...
	private DrawObjectBase selectedObject;
