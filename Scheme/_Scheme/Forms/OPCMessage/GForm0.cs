...
namespace Scheme.Forms.OPCMessage
{
	public partial class GForm0 : FormBase
	{
		...
		{
			if (new FormOPCMessageAddEdit(StateFormCreate.Add, -1)
			{
		...
		{
			if (this.dataGridViewExcelFilter_0.CurrentRow != null && new FormOPCMessageAddEdit(StateFormCreate.Edit, Convert.ToInt32(this.dataGridViewExcelFilter_0.CurrentRow.Cells["idDgvColumn"].Value))
			{
				SqlSettings = this.SqlSettings
			}.ShowDialog() == DialogResult.OK)
			{
		...
		{
			if (e.RowIndex >= 0 && this.dataGridViewExcelFilter_0.Columns[e.ColumnIndex].Name != "audioDgvColumn" && new FormOPCMessageAddEdit(StateFormCreate.Edit, Convert.ToInt32(this.dataGridViewExcelFilter_0.Rows[e.RowIndex].Cells["idDgvColumn"].Value))
			{
				SqlSettings = this.SqlSettings
			}.ShowDialog() == DialogResult.OK)
			{
