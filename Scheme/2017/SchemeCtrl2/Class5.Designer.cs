	...
	private void Class5_BeforeExpand(object sender, TreeViewCancelEventArgs e)
	{
		if (e.Node.Nodes.Count > 0 && e.Node.Level > 0)
		{
			...
			case 1:
			{
				...
				using (IEnumerator<Class22.Class59> enumerator2 = @class.vSchm_ObjList.GetEnumerator())
				{
			...
			using (IEnumerator<Class22.Class64> enumerator3 = @class.vSchm_TreeCellLine.GetEnumerator())
			{
