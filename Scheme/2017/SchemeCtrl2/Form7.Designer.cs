	...
	private void treeView_0_BeforeExpand(object sender, TreeViewCancelEventArgs e)
	{
		if (e.Node.Nodes.Count > 0 && e.Node.Level > 0)
		{
			...
			if (i != 1)
			{
				...
				using (IEnumerator<Class22.Class64> enumerator2 = @class.vSchm_TreeCellLine.GetEnumerator())
				{
			...
			{
				using (IEnumerator<Class22.Class59> enumerator4 = @class.vSchm_ObjList.GetEnumerator())
				{
