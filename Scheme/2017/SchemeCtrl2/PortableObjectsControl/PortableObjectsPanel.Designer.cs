...
namespace SchemeCtrl2.PortableObjectsControl
{
	public class PortableObjectsPanel : UserControl
	{
		...
		public void AddObject(DrawObjectBase obj)
		{
			this.list_0.Add(obj);
			...
			pictureBox.Tag = obj;
			if (obj.GetType() == typeof(GroundingTool))
			{
				pictureBox.Image = Resources.PortableGroundingTool;
				((GroundingTool)obj).PortEvent += this.method_1;
				((GroundingTool)obj).RemovePortEvent += this.method_0;
			}
		}
