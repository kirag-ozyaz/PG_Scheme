		...
		private void method_1()
		{
			if (this.comboBoxTP.SelectedItem != null)
			{
				...
				if (this.comboBoxVolt.SelectedItem != null)
				{
					...
					sqlDataCommand2.SelectSqlData(tSchm_ObjList, flag, string.Concat(array), null, false, 0);
					if (@class.tSchm_ObjList.Rows.Count > 0)
					{
					...
					sqlDataCommand3.SelectSqlData(tSchm_ObjList2, flag2, string.Concat(array2), null, false, 0);
