...
namespace SchemeCtrl2.DrawTool
{
	...
	public abstract class DrawObjectBase : IDisposable
	{
		...
		public virtual bool DeleteSql()
		{
			...
			{
				this.Deleted = sqlDataCommand.UpdateSqlData(this.drawingLayer_0.Parent.class22_0.tSchm_ObjList, " set [DELETED] = 1 ", " WHERE [ID] = " + this.IdBase.ToString());
			}
			else
			{
				RectangleTool rectangleTool = null;
				...
				if (rectangleTool != null)
				{
					this.Deleted = sqlDataCommand.DeleteSqlData(this.drawingLayer_0.Parent.class22_0.tSchm_Xml, string.Concat(new string[]
					{
						" where ObjId = ",
						this.IdBase.ToString(),
						" and TypeSchema = ",
				...
				{
					this.Deleted = sqlDataCommand.DeleteSqlData(this.drawingLayer_0.Parent.class22_0.tSchm_Xml, " where ObjId = " + this.IdBase.ToString() + " and TypeSchema = " + ((int)this.drawingLayer_0.Parent.TypeCanvas).ToString());
				}
			}
			return this.Deleted;
		}
