...
namespace SchemeCtrl2.Calculations
{
	...
	public class CouplingRelation : IDisposable
	{
		...
		private void method_6()
		{
			...
			new SqlDataCommand(this.pointTool_0.Branches.First<Branch>().Parent.Layer.Parent.SqlSettings).DeleteSqlDataById(this.pointTool_0.Branches.First<Branch>().Parent.Layer.Parent.class22_0.tSchm_Relation, this.Id);
			this.Id = 0;
		}
