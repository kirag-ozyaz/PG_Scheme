...
namespace SchemeCtrl2.Layers
{
	public class GridLayer : ICanvasLayer
	{
		...
		public CanvasControl Parent
		{
			get
			{
				return this.UucQeuNfbN;
			}
			set
			{
				this.UucQeuNfbN = value;
			}
		}
		...
		public GridLayer(CanvasControl parent)
		{
			...
			this.sizeF_0 = new SizeF(1f, 1f);
			this.bool_0 = true;
			this.int_0 = 15;
			this.eGridStyle_0 = GridLayer.eGridStyle.Lines;
			this.color_0 = Color.FromArgb(50, Color.Gray);
			base..ctor();
			this.UucQeuNfbN = parent;
		}
		...
		public ISnapPoint SnapPoint(CanvasControl canvas, UnitPoint point, List<DrawObjectBase> otherobj)
		{
			...
			{
				return new Class7(canvas, unitPoint_);
			}
			return null;
		}
		...
		private CanvasControl UucQeuNfbN;
