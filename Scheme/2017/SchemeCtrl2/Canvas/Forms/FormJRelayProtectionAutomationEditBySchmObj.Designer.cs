...
{
	public class FormJRelayProtectionAutomationEditBySchmObj : FormBase
	{
		...
		public FormJRelayProtectionAutomationEditBySchmObj(int type_sub, int subid, int busid, int cellid)
		{
			...
			base..ctor();
			this.method_3();
			this.method_0(type_sub, subid, busid, cellid);
		}

		private void method_0(int int_5, int int_6, int int_7, int int_8)
		{
			this.int_0 = int_5;
			this.int_1 = int_6;
			this.int_2 = int_7;
		...
		private void FormJRelayProtectionAutomationEditBySchmObj_Load(object sender, EventArgs e)
		{
			...
			base.SelectSqlData(this.class22_0, this.class22_0.vJ_RelayProtectionAutomation, true, " where cellid = " + this.int_3.ToString() + " order by relName ");
			if (this.class22_0.vJ_RelayProtectionAutomation.Rows.Count > 0)
			{
				this.tabPage_0.Text = this.class22_0.vJ_RelayProtectionAutomation.Rows[0]["relName"].ToString();
				this.tabPage_0.Tag = new FormJRelayProtectionAutomationEditBySchmObj.Struct0(Convert.ToInt32(this.class22_0.vJ_RelayProtectionAutomation.Rows[0]["id"]), Convert.ToInt32(this.class22_0.vJ_RelayProtectionAutomation.Rows[0]["relayidValue"]));
				list.Add(Convert.ToInt32(this.class22_0.vJ_RelayProtectionAutomation.Rows[0]["relayidValue"]));
				list2.Add(Convert.ToInt32(this.class22_0.vJ_RelayProtectionAutomation.Rows[0]["id"]));
				if (this.class22_0.vJ_RelayProtectionAutomation.Rows.Count > 1)
				{
					for (int i = 1; i < this.class22_0.vJ_RelayProtectionAutomation.Rows.Count; i++)
					{
						TabPage tabPage = new TabPage();
						tabPage.BackColor = Color.Transparent;
						tabPage.UseVisualStyleBackColor = true;
						tabPage.Text = this.class22_0.vJ_RelayProtectionAutomation.Rows[i]["relName"].ToString();
						tabPage.Tag = new FormJRelayProtectionAutomationEditBySchmObj.Struct0(Convert.ToInt32(this.class22_0.vJ_RelayProtectionAutomation.Rows[i]["id"]), Convert.ToInt32(this.class22_0.vJ_RelayProtectionAutomation.Rows[i]["relayidValue"]));
						list.Add(Convert.ToInt32(this.class22_0.vJ_RelayProtectionAutomation.Rows[i]["relayidValue"]));
						list2.Add(Convert.ToInt32(this.class22_0.vJ_RelayProtectionAutomation.Rows[i]["id"]));
			...
			if (text.Length > 0)
			{
				base.SelectSqlData(this.class22_0, this.class22_0.tJ_RelayProtectionAutomationValue, true, "where id in (" + text.Remove(text.Length - 1) + ")");
				base.SelectSqlData(this.class22_0, this.class22_0.tJ_RelayProtectionAutomation, true, "where id in (" + text2.Remove(text2.Length - 1) + ")");
		...
		private void FormJRelayProtectionAutomationEditBySchmObj_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (base.DialogResult == DialogResult.OK)
			{
				...
				this.class22_0.tJ_RelayProtectionAutomation.Rows[0].EndEdit();
				if (this.RjjuZqqfy0 < 0)
				{
					try
					{
						this.RjjuZqqfy0 = base.InsertSqlDataOneRow(this.class22_0, this.class22_0.tJ_RelayProtectionAutomation);
						if (this.RjjuZqqfy0 > 0)
						{
							this.class22_0.tJ_RelayProtectionAutomationValue.Rows[0]["idRelay"] = this.RjjuZqqfy0;
							this.class22_0.tJ_RelayProtectionAutomationValue.Rows[0].EndEdit();
							base.InsertSqlDataOneRow(this.class22_0, this.class22_0.tJ_RelayProtectionAutomationValue);
						}
						else
						{
							e.Cancel = true;
				...
				this.class22_0.tJ_RelayProtectionAutomationValue.Rows[0].EndEdit();
				base.UpdateSqlData(this.class22_0, this.class22_0.tJ_RelayProtectionAutomationValue);
			}
		}
		...
		{
			this.class22_0.tJ_RelayProtectionAutomationValue.Rows[0]["type_relay"] = this.comboBox_6.Text;
		}

		private void comboBox_5_TextUpdate(object sender, EventArgs e)
		{
			this.class22_0.tJ_RelayProtectionAutomationValue.Rows[0]["type_proc"] = this.comboBox_5.Text;
		}
		...
		protected override void Dispose(bool disposing)
		{
			...
			FormJRelayProtectionAutomationEditBySchmObj.V26KTvpjeoEkiUQuLaRf(this, disposing);
		}
		...
		private void method_3()
		{
			...
			this.JfyHopxIlV = new DataGridViewTextBoxColumn();
			...
			this.nkmHevXfyM = new DataGridViewCheckBoxColumn();
			...
			this.qutvwfuSvJ = new DataGridViewTextBoxColumn();
			...
			base.SuspendLayout();
			this.class22_0.DataSetName = "DataSetGES";
			...
			this.groupBox_0.Controls.Add(this.tmJuoShiiM);
			...
			this.tmJuoShiiM.BackColor = SystemColors.Window;
			this.tmJuoShiiM.DataBindings.Add(new Binding("Text", this.bindingSource_1, "amp_primary", true));
			this.tmJuoShiiM.Location = new Point(34, 24);
			this.tmJuoShiiM.Name = "txtT1";
			this.tmJuoShiiM.ReadOnly = true;
			this.tmJuoShiiM.Size = new Size(62, 20);
			this.tmJuoShiiM.TabIndex = 2;
			...
			this.textBox_2.DataBindings.Add(new Binding("Text", this.bindingSource_1, "speed_mtz", true));
			...
			this.textBox_3.DataBindings.Add(new Binding("Text", this.bindingSource_1, "time_mtz", true));
			...
			this.textBox_4.DataBindings.Add(new Binding("Text", this.bindingSource_1, "amp_mtz", true));
			...
			this.textBox_5.DataBindings.Add(new Binding("Text", this.bindingSource_1, "time_ozz", true));
			...
			this.textBox_6.DataBindings.Add(new Binding("Text", this.bindingSource_1, "amp_ozz", true));
			...
			this.textBox_7.DataBindings.Add(new Binding("Text", this.bindingSource_1, "time_to", true));
			...
			this.textBox_8.DataBindings.Add(new Binding("Text", this.bindingSource_1, "amp_to", true));
			...
			this.textBox_9.DataBindings.Add(new Binding("Text", this.bindingSource_1, "time_urov", true));
			...
			this.textBox_10.DataBindings.Add(new Binding("Text", this.bindingSource_1, "amp_urov", true));
			...
			this.textBox_11.DataBindings.Add(new Binding("Text", this.bindingSource_1, "cp_cell", true));
			...
			this.textBox_12.DataBindings.Add(new Binding("Text", this.bindingSource_1, "cp", true));
			...
			this.JfyHopxIlV.DataPropertyName = "time_to";
			this.JfyHopxIlV.HeaderText = "ТО, с";
			this.JfyHopxIlV.Name = "timetoDataGridViewTextBoxColumn";
			this.JfyHopxIlV.ReadOnly = true;
			this.JfyHopxIlV.Width = 40;
			this.dataGridViewTextBoxColumn_18.DataPropertyName = "amp_ozz";
			this.dataGridViewTextBoxColumn_18.HeaderText = "ОЗЗ, А";
			this.dataGridViewTextBoxColumn_18.Name = "ampozzDataGridViewTextBoxColumn";
			this.dataGridViewTextBoxColumn_18.ReadOnly = true;
			this.dataGridViewTextBoxColumn_18.Width = 40;
			this.dataGridViewTextBoxColumn_19.DataPropertyName = "time_ozz";
			this.dataGridViewTextBoxColumn_19.HeaderText = "ОЗЗ, с";
			this.dataGridViewTextBoxColumn_19.Name = "timeozzDataGridViewTextBoxColumn";
			this.dataGridViewTextBoxColumn_19.ReadOnly = true;
			this.dataGridViewTextBoxColumn_19.Width = 40;
			this.dataGridViewTextBoxColumn_20.DataPropertyName = "act_ozz";
			this.dataGridViewTextBoxColumn_20.HeaderText = "Действие ОЗЗ";
			this.dataGridViewTextBoxColumn_20.Name = "act_ozzDGVTxtColumn";
			this.dataGridViewTextBoxColumn_20.ReadOnly = true;
			this.dataGridViewTextBoxColumn_20.Width = 35;
			...
			this.dataGridViewTextBoxColumn_22.DataPropertyName = "amp_urov";
			this.dataGridViewTextBoxColumn_22.HeaderText = "УРОВ, А";
			this.dataGridViewTextBoxColumn_22.Name = "ampurovDataGridViewTextBoxColumn";
			this.dataGridViewTextBoxColumn_22.ReadOnly = true;
			this.dataGridViewTextBoxColumn_22.Width = 40;
			this.dataGridViewTextBoxColumn_23.DataPropertyName = "time_urov";
			this.dataGridViewTextBoxColumn_23.HeaderText = "УРОВ, с";
			this.dataGridViewTextBoxColumn_23.Name = "timeurovDataGridViewTextBoxColumn";
			...
			this.nkmHevXfyM.DataPropertyName = "lzsh";
			this.nkmHevXfyM.HeaderText = "ЛЗШ";
			this.nkmHevXfyM.Name = "lzshDataGridViewCheckBoxColumn";
			this.nkmHevXfyM.ReadOnly = true;
			this.nkmHevXfyM.Width = 40;
			this.dataGridViewTextBoxColumn_24.DataPropertyName = "type_relay";
			this.dataGridViewTextBoxColumn_24.HeaderText = "Тип реле";
			this.dataGridViewTextBoxColumn_24.Name = "typerelayDataGridViewTextBoxColumn";
			this.dataGridViewTextBoxColumn_24.ReadOnly = true;
			this.dataGridViewTextBoxColumn_24.Width = 50;
			this.dataGridViewTextBoxColumn_25.DataPropertyName = "type_proc";
			this.dataGridViewTextBoxColumn_25.HeaderText = "Тип микропроц";
			this.dataGridViewTextBoxColumn_25.Name = "typeprocDataGridViewTextBoxColumn";
			this.dataGridViewTextBoxColumn_25.ReadOnly = true;
			this.dataGridViewTextBoxColumn_25.Width = 50;
			this.dataGridViewTextBoxColumn_26.DataPropertyName = "cp";
			this.dataGridViewTextBoxColumn_26.HeaderText = "cp";
			this.dataGridViewTextBoxColumn_26.Name = "cpDataGridViewTextBoxColumn";
			this.dataGridViewTextBoxColumn_26.ReadOnly = true;
			this.dataGridViewTextBoxColumn_26.Visible = false;
			this.dataGridViewTextBoxColumn_27.DataPropertyName = "cp_cell";
			this.dataGridViewTextBoxColumn_27.HeaderText = "cp_cell";
			this.dataGridViewTextBoxColumn_27.Name = "cpcellDataGridViewTextBoxColumn";
			...
			this.dataGridViewTextBoxColumn_28.HeaderText = "comment";
			...
			this.dataGridViewTextBoxColumn_29.DataPropertyName = "dateCreate";
			this.dataGridViewTextBoxColumn_29.HeaderText = "dateCreate";
			this.dataGridViewTextBoxColumn_29.Name = "dateCreateDataGridViewTextBoxColumn";
			this.dataGridViewTextBoxColumn_29.ReadOnly = true;
			this.dataGridViewTextBoxColumn_29.Visible = false;
			this.qutvwfuSvJ.DataPropertyName = "dateIn";
			this.qutvwfuSvJ.HeaderText = "dateIn";
			this.qutvwfuSvJ.Name = "dateInDataGridViewTextBoxColumn";
			this.qutvwfuSvJ.ReadOnly = true;
			this.qutvwfuSvJ.Visible = false;
		...
		internal static void V26KTvpjeoEkiUQuLaRf(Form form_0, bool bool_0)
		{
		...
		private DataGridViewTextBoxColumn JfyHopxIlV;
		...
		private DataGridViewCheckBoxColumn nkmHevXfyM;
		...
		private DataGridViewTextBoxColumn qutvwfuSvJ;
