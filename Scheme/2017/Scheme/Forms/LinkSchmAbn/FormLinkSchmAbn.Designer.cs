...
{
	public class FormLinkSchmAbn : FormBase
	{
		...
		private void toolStripMenuItem_1_Click(object sender, EventArgs e)
		{
			...
			{
				int num = Convert.ToInt32(this.dataGridViewExcelFilter_0.SelectedRows[0].Cells["idSchmObjDgvColumn"].Value);
				this.OnGoToSchema(new GoToSchemaEventArgs(num));
			}
		}
