...
{
	public class FormGeneralScheme2 : FormBase
	{
		protected override XmlDocument CreateXmlConfig()
		{
			...
			xmlAttribute.Value = this.canvasControl_0.CenterPointUnit().X.ToString();
			xmlNode2.Attributes.Append(xmlAttribute);
			xmlAttribute = xmlDocument.CreateAttribute("CenterPointY");
			xmlAttribute.Value = this.canvasControl_0.CenterPointUnit().Y.ToString();
			xmlNode2.Attributes.Append(xmlAttribute);
			xmlAttribute = xmlDocument.CreateAttribute("Zoom");
			xmlAttribute.Value = this.canvasControl_0.Zoom.ToString();
			xmlNode2.Attributes.Append(xmlAttribute);
			...
			xmlAttribute.Value = this.class18_0.Visible.ToString();
			xmlNode5.Attributes.Append(xmlAttribute);
			xmlAttribute = xmlDocument.CreateAttribute("DockState");
			xmlAttribute.Value = this.class18_0.DockState.ToString();
			xmlNode5.Attributes.Append(xmlAttribute);
			xmlAttribute = xmlDocument.CreateAttribute("DockLeftPortion");
			xmlAttribute.Value = this.class18_0.DockPanel.DockLeftPortion.ToString();
			xmlNode5.Attributes.Append(xmlAttribute);
			xmlAttribute = xmlDocument.CreateAttribute("DockRightPortion");
			xmlAttribute.Value = this.class18_0.DockPanel.DockRightPortion.ToString();
			xmlNode5.Attributes.Append(xmlAttribute);
		...
		protected override void ApplyConfig(XmlDocument doc)
		{
			...
			if (xmlNode != null)
			{
				...
				if (xmlNode2 != null)
				{
					...
					{
						this.class18_0.Close();
					}
					xmlAttribute = xmlNode2.Attributes["DockState"];
					if (xmlAttribute != null)
					{
						this.class18_0.DockState = (DockState)Enum.Parse(typeof(DockState), xmlAttribute.Value);
					}
					xmlAttribute = xmlNode2.Attributes["DockLeftPortion"];
					if (xmlAttribute != null)
					{
						this.class18_0.DockPanel.DockLeftPortion = Convert.ToDouble(xmlAttribute.Value);
					}
					xmlAttribute = xmlNode2.Attributes["DockRightPortion"];
					if (xmlAttribute != null)
					{
						this.class18_0.DockPanel.DockRightPortion = Convert.ToDouble(xmlAttribute.Value);
					}
				}
				...
				this.opcClient.LoadOPCConfig(this.canvasControl_0.SqlSettings);
				this.opcClient.OpcConfig.SqlSettings.Autentification = this.canvasControl_0.SqlSettings.Autentification;
				this.opcClient.OpcConfig.SqlSettings.SqlUserConnect = this.canvasControl_0.SqlSettings.SqlUserConnect;
				this.opcClient.OpcConfig.SqlSettings.SqlPasswConnect = this.canvasControl_0.SqlSettings.SqlPasswConnect;
				...
				if (xmlNode10 != null)
				{
					...
					{
						this.canvasControl_0.Zoom = Convert.ToSingle(xmlAttribute8.Value);
						if (float.IsInfinity(this.canvasControl_0.Zoom) || float.IsNaN(this.canvasControl_0.Zoom))
						{
					...
					if (xmlAttribute9 != null && xmlAttribute10 != null)
					{
						...
						this.canvasControl_0.SetCenter(new UnitPoint((double)num2, (double)num3));
					}
		...
		private void method_1(string string_0)
		{
			...
			{
				((DrawingLayer)this.canvasControl_0.Layers.First<ICanvasLayer>()).Clear(true);
		...
		private void method_3()
		{
			...
			foreach (DrawObjectBase drawObjectBase in this.canvasControl_0.Layers.First<ICanvasLayer>().Objects)
			{
				bool flag = false;
				if (drawObjectBase.GetType() == typeof(RectangleTool))
				{
		...
		private void method_4(DataTable dataTable_0)
		{
			...
			foreach (object obj in dataTable_0.Rows)
			{
				...
				rectangleTool.Layer = (DrawingLayer)this.canvasControl_0.Layers.First<ICanvasLayer>();
				if (!this.canvasControl_0.ValidateToUnique(rectangleTool))
				{
					rectangleTool.CreateUniqueCopyName();
				}
				this.canvasControl_0.AddObject(this.canvasControl_0.Layers.First<ICanvasLayer>(), rectangleTool);
				...
				while (enumerator.MoveNext())
				{
					...
					if (!this.list_0.Contains(Convert.ToInt32(dataRow["id_obj"])))
					{
						...
						if (points.Length != 0)
						{
							...
							PointTool pointTool2 = new PointTool((DrawingLayer)this.canvasControl_0.Layers.First<ICanvasLayer>());
							if (points.Length != 0)
							{
		...
		{
			IEnumerable<DrawObjectBase> enumerable = from obj in this.canvasControl_0.Layers.First<ICanvasLayer>().Objects
			where obj.GetType() == typeof(LineCellTool)
			select obj;
			from obj in this.canvasControl_0.Layers.First<ICanvasLayer>().Objects
			where obj.GetType() == typeof(ShinaTool)
			select obj;
			foreach (object obj2 in dataTable_0.Rows)
			{
				...
				if (!this.list_0.Contains(Convert.ToInt32(dataRow["id_obj"])))
				{
					...
					PointTool pointTool = new PointTool((DrawingLayer)this.canvasControl_0.Layers.First<ICanvasLayer>());
					if (array.Length != 0)
					{
						...
						if (array.Length != 0)
						{
							...
							lineTool.Layer = (DrawingLayer)this.canvasControl_0.Layers.First<ICanvasLayer>();
							lineTool.Text = lineTool.ToString();
							if (!this.canvasControl_0.ValidateToUnique(lineTool))
							{
							...
							foreach (DataRow dataRow2 in dataTable_2.Select("id_line = " + dataRow["id_obj"].ToString()))
							{
								...
								objectOnLine.Layer = (DrawingLayer)this.canvasControl_0.Layers.First<ICanvasLayer>();
								objectOnLine.Text = "Выключатель";
								if (Convert.ToInt32(dataRow2["KEY_ON"]) == 1)
								{
									objectOnLine.On = true;
								...
								if (!this.canvasControl_0.ValidateToUnique(objectOnLine))
								{
									objectOnLine.CreateUniqueCopyName();
								}
								((DrawingLayer)this.canvasControl_0.Layers.First<ICanvasLayer>()).AddObject(objectOnLine);
							}
							bool flag = false;
							bool flag2 = false;
							foreach (DrawObjectBase drawObjectBase in enumerable)
							...
							lineTool.Validation();
							this.canvasControl_0.AddObject(this.canvasControl_0.Layers.First<ICanvasLayer>(), lineTool);
						}
					}
				}
			}
		...
		{
			this.canvasControl_0.undoRedoManager.SaveChanges = false;
		...
		{
			this.canvasControl_0.Enabled = true;
			this.toolStrip_0.Enabled = true;
			this.canvasControl_0.undoRedoManager.SaveChanges = true;
			this.canvasControl_0.DoInvalidate(true);
		}
		...
		public FormGeneralScheme2(SQLSettings sqlSettings, EndpointAddress endPoint, int a)
		{
			...
			base..ctor();
			this.method_56();
			this.endpointAddress_0 = endPoint;
			this.SqlSettings = sqlSettings;
			this.method_11();
		}
		...
		public FormGeneralScheme2(SQLSettings sqlSettings, int simulationMode, int a)
		{
			...
			this.SqlSettings = sqlSettings;
			this.eSimulationMode_0 = (eSimulationMode)simulationMode;
			this.method_11();
		}
		...
		public FormGeneralScheme2(eTypeCanvas typeCanvas, int activeObj)
		{
			...
			this.method_56();
			this.method_11();
			this.int_0 = activeObj;
			this.eTypeCanvas_0 = typeCanvas;
		}

		private void method_11()
		{
			GeneralFormSettings.smethod_0(new EventHandler(this.tbvehYxUr9));
			GeneralFormSettings.smethod_2(new EventHandler(this.method_15));
			DockContentBase dockContentBase = new DockContentBase();
			dockContentBase.SqlSettings = this.SqlSettings;
			dockContentBase.Controls.Add(this.canvasControl_0);
			...
			{
				this.canvasControl_0.Endpoint = this.endpointAddress_0;
			}
			dockContentBase.DockAreas = 32;
			dockContentBase.CloseButtonVisible = false;
			if (this.eSimulationMode_0 == eSimulationMode.Online)
			{
				dockContentBase.Text = "Оперативная схема";
			}
			else if (this.eSimulationMode_0 == eSimulationMode.Normal)
			{
				dockContentBase.Text = "Нормальная схема";
			}
			this.canvasControl_0.CanvasModeChanged += this.canvasControl_0_CanvasModeChanged;
			this.canvasControl_0.TypeCanvas = this.eTypeCanvas_0;
			this.canvasControl_0.SimulationMode = this.eSimulationMode_0;
			this.canvasControl_0.ShowContextMenuCanvasEvent += this.canvasControl_0_ShowContextMenuCanvasEvent;
			this.canvasControl_0.HideContextMenuCanvasEvent += this.canvasControl_0_HideContextMenuCanvasEvent;
			this.canvasControl_0.ObjectsAdded += this.canvasControl_0_ObjectsAdded;
			this.canvasControl_0.ObjectClicked += this.canvasControl_0_ObjectClicked;
			this.canvasControl_0.FlashObjectsAdded += this.canvasControl_0_FlashObjectsAdded;
			this.canvasControl_0.FlashObjectsRemoved += this.canvasControl_0_FlashObjectsRemoved;
			this.canvasControl_0.ContextMenuRectangle = this.contextMenuStrip_0;
			this.canvasControl_1 = this.canvasControl_0;
			this.dockPanel_0.ActiveDocumentChanged += this.dockPanel_0_ActiveDocumentChanged;
			dockContentBase.ShowForm += new ShowFormEventHandler(this.method_12);
		...
		private void FormGeneralScheme2_Load(object sender, EventArgs e)
		{
			...
			this.bool_1 = true;
			this.canvasControl_0.SaveProcessChanged += this.canvasControl_0_SaveProcessChanged;
			this.canvasControl_0.CanvasMessage += this.canvasControl_0_CanvasMessage;
			this.canvasControl_0.SelectedObjectMoved += this.canvasControl_0_SelectedObjectMoved;
			this.canvasControl_0.SelectedObjectEdited += this.canvasControl_0_SelectedObjectEdited;
			this.canvasControl_0.DrawingCompleted += this.canvasControl_0_DrawingCompleted;
			this.canvasControl_0.StateAdded += this.canvasControl_0_StateAdded;
			this.canvasControl_0.StateRemoved += this.canvasControl_0_StateRemoved;
			this.canvasControl_0.ObjectOnLinePropertyOnCanged += this.canvasControl_0_ObjectOnLinePropertyOnCanged;
			this.method_37();
			this.method_16(false);
			this.canvasControl_0.UpdateMeasurementForBus();
		}
		...
		private void method_16(bool bool_5)
		{
			...
			this.canvasControl_0.Enabled = false;
			...
			if (bool_5)
			{
				this.method_39();
				this.method_36();
				this.dictionary_1.Remove((IDockContent)this.canvasControl_0.Parent);
			}
		...
		{
			if (this.canvasControl_0.WorkerCounter <= 0 && !this.bool_1)
			{
		...
		{
			eTypeCanvas eTypeCanvas = this.eTypeCanvas_0;
			...
			{
				CanvasControl obj = this.canvasControl_0;
				lock (obj)
				{
		...
		private void backgroundWorker_1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
		{
			...
			this.canvasControl_0.Settings.LoadSchemeFromBase(this.canvasControl_0.SqlSettings, eTypeCanvas.SchemeMain);
			this.method_55();
			if (!flag)
			{
				this.method_33();
			...
			ClientManager.canvasControl = this.canvasControl_0;
			if (!flag)
			{
				foreach (ICanvasLayer canvasLayer in this.canvasControl_0.Layers)
				{
					...
					{
						if (this.int_0 > -1 && this.int_0 == drawObjectBase2.IdBase)
						{
				...
				this.canvasControl_0.undoRedoManager.SaveChanges = true;
				this.canvasControl_0.undoRedoManager.CanUndoRedoEvent += this.method_17;
				base.LoadFormConfig(null);
				this.canvasControl_0.UpdateAllTelemetryLabels();
			}
			this.class9_0.method_6("Загрузка завершена", 2, null);
			this.canvasControl_0.OpcClient = this.opcClient;
			this.InitOPC();
			if (drawObjectBase != null)
			{
				this.canvasControl_0.SetObjectsInCenterScreen(drawObjectBase, false, CanvasControl.SetObjectsInCenterScreenOptions.select);
			}
			if (!flag)
			{
				this.method_50();
		...
		private void method_18()
		{
			...
			this.class18_0.Show(this.dockPanel_0);
			if (flag)
			{
				this.class18_0.DockPanel.DockRightPortion = 0.15;
				this.class18_0.method_0(new TreeViewEventHandler(this.method_22));
				this.class18_0.method_14(new Delegate4(this.method_19));
				this.class18_0.Layout += this.class9_0_Layout;
				this.class18_0.FormClosing += this.class18_0_FormClosing;
				this.class18_0.method_10((CanvasControl)((DockContentBase)this.dockPanel_0.ActiveDocument).Controls[0]);
				this.dictionary_1.Add(this.dockPanel_0.ActiveDocument, this.class18_0.method_9());
				return;
			}
			this.method_21();
		}
		...
		{
			this.canvasControl_0.ClearSelectedObjects();
			foreach (DrawObjectBase drawobject in this.method_20())
			{
				this.canvasControl_0.SelectObject(drawobject);
			}
			this.canvasControl_0.DoInvalidate(true);
		}
		...
		private void method_21()
		{
			try
			{
				...
				{
					this.class18_0.method_11(this.dictionary_1[this.dockPanel_0.ActiveDocument]);
				}
				else if (((DockContentBase)this.dockPanel_0.ActiveDocument).Controls.Count > 0 && ((DockContentBase)this.dockPanel_0.ActiveDocument).Controls[0].GetType() == typeof(CanvasControl))
				{
					...
					this.class18_0.method_10(canvasControl);
					this.dictionary_1.Add(this.dockPanel_0.ActiveDocument, this.class18_0.method_9());
				}
			}
			catch (Exception ex)
		...
		private void method_35(object sender, DataGridViewCellEventArgs e)
		{
			if (e.RowIndex >= 0 && this.class12_0.method_0().Count > 0)
			{
				...
				{
					this.canvasControl_0.SetObjectsInCenterScreen((DrawObjectBase)dataGridViewRow.Tag, false, CanvasControl.SetObjectsInCenterScreenOptions.select);
				}
			}
		}
		...
		private void method_38(object sender, DataGridViewCellEventArgs e)
		{
			if (e.RowIndex >= 0 && this.class9_0.method_2().Count > 0)
			{
				...
				if (dataGridViewRow.Tag != null)
				{
					this.canvasControl_0.SetObjectsInCenterScreen(((CanvasMessageEventArgs)dataGridViewRow.Tag).MessageObjects, false, CanvasControl.SetObjectsInCenterScreenOptions.select);
				}
			}
		}
		...
		{
			FormCanvasFilterApply formCanvasFilterApply = new FormCanvasFilterApply(this.canvasControl_0.Settings);
		...
		{
			this.canvasControl_0.ClearFilter();
		}
		...
		private void toolStripButton_54_Click(object sender, EventArgs e)
		{
			...
			formJournalAbn.GoToSchema += new GoToSchemaEventHandler(this.method_42);
		...
		{
			if (this.canvasControl_0.FlashingObjects.Count<DrawObjectBase>() <= 0)
			{
		...
		private void canvasControl_0_DrawingCompleted(CanvasControl canvasControl_2, DrawObjectsEventArgs drawObjectsEventArgs_0)
		{
			...
			foreach (DrawObjectBase drawObjectBase in drawObjectsEventArgs_0.Objects)
			{
				...
				commandValue..ctor("Object");
				commandValue.AddAtribute("id", drawObjectBase.IdBase.ToString());
				commandBox.AddValue(commandValue);
			}
			sendCommandEventArgs.AddCommand(commandBox);
		...
		private void canvasControl_0_ObjectClicked(CanvasControl canvasControl_2, DrawObjectsEventArgs drawObjectsEventArgs_0)
		{
			if (this.class18_0 != null)
			{
				if (drawObjectsEventArgs_0.Objects == null || drawObjectsEventArgs_0.Objects.Count == 0)
				{
					this.class18_0.method_3(null);
					return;
				}
				bool flag = false;
				using (List<DrawObjectBase>.Enumerator enumerator = drawObjectsEventArgs_0.Objects.GetEnumerator())
				{
					if (enumerator.MoveNext())
					{
						...
						this.class18_0.method_3(drawObjectBase_);
						flag = true;
					}
				}
				if (!flag)
		...
		private void canvasControl_0_ShowContextMenuCanvasEvent(ContextMenuStrip contextMenuStrip_1, List<object> list_3)
		{
		...
		private void method_43(IEnumerable<DrawObjectBase> ienumerable_0)
		{
			...
			{
				SchemeModel.Calculations.TreeNodeObj treeNodeObj = this.canvasControl_1.PoweringReportForDrawObject(drawObjectBase, true);
				if (treeNodeObj.Nodes.Count<SchemeModel.Calculations.TreeNodeObj>() != 0)
				{
		...
		private void method_46()
		{
			...
			if (dataTable.Rows.Count > 0)
			{
				...
				if (flag)
				{
					...
					{
					case 535:
						this.canvasControl_0.Parent.Text = "ПП-";
						break;
					case 536:
						this.canvasControl_0.Parent.Text = "ЦП-";
						break;
					case 537:
						this.canvasControl_0.Parent.Text = "РП-";
						break;
					case 538:
						this.canvasControl_0.Parent.Text = "ТП-";
						break;
					}
					Control parent = this.canvasControl_0.Parent;
					parent.Text += str;
					RectangleTool rectangleTool = new RectangleTool();
					rectangleTool.IdBase = idBase;
					this.canvasControl_0.LoadScheme(rectangleTool);
				}
			}
		}
		...
		private void canvasControl_0_ObjectsAdded(CanvasControl canvasControl_2, DrawObjectsEventArgs drawObjectsEventArgs_0)
		{
		}
		...
		{
			this.canvasControl_0.ClearFlashingObjects();
			this.canvasControl_0.DoInvalidate(true);
		}
		...
		{
			this.canvasControl_0.VisibleCanvasSchemeMap = this.toolStripButton_20.Checked;
		...
		{
			this.canvasControl_0.undoRedoManager.Redo();
		}
		...
		private DockContentBase method_53(string string_0)
		{
			...
			canvasControl.Settings = this.canvasControl_0.Settings;
			dockContentBase.DockAreas = 32;
			dockContentBase.Text = string_0;
			canvasControl.ShowContextMenuCanvasEvent += this.canvasControl_0_ShowContextMenuCanvasEvent;
			canvasControl.HideContextMenuCanvasEvent += this.canvasControl_0_HideContextMenuCanvasEvent;
			canvasControl.ObjectsAdded += this.canvasControl_0_ObjectsAdded;
			canvasControl.ObjectClicked += this.canvasControl_0_ObjectClicked;
		...
		{
			this.toolStripMenuItem_7.Visible = (this.canvasControl_0.Mode != eCanvasEditingMode.ReadOnly);
			this.toolStripMenuItem_27.Visible = (this.canvasControl_0.Mode == eCanvasEditingMode.Edit);
			this.toolStripMenuItem_3.Visible = (this.canvasControl_0.Mode == eCanvasEditingMode.Edit);
			this.toolStripMenuItem_2.Visible = (this.canvasControl_0.Mode == eCanvasEditingMode.Edit);
			this.toolStripSeparator_2.Visible = (this.canvasControl_0.Mode == eCanvasEditingMode.Edit);
			this.toolStripMenuItem_10.Visible = (this.canvasControl_0.Mode == eCanvasEditingMode.Edit);
			this.toolStripSeparator_3.Visible = (this.canvasControl_0.Mode == eCanvasEditingMode.Edit);
			this.toolStripMenuItem_40.Visible = (this.canvasControl_0.Mode == eCanvasEditingMode.Edit);
			this.toolStripMenuItem_24.Enabled = (this.canvasControl_0.Mode == eCanvasEditingMode.Edit && CopyPasteCanvasObjects.IsPasteInObjects(this.canvasControl_0.SelectedObjects.ToList<DrawObjectBase>(), this.canvasControl_0.CopiedObjects.ToList<DrawObjectBase>()));
		...
		private void toolStripMenuItem_14_Click(object sender, EventArgs e)
		{
			if (this.contextMenuStrip_0.Tag != null)
			{
				...
				{
					this.canvasControl_0.SetObjectsInCenterScreen(list, true, CanvasControl.SetObjectsInCenterScreenOptions.select);
					return;
				}
				if (Convert.ToInt32(((ToolStripDropDownItem)sender).Tag) == 2)
				{
					this.canvasControl_0.SetObjectsInCenterScreen(list, true, CanvasControl.SetObjectsInCenterScreenOptions.flashing);
				}
			}
		}
		...
		{
			this.canvasControl_0.CopySelectedObjects();
		}

		private void toolStripMenuItem_24_Click(object sender, EventArgs e)
		{
			this.canvasControl_0.PasteInObjects(this.canvasControl_0.SelectedObjects.ToList<DrawObjectBase>());
		}

		private void toolStripMenuItem_2_Click(object sender, EventArgs e)
		{
			if (this.canvasControl_0.Mode == eCanvasEditingMode.Edit && this.canvasControl_1.SelectedCount > 0)
			{
		...
		private void toolStripMenuItem_5_Click(object sender, EventArgs e)
		{
			...
			if (!this.dictionary_0.ContainsKey(rectangleTool))
			{
				...
				canvasControl.Mode = this.canvasControl_0.Mode;
				canvasControl.SimulationMode = this.canvasControl_0.SimulationMode;
				dockContentBase.ShowForm += new ShowFormEventHandler(this.method_12);
				dockContentBase.Show(this.dockPanel_0);
				...
				canvasControl.Settings.MeasurementYear = this.canvasControl_0.Settings.MeasurementYear;
				canvasControl.MeasurementLabelVisible = this.canvasControl_0.MeasurementLabelVisible;
		...
		{
			new FormCanvasAddDelFilter(this.canvasControl_0.SelectedObjects.ToList<DrawObjectBase>(), 0)
			{
				SqlSettings = this.SqlSettings
			}.ShowDialog();
		}
		...
		{
			new FormCanvasAddDelFilter(this.canvasControl_0.SelectedObjects.ToList<DrawObjectBase>(), 2)
			{
				SqlSettings = this.SqlSettings
			}.ShowDialog();
		}
		...
		{
			if (this.canvasControl_0.SetObjectsInCenterScreen(idObjects, true, CanvasControl.SetObjectsInCenterScreenOptions.select))
			{
				if (this.canvasControl_0.Zoom > 2f)
				{
					this.canvasControl_0.SetZoom(2f);
				}
				if (this.canvasControl_0.Parent != null && this.canvasControl_0.Parent is DockContentBase)
				{
					((DockContentBase)this.canvasControl_0.Parent).Activate();
				}
				return true;
			}
			if (idObjects.Count == 1)
			{
				...
				if (dataTable.Rows.Count > 0)
				{
					DrawObjectBase drawObjectBase = this.canvasControl_0.FindObjectById(Convert.ToInt32(dataTable.Rows[0]["Tag"]));
		...
		private void method_55()
		{
			...
			try
			{
				...
				this.toolStripComboBox_2.SelectedItem = this.canvasControl_0.Settings.MeasurementYear.ToString();
			}
			catch
			{
			}
		...
		protected override void Dispose(bool disposing)
		{
			...
			FormGeneralScheme2.oasD8t7mCFJELxuQ5qd(this, disposing);
		}
