...
{
	public class FormPoweringReport : FormBase
	{
		public FormPoweringReport()
		{
			Class63.AGd1PxHzk5wxP();
			this.treeNodeObj_0 = new SchemeModel.Calculations.TreeNodeObj();
			base..ctor();
			this.method_5();
		...
		private void method_2()
		{
			...
			foreach (DrawObjectBase drawObjectBase in objects.Where(predicate))
			{
				try
				{
					this.treeNodeObj_0.AddNode(this.canvasControl_0.PoweringReportForDrawObject(drawObjectBase, this.radioButton_1.Checked));
				}
				catch
				{
				}
		...
		private void method_3(List<DataRow> list_0, SchemeModel.Calculations.TreeNodeObj treeNodeObj_1, DataRow dataRow_0)
		{
			if (list_0 == null && treeNodeObj_1.Level == 0)
			{
				...
				{
					int num = 0;
					foreach (SchemeModel.Calculations.TreeNodeObj treeNodeObj in treeNodeObj_1.LeafsList)
					{
			...
			if (treeNodeObj_1.Tag != null)
			{
				...
				else if (treeNodeObj_1.Tag.GetType() == typeof(LineCellTool))
				{
					...
					{
						bool flag = false;
						foreach (SchemeModel.Calculations.TreeNodeObj treeNodeObj2 in treeNodeObj_1.Nodes)
						{
			...
			{
				foreach (SchemeModel.Calculations.TreeNodeObj treeNodeObj_2 in treeNodeObj_1.Nodes)
				{
		...
		private SchemeModel.Calculations.TreeNodeObj treeNodeObj_0;
