...
internal class Class18 : DockContent
{
	...
	internal Class18()
	{
		...
		base..ctor();
		this.method_17();
		GeneralFormSettings.smethod_0(new EventHandler(this.method_7));
		GeneralFormSettings.smethod_2(new EventHandler(this.method_6));
	}
	...
	private void method_4()
	{
		...
		SchemeModel.Calculations.TreeNodeObj treeNodeObj = parent.PoweringReportForDrawObject(this.drawObjectBase_0, false);
		SchemeModel.Calculations.TreeNodeObj treeNodeObj2 = parent.PoweringReportForDrawObject(this.drawObjectBase_0, true);
		TreeNode treeNode = this.treeView_1.Nodes.Add(((DrawObjectBase)treeNodeObj.Tag).GetFullName());
		treeNode.Tag = treeNodeObj.Tag;
		SchemeModel.Calculations.TreeNodeObj treeNodeObj3 = treeNodeObj;
		while (!treeNodeObj3.IsLeaf)
		{
			treeNodeObj3 = treeNodeObj3.Nodes.First<SchemeModel.Calculations.TreeNodeObj>();
	...
	private void method_5(SchemeModel.Calculations.TreeNodeObj treeNodeObj_0, TreeNode treeNode_0)
	{
		if (treeNodeObj_0.IsLeaf)
		{
			return;
		}
		foreach (SchemeModel.Calculations.TreeNodeObj treeNodeObj in treeNodeObj_0.Nodes)
		{
