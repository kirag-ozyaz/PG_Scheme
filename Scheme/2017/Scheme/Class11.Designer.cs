...
internal class Class11 : DockContent
{
	[CompilerGenerated]
	...
	internal Class11()
	{
		...
		base..ctor();
		this.method_19();
		GeneralFormSettings.smethod_2(new EventHandler(this.method_2));
	...
	private void method_9(DataRow dataRow_0)
	{
		...
		{
			Class11.Delegate2 method = new Class11.Delegate2(this.method_9);
	...
	private void method_10(DataRow dataRow_0)
	{
		if (base.InvokeRequired)
		{
			try
			{
				Class11.Delegate2 method = new Class11.Delegate2(this.method_10);
				base.Invoke(method, new object[]
				{
					dataRow_0
				});
	...
	private void method_11(DataRow dataRow_0)
	{
		if (base.InvokeRequired)
		{
			try
			{
				Class11.Delegate2 method = new Class11.Delegate2(this.method_11);
				base.Invoke(method, new object[]
				{
					dataRow_0
				});
	...
	private void method_12(DataRow dataRow_0)
	{
		if (base.InvokeRequired)
		{
			try
			{
				Class11.Delegate2 method = new Class11.Delegate2(this.method_12);
				base.Invoke(method, new object[]
				{
					dataRow_0
				});
	...
	private void method_19()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(Class11));
