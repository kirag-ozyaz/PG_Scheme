...
namespace SchemeCtrl2.DrawTool
{
	public class DischargerTool : ObjectOnLine
	{
		...
		public DischargerTool(Branch branch) : base(branch)
		{
		}

		public DischargerTool(DataRow dataRow_0, Branch branch) : base(dataRow_0, branch)
		{
		}
		...
		public override void DrawPrint(CanvasControl canvas, Graphics graphics_0, bool isColor = false)
		{
			...
			graphics_0.DrawLine(pen, array[7], array[5]);
