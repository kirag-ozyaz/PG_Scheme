...
{
	public partial class FormTelemetryLabelPropertiy : FormBase
	{
		...
		public FormTelemetryLabelPropertiy()
		{
			this.method_0();
		}

		public FormTelemetryLabelPropertiy(SQLSettings sqlSettings, TelemetryLabelTool telemetryLabelTool_1)
		{
			this.method_0();
			...
			this.textBox_1.Text = text + " " + drawObjectBase.ToString();
		...
		private void comboBox_0_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			if (this.comboBox_0.ValueMember != string.Empty)
			{
