...
namespace SchemeCtrl2.DrawTool.FormsObj
{
	public partial class TransformerToolPropertyForm : Form
	{
		...
		public TransformerToolPropertyForm(int idRect, ObjectOnLine objectInLine, SQLSettings sqlSett)
		{
			...
			this.objectOnLine_0 = objectInLine;
			this.method_0();
			sqlDataCommand.SelectSqlData(this.dataSetScheme_0, this.dataSetScheme_0.tSchm_ObjList, true, "where [IdParent]=" + idRect.ToString() + " AND TypeCodeId=556 AND Deleted=0");
		...
		private void oldTransRadioButton_CheckedChanged(object sender, EventArgs e)
		{
