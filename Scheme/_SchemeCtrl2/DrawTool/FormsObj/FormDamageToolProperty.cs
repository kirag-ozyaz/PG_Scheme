...
{
	public partial class FormDamageToolProperty : FormBase
	{
		private void method_0()
		{
			...
			base.Load += this.FormDamageToolProperty_Load;
			base.ResumeLayout(false);
			base.PerformLayout();
		}

		public FormDamageToolProperty()
		{
			this.method_0();
		}

		public bool BeforRemove { get; set; }
		...
		public string ReasonDiscription
		{
			get
			{
		...
		private void FormDamageToolProperty_Load(object sender, EventArgs e)
		{
			if (!this.BeforRemove && this.SqlSettings != null)
			{
				this.Text = "Вывод кабеля из эксплуатации";
		...
		private const string string_0 = "Вывод кабеля из эксплуатации";

		private const string string_1 = "Ввод кабеля в эксплуатацию";
