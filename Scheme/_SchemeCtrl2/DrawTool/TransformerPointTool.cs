...
namespace SchemeCtrl2.DrawTool
{
	public class TransformerPointTool : PointTool
	{
		public TransformerPointTool(PointTool pointTool)
		{
			...
			IL_138:
			pointTool.CouplingRelations[0].ChangeCoupling(pointTool, this);
			IL_14B:
		...
		public TransformerPointTool(DataRow dataRow_0) : base(dataRow_0)
		{
			this.list_2.Add(new UnitPoint(0.0, 0.15));
			this.list_2.Add(new UnitPoint(0.0, -0.15));
		...
		{
			return this.Layer != null && (Class88.smethod_4(this.list_2[0] + this.point, 0.2f, uPoint) || Class88.smethod_4(this.list_2[1] + this.point, 0.2f, uPoint));
		}

		public const int TYPE_TRANSFORMERPOINT = 556;

		private List<UnitPoint> list_2 = new List<UnitPoint>();
	}
}
