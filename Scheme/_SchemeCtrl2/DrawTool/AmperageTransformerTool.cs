...
namespace SchemeCtrl2.DrawTool
{
	public class AmperageTransformerTool : ObjectOnLine
	{
		...
		public AmperageTransformerTool(Branch branch) : base(branch)
		{
		}

		public AmperageTransformerTool(DataRow dataRow_0, Branch branch) : base(dataRow_0, branch)
		{
		}
		...
		{
			return this.Layer != null && Class88.smethod_9(point, base.Points.ToArray());
		}
