...
{
	public class ElectricMeterTool : ObjectOnLine
	{
		public ElectricMeterTool()
		{
		}

		public ElectricMeterTool(Branch branch) : base(branch)
		{
		}

		public ElectricMeterTool(DataRow dataRow_0, Branch branch) : base(dataRow_0, branch)
		{
		}
