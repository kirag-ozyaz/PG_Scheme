...
namespace SchemeCtrl2.DrawTool
{
	public class DamageTool : ObjectOnLine
	{
		...
		public DamageTool(Branch branch) : base(branch)
		{
		}

		public DamageTool(DataRow dataRow_0, Branch branch) : base(dataRow_0, branch)
		{
		}
		...
		public override void DrawPrint(CanvasControl canvas, Graphics graphics_0, bool isColor = false)
		{
			...
			graphics_0.DrawLine(pen, array[5], array[6]);
			graphics_0.DrawLine(pen, array[6], array[7]);
			graphics_0.DrawLine(pen, array[7], array[8]);
			graphics_0.DrawLine(pen, array[7], array[9]);
