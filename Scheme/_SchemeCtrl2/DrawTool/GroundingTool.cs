...
namespace SchemeCtrl2.DrawTool
{
	public class GroundingTool : ObjectOnLine
	{
		...
		public GroundingTool(bool isPortable)
		{
			this.bool_1 = isPortable;
		}

		public GroundingTool(Branch branch) : base(branch)
		{
		...
		public GroundingTool(DataRow dataRow_0, Branch branch) : base(dataRow_0, branch)
		{
		}
		...
		protected override void CreateImagePoints()
		{
			...
			this.PortEvent += this.method_13;
			this.RemovePortEvent += this.method_12;
		}

		private void method_12(GroundingTool groundingTool_0)
		{
		}
		...
		public override DrawObjectBase Clone(bool SaveParentRelation)
		{
			...
			((GroundingTool)drawObjectBase).bool_1 = this.bool_1;
