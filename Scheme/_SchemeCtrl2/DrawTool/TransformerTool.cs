...
namespace SchemeCtrl2.DrawTool
{
	public class TransformerTool : ObjectOnLine
	{
		...
		public TransformerTool(DataRow dataRow_0, Branch branch) : base(dataRow_0, branch)
		{
		}
		...
		{
			return this.Layer != null && (Class88.smethod_4(base.Points[0], 0.2f, point) || Class88.smethod_4(base.Points[1], 0.2f, point));
		}
