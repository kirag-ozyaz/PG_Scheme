...
namespace SchemeCtrl2.DrawTool
{
	public class Branch : DrawObjectBase
	{
		public CouplingRelation CouplingRelation
		{
			...
			set
			{
				if (this.couplingRelation_0 != null && this.couplingRelation_0.Branches.Contains(this))
				{
					if (this.couplingRelation_0.Branches.Count == 1 && ((LineTool)this.Parent).CouplingRelations.Contains(this.couplingRelation_0))
					{
						((LineTool)this.Parent).CouplingRelations.Remove(this.couplingRelation_0);
					}
					this.couplingRelation_0.Branches.Remove(this);
				}
				this.couplingRelation_0 = value;
				if (this.couplingRelation_0 != null)
				{
					this.couplingRelation_0.Branches.Add(this);
				}
			}
		}
		...
		public PointTool Source
		{
			...
			set
			{
				...
				{
					this.pointTool_0.ChangePoint -= this.method_7;
				}
		...
		public PointTool Destination
		{
			...
			set
			{
				...
				{
					this.pointTool_1.ChangePoint -= this.method_8;
				}
		...
		public Branch(PointTool pointTool_2, PointTool dest)
		{
			this.Source = pointTool_2;
			this.Destination = dest;
			this.Source.AddBranch(this);
			this.Destination.AddBranch(this);
		}

		public Branch(LineTool line, PointTool pointTool_2, PointTool dest)
		{
		...
		public Branch(LineTool line, PointTool pointTool_2, PointTool dest, BranchType type)
		{
			this.lineTool_0 = line;
			this.Source = pointTool_2;
			this.Destination = dest;
		...
		public Branch(LineTool lineTool, PointTool pointTool_2, PointTool dest, BranchType type, CouplingRelation couplingRelation)
		{
		...
		public override void Draw(CanvasControl canvas, RectangleF unitrect, eDrawMode drawMode = eDrawMode.Color)
		{
			...
			using (Pen pen2 = new Pen(this.Color, ConvertCanvas.ConvertToScreen(canvas, (double)base.Width)))
			{
				if (canvas.KoefResolution > 1)
				{
					if (pen2.Width == 0f)
					{
						pen2.Width = (float)canvas.KoefResolution;
					}
					else
					{
						pen2.Width *= (float)canvas.KoefResolution;
				...
				if ((drawMode & eDrawMode.Color) == eDrawMode.Color)
				{
					...
					else if (this.couplingRelation_0 != null)
					{
						if (this.couplingRelation_0.On && this.couplingRelation_0.amperagePoint != null && ((LineTool)this.Parent).Amperages.ContainsKey(this.couplingRelation_0.amperagePoint))
						{
							...
							IEnumerable<DrawObjectBase> childObjects = this.ChildObjects;
							if (Branch.func_0 == null)
							{
								Branch.func_0 = new Func<DrawObjectBase, bool>(Branch.smethod_1);
							}
							IEnumerable<DrawObjectBase> source = childObjects.Where(Branch.func_0);
							if (source.Count<DrawObjectBase>() == 1 && this.Source.Parent != null && this.Source.Parent.GetType() == typeof(LineCellTool) && this.Destination.Parent != null && this.Destination.Parent.GetType() == typeof(LineCellTool) && ((LineCellTool)this.Source.Parent).Type != ((LineCellTool)this.Destination.Parent).Type)
							{
								IEnumerable<DrawObjectBase> childObjects2 = this.ChildObjects;
								if (Branch.func_1 == null)
								{
									Branch.func_1 = new Func<DrawObjectBase, bool>(Branch.smethod_2);
								}
								objectOnLine = (ObjectOnLine)childObjects2.First(Branch.func_1);
							...
							if (num != 0)
							{
								...
								if (num == 3)
								{
									if (this.ChildObjects.Count<DrawObjectBase>() > 1)
									{
										...
										double num3 = -1.0;
										using (IEnumerator<DrawObjectBase> enumerator2 = this.ChildObjects.GetEnumerator())
										{
								...
								{
									double num4 = 2.0;
									using (IEnumerator<DrawObjectBase> enumerator3 = this.ChildObjects.GetEnumerator())
									{
										while (enumerator3.MoveNext())
										{
											DrawObjectBase drawObjectBase3 = enumerator3.Current;
								...
								double num5 = -1.0;
								using (IEnumerator<DrawObjectBase> enumerator4 = this.ChildObjects.GetEnumerator())
								{
									while (enumerator4.MoveNext())
									{
										DrawObjectBase drawObjectBase4 = enumerator4.Current;
		...
		private static bool smethod_0(PointTool pointTool_2, Branch branch_0)
		{
			...
			while (!((LineTool)branch_0.Parent).Amperages.ContainsKey(pointTool_2))
			{
				...
				foreach (Branch branch in pointTool_2.Branches)
				{
					if (branch_0 != branch)
					{
						branch_0 = branch;
				...
				pointTool_2 = ((pointTool_2 == branch_0.Source) ? branch_0.Destination : branch_0.Source);
				if (!branch_0.On)
				{
					return false;
				}
		...
		public override void DrawPrint(CanvasControl canvas, Graphics graphics_0, bool isColor = false)
		{
			using (Pen pen = new Pen(Color.Black, ConvertCanvas.ConvertToScreen(canvas, (double)base.Width)))
			{
				...
				if (this.pointTool_0.Parent == null || this.pointTool_0.Parent == this.Parent)
				{
					this.pointTool_0.DrawPrint(canvas, graphics_0, false);
				}
				if (this.pointTool_1.Parent == null || this.pointTool_1.Parent == this.Parent)
				{
					this.pointTool_1.DrawPrint(canvas, graphics_0, false);
				}
			}
		}
		...
		public override bool PointInObject(UnitPoint uPoint)
		{
			...
			return this.pointTool_1.Point.Y == this.pointTool_0.Point.Y && this.pointTool_1.Point.X == this.pointTool_0.Point.X && Class88.smethod_4(this.pointTool_0.Point, base.ThresholdWidth(parent, base.Width), uPoint);
		}
		...
		{
			return Class88.smethod_0(this.pointTool_0.Point, this.pointTool_1.Point, rect);
		}

		public override bool ShowPropertyForm(Point location)
		{
			BranchPropertyesForm branchPropertyesForm = new BranchPropertyesForm(this);
		...
		public ObjectOnLine AddSwitchTool(TypeSwitch typeSwitch, UnitPoint pointClick)
		{
			...
			objectOnLine.CenterPoint = Class88.smethod_5(this.Source.Point, this.Destination.Point, pointClick);
		...
		public ObjectOnLine AddSwitchTool(TypeSwitch typeSwitch, DataRow dataRow_0)
		{
			ObjectOnLine objectOnLine = ObjectOnLine.CreateObjectOnLine(typeSwitch, dataRow_0, this);
			objectOnLine.RecalcAngle();
		...
		{
			this.AddSwitchTool(switchTool);
			switchTool.CenterPoint = Class88.smethod_5(this.Source.Point, this.Destination.Point, pointClick);
		...
		public override void SaveToXML(XmlNode xmlNode, List<PointTool> pointList)
		{
			...
			XmlElement xmlElement = ownerDocument.CreateElement("Branch");
		...
		private void method_7(DrawObjectBase drawObjectBase_1, PointToolEvetsArgs pointToolEvetsArgs_0)
		{
			this.ReCalcSwitchCoords(this.Destination.Point, pointToolEvetsArgs_0.oldPoint, pointToolEvetsArgs_0.newPoint);
		}

		private void method_8(DrawObjectBase drawObjectBase_1, PointToolEvetsArgs pointToolEvetsArgs_0)
		{
		...
		[CompilerGenerated]
		private static bool smethod_1(DrawObjectBase drawObjectBase_1)
		{
			return drawObjectBase_1.GetType() == typeof(TransformerTool);
		}

		[CompilerGenerated]
		private static bool smethod_2(DrawObjectBase drawObjectBase_1)
		{
			return drawObjectBase_1.GetType() == typeof(TransformerTool);
		}

		private BranchType branchType_0 = BranchType.CabelLine;
		...
		internal Branch.Enum0 enum0_0 = Branch.Enum0.const_2;

		public bool useParentColor = true;
