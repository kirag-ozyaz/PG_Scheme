...
namespace SchemeCtrl2.DrawTool
{
	public class MagneticStarterTool : ObjectOnLine
	{
		...
		public MagneticStarterTool(Branch branch) : base(branch)
		{
		}

		public MagneticStarterTool(DataRow dataRow_0, Branch branch) : base(dataRow_0, branch)
		{
			XmlDocument xmlDocument = new XmlDocument();
			xmlDocument.LoadXml((string)dataRow_0["SchemaXml"]);
			XmlNode xmlNode = xmlDocument.SelectSingleNode("/Obj");
			XmlAttribute xmlAttribute = (XmlAttribute)xmlNode.Attributes.GetNamedItem("phaseFlags");
