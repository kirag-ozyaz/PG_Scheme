...
internal class Class88
{
	public static bool smethod_0(UnitPoint unitPoint_0, UnitPoint unitPoint_1, RectangleF rectangleF_0)
	{
		...
		if (Class88.smethod_2(unitPoint_0, unitPoint_1, unitPoint_2, unitPoint_3))
		{
			return true;
		}
		...
		return Class88.smethod_2(unitPoint_0, unitPoint_1, unitPoint_2, unitPoint_3);
	}
	...
	public static bool smethod_2(UnitPoint unitPoint_0, UnitPoint unitPoint_1, UnitPoint unitPoint_2, UnitPoint unitPoint_3)
	{
		double num = 0.0;
		double num2 = 0.0;
		return Class88.smethod_3(unitPoint_0, unitPoint_1, unitPoint_2, unitPoint_3, ref num, ref num2, false, false, false);
	}
	...
	public static bool smethod_4(UnitPoint unitPoint_0, float float_0, UnitPoint unitPoint_1)
	{
	...
	public static UnitPoint smethod_5(UnitPoint unitPoint_0, UnitPoint unitPoint_1, UnitPoint unitPoint_2)
	{
		double num;
		double double_;
		...
		{
			num = unitPoint_1.X;
			double_ = unitPoint_2.Y;
		}
		else if (unitPoint_1.Y == unitPoint_0.Y)
		{
			num = unitPoint_2.X;
			double_ = unitPoint_1.Y;
		}
		else
		{
			...
			double_ = (unitPoint_1.Y - unitPoint_0.Y) * (num - unitPoint_0.X) / (unitPoint_1.X - unitPoint_0.X) + unitPoint_0.Y;
		}
		return new UnitPoint(num, double_);
	}

	public static float smethod_6(UnitPoint unitPoint_0, UnitPoint unitPoint_1)
	{
	...
	public static bool smethod_7(UnitPoint unitPoint_0, RectangleF rectangleF_0)
	{
	...
	public static UnitPoint smethod_8(UnitPoint unitPoint_0, UnitPoint unitPoint_1)
	{
	...
	public static bool smethod_9(UnitPoint unitPoint_0, UnitPoint[] unitPoint_1)
	{
		bool flag = false;
		int i = 0;
