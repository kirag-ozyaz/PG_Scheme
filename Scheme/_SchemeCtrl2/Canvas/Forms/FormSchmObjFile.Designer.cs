...
namespace SchemeCtrl2.Canvas.Forms
{
	public class FormSchmObjFile : DockContentBase
	{
		...
		public FormSchmObjFile(DrawObjectBase drawObjectBase_1)
		{
			this.method_0();
		...
		private void FormSchmObjFile_Load(object sender, EventArgs e)
		{
			if (this.drawObjectBase_0 != null && this.drawObjectBase_0.IdBase > 0)
			{
				...
				if (this.drawObjectBase_0.Layer != null && this.drawObjectBase_0.Layer.Parent != null && this.drawObjectBase_0.Layer.Parent.Mode == eCanvasEditingMode.ReadOnly)
				{
		...
		private void toolStripButton_0_Click(object sender, EventArgs e)
		{
			try
			{
				...
				if (openFileDialog.ShowDialog() == DialogResult.OK)
				{
					...
					{
						DataRow dataRow = this.dataSetScheme_0.tSchm_ObjFile.NewRow();
						...
						this.dataSetScheme_0.tSchm_ObjFile.Rows.Add(dataRow);
				...
				base.InsertSqlData(this.dataSetScheme_0, this.dataSetScheme_0.tSchm_ObjFile);
				this.dataSetScheme_0.tSchm_ObjFile.Clear();
				this.dataGridViewExcelFilter_0.CellValueChanged -= this.dataGridViewExcelFilter_0_CellValueChanged;
				base.SelectSqlData(this.dataSet_0, this.dataSet_0.Tables[this.dataTable_0.TableName], true, " where idObj = " + this.drawObjectBase_0.IdBase.ToString());
				this.dataGridViewExcelFilter_0.CellValueChanged += this.dataGridViewExcelFilter_0_CellValueChanged;
			}
		...
		private void toolStripButton_1_Click(object sender, EventArgs e)
		{
			if (this.dataGridViewExcelFilter_0.CurrentRow != null)
			{
				...
				base.DeleteSqlDataById(this.dataSetScheme_0.tSchm_ObjFile, id);
				return;
			}
		...
		private void toolStripButton_2_Click(object sender, EventArgs e)
		{
			...
			base.SelectSqlData(this.dataSetScheme_0, this.dataSetScheme_0.tSchm_ObjFile, true, " where id = " + num.ToString());
			if (this.dataSetScheme_0.tSchm_ObjFile.Rows.Count > 0)
			{
				byte[] array = (byte[])this.dataSetScheme_0.tSchm_ObjFile.Rows[0]["Document"];
				string text = Path.GetTempFileName();
				text = Path.ChangeExtension(text, Path.GetExtension(this.dataSetScheme_0.tSchm_ObjFile.Rows[0]["FileName"].ToString()));
