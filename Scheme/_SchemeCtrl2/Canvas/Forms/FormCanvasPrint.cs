...
{
	public partial class FormCanvasPrint : FormBase
	{
		private void method_0()
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(FormCanvasPrint));
			...
			this.printPreviewControl_0.Size = new Size(535, 540);
			...
			this.button_0.Location = new Point(12, 534);
			...
			this.button_2.Location = new Point(209, 534);
			...
			this.button_3.Location = new Point(12, 508);
			...
			this.groupBox_2.Size = new Size(296, 221);
			...
			this.label_4.Location = new Point(3, 192);
			...
			this.label_3.Location = new Point(6, 162);
			...
			NumericUpDown numericUpDown3 = this.numericUpDown_1;
			...
			NumericUpDown numericUpDown5 = this.numericUpDown_0;
			...
			base.ClientSize = new Size(849, 563);
			...
			base.FormClosing += this.FormCanvasPrint_FormClosing;
			base.Load += this.FormCanvasPrint_Load;
		...
		public FormCanvasPrint()
		{
			this.method_0();
		}

		private void FormCanvasPrint_Load(object sender, EventArgs e)
		{
			if (this.canvasControl_0 != null)
			{
				if (this.canvasControl_0.SelectedCount > 0)
				{
					this.canvasControl_0.enum3_0 = Enum3.const_0;
				}
				if (this.canvasControl_0.eCommandType_0 == eCommandType.frame)
				{
					this.canvasControl_0.enum3_0 = Enum3.const_3;
				}
				this.printPreviewControl_0.Document = this.canvasControl_0.printDocument;
				this.method_5(this.printPreviewControl_0.Document.PrinterSettings);
				...
				switch (this.canvasControl_0.enum3_0)
				{
				case Enum3.const_0:
		...
		private void FormCanvasPrint_FormClosing(object sender, FormClosingEventArgs e)
		{
		...
		private void method_2()
		{
			...
			DataTable dataTable = this.method_1();
			base.SelectSqlData(dataTable, true, " where ParentKey in (';GroupWorker;ITR;')  and dateend is null group by id, fio, groupelectrical order by fio ", false);
			...
			DataTable dataTable2 = this.method_1();
			...
			DataTable dataTable3 = this.method_1();
			base.SelectSqlData(dataTable3, true, " where ParentKey in (';GroupWorker;MasterNetRegion;')  and dateend is null group by id, fio, groupelectrical order by fio ", false);
			...
			DataTable dataTable4 = this.method_1();
			base.SelectSqlData(dataTable4, true, " where ParentKey in (';GroupWorker;HeadRegion;')  and dateend is null group by id, fio, groupelectrical order by fio ", false);
			...
			DataTable dataTable5 = this.method_1();
			base.SelectSqlData(dataTable5, true, " where dateend is null group by id, fio, groupelectrical order by fio ", false);
		...
		private void method_3()
		{
			...
			this.canvasControl_0.PrintOrg = this.textBox_0.Text;
			this.canvasControl_0.SchmPrintName = this.textBox_1.Text;
		...
		private void comboBox_0_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			this.method_5(this.printerSettings_0);
		}
		...
		private static extern int DocumentPropertiesW(IntPtr intptr_0, IntPtr intptr_1, [MarshalAs(UnmanagedType.LPWStr)] string string_0, IntPtr intptr_2, IntPtr intptr_3, int int_3);

		private DialogResult method_4(PrinterSettings printerSettings_1)
		{
			DialogResult result = DialogResult.Cancel;
			IntPtr hdevmode = printerSettings_1.GetHdevmode(printerSettings_1.DefaultPageSettings);
			IntPtr intPtr = FormCanvasPrint.GlobalLock(hdevmode);
			int cb = FormCanvasPrint.DocumentPropertiesW(base.Handle, IntPtr.Zero, printerSettings_1.PrinterName, intPtr, intPtr, 0);
			IntPtr intPtr2 = Marshal.AllocHGlobal(cb);
			long num = (long)FormCanvasPrint.DocumentPropertiesW(base.Handle, IntPtr.Zero, printerSettings_1.PrinterName, intPtr2, intPtr, 14);
			if (num == 1L)
			{
				...
				this.method_5(printerSettings_1);
			}
			FormCanvasPrint.GlobalUnlock(hdevmode);
			FormCanvasPrint.GlobalFree(hdevmode);
			Marshal.FreeHGlobal(intPtr2);
			return result;
		}

		private void method_5(PrinterSettings printerSettings_1)
		{
			this.printPreviewControl_0.InvalidatePreview();
		...
		{
			this.canvasControl_0.enum3_0 = Enum3.const_2;
			this.method_5(this.printerSettings_0);
		}

		private void radioButton_1_CheckedChanged(object sender, EventArgs e)
		{
			this.canvasControl_0.enum3_0 = Enum3.const_1;
			this.method_5(this.printerSettings_0);
		}
		...
		{
			this.method_6((ToolStripMenuItem)sender);
			this.printPreviewControl_0.AutoZoom = true;
		}
		...
		private void method_6(ToolStripMenuItem toolStripMenuItem_10)
		{
		...
		private void checkBox_1_CheckedChanged(object sender, EventArgs e)
		{
			if (this.canvasControl_0 != null)
			{
				this.canvasControl_0.bool_0 = this.checkBox_1.Checked;
				this.method_5(this.printerSettings_0);
			}
		}
		...
		private PrinterSettings printerSettings_0 = new PrinterSettings();
