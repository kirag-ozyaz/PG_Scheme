	...
	private void Form5_FormClosing(object sender, FormClosingEventArgs e)
	{
		if (base.DialogResult == DialogResult.OK)
		{
			...
			if (this.tabControl_0.SelectedTab == this.tabPage_1)
			{
				...
				int idObjList2 = Convert.ToInt32(this.textBox_0.Text);
				int idBindObjList = (int)this.dataGridView_0.SelectedRows[0].Cells["idUnbind"].Value;
				SchmObj.BindPassport(this.SqlSettings, idObjList2, idBindObjList);
			}
		}
	}
