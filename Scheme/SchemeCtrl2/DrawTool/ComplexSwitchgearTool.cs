...
namespace SchemeCtrl2.DrawTool
{
	public class ComplexSwitchgearTool : ObjectOnLine
	{
		public ComplexSwitchgearTool()
		{
			...
			this.eRollingOutReason_0 = ComplexSwitchgearTool.eRollingOutReason.None;
			
		}

		public ComplexSwitchgearTool(Branch branch)
		{
		...
		public ComplexSwitchgearTool(DataRow r, Branch branch)
		{
		...
		public bool RollingOut
		{
			get
			{
				return !base.NormalSectionModeOn && this.bool_15;
			}
			set
			{
				if (this.bool_15 != value && this.IntegratedSwitch != null && !this.IntegratedSwitch.On)
				{
					this.bool_15 = value;
		...
		protected override RectangleF GetRectangleText(CanvasControl canvas)
		{
			...
			if (base.Points.Count > 0)
			{
				...
				ComplexSwitchgearTool.eRollingOutReason eRollingOutReason = this.eRollingOutReason_0;
				if (eRollingOutReason != ComplexSwitchgearTool.eRollingOutReason.Repair)
				{
					if (eRollingOutReason == ComplexSwitchgearTool.eRollingOutReason.Test)
					{
						text = "И";
					}
				}
		...
		private ComplexSwitchgearTool.eRollingOutReason eRollingOutReason_0;
