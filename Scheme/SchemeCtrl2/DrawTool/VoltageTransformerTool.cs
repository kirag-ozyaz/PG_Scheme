...
namespace SchemeCtrl2.DrawTool
{
	public class VoltageTransformerTool : ObjectOnLine
	{
		...
		public VoltageTransformerTool(Branch branch)
		{
		...
		public VoltageTransformerTool(DataRow r, Branch branch)
		{
		...
		public override void DrawPrint(CanvasControl canvas, Graphics g, bool isColor = false)
		{
			...
			g.FillEllipse(brush, rectangleF3);
			g.DrawEllipse(pen, rectangleF);
			g.DrawEllipse(pen, rectangleF2);
			g.DrawEllipse(pen, rectangleF3);
		...
		{
			return this.Layer != null && (Class79.XrgxasnnaZ(base.Points[0], 0.2f, point) || Class79.XrgxasnnaZ(base.Points[1], 0.2f, point) || Class79.XrgxasnnaZ(base.Points[2], 0.2f, point));
		}
