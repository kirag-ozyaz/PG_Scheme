	...
	public class UndoRedoManager
	{
		...
		public class RegistrarOfChanges
		{
			...
			private void method_0(DrawObjectBase drawObjectBase_0)
			{
				...
				drawObjectBase_0.Deleted = !sqlDataCommand.UpdateSqlData(UndoRedoManager.canvasControl_0.dsScheme.tSchm_ObjList, " set [DELETED] = 0 ", " WHERE [ID] = " + drawObjectBase_0.IdBase.ToString());
