...
internal class Class80 : DockContentBase
{
	...
	private void method_4()
	{
		try
		{
			var source = from row in this.class22_0.vL_SchmAbnFull.AsEnumerable<DataSetScheme.Class76>()
			group row by row.Field("idAbn") into abns
			orderby abns.Key
			select new
			{
				IdAbn = abns.Key,
				CountAbn = abns.Count<DataSetScheme.Class76>()
			};
			this.textBox_1.Text = source.Count().ToString();
			source = from row in this.class22_0.vL_SchmAbnFull.AsEnumerable<DataSetScheme.Class76>()
			...
			var source2 = from row in this.class22_0.vL_SchmAbnFull.AsEnumerable<DataSetScheme.Class76>()
			group row by new
			{
	...
	{
		DataSetScheme.Class73 @class = (DataSetScheme.Class73)((DataRowView)this.bindingSource_0.Current).Row;
	...
	private void method_15()
	{
		...
		this.juXjixQvHf.ProgressStyle = ProgressBarEndLess.ProgressBarEndLessStyleConstants.LeftAndRight;
		this.juXjixQvHf.ProgressType = ProgressBarEndLess.ProgressBarEndLessTypeConstants.GraphicType;
