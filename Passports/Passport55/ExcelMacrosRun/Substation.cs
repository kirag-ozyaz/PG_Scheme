...
namespace ExcelMacrosRun
{
	public class Substation : IDisposable
	{
		...
		public Substation(Application application_1)
		{
			this.application_0 = application_1;
			application_1.ScreenUpdating = true;
			application_1.Visible = true;
		}
		...
		private string string_0 = "aq1sw2de3";
