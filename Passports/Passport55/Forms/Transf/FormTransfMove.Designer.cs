...
namespace Passport.Forms.Transf
{
	public class FormTransfMove : FormBase
	{
		...
		{
			Class116 @class = new Class116(this.SqlSettings);
			try
			{
				if ((decimal)((DataRowView)this.comboBox_4.SelectedItem)[2] == 2m)
				{
					...
					case TransfMove.ToSubstation:
						if (!Class115.smethod_1(this.SqlSettings, this.int_0, this.comboBox_3.SelectedValue.ToString(), this.dateTimePicker_0.Value, (!this.comboBox_2.Enabled || this.comboBox_2.SelectedValue == null) ? ((int)this.comboBox_5.SelectedValue) : ((int)this.comboBox_2.SelectedValue), this.string_0, (int)this.comboBox_4.SelectedValue, this.textBox_0.Text))
						{
							return;
						}
						break;
					...
					case TransfMove.ToRapairShop:
						if (!Class115.smethod_0(this.SqlSettings, this.int_0, (int)this.comboBox_0.SelectedValue, this.dateTimePicker_0.Value, this.string_0, ((DataRowView)this.comboBox_0.SelectedItem)[1].ToString(), (int)this.comboBox_4.SelectedValue, this.textBox_0.Text))
						{
							return;
						}
						break;
					...
					case TransfMove.Dispose:
						Class115.smethod_3(this.SqlSettings, this.int_0, this.dateTimePicker_0.Value, this.textBox_0.Text);
						break;
					}
				}
				else
		...
		private void FormTransfMove_Load(object sender, EventArgs e)
		{
			...
			try
			{
				@class = new Class116(this.SqlSettings);
		...
		private DataTable method_1()
		{
			...
			return new SqlDataCommand(this.SqlSettings).SelectSqlData(this.dsPassport_0.tR_Classifier.TableName, true, text, null);
		}
		...
		private void comboBox_0_SelectedValueChanged(object sender, EventArgs e)
		{
			...
			{
				this.comboBox_1.DataSource = Class112.smethod_3(this.SqlSettings, (int)this.comboBox_0.SelectedValue);
		...
		private void method_10()
		{
			...
			this.tableLayoutPanel_0.Controls.Add(this.label_4, 0, 7);
			this.tableLayoutPanel_0.Controls.Add(this.label_5, 0, 8);
			...
			this.tableLayoutPanel_0.Controls.Add(this.label_6, 0, 3);
			this.tableLayoutPanel_0.Controls.Add(this.comboBox_5, 1, 5);
			this.tableLayoutPanel_0.Controls.Add(this.label_7, 0, 5);
			...
			this.label_3.Location = new Point(3, 135);
			...
			this.label_7.Location = new Point(3, 110);
			this.label_7.Name = "label8";
			this.label_7.Size = new Size(104, 25);
			this.label_7.TabIndex = 17;
			this.label_7.Text = "Шина / Кабель";
