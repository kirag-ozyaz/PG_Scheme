	...
	public class FormAddTransfPassport : FormBase
	{
		...
		private void comboBox_0_SelectedValueChanged(object sender, EventArgs e)
		{
			...
			if (int.TryParse(this.comboBox_0.SelectedValue.ToString(), out num))
			{
				...
				if (flag)
				{
					this.dsPassport_0.tSchm_ObjList.Rows[0]["Location"] = DBNull.Value;
					this.comboBox_1.DataSource = Class112.smethod_3(this.SqlSettings, num);
					this.comboBox_1.DisplayMember = "FullName";
					this.comboBox_1.ValueMember = "Id";
					return;
				}
				this.comboBox_1.SelectedValue = -1;
				this.dsPassport_0.tSchm_ObjList.Rows[0]["Location"] = num;
				this.dsPassport_0.tSchm_ObjList.Rows[0]["Deleted"] = (num == 909);
				this.dsPassport_0.tSchm_ObjList.Rows[0]["idParent"] = DBNull.Value;
				this.dsPassport_0.tSchm_ObjList.Rows[0]["idParentAddl"] = DBNull.Value;
			}
		}
		...
		private void FormAddTransfPassport_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (base.DialogResult == DialogResult.OK)
			{
				...
				this.dsPassport_0.tSchm_ObjList.Rows[0]["Name"] = "Т" + this.numericUpDown_0.Value.ToString();
				this.dsPassport_0.tSchm_ObjList.Rows[0].EndEdit();
		...
		private void comboBox_1_SelectedValueChanged(object sender, EventArgs e)
		{
			...
			if (this.comboBox_1.SelectedValue != null && int.TryParse(this.comboBox_1.SelectedValue.ToString(), out num))
			{
				if (num != -1)
				{
					this.dsPassport_0.tSchm_ObjList.Rows[0]["idParent"] = num;
					this.dsPassport_0.tSchm_ObjList.Rows[0]["idParentAddl"] = num;
					return;
				}
				this.dsPassport_0.tSchm_ObjList.Rows[0]["idParent"] = DBNull.Value;
				this.dsPassport_0.tSchm_ObjList.Rows[0]["idParentAddl"] = DBNull.Value;
