...
namespace Passport.Forms.PassportChars
{
	public class FormAddEditNaimEquipmentChars : FormPassportBase
	{
		...
		public FormAddEditNaimEquipmentChars(SQLSettings sqlSettings, int idEquipment)
		{
			...
			this.Id = idEquipment;
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_CharList, true, "WHERE id = " + this.Id.ToString());
			if (this.dsPassport_0.tP_CharList.Rows.Count > 0)
			{
				this.textBox_0.Text = this.dsPassport_0.tP_CharList.Rows[0]["Name"].ToString();
			}
		}
		...
		private bool method_2(int int_1, string string_0)
		{
			if (this.dsPassport_0.tP_CharList.Rows.Count > 0)
			{
				this.dsPassport_0.tP_CharList.Rows[0]["Name"] = this.textBox_0.Text;
			}
		...
		private string method_3(string string_0, string string_1)
		{
			...
			return string_0 + string.Join("", array.Select(new Func<string, string>(FormAddEditNaimEquipmentChars.<>c.<>9.method_0)).ToArray<string>()) + ";";
		}
