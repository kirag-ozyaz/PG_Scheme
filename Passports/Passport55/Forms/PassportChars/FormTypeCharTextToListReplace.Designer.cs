...
namespace Passport.Forms.PassportChars
{
	public class FormTypeCharTextToListReplace : FormBase
	{
		public FormTypeCharTextToListReplace(SQLSettings settings)
		{
			...
			base.SelectSqlDataTableOther(this.dsPassport_0, this.dsPassport_0.vP_GetGroupList, "vP_GetValueList", true, "where ParentId is null and isGroup = ((1)) and deleted = ((0)) order by Name");
		...
		{
			this.radioButton_1.Checked = !this.radioButton_0.Checked;
			this.comboBox_0.Enabled = this.radioButton_0.Checked;
			this.textBox_0.Enabled = this.radioButton_1.Checked;
		}

		private void radioButton_1_CheckedChanged(object sender, EventArgs e)
		{
			this.radioButton_0.Checked = !this.radioButton_1.Checked;
		}
		...
		private void method_1()
		{
			...
			this.radioButton_1.Location = new Point(15, 114);
			this.radioButton_1.Name = "rbNew";
			this.radioButton_1.Size = new Size(14, 13);
