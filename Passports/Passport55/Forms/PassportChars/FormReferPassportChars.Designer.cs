...
namespace Passport.Forms.PassportChars
{
	public class FormReferPassportChars : DockContentBase
	{
		...
		{
			base.SelectSqlDataTableOther(this.dsPassport_0, this.dsPassport_0.tP_CharListRefer, "tP_CharList", true, "where ParentKey like '" + this.method_1(this.typeCharacteristic_0) + "%' and dbo.CharCount(';', ParentKey) = 4 and Deleted = ((0))");
			this.dataGridView_0.DataSource = this.dsPassport_0.tP_CharListRefer;
		}
		...
		{
			if (this.comboBox_0.SelectedValue != null && this.comboBox_0.SelectedValue.GetType() == typeof(int))
			{
				this.method_5((int)this.comboBox_0.SelectedValue);
			}
		}
		...
		private void method_5(int int_0)
		{
			...
			{
				base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_ObjClassParamList, true, "WHERE IdClassifier = " + int_0.ToString() + " AND Deleted = ((0))");
				if (this.dsPassport_0.tP_ObjClassParamList.Rows.Count > 0)
				{
					int num = (int)this.dsPassport_0.tP_ObjClassParamList.Rows[0]["idParamList"];
		...
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_ObjClassParamList, true, "WHERE IdParamList = " + int_0.ToString() + " AND Deleted = ((0))");
			if (this.dsPassport_0.tP_ObjClassParamList.Rows.Count > 0)
			{
				this.comboBox_0.SelectedValue = this.dsPassport_0.tP_ObjClassParamList.Rows[0]["idClassifier"];
				return;
			}
		...
		private void method_7(int int_0, int int_1)
		{
			...
			if (this.dsPassport_0.tP_ObjClassParamList.Rows.Count > 0)
			{
				((dsPassport.Class51)this.dsPassport_0.tP_ObjClassParamList.Rows[0]).method_3(int_1);
				base.UpdateSqlData(this.dsPassport_0, this.dsPassport_0.tP_ObjClassParamList);
				return;
			}
			dsPassport.Class51 @class = this.dsPassport_0.tP_ObjClassParamList.method_5();
			@class.method_1(int_0);
			@class.method_3(int_1);
			@class.method_5(false);
			this.dsPassport_0.tP_ObjClassParamList.method_0(@class);
			base.InsertSqlData(this.dsPassport_0, this.dsPassport_0.tP_ObjClassParamList);
		}
		...
		private void method_8(int int_0, int int_1)
		{
			...
			{
				base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_ObjClassParamList, true, string.Concat(new string[]
				{
					"WHERE idClassifier = ",
					int_0.ToString(),
					" AND idParamList = ",
				...
				if (this.dsPassport_0.tP_ObjClassParamList.Rows.Count > 0)
				{
					((dsPassport.Class51)this.dsPassport_0.tP_ObjClassParamList.Rows[0]).method_5(true);
					base.UpdateSqlData(this.dsPassport_0, this.dsPassport_0.tP_ObjClassParamList);
					this.method_5((int)this.comboBox_0.SelectedValue);
				}
			}
		...
		private void button_1_Click(object sender, EventArgs e)
		{
			...
			{
				this.method_7((int)this.comboBox_0.SelectedValue, (int)this.dataGridView_0.SelectedRows[0].Cells["idEquipment"].Value);
				return;
			}
		...
		{
			this.method_8((int)this.comboBox_0.SelectedValue, (int)this.dataGridView_0.SelectedRows[0].Cells["idEquipment"].Value);
		}
		...
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_CharList, true, "Where id = " + int_0.ToString());
			if (this.dsPassport_0.tP_CharList.Rows.Count > 0)
			{
				this.dsPassport_0.tP_CharList.Rows[0]["Deleted"] = true;
			}
			if (base.UpdateSqlData(this.dsPassport_0, this.dsPassport_0.tP_CharList))
			{
				this.method_2();
			}
		}
		...
		private void method_11()
		{
			...
			this.dataGridViewTextBoxColumn_6.DataPropertyName = "Format";
			this.dataGridViewTextBoxColumn_6.HeaderText = "FormatEquipment";
			this.dataGridViewTextBoxColumn_6.Name = "FormatEquipment";
			this.dataGridViewTextBoxColumn_6.ReadOnly = true;
			this.dataGridViewTextBoxColumn_6.Visible = false;
			this.dataGridViewTextBoxColumn_7.DataPropertyName = "idValueList";
			this.dataGridViewTextBoxColumn_7.HeaderText = "idValueListEquipment";
			this.dataGridViewTextBoxColumn_7.Name = "idValueListEquipment";
			this.dataGridViewTextBoxColumn_7.ReadOnly = true;
			this.dataGridViewTextBoxColumn_7.Visible = false;
			this.dataGridViewTextBoxColumn_8.DataPropertyName = "TableName";
			this.dataGridViewTextBoxColumn_8.HeaderText = "TableNameEquipment";
			this.dataGridViewTextBoxColumn_8.Name = "TableNameEquipment";
			this.dataGridViewTextBoxColumn_8.ReadOnly = true;
			this.dataGridViewTextBoxColumn_8.Visible = false;
			this.dataGridViewTextBoxColumn_9.DataPropertyName = "TabIndex";
			this.dataGridViewTextBoxColumn_9.HeaderText = "TabIndexEquipment";
			this.dataGridViewTextBoxColumn_9.Name = "TabIndexEquipment";
			this.dataGridViewTextBoxColumn_9.ReadOnly = true;
			this.dataGridViewTextBoxColumn_9.Visible = false;
			this.dataGridViewTextBoxColumn_10.DataPropertyName = "Comment";
			this.dataGridViewTextBoxColumn_10.HeaderText = "CommentEquipment";
			this.dataGridViewTextBoxColumn_10.Name = "CommentEquipment";
			this.dataGridViewTextBoxColumn_10.ReadOnly = true;
			this.dataGridViewTextBoxColumn_10.Visible = false;
			this.dataGridViewTextBoxColumn_11.DataPropertyName = "isGroup";
			this.dataGridViewTextBoxColumn_11.HeaderText = "isGroupEquipment";
			this.dataGridViewTextBoxColumn_11.Name = "isGroupEquipment";
			this.dataGridViewTextBoxColumn_11.ReadOnly = true;
			this.dataGridViewTextBoxColumn_11.Visible = false;
			this.dataGridViewTextBoxColumn_12.DataPropertyName = "Panel";
			this.dataGridViewTextBoxColumn_12.HeaderText = "PanelEquipment";
			this.dataGridViewTextBoxColumn_12.Name = "PanelEquipment";
			this.dataGridViewTextBoxColumn_12.ReadOnly = true;
			this.dataGridViewTextBoxColumn_12.Visible = false;
			this.dataGridViewTextBoxColumn_13.DataPropertyName = "Deleted";
			this.dataGridViewTextBoxColumn_13.HeaderText = "DeletedEquipment";
			this.dataGridViewTextBoxColumn_13.Name = "DeletedEquipment";
			...
			this.toolStripMenuItem_4.Image = Resources.ElementEdit;
			...
			this.comboBox_0.Location = new Point(0, 32);
			this.comboBox_0.Name = "cbObjListType";
			this.comboBox_0.Size = new Size(241, 21);
			...
			this.dataGridViewTextBoxColumn_14.HeaderText = "idChar";
			this.dataGridViewTextBoxColumn_14.Name = "idChar";
			...
			this.dataGridViewTextBoxColumn_15.HeaderText = "ParentIdChar";
			this.dataGridViewTextBoxColumn_15.Name = "ParentIdChar";
			...
			this.dataGridViewTextBoxColumn_16.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_16.Name = "TabIndexChar";
			...
			this.dataGridViewTextBoxColumn_17.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_17.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_17.Name = "NameChar";
			...
			this.dataGridViewTextBoxColumn_18.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_18.Name = "ValueChar";
			...
			this.contextMenuStrip_1.Name = "cmsChars";
			this.contextMenuStrip_1.Size = new Size(155, 76);
			this.toolStripMenuItem_6.DropDownItems.AddRange(new ToolStripItem[]
			{
				this.toolStripMenuItem_7,
				this.toolStripMenuItem_8
			});
			this.toolStripMenuItem_6.Image = Resources.ElementAdd;
			...
			this.toolStripMenuItem_9.Image = Resources.ElementEdit;
			...
			this.toolStripMenuItem_10.Image = Resources.ElementDel;
			this.toolStripMenuItem_10.Name = "tsmiDeleteChars";
			this.toolStripMenuItem_10.Size = new Size(154, 22);
			this.toolStripMenuItem_10.Text = "Удалить";
