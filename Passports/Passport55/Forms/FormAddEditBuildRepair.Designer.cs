...
namespace Passport.Forms
{
	public class FormAddEditBuildRepair : FormBase
	{
		...
		public FormAddEditBuildRepair(SQLSettings settings, int int_2, StateFormCreate state)
		{
			this.method_5();
			...
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_BuildSubsRepair, true, "WHERE id = " + int_2.ToString());
			this.bindingSource_0.Position = this.bindingSource_0.Find("Id", int_2);
			this.comboBox_2.SelectedItem = Convert.ToInt32(this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["DateFactRepair"]);
			this.textBox_0.Text = this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["DateFactRepairComm"].ToString();
			this.comboBox_3.SelectedItem = Convert.ToInt32(this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["DateHousetopRepair"].ToString());
			this.textBox_2.Text = this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["DateHousetopRepairComm"].ToString();
			this.comboBox_4.SelectedItem = Convert.ToInt32(this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["DatePlanRepair"].ToString());
			this.textBox_1.Text = this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["DatePlanRepairComm"].ToString();
			this.comboBox_0.SelectedValue = (int)this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["DoorType"];
			this.textBox_3.Text = this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["DoorRepair"].ToString();
			this.textBox_4.Text = this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["OtmostRepair"].ToString();
			this.comboBox_1.SelectedValue = (int)this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["Company"];
			this.textBox_5.Text = this.dsPassport_0.tP_BuildSubsRepair.Rows[0]["Comment"].ToString();
		}

		private void method_0()
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tAbn, true, "WHERE TypeAbn IN (207, 230, 231, 614, 683) AND Deleted = ((0))", true);
			...
			base.SelectSqlDataTableOther(this.dsPassport_0, this.dsPassport_0.tP_ValueList, "tP_ValueLists", true, "WHERE ParentKey = ';Param;BuildRepair;DoorsMaterial;' AND isGroup = ((0)) AND Deleted = ((0))");
			BindingSource bindingSource2 = new BindingSource();
			dsPassport.Class34 class2 = this.dsPassport_0.tP_ValueList.method_5();
			class2.Int32_0 = -1;
			class2.Name = " ";
			this.dsPassport_0.tP_ValueList.method_0(class2);
			bindingSource2.DataSource = this.dsPassport_0.tP_ValueList;
		...
		private void method_1()
		{
			...
			int num = base.InsertSqlDataOneRow(this.dsPassport_0, this.dsPassport_0.tP_DocList);
			dsPassport.Class59 class2 = this.dsPassport_0.tP_BuildSubsRepair.method_5();
			class2.method_1(num);
			class2.method_3(this.comboBox_2.Text);
			class2.method_5(this.textBox_0.Text);
			class2.method_11(this.comboBox_3.Text);
			class2.method_13(this.textBox_2.Text);
			class2.method_7(this.comboBox_4.Text);
			class2.method_9(this.textBox_1.Text);
			class2.method_15((this.comboBox_0.SelectedValue == null) ? -1 : ((int)this.comboBox_0.SelectedValue));
			class2.method_17(this.textBox_3.Text);
			class2.method_19(this.textBox_4.Text);
			class2.method_21((this.comboBox_1.SelectedValue == null) ? -1 : ((int)this.comboBox_1.SelectedValue));
			class2.Comment = this.textBox_5.Text;
			class2.method_23(false);
			this.dsPassport_0.tP_BuildSubsRepair.method_0(class2);
			this.int_0 = base.InsertSqlDataOneRow(this.dsPassport_0, this.dsPassport_0.tP_BuildSubsRepair);
		}

		private void method_2()
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_BuildSubsRepair, true, "WHERE id = " + this.int_0.ToString());
			this.bindingSource_0.Position = this.bindingSource_0.Find("Id", this.int_0);
			DataRow dataRow = this.dsPassport_0.tP_BuildSubsRepair.Rows[0];
			dataRow["DateFactRepair"] = this.comboBox_2.Text;
			dataRow["DateFactRepairComm"] = this.textBox_0.Text;
			dataRow["DateHousetopRepair"] = this.comboBox_3.Text;
			dataRow["DateHousetopRepairComm"] = this.textBox_2.Text;
			dataRow["DatePlanRepair"] = this.comboBox_4.Text;
			dataRow["DatePlanRepairComm"] = this.textBox_1.Text;
			dataRow["DoorType"] = ((this.comboBox_0.SelectedValue == null) ? -1 : ((int)this.comboBox_0.SelectedValue));
			dataRow["DoorRepair"] = this.textBox_3.Text;
			dataRow["OtmostRepair"] = this.textBox_4.Text;
			dataRow["Company"] = ((this.comboBox_1.SelectedValue == null) ? -1 : ((int)this.comboBox_1.SelectedValue));
			dataRow["Comment"] = this.textBox_5.Text;
		...
		private bool method_4(TextBox textBox_6)
		{
			if (textBox_6.TextLength != 4 && textBox_6.TextLength != 0)
			{
		...
		private void method_5()
		{
			...
			this.dsPassport_0.DataSetName = "dsPassport1";
			...
			this.textBox_0.Location = new Point(245, 12);
			this.textBox_0.Name = "tbFactRepairComm";
			this.textBox_0.Size = new Size(221, 20);
			this.textBox_0.TabIndex = 8;
			this.textBox_1.Location = new Point(245, 64);
			this.textBox_1.Name = "tbPlanRepairComm";
			this.textBox_1.Size = new Size(221, 20);
			this.textBox_1.TabIndex = 10;
			this.textBox_2.Location = new Point(245, 38);
			this.textBox_2.Name = "tbHousetopRepairComm";
			...
			this.textBox_3.Location = new Point(104, 117);
			this.textBox_3.Name = "tbDoorRepair";
			this.textBox_3.Size = new Size(362, 20);
			...
			this.textBox_4.Location = new Point(110, 143);
			this.textBox_4.Name = "tbOtmostRepair";
			this.textBox_4.Size = new Size(356, 20);
			...
			this.textBox_5.Location = new Point(96, 196);
			this.textBox_5.Multiline = true;
			this.textBox_5.Name = "tbComment";
			this.textBox_5.Size = new Size(368, 44);
			this.textBox_5.TabIndex = 22;
			...
			this.comboBox_2.Location = new Point(101, 12);
			this.comboBox_2.Name = "cbFactRepair";
			...
			this.comboBox_3.Location = new Point(101, 38);
			this.comboBox_3.Name = "cbHousetopRepair";
			this.comboBox_3.Size = new Size(55, 21);
			this.comboBox_3.TabIndex = 24;
			this.comboBox_4.AutoCompleteMode = AutoCompleteMode.Append;
			this.comboBox_4.AutoCompleteSource = AutoCompleteSource.ListItems;
			this.comboBox_4.FormattingEnabled = true;
			this.comboBox_4.Location = new Point(101, 64);
			this.comboBox_4.Name = "cbPlanRepair";
			this.comboBox_4.Size = new Size(55, 21);
			this.comboBox_4.TabIndex = 24;
