...
{
	public class FormChoosePylone : FormBase
	{
		public int PylonId
		{
			get
		...
		protected override void OnLoad(EventArgs eventArgs_0)
		{
			...
			this.method_3();
			this.method_5(-3);
			this.method_4(this.treeView_0.Nodes);
		}

		private void method_0()
		{
			TypeObjListGroup group = TypeObjListGroup.AirLines;
			string arg = string.Join(",", ObjList.GetGroupValue(TypeObjListGroup.AirLines).Select(new Func<decimal, string>(FormChoosePylone.<>c.<>9.method_0)).ToArray<string>());
		...
		private void method_2(TreeNodeData treeNodeData_0, TreeNode treeNode_2)
		{
		...
		private void method_3()
		{
			...
			try
			{
				string text = string.Join(",", ObjList.GetGroupValue(group).Select(new Func<decimal, string>(FormChoosePylone.<>c.<>9.method_1)).ToArray<string>());
				...
				try
				{
					this.method_0();
					this.method_1();
					list = base.SelectSqlData("vP_CableLine", true, text3).AsEnumerable().Select(new Func<DataRow, TreeNodeData>(FormChoosePylone.<>c.<>9.method_2)).ToList<TreeNodeData>();
				}
				catch (Exception ex)
				{
				...
				{
					this.method_2(treeNodeData, new TreeNode(treeNodeData.Text)
					{
		...
		private void method_4(TreeNodeCollection treeNodeCollection_0)
		{
		...
		private void method_6()
		{
			...
			this.dataGridViewTextBoxColumn_2.Name = "NamePylon";
			this.dataGridViewTextBoxColumn_2.ReadOnly = true;
			this.dataGridViewTextBoxColumn_3.DataPropertyName = "idObjList";
			this.dataGridViewTextBoxColumn_3.HeaderText = "idObjListPylon";
			this.dataGridViewTextBoxColumn_3.Name = "idObjListPylon";
			...
			this.dataGridViewTextBoxColumn_4.HeaderText = "idPylon";
			this.dataGridViewTextBoxColumn_4.Name = "dataGridViewTextBoxColumn1";
			this.dataGridViewTextBoxColumn_4.ReadOnly = true;
			this.dataGridViewTextBoxColumn_4.Visible = false;
			this.dataGridViewTextBoxColumn_5.DataPropertyName = "IdEquipment";
			this.dataGridViewTextBoxColumn_5.HeaderText = "IdEquipment";
			...
			this.dataGridViewTextBoxColumn_6.MinimumWidth = 100;
			this.dataGridViewTextBoxColumn_6.Name = "dataGridViewTextBoxColumn3";
			this.dataGridViewTextBoxColumn_6.ReadOnly = true;
			this.dataGridViewTextBoxColumn_7.DataPropertyName = "idObjList";
			this.dataGridViewTextBoxColumn_7.HeaderText = "idObjListPylon";
