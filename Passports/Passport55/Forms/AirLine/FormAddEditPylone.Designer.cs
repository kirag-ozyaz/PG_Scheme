...
{
	public class FormAddEditPylone : FormBase
	{
		public int IdPole
		{
			get
		...
		public AirLinePole LocationPole { get; set; }

		public FormAddEditPylone()
		{
			this.method_19();
			this.method_0();
		...
		public FormAddEditPylone(int idPole, int idAirLine)
		{
			this.method_19();
			this.method_0();
			this.int_2 = idPole;
		...
		{
			this.textBox_1.DataBindings[0].DataSourceNullValue = string.Empty;
			this.textBox_1.DataBindings[0].NullValue = 0;
		}
		...
		private void FormAddEditPylone_Load(object sender, EventArgs e)
		{
			this.method_1();
			...
			if (createState == null)
			{
				...
				@class.IdParent = this.IdAirLine;
				@class.idParentAddl = this.IdAirLine;
				@class.method_5(false);
				if (this.IdSpan != -1)
				{
					this.Text = "Добавление опоры в пролет № " + this.method_2(this.IdSpan);
					int num = this.method_18(";SCM;Pole;", 2m);
					if (num != -1)
					{
				...
				this.dataGridViewPassport_0.AddRowAddingParemeter(ObjectBase.GetTypeCodeId(this.SqlSettings, ";SCM;Pole;", 1m), this.SqlSettings);
				return;
			}
			if (createState != 1)
			{
				...
				base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tSchm_ObjList, true, string.Format("WHERE id = {0}", this.IdPole));
				this.Text = "Копирование опоры № " + this.dsPassport_0.tSchm_ObjList[0].Name;
				this.bindingSource_2.ResetBindings(false);
				int activePassport = PassportData.GetActivePassport(this.SqlSettings, this.IdPole);
				base.SelectSqlData(this.dsPassport_0.tP_Passport, true, string.Format("where id = '{0}'", activePassport), false);
				this.dataGridViewPassport_0.AddRowEditingParameter(this.SqlSettings, activePassport, DataGridViewPassport.CreateState.Copy);
				return;
			}
			else
			{
				...
				{
					base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tSchm_ObjList, true, string.Format("WHERE id = {0}", this.IdPole));
					this.Text = "Редактирование опоры № " + this.dsPassport_0.tSchm_ObjList[0].Name;
					this.bindingSource_2.ResetBindings(false);
					int activePassport = PassportData.GetActivePassport(this.SqlSettings, this.IdPole);
					base.SelectSqlData(this.dsPassport_0.tP_Passport, true, string.Format("where id = '{0}'", activePassport), false);
				...
				this.Text = "Вставка опоры в пролет № " + this.method_2(this.IdSpan);
				return;
			}
		}
		...
		private string method_2(int int_4)
		{
			DataTable dataTable = new DataTable("tP_CabSection");
			base.SelectSqlData(dataTable, true, string.Format("where id = '{0}'", int_4), false);
		...
		private bool method_3()
		{
			...
			if (createState != null)
			{
				if (createState == 1)
				{
					...
					this.dataGridViewPassport_0.SaveUpdatedData(datePassport, Convert.ToInt32(this.dsPassport_0.tP_Passport[0]["Number"]));
					this.method_9();
					this.method_4();
					return true;
				}
				...
				this.IdPole = base.InsertSqlDataOneRow(this.dsPassport_0.tSchm_ObjList[0]);
				if (this.IdPole == -1)
				{
					return false;
				}
				this.dataGridViewPassport_0.SaveInsertedData(this.IdPole, datePassport, Convert.ToInt32(this.dsPassport_0.tP_Passport[0]["Number"]));
				this.method_9();
				return true;
			}
			else
			{
				this.IdPole = base.InsertSqlDataOneRow(this.dsPassport_0, this.dsPassport_0.tSchm_ObjList);
				if (this.IdPole == -1)
				{
					return false;
				}
		...
		{
			if (base.DialogResult == DialogResult.OK && (!this.method_7() || (!this.method_3() && this.CreateState == 1)))
			{
			...
			if (this.formAddEditCabBranch_0 != null)
			{
				this.formAddEditCabBranch_0.DialogResult = DialogResult.Cancel;
				this.formAddEditCabBranch_0.Close();
			}
		}
		...
		private bool method_7()
		{
			...
			string text = this.dsPassport_0.tSchm_ObjList.Rows[0]["Name"].ToString();
			if (text.Trim() == string.Empty)
			{
				new ToolTip().Show("!", this.textBox_0, 10, 5, 3000);
				result = false;
			}
			string text2 = string.Format("WHERE name = '{0}' AND IdParent = {1} AND idParentAddl = {2} and deleted = 0 ", text, this.IdAirLine, this.IdAirLine);
			if (this.CreateState == 1)
			{
				text2 += string.Format(" AND id <> {0}", this.IdPole);
			}
		...
		{
			this.formAddEditCabBranch_0 = new FormAddEditCabBranch(this.IdAirLine, this.IdPole, -1, -1);
			this.formAddEditCabBranch_0.SqlSettings = this.SqlSettings;
			this.formAddEditCabBranch_0.MdiParent = base.MdiParent;
			this.formAddEditCabBranch_0.createState = 0;
			this.formAddEditCabBranch_0.tCabBranchRow = this.dsPassport_0.tP_CabBranches.method_5();
			this.formAddEditCabBranch_0.tBranchObjRelationRow = this.dsPassport_0.tP_BranchObjRelation.method_5();
			this.formAddEditCabBranch_0.Show();
			this.formAddEditCabBranch_0.FormClosed -= this.formAddEditCabBranch_0_FormClosed;
			this.formAddEditCabBranch_0.FormClosed += this.formAddEditCabBranch_0_FormClosed;
		}
		...
		private void toolStripButton_1_Click(object sender, EventArgs e)
		{
			...
			int num = (int)this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_94.Name].Value;
			int num2;
			if (!int.TryParse(this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_97.Name].Value.ToString(), out num2))
			{
				num2 = -1;
			}
			this.int_3 = this.dataGridView_0.CurrentRow.Index;
			this.formAddEditCabBranch_0 = new FormAddEditCabBranch(this.IdAirLine, this.IdPole, num, num2);
			this.formAddEditCabBranch_0.SqlSettings = this.SqlSettings;
			this.formAddEditCabBranch_0.MdiParent = base.MdiParent;
			this.formAddEditCabBranch_0.createState = 1;
			DataRow[] array = this.dsPassport_0.tP_CabBranches.Select("id = " + num.ToString());
			this.formAddEditCabBranch_0.tCabBranchRow = (dsPassport.Class94)array[0];
			DataRow[] array2 = this.dsPassport_0.tP_BranchObjRelation.Select(string.Format("idCabBranch = {0} and idObj = {1}", num, num2));
			this.formAddEditCabBranch_0.tBranchObjRelationRow = (dsPassport.Class95)array2[0];
			this.formAddEditCabBranch_0.Show();
			this.formAddEditCabBranch_0.FormClosed -= this.formAddEditCabBranch_0_FormClosed;
			this.formAddEditCabBranch_0.FormClosed += this.formAddEditCabBranch_0_FormClosed;
		}
		...
		private void toolStripButton_2_Click(object sender, EventArgs e)
		{
			...
			int num = (int)this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_94.Name].Value;
			for (int i = 0; i < this.dsPassport_0.vP_CabBranches.Rows.Count; i++)
			{
				if (this.dsPassport_0.vP_CabBranches[i].RowState != DataRowState.Deleted && this.dsPassport_0.vP_CabBranches[i].Int32_0 == num)
				{
					this.dsPassport_0.vP_CabBranches[i].Delete();
				}
			}
			for (int j = 0; j < this.dsPassport_0.tP_CabBranches.Rows.Count; j++)
			{
				if (this.dsPassport_0.tP_CabBranches[j].RowState != DataRowState.Deleted && this.dsPassport_0.tP_CabBranches[j].Int32_0 == num)
				{
					this.dsPassport_0.tP_CabBranches[j].Delete();
					IL_10D:
					for (int k = 0; k < this.dsPassport_0.tP_BranchObjRelation.Rows.Count; k++)
					{
						if (this.dsPassport_0.tP_BranchObjRelation[k].RowState != DataRowState.Deleted && this.dsPassport_0.tP_BranchObjRelation[k].method_0() == num)
						{
							this.dsPassport_0.tP_BranchObjRelation[k].Delete();
						}
					}
					return;
				}
		...
		private void toolStripButton_4_Click(object sender, EventArgs e)
		{
			...
			int idBranch = (int)this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_94.Name].Value;
			this.formAddEditCabBranch_0 = new FormAddEditCabBranch(this.IdAirLine, this.IdPole, idBranch, -1);
			this.formAddEditCabBranch_0.SqlSettings = this.SqlSettings;
			this.formAddEditCabBranch_0.MdiParent = base.MdiParent;
			this.formAddEditCabBranch_0.createState = 4;
			DataRow[] array = this.dsPassport_0.tP_CabBranches.Select("id = " + idBranch.ToString());
			this.formAddEditCabBranch_0.tCabBranchRow = (dsPassport.Class94)array[0];
			this.formAddEditCabBranch_0.tBranchObjRelationRow = this.dsPassport_0.tP_BranchObjRelation.method_5();
			this.formAddEditCabBranch_0.Show();
			this.formAddEditCabBranch_0.FormClosed -= this.formAddEditCabBranch_0_FormClosed;
		...
		private void toolStripButton_5_Click(object sender, EventArgs e)
		{
			...
			this.formAddEditCabBranch_0.SqlSettings = this.SqlSettings;
			this.formAddEditCabBranch_0.MdiParent = base.MdiParent;
			this.formAddEditCabBranch_0.createState = 6;
			DataRow[] array = this.dsPassport_0.tP_CabBranches.Select("id = " + num.ToString());
			this.formAddEditCabBranch_0.tCabBranchRow = (dsPassport.Class94)array[0];
			DataRow[] array2 = this.dsPassport_0.tP_BranchObjRelation.Select(string.Format("idCabBranch = {0} and idObj = {1}", num, num2));
			this.formAddEditCabBranch_0.tBranchObjRelationRow = (dsPassport.Class95)array2[0];
		...
		private void toolStripButton_6_Click(object sender, EventArgs e)
		{
			...
			int num = (int)this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_94.Name].Value;
			int num2 = (int)this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_97.Name].Value;
			this.bindingSource_3.RemoveCurrent();
			for (int i = 0; i < this.dsPassport_0.tP_BranchObjRelation.Rows.Count; i++)
			{
				if (this.dsPassport_0.tP_BranchObjRelation[i].RowState != DataRowState.Deleted && this.dsPassport_0.tP_BranchObjRelation[i].method_0() == num && this.dsPassport_0.tP_BranchObjRelation[i].method_2() == num2)
				{
					this.dsPassport_0.tP_BranchObjRelation[i].Delete();
					if (this.dsPassport_0.tP_BranchObjRelation.Select("idCabBranch = " + num.ToString()).Length == 0)
					{
						this.dsPassport_0.tP_CabBranches.Select("id = " + num.ToString())[0].Delete();
					}
					return;
				}
			}
		...
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_CabBranches, true, string.Format("where idPole = '{0}'", this.IdPole));
			if (this.dsPassport_0.tP_CabBranches.Rows.Count == 0)
			{
				return;
			}
			string text = string.Empty;
			foreach (object obj in this.dsPassport_0.tP_CabBranches.Rows)
			{
				dsPassport.Class94 @class = (dsPassport.Class94)obj;
				text = text + "," + @class.Int32_0.ToString();
			}
			if (!string.IsNullOrEmpty(text))
			{
				text = text.Remove(0, 1);
				base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_BranchObjRelation, true, string.Format("where idCabBranch in ({0})", text));
			}
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.vP_CabBranches, true, string.Format(" where idPole = '{0}' order by id, idAirLine desc", this.IdPole));
			this.bindingSource_3.ResetBindings(false);
		}

		private void formAddEditCabBranch_0_FormClosed(object sender, FormClosedEventArgs e)
		{
			if (this.formAddEditCabBranch_0.DialogResult == DialogResult.OK)
			{
				dsPassport.Class96 @class = this.dsPassport_0.vP_CabBranches.method_4();
				switch (this.formAddEditCabBranch_0.createState)
				{
				case 0:
				{
					this.dsPassport_0.tP_CabBranches.Rows.Add(this.formAddEditCabBranch_0.tCabBranchRow);
					int num = this.dsPassport_0.tP_CabBranches.Rows.IndexOf(this.formAddEditCabBranch_0.tCabBranchRow);
					this.formAddEditCabBranch_0.tBranchObjRelationRow.method_1(this.dsPassport_0.tP_CabBranches[num].Int32_0);
					this.dsPassport_0.tP_BranchObjRelation.Rows.Add(this.formAddEditCabBranch_0.tBranchObjRelationRow);
					@class.Int32_0 = this.dsPassport_0.tP_CabBranches[num].Int32_0;
					for (int i = 1; i < this.formAddEditCabBranch_0.tCabBranchRow.ItemArray.Count<object>(); i++)
					{
						string columnName = this.dsPassport_0.tP_CabBranches.Columns[i].ColumnName;
						@class[columnName] = this.formAddEditCabBranch_0.tCabBranchRow[columnName];
					}
					for (int j = 2; j < this.formAddEditCabBranch_0.tBranchObjRelationRow.ItemArray.Count<object>(); j++)
					{
						string columnName2 = this.dsPassport_0.tP_BranchObjRelation.Columns[j].ColumnName;
						@class[columnName2] = this.formAddEditCabBranch_0.tBranchObjRelationRow[columnName2];
					}
					@class.method_3(this.formAddEditCabBranch_0.AirLineName);
					@class.method_9(this.formAddEditCabBranch_0.ObjName);
					@class.method_17(this.formAddEditCabBranch_0.CableType);
					@class.EndEdit();
					this.dsPassport_0.vP_CabBranches.Rows.Add(@class);
					goto IL_4CB;
				}
				case 1:
					using (IEnumerator enumerator = this.dsPassport_0.vP_CabBranches.Rows.GetEnumerator())
					{
						while (enumerator.MoveNext())
						{
							object obj = enumerator.Current;
							dsPassport.Class96 class2 = (dsPassport.Class96)obj;
							if (class2.Int32_0 == this.formAddEditCabBranch_0.tCabBranchRow.Int32_0)
							{
								for (int k = 1; k < this.formAddEditCabBranch_0.tCabBranchRow.ItemArray.Count<object>(); k++)
								{
									string columnName3 = this.dsPassport_0.tP_CabBranches.Columns[k].ColumnName;
									class2[columnName3] = this.formAddEditCabBranch_0.tCabBranchRow[columnName3];
								}
								class2.method_3(this.formAddEditCabBranch_0.AirLineName);
								class2.method_17(this.formAddEditCabBranch_0.CableType);
							}
						}
						goto IL_4CB;
					}
				...
				case 6:
				{
					...
					this.dsPassport_0.vP_CabBranches[this.int_3].method_7(this.formAddEditCabBranch_0.tBranchObjRelationRow.method_2());
					this.dsPassport_0.vP_CabBranches[this.int_3].method_9(this.formAddEditCabBranch_0.ObjName);
					this.dsPassport_0.vP_CabBranches[this.int_3].method_11(this.formAddEditCabBranch_0.tBranchObjRelationRow.method_4());
					goto IL_4CB;
				}
				default:
					goto IL_4CB;
				}
				this.formAddEditCabBranch_0.tBranchObjRelationRow.method_1(this.formAddEditCabBranch_0.tCabBranchRow.Int32_0);
				this.dsPassport_0.tP_BranchObjRelation.Rows.Add(this.formAddEditCabBranch_0.tBranchObjRelationRow);
				for (int l = 0; l < this.formAddEditCabBranch_0.tCabBranchRow.ItemArray.Count<object>(); l++)
				{
					string columnName4 = this.dsPassport_0.tP_CabBranches.Columns[l].ColumnName;
					@class[columnName4] = this.formAddEditCabBranch_0.tCabBranchRow[columnName4];
				}
				for (int m = 2; m < this.formAddEditCabBranch_0.tBranchObjRelationRow.ItemArray.Count<object>(); m++)
				{
					string columnName5 = this.dsPassport_0.tP_BranchObjRelation.Columns[m].ColumnName;
					@class[columnName5] = this.formAddEditCabBranch_0.tBranchObjRelationRow[columnName5];
				}
				@class.method_3(this.formAddEditCabBranch_0.AirLineName);
				@class.method_9(this.formAddEditCabBranch_0.ObjName);
				@class.method_17(this.formAddEditCabBranch_0.CableType);
				...
				this.dsPassport_0.vP_CabBranches.Rows.Add(@class);
				IL_4CB:
				DataView dataView = new DataView(this.dsPassport_0.vP_CabBranches);
		...
		{
			for (int i = 0; i < this.dsPassport_0.tP_CabBranches.Rows.Count; i++)
			{
				if (this.dsPassport_0.tP_CabBranches[i].RowState == DataRowState.Added)
				{
					this.dsPassport_0.tP_CabBranches[i].method_3(this.IdPole);
					int int32_ = this.dsPassport_0.tP_CabBranches[i].Int32_0;
					int num = base.InsertSqlDataOneRow(this.dsPassport_0.tP_CabBranches[i]);
					if (num != -1)
					{
						for (int j = 0; j < this.dsPassport_0.tP_BranchObjRelation.Rows.Count; j++)
						{
							if (this.dsPassport_0.tP_BranchObjRelation[j].RowState != DataRowState.Deleted && this.dsPassport_0.tP_BranchObjRelation[j].method_0() == int32_)
							{
								this.dsPassport_0.tP_BranchObjRelation[j].method_1(num);
							}
						}
					}
				}
			}
			base.InsertSqlData(this.dsPassport_0.tP_BranchObjRelation);
			base.UpdateSqlDataOnlyChange(this.dsPassport_0.tP_CabBranches);
			base.UpdateSqlDataOnlyChange(this.dsPassport_0.tP_BranchObjRelation);
			base.DeleteSqlData(this.dsPassport_0.tP_CabBranches);
			base.DeleteSqlData(this.dsPassport_0.tP_BranchObjRelation);
		}
		...
		{
			this.method_12(this.IdPole);
		}

		private void method_11(int int_4, int int_5)
		{
			this.method_12(int_4);
			foreach (object obj in ((IEnumerable)this.dataGridViewExcelFilter_0.Rows))
			{
				DataGridViewRow dataGridViewRow = (DataGridViewRow)obj;
				if ((int)dataGridViewRow.Cells[this.dataGridViewTextBoxColumn_187.Name].Value == int_5)
				{
					dataGridViewRow.Cells[this.dataGridViewTextBoxColumn_189.Name].Selected = true;
		...
		private void method_12(int int_4)
		{
			...
			this.method_13(dataTable, dataTable_);
		...
		private void method_13(DataTable dataTable_1, DataTable dataTable_2)
		{
		...
		private void method_14(int int_4 = -1)
		{
			FormAddPylonEquipment formAddPylonEquipment = new FormAddPylonEquipment(this.IdAirLine, -1, int_4);
			formAddPylonEquipment.SqlSettings = this.SqlSettings;
			formAddPylonEquipment.CreateState = 0;
			formAddPylonEquipment.MdiParent = base.MdiParent;
			formAddPylonEquipment.FormClosed += this.method_17;
			formAddPylonEquipment.Show();
		}
		...
		private void method_15()
		{
			...
			{
				int idPylonEquipment = Convert.ToInt32(((DataRowView)this.bindingSource_0.Current).Row["idObjList"]);
				FormAddPylonEquipment formAddPylonEquipment = new FormAddPylonEquipment(this.IdAirLine, idPylonEquipment, -1);
				formAddPylonEquipment.SqlSettings = this.SqlSettings;
				formAddPylonEquipment.CreateState = 1;
				formAddPylonEquipment.FormClosed += this.method_17;
				formAddPylonEquipment.MdiParent = base.MdiParent;
				formAddPylonEquipment.Show();
				return;
		...
		{
			FormAddPylonEquipment formAddPylonEquipment = (FormAddPylonEquipment)sender;
			if (formAddPylonEquipment.DialogResult == DialogResult.OK)
			{
				if (formAddPylonEquipment.CreateState == null)
				{
					this.method_12(this.IdPole);
					return;
				}
				if (formAddPylonEquipment.CreateState == 1)
				{
					this.method_11(this.IdPole, formAddPylonEquipment.IdPylonEquipment);
				}
			}
		}
		...
		{
			if (this.tabControl_0.SelectedTab == this.tabPage_1 && this.CreateState == 1)
			{
				this.method_10();
				return;
			}
		...
		private int method_18(string string_1, decimal decimal_0)
		{
			DataTable dataTable = new DataTable("tR_Classifier");
			dataTable.Columns.Add("id", typeof(int));
			dataTable.Columns.Add("Name", typeof(string));
			base.SelectSqlData(dataTable, true, string.Format("where ParentKey = '{0}' and Value = '{1}' and deleted = '0'", string_1, decimal_0), false);
			if (dataTable.Rows.Count > 0)
			{
		...
		private void comboBox_1_SelectedValueChanged(object sender, EventArgs e)
		{
			...
			this.IdPole = Convert.ToInt32(this.comboBox_1.SelectedValue);
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tSchm_ObjList, true, string.Format("WHERE id = {0}", this.IdPole));
			int activePassport = PassportData.GetActivePassport(this.SqlSettings, this.IdPole);
			base.SelectSqlData(this.dsPassport_0.tP_Passport, true, string.Format("where id = '{0}'", activePassport), false);
			this.dataGridViewPassport_0.AddRowEditingParameter(this.SqlSettings, activePassport, DataGridViewPassport.CreateState.EditValue);
		...
		private void method_19()
		{
			...
			this.tableLayoutPanel_0.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 54f));
			this.tableLayoutPanel_0.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 176f));
			this.tableLayoutPanel_0.Controls.Add(this.label_0, 1, 1);
			this.tableLayoutPanel_0.Controls.Add(this.label_1, 1, 2);
			this.tableLayoutPanel_0.Controls.Add(this.label_2, 1, 3);
			this.tableLayoutPanel_0.Controls.Add(this.button_0, 5, 8);
			this.tableLayoutPanel_0.Controls.Add(this.button_1, 2, 8);
			this.tableLayoutPanel_0.Controls.Add(this.comboBox_0, 2, 2);
			this.tableLayoutPanel_0.Controls.Add(this.dataGridViewPassport_0, 0, 5);
			this.tableLayoutPanel_0.Controls.Add(this.label_3, 4, 4);
			this.tableLayoutPanel_0.Controls.Add(this.nullableDateTimePicker_0, 5, 4);
			...
			this.tableLayoutPanel_0.Controls.Add(this.textBox_1, 2, 4);
			this.tableLayoutPanel_0.Controls.Add(this.tableLayoutPanel_1, 2, 1);
			...
			this.tableLayoutPanel_0.RowStyles.Add(new RowStyle(SizeType.Percent, 70f));
			this.tableLayoutPanel_0.RowStyles.Add(new RowStyle(SizeType.Absolute, 25f));
			this.tableLayoutPanel_0.RowStyles.Add(new RowStyle(SizeType.Percent, 30f));
			this.tableLayoutPanel_0.RowStyles.Add(new RowStyle(SizeType.Absolute, 43f));
			this.tableLayoutPanel_0.Size = new Size(455, 558);
			...
			this.label_1.Location = new Point(23, 37);
			this.label_1.Name = "label2";
			this.label_1.Size = new Size(83, 27);
			this.label_1.TabIndex = 1;
			this.label_1.Text = "Тип опоры";
			this.label_1.TextAlign = ContentAlignment.MiddleLeft;
			this.label_2.AutoSize = true;
			this.tableLayoutPanel_0.SetColumnSpan(this.label_2, 2);
			this.label_2.Dock = DockStyle.Fill;
			this.label_2.Location = new Point(23, 71);
			this.label_2.Margin = new Padding(3, 7, 3, 3);
			this.label_2.Name = "label3";
			this.label_2.Size = new Size(189, 13);
			...
			this.tableLayoutPanel_0.SetColumnSpan(this.button_1, 3);
			...
			this.tableLayoutPanel_0.SetColumnSpan(this.dataGridViewPassport_0, 6);
			...
			this.dataGridViewPassport_0.Location = new Point(3, 124);
			...
			this.dataGridViewPassport_0.Size = new Size(449, 252);
			this.dataGridViewPassport_0.TabIndex = 7;
			this.dataGridViewTextBoxColumn_226.HeaderText = "idChar";
			this.dataGridViewTextBoxColumn_226.Name = "dataGridViewTextBoxColumn196";
			...
			this.dataGridViewTextBoxColumn_227.HeaderText = "ParentIdChar";
			this.dataGridViewTextBoxColumn_227.Name = "dataGridViewTextBoxColumn197";
			...
			this.dataGridViewTextBoxColumn_228.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_228.Name = "dataGridViewTextBoxColumn198";
			...
			this.dataGridViewTextBoxColumn_229.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
			this.dataGridViewTextBoxColumn_229.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_229.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_229.Name = "dataGridViewTextBoxColumn199";
			...
			this.dataGridViewTextBoxColumn_229.Width = 5;
			this.dataGridViewTextBoxColumn_230.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			this.dataGridViewTextBoxColumn_230.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_230.Name = "dataGridViewTextBoxColumn200";
			...
			this.label_3.Location = new Point(243, 87);
			this.label_3.Name = "label4";
			this.label_3.Size = new Size(33, 34);
			this.label_3.TabIndex = 8;
			this.label_3.Text = "Дата";
			this.label_3.TextAlign = ContentAlignment.MiddleRight;
			this.nullableDateTimePicker_0.DataBindings.Add(new Binding("Value", this.dsPassport_0, "tP_Passport.Date", true));
			...
			this.toolStrip_0.Location = new Point(0, 379);
			this.toolStrip_0.Name = "toolStripBranch";
			this.toolStrip_0.Size = new Size(455, 25);
			...
			this.toolStripButton_4.Image = Resources._1304663065_Add;
			...
			this.toolStripButton_5.Image = Resources._1304663141_Pen;
			...
			this.dataGridViewTextBoxColumn_94.HeaderText = "Отвод";
			this.dataGridViewTextBoxColumn_94.MinimumWidth = 15;
			this.dataGridViewTextBoxColumn_94.Name = "idDgvCabBranches";
			this.dataGridViewTextBoxColumn_94.ReadOnly = true;
			this.dataGridViewTextBoxColumn_94.Width = 30;
			this.dataGridViewTextBoxColumn_95.DataPropertyName = "idAirLine";
			this.dataGridViewTextBoxColumn_95.HeaderText = "idAirLine";
			this.dataGridViewTextBoxColumn_95.Name = "idAirLineDgvCabBranches";
			this.dataGridViewTextBoxColumn_95.ReadOnly = true;
			this.dataGridViewTextBoxColumn_95.Visible = false;
			this.dataGridViewTextBoxColumn_96.DataPropertyName = "idPole";
			this.dataGridViewTextBoxColumn_96.HeaderText = "idPole";
			this.dataGridViewTextBoxColumn_96.Name = "idPoleDgvCabBranches";
			this.dataGridViewTextBoxColumn_96.ReadOnly = true;
			this.dataGridViewTextBoxColumn_96.Visible = false;
			this.dataGridViewTextBoxColumn_97.DataPropertyName = "idObj";
			this.dataGridViewTextBoxColumn_97.HeaderText = "idObj";
			this.dataGridViewTextBoxColumn_97.Name = "idObjDgvCabBranches";
			this.dataGridViewTextBoxColumn_97.ReadOnly = true;
			this.dataGridViewTextBoxColumn_97.Visible = false;
			this.dataGridViewTextBoxColumn_98.DataPropertyName = "typeCodeId";
			this.dataGridViewTextBoxColumn_98.HeaderText = "typeCodeId";
			this.dataGridViewTextBoxColumn_98.Name = "typeCodeIdDgvCabBranches";
			...
			this.dataGridViewTextBoxColumn_99.DataPropertyName = "AirLineName";
			this.dataGridViewTextBoxColumn_99.HeaderText = "Линия";
			this.dataGridViewTextBoxColumn_99.MinimumWidth = 30;
			this.dataGridViewTextBoxColumn_99.Name = "airLineNameDgvCabBranches";
			...
			this.dataGridViewTextBoxColumn_100.DataPropertyName = "ObjName";
			this.dataGridViewTextBoxColumn_100.HeaderText = "Объект";
			this.dataGridViewTextBoxColumn_100.MinimumWidth = 30;
			this.dataGridViewTextBoxColumn_100.Name = "objNameDgvCabBranches";
			this.dataGridViewTextBoxColumn_100.ReadOnly = true;
			this.dataGridViewTextBoxColumn_101.DataPropertyName = "cableMakeup";
			this.dataGridViewTextBoxColumn_101.HeaderText = "Марка кабеля";
			this.dataGridViewTextBoxColumn_101.Name = "cableMakeupDgvCabBranches";
			...
			this.dataGridViewTextBoxColumn_102.DataPropertyName = "cableType";
			this.dataGridViewTextBoxColumn_102.HeaderText = "Тип провода";
			this.dataGridViewTextBoxColumn_102.MinimumWidth = 30;
			this.dataGridViewTextBoxColumn_102.Name = "cableTypeDgvCabBranches";
			this.dataGridViewTextBoxColumn_102.ReadOnly = true;
			this.dataGridViewTextBoxColumn_103.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			this.dataGridViewTextBoxColumn_103.DataPropertyName = "wireGauge";
			this.dataGridViewTextBoxColumn_103.HeaderText = "Сечение";
			this.dataGridViewTextBoxColumn_103.MinimumWidth = 30;
			this.dataGridViewTextBoxColumn_103.Name = "wireGaugeDgvCabBranches";
			...
			this.dataGridViewTextBoxColumn_104.DataPropertyName = "cableLength";
			this.dataGridViewTextBoxColumn_104.HeaderText = "Длина кабеля, м";
			this.dataGridViewTextBoxColumn_104.MinimumWidth = 30;
			this.dataGridViewTextBoxColumn_104.Name = "cableLengthDgvCabBranches";
			...
			this.label_4.Location = new Point(23, 87);
			this.label_4.Name = "label5";
			this.label_4.Size = new Size(83, 34);
			this.label_4.TabIndex = 12;
			this.label_4.Text = "Номер";
			this.label_4.TextAlign = ContentAlignment.MiddleLeft;
			this.textBox_1.DataBindings.Add(new Binding("Text", this.dsPassport_0, "tP_Passport.Number", true));
			this.textBox_1.Dock = DockStyle.Fill;
			this.textBox_1.Location = new Point(112, 94);
			this.textBox_1.Margin = new Padding(3, 7, 3, 3);
			this.textBox_1.Name = "txtNumber";
			this.textBox_1.Size = new Size(100, 20);
			this.textBox_1.TabIndex = 13;
			this.tableLayoutPanel_1.ColumnCount = 1;
			this.tableLayoutPanel_0.SetColumnSpan(this.tableLayoutPanel_1, 3);
			this.tableLayoutPanel_1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100f));
			this.tableLayoutPanel_1.Controls.Add(this.comboBox_1, 0, 1);
			this.tableLayoutPanel_1.Controls.Add(this.textBox_0, 0, 0);
			this.tableLayoutPanel_1.Location = new Point(112, 13);
			...
			this.tableLayoutPanel_1.RowStyles.Add(new RowStyle());
			this.tableLayoutPanel_1.Size = new Size(164, 21);
			this.tableLayoutPanel_1.TabIndex = 14;
			...
			this.textBox_0.DataBindings.Add(new Binding("Text", this.bindingSource_2, "Name", true));
			...
			this.textBox_0.Size = new Size(164, 20);
			this.textBox_0.TabIndex = 6;
			this.dataGridViewTextBoxColumn_221.HeaderText = "idChar";
			this.dataGridViewTextBoxColumn_221.Name = "dataGridViewTextBoxColumn191";
			...
			this.dataGridViewTextBoxColumn_222.HeaderText = "ParentIdChar";
			this.dataGridViewTextBoxColumn_222.Name = "dataGridViewTextBoxColumn192";
			...
			this.dataGridViewTextBoxColumn_223.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_223.Name = "dataGridViewTextBoxColumn193";
			...
			this.dataGridViewTextBoxColumn_224.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
			this.dataGridViewTextBoxColumn_224.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_224.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_224.Name = "dataGridViewTextBoxColumn194";
			...
			this.dataGridViewTextBoxColumn_225.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			this.dataGridViewTextBoxColumn_225.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_225.Name = "dataGridViewTextBoxColumn195";
			...
			this.dataGridViewTextBoxColumn_216.Name = "dataGridViewTextBoxColumn186";
			...
			this.dataGridViewTextBoxColumn_217.Name = "dataGridViewTextBoxColumn187";
			...
			this.dataGridViewTextBoxColumn_218.Name = "dataGridViewTextBoxColumn188";
			...
			this.dataGridViewTextBoxColumn_219.Name = "dataGridViewTextBoxColumn189";
			...
			this.dataGridViewTextBoxColumn_220.Name = "dataGridViewTextBoxColumn190";
			...
			this.dataGridViewTextBoxColumn_211.HeaderText = "idChar";
			this.dataGridViewTextBoxColumn_211.Name = "dataGridViewTextBoxColumn181";
			...
			this.dataGridViewTextBoxColumn_212.HeaderText = "ParentIdChar";
			this.dataGridViewTextBoxColumn_212.Name = "dataGridViewTextBoxColumn182";
			...
			this.dataGridViewTextBoxColumn_213.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_213.Name = "dataGridViewTextBoxColumn183";
			...
			this.dataGridViewTextBoxColumn_214.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
			this.dataGridViewTextBoxColumn_214.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_214.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_214.Name = "dataGridViewTextBoxColumn184";
			...
			this.dataGridViewTextBoxColumn_215.Name = "dataGridViewTextBoxColumn185";
			...
			this.dataGridViewTextBoxColumn_206.HeaderText = "idChar";
			this.dataGridViewTextBoxColumn_206.Name = "dataGridViewTextBoxColumn176";
			...
			this.dataGridViewTextBoxColumn_207.HeaderText = "ParentIdChar";
			this.dataGridViewTextBoxColumn_207.Name = "dataGridViewTextBoxColumn177";
			...
			this.dataGridViewTextBoxColumn_208.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_208.Name = "dataGridViewTextBoxColumn178";
			...
			this.dataGridViewTextBoxColumn_209.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
			this.dataGridViewTextBoxColumn_209.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_209.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_209.Name = "dataGridViewTextBoxColumn179";
			...
			this.dataGridViewTextBoxColumn_210.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_210.Name = "dataGridViewTextBoxColumn180";
			...
			this.dataGridViewTextBoxColumn_201.HeaderText = "idChar";
			this.dataGridViewTextBoxColumn_201.Name = "dataGridViewTextBoxColumn171";
			...
			this.dataGridViewTextBoxColumn_202.HeaderText = "ParentIdChar";
			this.dataGridViewTextBoxColumn_202.Name = "dataGridViewTextBoxColumn172";
			...
			this.dataGridViewTextBoxColumn_203.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_203.Name = "dataGridViewTextBoxColumn173";
			...
			this.dataGridViewTextBoxColumn_204.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
			this.dataGridViewTextBoxColumn_204.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_204.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_204.Name = "dataGridViewTextBoxColumn174";
			...
			this.dataGridViewTextBoxColumn_205.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			this.dataGridViewTextBoxColumn_205.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_205.Name = "dataGridViewTextBoxColumn175";
			...
			this.dataGridViewTextBoxColumn_196.HeaderText = "idChar";
			this.dataGridViewTextBoxColumn_196.Name = "dataGridViewTextBoxColumn166";
			...
			this.dataGridViewTextBoxColumn_197.HeaderText = "ParentIdChar";
			this.dataGridViewTextBoxColumn_197.Name = "dataGridViewTextBoxColumn167";
			...
			this.dataGridViewTextBoxColumn_198.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_198.Name = "dataGridViewTextBoxColumn168";
			...
			this.dataGridViewTextBoxColumn_199.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
			this.dataGridViewTextBoxColumn_199.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_199.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_199.Name = "dataGridViewTextBoxColumn169";
			...
			this.dataGridViewTextBoxColumn_200.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			this.dataGridViewTextBoxColumn_200.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_200.Name = "dataGridViewTextBoxColumn170";
			...
			this.dataGridViewTextBoxColumn_191.HeaderText = "idChar";
			this.dataGridViewTextBoxColumn_191.Name = "dataGridViewTextBoxColumn161";
			...
			this.dataGridViewTextBoxColumn_192.HeaderText = "ParentIdChar";
			this.dataGridViewTextBoxColumn_192.Name = "dataGridViewTextBoxColumn162";
			...
			this.dataGridViewTextBoxColumn_193.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_193.Name = "dataGridViewTextBoxColumn163";
			...
			this.dataGridViewTextBoxColumn_194.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
			this.dataGridViewTextBoxColumn_194.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_194.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_194.Name = "dataGridViewTextBoxColumn164";
			...
			this.dataGridViewTextBoxColumn_195.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			this.dataGridViewTextBoxColumn_195.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_195.Name = "dataGridViewTextBoxColumn165";
			...
			this.dataGridViewTextBoxColumn_180.Name = "dataGridViewTextBoxColumn156";
			...
			this.dataGridViewTextBoxColumn_181.Name = "dataGridViewTextBoxColumn157";
			...
			this.dataGridViewTextBoxColumn_182.Name = "dataGridViewTextBoxColumn158";
			...
			this.dataGridViewTextBoxColumn_183.Name = "dataGridViewTextBoxColumn159";
			...
			this.dataGridViewTextBoxColumn_184.Name = "dataGridViewTextBoxColumn160";
			...
			this.dataGridViewTextBoxColumn_175.Name = "dataGridViewTextBoxColumn151";
			...
			this.dataGridViewTextBoxColumn_176.Name = "dataGridViewTextBoxColumn152";
			...
			this.dataGridViewTextBoxColumn_177.Name = "dataGridViewTextBoxColumn153";
			...
			this.dataGridViewTextBoxColumn_178.Name = "dataGridViewTextBoxColumn154";
			...
			this.dataGridViewTextBoxColumn_179.Name = "dataGridViewTextBoxColumn155";
			...
			this.dataGridViewTextBoxColumn_170.Name = "dataGridViewTextBoxColumn146";
			...
			this.dataGridViewTextBoxColumn_171.Name = "dataGridViewTextBoxColumn147";
			...
			this.dataGridViewTextBoxColumn_172.Name = "dataGridViewTextBoxColumn148";
			...
			this.dataGridViewTextBoxColumn_173.Name = "dataGridViewTextBoxColumn149";
			...
			this.dataGridViewTextBoxColumn_174.Name = "dataGridViewTextBoxColumn150";
			...
			this.dataGridViewTextBoxColumn_165.Name = "dataGridViewTextBoxColumn141";
			...
			this.dataGridViewTextBoxColumn_166.Name = "dataGridViewTextBoxColumn142";
			...
			this.dataGridViewTextBoxColumn_167.Name = "dataGridViewTextBoxColumn143";
			...
			this.dataGridViewTextBoxColumn_168.Name = "dataGridViewTextBoxColumn144";
			...
			this.dataGridViewTextBoxColumn_169.Name = "dataGridViewTextBoxColumn145";
			...
			this.dataGridViewTextBoxColumn_160.Name = "dataGridViewTextBoxColumn136";
			...
			this.dataGridViewTextBoxColumn_161.Name = "dataGridViewTextBoxColumn137";
			...
			this.dataGridViewTextBoxColumn_162.Name = "dataGridViewTextBoxColumn138";
			...
			this.dataGridViewTextBoxColumn_163.Name = "dataGridViewTextBoxColumn139";
			...
			this.dataGridViewTextBoxColumn_164.Name = "dataGridViewTextBoxColumn140";
			...
			this.dataGridViewTextBoxColumn_155.Name = "dataGridViewTextBoxColumn131";
			...
			this.dataGridViewTextBoxColumn_156.Name = "dataGridViewTextBoxColumn132";
			...
			this.dataGridViewTextBoxColumn_157.Name = "dataGridViewTextBoxColumn133";
			...
			this.dataGridViewTextBoxColumn_158.Name = "dataGridViewTextBoxColumn134";
			...
			this.dataGridViewTextBoxColumn_159.Name = "dataGridViewTextBoxColumn135";
			...
			this.dataGridViewTextBoxColumn_150.Name = "dataGridViewTextBoxColumn126";
			...
			this.dataGridViewTextBoxColumn_151.Name = "dataGridViewTextBoxColumn127";
			...
			this.dataGridViewTextBoxColumn_152.Name = "dataGridViewTextBoxColumn128";
			...
			this.dataGridViewTextBoxColumn_153.Name = "dataGridViewTextBoxColumn129";
			...
			this.dataGridViewTextBoxColumn_154.Name = "dataGridViewTextBoxColumn130";
			...
			this.dataGridViewTextBoxColumn_145.Name = "dataGridViewTextBoxColumn121";
			...
			this.dataGridViewTextBoxColumn_146.Name = "dataGridViewTextBoxColumn122";
			...
			this.dataGridViewTextBoxColumn_147.Name = "dataGridViewTextBoxColumn123";
			...
			this.dataGridViewTextBoxColumn_148.Name = "dataGridViewTextBoxColumn124";
			...
			this.dataGridViewTextBoxColumn_149.Name = "dataGridViewTextBoxColumn125";
			...
			this.dataGridViewTextBoxColumn_140.Name = "dataGridViewTextBoxColumn116";
			...
			this.dataGridViewTextBoxColumn_141.Name = "dataGridViewTextBoxColumn117";
			...
			this.dataGridViewTextBoxColumn_142.Name = "dataGridViewTextBoxColumn118";
			...
			this.dataGridViewTextBoxColumn_143.Name = "dataGridViewTextBoxColumn119";
			...
			this.dataGridViewTextBoxColumn_144.Name = "dataGridViewTextBoxColumn120";
			...
			this.dataGridViewTextBoxColumn_135.Name = "dataGridViewTextBoxColumn111";
			...
			this.dataGridViewTextBoxColumn_136.Name = "dataGridViewTextBoxColumn112";
			...
			this.dataGridViewTextBoxColumn_137.Name = "dataGridViewTextBoxColumn113";
			...
			this.dataGridViewTextBoxColumn_138.Name = "dataGridViewTextBoxColumn114";
			...
			this.dataGridViewTextBoxColumn_139.Name = "dataGridViewTextBoxColumn115";
			...
			this.dataGridViewTextBoxColumn_130.Name = "dataGridViewTextBoxColumn106";
			...
			this.dataGridViewTextBoxColumn_131.Name = "dataGridViewTextBoxColumn107";
			...
			this.dataGridViewTextBoxColumn_132.Name = "dataGridViewTextBoxColumn108";
			...
			this.dataGridViewTextBoxColumn_133.Name = "dataGridViewTextBoxColumn109";
			...
			this.dataGridViewTextBoxColumn_134.Name = "dataGridViewTextBoxColumn110";
			...
			this.dataGridViewTextBoxColumn_125.Name = "dataGridViewTextBoxColumn101";
			...
			this.dataGridViewTextBoxColumn_126.Name = "dataGridViewTextBoxColumn102";
			...
			this.dataGridViewTextBoxColumn_127.Name = "dataGridViewTextBoxColumn103";
			...
			this.dataGridViewTextBoxColumn_128.Name = "dataGridViewTextBoxColumn104";
			...
			this.dataGridViewTextBoxColumn_129.Name = "dataGridViewTextBoxColumn105";
			...
			this.dataGridViewTextBoxColumn_120.Name = "dataGridViewTextBoxColumn96";
			...
			this.dataGridViewTextBoxColumn_121.Name = "dataGridViewTextBoxColumn97";
			...
			this.dataGridViewTextBoxColumn_122.Name = "dataGridViewTextBoxColumn98";
			...
			this.dataGridViewTextBoxColumn_123.Name = "dataGridViewTextBoxColumn99";
			...
			this.dataGridViewTextBoxColumn_124.Name = "dataGridViewTextBoxColumn100";
			...
			this.dataGridViewTextBoxColumn_115.Name = "dataGridViewTextBoxColumn91";
			...
			this.dataGridViewTextBoxColumn_116.Name = "dataGridViewTextBoxColumn92";
			...
			this.dataGridViewTextBoxColumn_117.Name = "dataGridViewTextBoxColumn93";
			...
			this.dataGridViewTextBoxColumn_118.Name = "dataGridViewTextBoxColumn94";
			...
			this.dataGridViewTextBoxColumn_119.Name = "dataGridViewTextBoxColumn95";
			...
			this.dataGridViewTextBoxColumn_110.Name = "dataGridViewTextBoxColumn86";
			...
			this.dataGridViewTextBoxColumn_111.Name = "dataGridViewTextBoxColumn87";
			...
			this.dataGridViewTextBoxColumn_112.Name = "dataGridViewTextBoxColumn88";
			...
			this.dataGridViewTextBoxColumn_113.Name = "dataGridViewTextBoxColumn89";
			...
			this.dataGridViewTextBoxColumn_114.Name = "dataGridViewTextBoxColumn90";
			...
			this.dataGridViewTextBoxColumn_105.Name = "dataGridViewTextBoxColumn81";
			...
			this.dataGridViewTextBoxColumn_106.Name = "dataGridViewTextBoxColumn82";
			...
			this.dataGridViewTextBoxColumn_107.Name = "dataGridViewTextBoxColumn83";
			...
			this.dataGridViewTextBoxColumn_108.Name = "dataGridViewTextBoxColumn84";
			...
			this.dataGridViewTextBoxColumn_109.Name = "dataGridViewTextBoxColumn85";
			...
			this.dataGridViewTextBoxColumn_85.HeaderText = "id";
			this.dataGridViewTextBoxColumn_85.Name = "idDgvAttachment";
			...
			this.dataGridViewTextBoxColumn_86.HeaderText = "idObjList";
			this.dataGridViewTextBoxColumn_86.Name = "idObjListDgvAttachment";
			this.dataGridViewTextBoxColumn_86.ReadOnly = true;
			this.dataGridViewTextBoxColumn_86.Visible = false;
			this.dataGridViewTextBoxColumn_87.DataPropertyName = "idClutchFirst";
			this.dataGridViewTextBoxColumn_87.HeaderText = "idClutchFirst";
			this.dataGridViewTextBoxColumn_87.Name = "idClutchFirstDgvAttachment";
			this.dataGridViewTextBoxColumn_87.ReadOnly = true;
			this.dataGridViewTextBoxColumn_87.Visible = false;
			this.dataGridViewTextBoxColumn_88.DataPropertyName = "idClutchSecond";
			this.dataGridViewTextBoxColumn_88.HeaderText = "idClutchSecond";
			this.dataGridViewTextBoxColumn_88.Name = "idClutchSecondDgvAttachment";
			this.dataGridViewTextBoxColumn_88.ReadOnly = true;
			this.dataGridViewTextBoxColumn_88.Visible = false;
			this.dataGridViewTextBoxColumn_89.DataPropertyName = "idEquipment";
			this.dataGridViewTextBoxColumn_89.HeaderText = "idEquipment";
			this.dataGridViewTextBoxColumn_89.Name = "idEquipmentDgvAttachment";
			...
			this.dataGridViewTextBoxColumn_90.DataPropertyName = "AirLineName";
			this.dataGridViewTextBoxColumn_90.HeaderText = "Линия";
			this.dataGridViewTextBoxColumn_90.MinimumWidth = 20;
			this.dataGridViewTextBoxColumn_90.Name = "airLineNameDgvAttachment";
			...
			this.dataGridViewTextBoxColumn_91.DataPropertyName = "fPole";
			this.dataGridViewTextBoxColumn_91.HeaderText = "Опора №1";
			this.dataGridViewTextBoxColumn_91.MinimumWidth = 20;
			this.dataGridViewTextBoxColumn_91.Name = "fPoleDgvAttachment";
			...
			this.dataGridViewTextBoxColumn_92.DataPropertyName = "sPole";
			this.dataGridViewTextBoxColumn_92.HeaderText = "Опора №2";
			this.dataGridViewTextBoxColumn_92.MinimumWidth = 20;
			this.dataGridViewTextBoxColumn_92.Name = "sPoleDgvAttachment";
			this.dataGridViewTextBoxColumn_92.ReadOnly = true;
			this.dataGridViewTextBoxColumn_93.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			this.dataGridViewTextBoxColumn_93.DataPropertyName = "CableMakeup";
			this.dataGridViewTextBoxColumn_93.HeaderText = "Марка кабеля";
			this.dataGridViewTextBoxColumn_93.MinimumWidth = 20;
			this.dataGridViewTextBoxColumn_93.Name = "cableMakeupDgvAttachment";
			...
			this.dataGridViewTextBoxColumn_185.HeaderText = "id";
			this.dataGridViewTextBoxColumn_185.Name = "idDgvEquip";
			this.dataGridViewTextBoxColumn_185.ReadOnly = true;
			this.dataGridViewTextBoxColumn_185.Visible = false;
			this.dataGridViewTextBoxColumn_186.DataPropertyName = "idEquipment";
			this.dataGridViewTextBoxColumn_186.HeaderText = "idEquipment";
			this.dataGridViewTextBoxColumn_186.Name = "idEquipmentDgvEquip";
			this.dataGridViewTextBoxColumn_186.ReadOnly = true;
			this.dataGridViewTextBoxColumn_186.Visible = false;
			this.dataGridViewTextBoxColumn_187.DataPropertyName = "idObjList";
			this.dataGridViewTextBoxColumn_187.HeaderText = "idObjList";
			this.dataGridViewTextBoxColumn_187.Name = "idObjListDgvEquip";
			this.dataGridViewTextBoxColumn_187.ReadOnly = true;
			this.dataGridViewTextBoxColumn_187.Visible = false;
			this.dataGridViewTextBoxColumn_188.DataPropertyName = "idPylon";
			this.dataGridViewTextBoxColumn_188.HeaderText = "idPylon";
			this.dataGridViewTextBoxColumn_188.Name = "idPylonDgvEquip";
			this.dataGridViewTextBoxColumn_188.ReadOnly = true;
			this.dataGridViewTextBoxColumn_188.Visible = false;
			this.dataGridViewTextBoxColumn_189.DataPropertyName = "typeCodeName";
			this.dataGridViewTextBoxColumn_189.HeaderText = "Оборудование";
			this.dataGridViewTextBoxColumn_189.Name = "typeCodeNameDgvEquip";
			this.dataGridViewTextBoxColumn_189.ReadOnly = true;
			this.dataGridViewTextBoxColumn_190.DataPropertyName = "Name";
			this.dataGridViewTextBoxColumn_190.HeaderText = "Наименование";
			this.dataGridViewTextBoxColumn_190.Name = "NameDgvEquip";
			...
			this.toolStrip_1.Name = "tsEquipment";
			this.toolStrip_1.Size = new Size(461, 25);
			...
			this.Text = "1";
			base.Load += this.FormAddEditPylone_Load;
		...
		[CompilerGenerated]
		private AirLinePole airLinePole_0;

		private string string_0 = string.Empty;

		internal FormAddEditCabBranch formAddEditCabBranch_0;
