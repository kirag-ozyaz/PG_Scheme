...
namespace Passport.Forms.AirLine.Report
{
	public class FormAirLinePassport : FormBase
	{
		...
		private void method_1()
		{
			...
			this.int_1 = ObjectBase.GetTypeCodeId(this.SqlSettings, ";SCM;Pole;", 1m);
		...
		private DataTable method_2()
		{
			...
			dataTable2 = PassportData.GetEquipmentData(this.SqlSettings, this.int_1, ", Number", ", p.Number", "WHERE ol.id = " + this.int_0.ToString(), "", false);
		...
		private DataTable method_7(string string_0)
		{
			...
			using (DataTable dataTable = base.SelectSqlData("tr_Classifier", true, "WHERE ParentKey = ';SCM;Pole;' and isGroup = 0"))
			{
				...
				this.int_1 = (int)dataTable.Rows[0]["id"];
			}
			string text5 = this.method_8(this.int_1, "");
			string text6 = this.method_8(this.int_1, "pvt");
		...
		private string method_8(int int_2, string string_0)
		{
			string result;
			using (SqlConnection sqlConnection = new SqlConnection(this.SqlSettings.GetConnectionString()))
			{
		...
		private FormGeneralPassport.FormatReport formatReport_0 = FormGeneralPassport.FormatReport.A4;
