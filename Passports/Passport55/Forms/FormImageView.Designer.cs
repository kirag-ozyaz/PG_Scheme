...
namespace Passport.Forms
{
	public class FormImageView : FormBase
	{
		...
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_Image, true, "WHERE id = " + ((DataRowView)this.bindingSource_0.Current)["id"].ToString());
		}
		...
		private void method_2()
		{
			...
			this.pictureBox_0.DataBindings.Add(new Binding("Image", this.dsPassport_0, "tP_Image.Image", true));
