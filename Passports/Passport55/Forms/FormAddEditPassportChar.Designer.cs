...
namespace Passport.Forms
{
	public class FormAddEditPassportChar : FormBase
	{
		...
		public FormAddEditPassportChar(SQLSettings settings, StateFormCreate state, int int_9, int tabIndex)
		{
			this.method_31();
		...
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_CharList, true, "where id = " + int_9.ToString());
			this.textBox_2.Text = this.dsPassport_0.tP_CharList.Rows[0]["Name"].ToString();
			this.comboBox_1.SelectedIndex = 0;
			this.comboBox_0.SelectedIndex = 0;
			this.comboBox_1.Enabled = false;
			this.string_0 = this.dsPassport_0.tP_CharList.Rows[0]["ParentKey"].ToString();
		}

		private void method_2(int int_9)
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.vP_ParameterEdit, true, "where id = " + int_9.ToString());
			this.textBox_2.Text = this.dsPassport_0.vP_ParameterEdit.Rows[0]["ParentName"].ToString();
			this.textBox_1.Text = this.dsPassport_0.vP_ParameterEdit.Rows[0]["Name"].ToString();
			this.textBox_0.Text = this.dsPassport_0.vP_ParameterEdit.Rows[0]["ShortName"].ToString();
			this.comboBox_1.SelectedValue = (int)this.dsPassport_0.vP_ParameterEdit.Rows[0]["Type"];
			this.comboBox_0.SelectedValue = (int)this.dsPassport_0.vP_ParameterEdit.Rows[0]["Format"];
			this.comboBox_1.Enabled = false;
			this.string_0 = this.dsPassport_0.vP_ParameterEdit.Rows[0]["ParentKey"].ToString();
			this.richTextBox_0.Text = this.dsPassport_0.vP_ParameterEdit.Rows[0]["Comment"].ToString();
		}

		private void method_3(int int_9)
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_CharList, true, "where id = " + int_9);
			this.textBox_2.Text = this.dsPassport_0.tP_CharList.Rows[0]["Name"].ToString();
			this.comboBox_1.SelectedValue = (int)this.dsPassport_0.tP_CharList.Rows[0]["Type"];
			this.comboBox_0.SelectedValue = (int)this.dsPassport_0.tP_CharList.Rows[0]["Format"];
		...
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.vP_ParameterEdit, true, "where id = " + int_9);
			this.textBox_2.Text = this.dsPassport_0.vP_ParameterEdit.Rows[0]["ParentName"].ToString();
			this.textBox_1.Text = this.dsPassport_0.vP_ParameterEdit.Rows[0]["Name"].ToString();
			this.textBox_0.Text = this.dsPassport_0.vP_ParameterEdit.Rows[0]["ShortName"].ToString();
			this.comboBox_3.SelectedValue = ((this.dsPassport_0.vP_ParameterEdit.Rows[0]["Dimention"] == DBNull.Value) ? -1 : ((int)this.dsPassport_0.vP_ParameterEdit.Rows[0]["Dimention"]));
			this.checkBox_0.Checked = (bool)this.dsPassport_0.vP_ParameterEdit.Rows[0]["UseDimention"];
			this.comboBox_1.SelectedValue = (int)this.dsPassport_0.vP_ParameterEdit.Rows[0]["Type"];
			this.int_8 = (int)this.comboBox_1.SelectedValue;
			this.comboBox_0.SelectedValue = (int)this.dsPassport_0.vP_ParameterEdit.Rows[0]["Format"];
			if (int.TryParse(this.dsPassport_0.vP_ParameterEdit.Rows[0]["idValueList"].ToString(), out this.int_6))
			{
		...
		{
			base.SelectSqlDataTableOther(this.dsPassport_0, this.dsPassport_0.tR_ParameterTypes, "tR_Classifier", true, "where ParentKey like ';Passport;DataType;' and deleted = 0 and isGroup = 0 order by Name");
			base.SelectSqlDataTableOther(this.dsPassport_0, this.dsPassport_0.tR_ParameterFormat, "tR_Classifier", true, "where (ParentKey like ';Passport;DateFormat;' or ParentKey like ';Passport;DigitFormat;')\r\nand deleted = 0 and isGroup = 0 order by Name");
			base.SelectSqlDataTableOther(this.dsPassport_0, this.dsPassport_0.vP_GetGroupList, "vP_GetValueList", true, "where isGroup = ((1)) and deleted = ((0)) order by Name");
			this.comboBox_1.DataSource = this.dsPassport_0.tR_ParameterTypes;
			this.comboBox_1.DisplayMember = "Name";
			this.comboBox_1.ValueMember = "id";
			BindingSource bindingSource = new BindingSource();
			bindingSource.DataSource = this.dsPassport_0.tR_ParameterFormat;
			this.comboBox_0.DataSource = bindingSource;
			this.comboBox_0.DisplayMember = "Name";
			this.comboBox_0.ValueMember = "id";
			this.comboBox_2.DataSource = this.dsPassport_0.vP_GetGroupList;
		...
		{
			dsPassport.Class91 @class = this.dsPassport_0.tP_CharList.method_5();
			...
			this.dsPassport_0.tP_CharList.method_0(@class);
			this.Id = base.InsertSqlDataOneRow(this.dsPassport_0, this.dsPassport_0.tP_CharList);
			return this.Id != -1;
		}

		private bool method_8(int int_9)
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_CharList, true, string.Format("where id = {0}", int_9.ToString()));
			foreach (object obj in this.dsPassport_0.tP_CharList.Rows)
			{
				dsPassport.Class91 @class = (dsPassport.Class91)obj;
				@class.Name = this.textBox_1.Text;
				@class.ShortName = this.textBox_0.Text;
				@class.Comment = this.richTextBox_0.Text;
			}
			return base.UpdateSqlData(this.dsPassport_0, this.dsPassport_0.tP_CharList);
		}
		...
		private bool method_10(int int_9)
		{
			...
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_CharList, true, "where id = " + int_9.ToString());
			this.dsPassport_0.tP_CharList.Rows[0]["Name"] = this.textBox_1.Text;
			this.dsPassport_0.tP_CharList.Rows[0]["ShortName"] = this.textBox_0.Text;
			this.dsPassport_0.tP_CharList.Rows[0]["Type"] = this.comboBox_1.SelectedValue;
			this.dsPassport_0.tP_CharList.Rows[0]["Format"] = this.comboBox_0.SelectedValue;
			if (this.comboBox_3.SelectedValue != null && int.TryParse(this.comboBox_3.SelectedValue.ToString(), out num) && num != -1)
			{
				this.dsPassport_0.tP_CharList.Rows[0]["Dimention"] = num;
			}
			this.dsPassport_0.tP_CharList.Rows[0]["UseDimention"] = this.checkBox_0.Checked;
			this.dsPassport_0.tP_CharList.Rows[0]["idValueList"] = this.int_3;
			this.dsPassport_0.tP_CharList.Rows[0]["TableName"] = this.GetValueListTableName(this.int_3);
			this.dsPassport_0.tP_CharList.Rows[0]["Comment"] = this.richTextBox_0.Text;
			return base.UpdateSqlData(this.dsPassport_0, this.dsPassport_0.tP_CharList);
		}
		...
		public TableNameEnum GetValueListTableName(int int_9)
		{
			FormAddEditPassportChar.Class128 @class = new FormAddEditPassportChar.Class128();
			@class.int_0 = int_9;
			EnumerableRowCollection<dsPassport.Class32> source = this.dsPassport_0.vP_GetGroupList.Where(new Func<dsPassport.Class32, bool>(@class.method_0));
			if (source.Count<dsPassport.Class32>() <= 0)
			{
				return TableNameEnum.None;
			}
			this.TableName = source.First<dsPassport.Class32>().TableName;
			string tableName = source.First<dsPassport.Class32>().TableName;
		...
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.vP_GetValueList, true, "WHERE ParentId = " + int_9.ToString() + " AND Deleted = ((0)) ORDER BY Name");
			this.dataGridView_0.DataSource = this.dsPassport_0.vP_GetValueList;
		}

		private int method_23(string string_2)
		{
			FormAddEditPassportChar.Class129 @class = new FormAddEditPassportChar.Class129();
			@class.string_0 = string_2;
			EnumerableRowCollection<int> source = this.dsPassport_0.tR_ParameterTypes.Where(new Func<dsPassport.Class26, bool>(@class.method_0)).Select(new Func<dsPassport.Class26, int>(FormAddEditPassportChar.<>c.<>9.method_0));
		...
		private string method_25(string string_2, string string_3)
		{
			...
			return string_2 + string.Join("", array.Select(new Func<string, string>(FormAddEditPassportChar.<>c.<>9.method_1)).ToArray<string>()) + ";";
		}

		private int method_26(int int_9)
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_CharList, true, string.Format("where id = {0}", int_9), true);
			if (this.dsPassport_0.tP_CharList.Rows.Count > 0)
			{
				return (int)this.dsPassport_0.tP_CharList.Rows[0]["ParentIdValue"];
			}
			return -1;
		}

		public static string FirstUpper(string string_2)
		{
			return string_2.Substring(0, 1).ToUpper() + ((string_2.Length > 1) ? string_2.Substring(1) : "");
		}
		...
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tAbn, true, "WHERE Id = " + this.dataGridView_0.SelectedRows[0].Cells["idValue"].Value.ToString());
			if (this.dsPassport_0.tAbn.Rows.Count <= 0)
			{
				return false;
			}
			((dsPassport.Class16)this.dsPassport_0.tAbn.Rows[0]).method_7(true);
			return base.UpdateSqlData(this.dsPassport_0, this.dsPassport_0.tAbn);
		}

		private bool method_30(int int_9)
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_ValueLists, true, "WHERE Id = " + this.dataGridView_0.SelectedRows[0].Cells["idValue"].Value.ToString());
			if (this.dsPassport_0.tP_ValueLists.Rows.Count <= 0)
			{
				return false;
			}
			((dsPassport.Class79)this.dsPassport_0.tP_ValueLists.Rows[0]).method_5(true);
			return base.UpdateSqlData(this.dsPassport_0, this.dsPassport_0.tP_ValueLists);
		}
		...
		private void method_31()
		{
			...
			this.label_7.Location = new Point(6, 134);
			this.label_7.Name = "lbDimention";
			this.label_7.Size = new Size(75, 13);
			this.label_7.TabIndex = 17;
			this.label_7.Text = "Размерность";
			...
			this.label_2.Location = new Point(6, 55);
			this.label_2.Name = "lbSocrName";
			this.label_2.Size = new Size(109, 13);
			this.label_2.TabIndex = 2;
			this.label_2.Text = "Сокр наименование";
			...
			this.richTextBox_0.Location = new Point(9, 190);
			this.richTextBox_0.Name = "rtbComment";
			this.richTextBox_0.Size = new Size(233, 71);
			this.richTextBox_0.TabIndex = 9;
			this.richTextBox_0.Text = "";
			this.label_3.AutoSize = true;
			this.label_3.Location = new Point(6, 174);
			this.label_3.Name = "lbComment";
			...
			this.label_5.Location = new Point(15, 14);
			this.label_5.Name = "lbParent";
			this.label_5.Size = new Size(42, 13);
			this.label_5.TabIndex = 20;
			this.label_5.Text = "Группа";
			...
			this.toolStripMenuItem_1.Image = Resources.FolderAddYellow;
			...
			this.label_6.Location = new Point(20, 37);
			this.label_6.Name = "label2";
			this.label_6.Size = new Size(94, 13);
			this.label_6.TabIndex = 25;
			this.label_6.Text = "Список значений";
		...
		{
			internal bool method_0(dsPassport.Class32 class32_0)
			{
				return class32_0.Int32_0 == this.int_0;
			}
		...
		{
			internal bool method_0(dsPassport.Class26 class26_0)
			{
				return class26_0.Name == this.string_0;
			}
