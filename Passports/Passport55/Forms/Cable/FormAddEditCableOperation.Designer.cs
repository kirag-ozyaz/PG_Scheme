...
namespace Passport.Forms.Cable
{
	public class FormAddEditCableOperation : FormBase
	{
		...
		private void FormAddEditCableOperation_Load(object sender, EventArgs e)
		{
			...
			base.SelectSqlData(this.dsPassport_0.tP_CabOperation, true, string.Format(" where  idObjList = {0} and deleted = 0  order by Convert(datetime, dateDecommissioning, 104) desc", this.int_1), false);
			this.dateTimePicker_1.MinDate = this.dateTimePicker_0.Value;
		}

		private void method_0()
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_ValueLists, true, "WHERE ParentKey = ';Cable;Addl;OperReason;' AND Deleted = ((0)) and isgroup = 0 order by Name");
			this.comboBox_0.DataSource = this.dsPassport_0.tP_ValueLists;
		...
		{
			DataRow dataRow = this.dsPassport_0.tP_CabOperation.NewRow();
			...
			dataRow["deleted"] = 0;
			this.dsPassport_0.tP_CabOperation.Rows.Add(dataRow);
			this.dsPassport_0.tP_CabOperation.Rows[0].EndEdit();
			this.int_0 = base.InsertSqlDataOneRow(this.dsPassport_0.tP_CabOperation.Rows[0]);
			return this.int_0 >= 1;
		}

		private bool method_3()
		{
			this.dsPassport_0.tP_CabOperation.Rows[0]["dateCommissioning"] = this.dateTimePicker_1.Value;
			this.dsPassport_0.tP_CabOperation.Rows[0].EndEdit();
			return base.UpdateSqlDataOnlyChange(this.dsPassport_0.tP_CabOperation);
		}
		...
		private void method_5()
		{
			...
			base.SuspendLayout();
			this.dateTimePicker_0.DataBindings.Add(new Binding("Value", this.dsPassport_0, "tP_CabOperation.DateDecommissioning", true));
			...
			this.dateTimePicker_1.DataBindings.Add(new Binding("Value", this.dsPassport_0, "tP_CabOperation.DateCommissioning", true));
			...
			this.comboBox_0.DataBindings.Add(new Binding("SelectedValue", this.dsPassport_0, "tP_CabOperation.Reason", true));
