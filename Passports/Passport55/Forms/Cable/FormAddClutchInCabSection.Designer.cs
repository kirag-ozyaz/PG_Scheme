		...
		private void FormAddClutchInCabSection_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (base.DialogResult == DialogResult.OK)
			{
				...
				if (this.panelClutch_0.CreateState != 7)
				{
					...
					if (!Class109.smethod_2(this.SqlSettings, this.int_0, id, this.decimal_0, this.decimal_1))
					{
				...
				else
				{
					...
					if (!Class109.smethod_2(this.SqlSettings, this.int_0, id2, this.decimal_0, this.decimal_1))
					{
						MessageBox.Show("Ошибка при делении участка.", "Ошибка.", MessageBoxButtons.OK, MessageBoxIcon.Hand);
					}
				}
				Class110.smethod_2(this.SqlSettings, this.int_2, 0);
			}
