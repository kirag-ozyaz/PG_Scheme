...
namespace Passport.Forms.Cable
{
	public class FormAddEditCabPerambulation : FormBase
	{
		...
		public FormAddEditCabPerambulation(SQLSettings settings, int int_2, StateFormCreate state)
		{
			this.method_6();
			this.SqlSettings = settings;
			this.Id = ((state == 1) ? int_2 : -1);
			this.IdObjList = ((state == null) ? int_2 : -1);
			this.StateCreate = state;
		}

		private void FormAddEditCabPerambulation_Load(object sender, EventArgs e)
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.vP_Worker, true, string.Format("WHERE ParentKey = ';GroupWorker;CableService;Check;'", new object[0]));
			if (this.StateCreate == 1)
			{
				this.method_0();
				return;
			}
			dsPassport.Class82 @class = this.dsPassport_0.tP_CabPerambulation.method_5();
			@class.method_1(this.IdObjList);
			@class.method_5(false);
			this.dsPassport_0.tP_CabPerambulation.method_0(@class);
		}

		private void method_0()
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_CabPerambulation, true, string.Format("WHERE id = {0} AND Deleted = ((0))", this.Id));
		...
		{
			base.SelectSqlData(this.dsPassport_0, this.dsPassport_0.tP_CabPeramWorker, true, string.Format("WHERE idPerambulation = {0} AND Deleted = ((0))", (int)this.dsPassport_0.tP_CabPerambulation.Rows[0]["id"]));
		...
		private void method_2()
		{
			...
			{
				SqlCommand selectCommand = new SqlCommand(string.Format("SELECT [id],[idPasspDoc],[DateIn],[DateCreate],[FileName],[Icon],[isActive],[Deleted] FROM [tP_Image] WHERE idPasspDoc = {0} AND Deleted = ((0))", (int)this.dsPassport_0.tP_CabPerambulation.Rows[0]["id"]), sqlConnection);
				sqlConnection.Open();
				DbDataAdapter dbDataAdapter = new SqlDataAdapter(selectCommand);
				this.dsPassport_0.tP_Image.Clear();
				dbDataAdapter.Fill(this.dsPassport_0.tP_Image);
			}
		...
		private bool method_3()
		{
			...
			if (this.StateCreate == null)
			{
				if (this.Id == -1)
				{
					this.Id = base.InsertSqlDataOneRow(this.dsPassport_0, this.dsPassport_0.tP_CabPerambulation);
				}
				else
				{
		...
		{
			FormAddEditCabPerambulation.Class153 @class = new FormAddEditCabPerambulation.Class153();
			@class.dataGridViewCellFormattingEventArgs_0 = e;
			@class.dataGridView_0 = (DataGridView)sender;
			if (@class.dataGridView_0.Columns[@class.dataGridViewCellFormattingEventArgs_0.ColumnIndex].Name == "idWorkerDataGridViewTextBoxColumn" && @class.dataGridViewCellFormattingEventArgs_0.RowIndex >= 0 && @class.dataGridView_0["idWorkerDataGridViewTextBoxColumn", @class.dataGridViewCellFormattingEventArgs_0.RowIndex].Value is int)
			{
				@class.dataGridViewCellFormattingEventArgs_0.Value = this.dsPassport_0.vP_Worker.Where(new Func<dsPassport.Class77, bool>(@class.method_0)).Select(new Func<dsPassport.Class77, string>(FormAddEditCabPerambulation.<>c.<>9.method_0)).First<string>();
				@class.dataGridViewCellFormattingEventArgs_0.FormattingApplied = true;
			}
		}
		...
		private void toolStripMenuItem_0_Click(object sender, EventArgs e)
		{
			...
			FormAddEditWorker formAddEditWorker = new FormAddEditWorker(this.dsPassport_0.vP_Worker);
			if (formAddEditWorker.ShowDialog() == DialogResult.OK)
			{
				dsPassport.Class81 @class = this.dsPassport_0.tP_CabPeramWorker.method_5();
				@class.method_1(this.Id);
				@class.method_3(formAddEditWorker.IdWorker);
				@class.method_5(false);
				this.dsPassport_0.tP_CabPeramWorker.method_0(@class);
				int num = base.InsertSqlDataOneRow(this.dsPassport_0, this.dsPassport_0.tP_CabPeramWorker);
				this.method_1();
		...
		private void toolStripMenuItem_1_Click(object sender, EventArgs e)
		{
			...
			{
				FormAddEditWorker formAddEditWorker = new FormAddEditWorker(this.dsPassport_0.vP_Worker, (int)this.dataGridView_1.SelectedRows[0].Cells["idWorkerDataGridViewTextBoxColumn"].Value);
				if (formAddEditWorker.ShowDialog() == DialogResult.OK)
				{
					...
					base.UpdateSqlData(this.dsPassport_0, this.dsPassport_0.tP_CabPeramWorker);
					this.method_1();
					this.bindingSource_1.Position = this.bindingSource_1.Find("id", num);
				}
			}
		...
		private void method_5(string string_0)
		{
			...
			DataRow dataRow = this.dsPassport_0.tP_Image.NewRow();
			...
			this.dsPassport_0.tP_Image.Rows.Add(dataRow);
			int num = base.InsertSqlDataOneRow(this.dsPassport_0, this.dsPassport_0.tP_Image);
			this.method_2();
		...
		private void method_6()
		{
			...
			this.toolStripButton_0.Image = Resources.picture_add;
			...
			this.toolStripButton_1.Image = Resources.picture_save;
			...
			this.toolStripButton_2.Image = Resources.picture_delete;
			...
			this.toolStripButton_6.Image = Resources.page_white_picture;
			this.toolStripButton_6.ImageTransparentColor = Color.Magenta;
			this.toolStripButton_6.Name = "tsbShowImage";
			this.toolStripButton_6.Size = new Size(23, 22);
			this.toolStripButton_6.Text = "toolStripButton1";
			...
			this.toolStripMenuItem_3.Image = Resources.page_white_picture;
			...
			this.toolStripMenuItem_4.Image = Resources.picture_save;
			...
			this.toolStripMenuItem_5.Image = Resources.picture_add;
			...
			this.toolStripMenuItem_6.Image = Resources.picture_delete;
		...
		{
			internal bool method_0(dsPassport.Class77 class77_0)
			{
				return class77_0.Id == (int)this.dataGridView_0["idWorkerDataGridViewTextBoxColumn", this.dataGridViewCellFormattingEventArgs_0.RowIndex].Value;
			}

			public DataGridView dataGridView_0;

			public DataGridViewCellFormattingEventArgs dataGridViewCellFormattingEventArgs_0;
		}
	}
}
