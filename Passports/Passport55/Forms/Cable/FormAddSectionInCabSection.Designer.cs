...
namespace Passport.Forms.Cable
{
	public class FormAddSectionInCabSection : FormBase
	{
		...
		private void FormAddSectionInCabSection_Load(object sender, EventArgs e)
		{
			...
			this.int_5 = Class110.smethod_0(this.SqlSettings, base.Name);
		}
		...
		private void FormAddSectionInCabSection_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (base.DialogResult == DialogResult.OK)
			{
				...
				if (!decimal.TryParse(this.textBox_1.Text, out this.decimal_1))
				{
				...
				DataRow cabSectionRow = this.panelPassportCabSection_0.CabSectionRow;
				if (!Class109.smethod_3(this.SqlSettings, this.int_1, cabSectionRow, this.int_3, this.int_4, this.decimal_0, this.decimal_1))
				{
					e.Cancel = true;
					return;
				}
				Class110.smethod_2(this.SqlSettings, this.int_5, 0);
			}
			Class110.smethod_1(this.SqlSettings, this.int_5);
		}
