...
namespace Passport.Forms.Documents
{
	public class FormPlanRenovationsAddEdit : FormBase
	{
		...
		{
			base.SelectSqlData(this.dsDocuments_0.tP_DocPlanRenovations, true, "where idDoc =" + this.nullable_0.ToString(), false);
			foreach (object obj in this.dsDocuments_0.tP_DocPlanRenovations.Rows)
			{
				...
				if (tabPage == null)
				{
					...
					base.SelectSqlData(dataTable, true, "where id = " + dataRow["idObjList"].ToString(), false);
		...
		private void method_3()
		{
			...
			dataTable.Columns.Add("name", typeof(string));
			base.SelectSqlData(dataTable, true, string.Format("where idParent = {0} and deleted = 0 and typeCodeId in ({1})", this.int_0, text), false);
			...
			dataTable.Columns.Add("id", typeof(int));
			dataTable.Columns.Add("name", typeof(string));
			base.SelectSqlData(dataTable, true, string.Format("where idParentAddl = {0} and deleted = 0 and typeCodeId = 556", this.int_0), false);
		...
		private bool method_4()
		{
			...
			this.dsDocuments_0.tP_DocList.Rows[0].EndEdit();
			return base.UpdateSqlData(this.dsDocuments_0.tP_DocList);
		}
		...
		private bool method_5()
		{
			...
			foreach (object obj in this.tabControl_0.TabPages)
			{
				...
				DataRow[] array = this.dsDocuments_0.tP_DocPlanRenovations.Select("idObjList = " + tabPage.Tag.ToString());
				if (array.Length == 0)
				{
					DataRow dataRow = this.dsDocuments_0.tP_DocPlanRenovations.NewRow();
					...
					this.dsDocuments_0.tP_DocPlanRenovations.Rows.Add(dataRow);
				}
				else
				{
			...
			return base.InsertSqlData(this.dsDocuments_0.tP_DocPlanRenovations) && base.UpdateSqlData(this.dsDocuments_0.tP_DocPlanRenovations);
		}
		...
		private void method_11()
		{
			...
			this.dateTimePicker_0.Location = new Point(76, 5);
			this.dateTimePicker_0.Name = "dtpPlanWork";
			this.dateTimePicker_0.Size = new Size(138, 20);
			this.dateTimePicker_0.TabIndex = 1;
			this.dateTimePicker_0.Tag = "plan";
			...
			this.dateTimePicker_1.DataBindings.Add(new Binding("Value", this.dsDocuments_0, "tP_DocList.DateDoc", true));
			this.dateTimePicker_1.Location = new Point(273, 35);
			this.dateTimePicker_1.Name = "dateTimePicker1";
			this.dateTimePicker_1.Size = new Size(200, 20);
			this.dateTimePicker_1.TabIndex = 9;
