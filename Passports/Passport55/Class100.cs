...
{
	internal Class100(IDataPageRetriever idataPageRetriever_1, int int_1)
	{
		this.idataPageRetriever_0 = idataPageRetriever_1;
		Class100.int_0 = int_1;
		this.method_2();
	}
	...
	private bool method_0(int int_1, int int_2, ref string string_0)
	{
		...
		{
			string_0 = this.struct1_0[0].dataTable_0.Rows[int_1 % Class100.int_0][int_2].ToString();
			return true;
		}
		if (this.method_5(1, int_1))
		{
			string_0 = this.struct1_0[1].dataTable_0.Rows[int_1 % Class100.int_0][int_2].ToString();
			return true;
		}
		return false;
	}
	...
	{
		this.struct1_0 = new Class100.Struct1[]
		{
			new Class100.Struct1(this.idataPageRetriever_0.SupplyPageOfData(Class100.Struct1.smethod_0(0), Class100.int_0), 0),
			new Class100.Struct1(this.idataPageRetriever_0.SupplyPageOfData(Class100.Struct1.smethod_0(Class100.int_0), Class100.int_0), Class100.int_0)
		};
	}

	private string method_3(int int_1, int int_2)
	{
		DataTable dataTable_ = this.idataPageRetriever_0.SupplyPageOfData(Class100.Struct1.smethod_0(int_1), Class100.int_0);
		this.struct1_0[this.method_4(int_1)] = new Class100.Struct1(dataTable_, int_1);
	...
	private Class100.Struct1[] struct1_0;
	...
	internal struct Struct1
	{
		internal Struct1(DataTable dataTable_1, int int_2)
		{
			...
			this.int_0 = Class100.Struct1.smethod_0(int_2);
			this.int_1 = Class100.Struct1.smethod_1(int_2);
		}
		...
		{
			return int_2 / Class100.int_0 * Class100.int_0;
		}

		internal static int smethod_1(int int_2)
		{
			return Class100.Struct1.smethod_0(int_2) + Class100.int_0 - 1;
		}
