...
namespace Passport.Classes
{
	public class DataGridViewParse
	{
		...
		public DataGridViewParse(DataGridView dataGridView_1, bool selected, string no_column_name)
		{
			...
			DataGridViewSelectedRowCollection selectedRows = dataGridView_1.SelectedRows;
			if (selected)
			{
			...
			this.int_1 = dataGridView_1.RowCount;
		}
