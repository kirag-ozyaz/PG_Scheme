...
namespace Passport.Classes
{
	public class ObjList
	{
		...
		protected virtual void OnObjListChanged(ObjListEventArgs objListEventArgs_0)
		{
			EventHandler<ObjListEventArgs> eventHandler = this.eventHandler_0;
			if (eventHandler != null)
			{
				eventHandler(this, objListEventArgs_0);
			}
		}
		...
		{
			uint num = Class121.smethod_0(parentKey);
			if (num <= 1824009846u)
			{
				if (num <= 619851038u)
				{
		...
		public static string GetParentKey(TypeObjList value)
		{
			...
			case TypeObjList.SubstationCenter:
				return ";SCM;PS;";
			case TypeObjList.SwGear023:
			case TypeObjList.SwGear04:
			case TypeObjList.SwGear10:
			case TypeObjList.SwGear110:
