...
namespace Passport.Forms
{
	public class FormRegistrAddEditRepair : FormBase
	{
		...
		public FormRegistrAddEditRepair(SQLSettings settings, int id, StateFormCreate state)
		{
			Class330.Mus9JxKz1CNxy();
			base..ctor();
			this.method_2();
		...
		private void method_0()
		{
			...
			this.textBox_0.SelectedText = this.class248_0.Comment;
		...
		private void method_1()
		{
			...
			this.class248_0.Comment = this.textBox_0.Text;
