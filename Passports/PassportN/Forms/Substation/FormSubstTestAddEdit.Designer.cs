	...
	public class FormSubstTestAddEdit : FormBase
	{
		...
		private void FormSubstTestAddEdit_Load(object sender, EventArgs e)
		{
			if (this.CreateState == null)
			{
				...
				@class.TypeDoc = this.method_0();
				@class.Deleted = false;
				@class.isActive = true;
				@class.EndEdit();
				this.class14_0.tP_DocList.method_0(@class);
				Class14.Class99 class2 = this.class14_0.tP_SubstationTest.method_5();
				class2.idDocList = this.int_0;
				class2.deleted = false;
				class2.EndEdit();
				this.class14_0.tP_SubstationTest.method_0(class2);
				return;
			}
			if (this.CreateState == 1)
			{
				this.Text = "Редактировать испытание подстанции";
				base.SelectSqlData(this.class14_0.tP_DocList, true, "where id = " + this.int_0.ToString(), null, false, 0);
				base.SelectSqlData(this.class14_0.tP_SubstationTest, true, "where deleted = '0' and idDocList = " + this.int_0.ToString(), null, false, 0);
			}
		}
		...
		{
			bool result = true;
			if (string.IsNullOrEmpty(Convert.ToString(this.class14_0.tP_SubstationTest[0]["worker"])))
			{
				new ToolTip
				{
		...
		private bool method_3()
		{
			...
			else if (this.CreateState == 1 && !base.UpdateSqlDataOnlyChange(this.class14_0.tP_DocList))
			{
				return false;
			}
			return true;
		...
		private bool method_4()
		{
			if (this.CreateState == null)
			{
				this.class14_0.tP_SubstationTest[0].idDocList = this.int_0;
				this.class14_0.tP_SubstationTest[0].EndEdit();
				if (!base.InsertSqlData(this.class14_0.tP_SubstationTest))
				{
					return false;
				}
			}
			...
			{
				this.class14_0.tP_SubstationTest[0].EndEdit();
				if (!base.UpdateSqlDataOnlyChange(this.class14_0.tP_SubstationTest))
				{
					return false;
				}
			}
		...
		private void method_5()
		{
			...
			this.textBox_8.DataBindings.Add(new Binding("Text", this.class14_0, "tP_SubstationTest.worker", true));
			...
			this.textBox_1.DataBindings.Add(new Binding("Text", this.class14_0, "tP_SubstationTest.faseResist", true));
			...
			this.textBox_2.DataBindings.Add(new Binding("Text", this.class14_0, "tP_SubstationTest.resist", true));
			...
			this.textBox_3.DataBindings.Add(new Binding("Text", this.class14_0, "tP_SubstationTest.typeDevice", true));
			...
			this.nullableDateTimePicker_0.DataBindings.Add(new Binding("Value", this.class14_0, "tP_SubstationTest.date", true));
			...
			this.textBox_4.DataBindings.Add(new Binding("Text", this.class14_0, "tP_SubstationTest.weather", true));
			...
			this.textBox_5.DataBindings.Add(new Binding("Text", this.class14_0, "tP_SubstationTest.gndIsol", true));
			...
			this.textBox_6.DataBindings.Add(new Binding("Text", this.class14_0, "tP_SubstationTest.faseIsol", true));
			...
			this.nullableDateTimePicker_1.DataBindings.Add(new Binding("Value", this.class14_0, "tP_SubstationTest.dateIsol", true));
			...
			this.textBox_7.DataBindings.Add(new Binding("Text", this.class14_0, "tP_SubstationTest.voltTrans", true));
			...
			this.nullableDateTimePicker_2.DataBindings.Add(new Binding("Value", this.class14_0, "tP_SubstationTest.dateTrans", true));
