...
namespace Passport.Forms.Reports
{
	public class FormReports : FormBase
	{
		public FormReports(DataTable table)
		{
			...
			this.zudwPpEklG = new DataTable();
			base..ctor();
			this.method_6();
			this.zudwPpEklG = table;
			this.method_3();
		}

		private List<Class328> method_0(DataTable dataTable_0)
		{
			List<Class328> list = new List<Class328>();
			for (int i = 0; i < dataTable_0.Columns.Count; i++)
			{
				if (dataTable_0.Columns[i].ColumnName != "IdObj")
				{
					list.Add(new Class328(dataTable_0.Columns[i].Caption, dataTable_0.Columns[i].ColumnName));
				}
			}
			return list;
		}

		private MemoryStream method_1(List<Class328> list_0, List<Class328> list_1)
		{
			MemoryStream memoryStream = new MemoryStream();
			Class326 @class = new Class326();
			@class.method_1(list_0);
			@class.method_3(list_1);
			@class.method_15(memoryStream);
		...
		private void method_2()
		{
			...
			this.reportViewer_0.LocalReport.DataSources.Add(new ReportDataSource("MyData", this.zudwPpEklG));
		...
		private string method_5(string string_0)
		{
			...
			return string.Join("", (from s in array
		...
		protected override void Dispose(bool disposing)
		{
			...
			FormReports.EqhbEdZKaM1LwvPn9aM(this, disposing);
		}
		...
		internal static void EqhbEdZKaM1LwvPn9aM(Form form_0, bool bool_0)
		{
