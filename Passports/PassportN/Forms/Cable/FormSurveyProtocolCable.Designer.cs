...
namespace Passport.Forms.Cable
{
	public class FormSurveyProtocolCable : FormBase
	{
		...
		public FormSurveyProtocolCable(SQLSettings settings, int id, int idCable, string cableName, StateFormCreate state)
		{
			Class330.Mus9JxKz1CNxy();
			base..ctor();
			this.method_15();
			...
			if (state != null)
			{
				if (state != 1)
				{
					if (state == 7)
					{
						...
						base.SelectSqlData(this.class14_0, this.class14_0.tP_CabProtocol, true, "WHERE idObjList = " + idCable.ToString() + " AND Deleted = ((0))");
		...
		{
			base.SelectSqlData(this.class14_0, this.class14_0.tP_CabProtocol, true, "WHERE id = " + this.int_0.ToString() + " AND Deleted = ((0))");
			this.bindingSource_0.ResetBindings(false);
		}

		private void method_1(int int_3, string string_1)
		{
			Class14.Class94 @class = this.class14_0.tP_CabProtocol.method_4();
			@class.idObjList = int_3;
			@class.NaimKL = string_1;
			@class.Deleted = false;
			this.class14_0.tP_CabProtocol.method_0(@class);
			this.bindingSource_0.ResetBindings(false);
			this.class14_0.tP_CabProtocol.BeginInit();
		}
		...
		private void method_4()
		{
			...
			base.SelectSqlData(this.class14_0, this.class14_0.tP_CabSection, true, str + " " + str2);
			...
			base.SelectSqlData(this.class14_0, this.class14_0.tSchm_ObjList, true, str + " " + str3);
			this.comboBoxReadOnly_22.DataSource = this.method_5();
			this.comboBoxReadOnly_22.DisplayMember = "FIO";
			this.comboBoxReadOnly_22.ValueMember = "Id";
			this.comboBoxReadOnly_24.DataSource = this.method_6();
			this.comboBoxReadOnly_24.DisplayMember = "FIO";
			this.comboBoxReadOnly_24.ValueMember = "Id";
			this.comboBoxReadOnly_25.DataSource = this.method_8();
			this.comboBoxReadOnly_25.DisplayMember = "FIO";
			this.comboBoxReadOnly_25.ValueMember = "Id";
			this.comboBoxReadOnly_21.DataSource = this.method_9();
			this.comboBoxReadOnly_21.DisplayMember = "FIO";
			this.comboBoxReadOnly_21.ValueMember = "Id";
			this.comboBoxReadOnly_23.DataSource = this.method_7();
			this.comboBoxReadOnly_23.DisplayMember = "FIO";
			this.comboBoxReadOnly_23.ValueMember = "Id";
			this.comboBoxReadOnly_20.DataSource = this.method_10();
		...
		{
			base.SelectSqlData(this.class14_0, this.class14_0.vWorkerGroup, true, "WHERE ParentKey = ';GroupWorker;ChairmanCommission;'  AND DateEnd IS NULL");
			return this.class14_0.vWorkerGroup.Copy();
		}

		private DataTable method_6()
		{
			base.SelectSqlData(this.class14_0, this.class14_0.vWorkerGroup, true, "WHERE ParentKey = ';GroupWorker;CableService;Chief;'  AND DateEnd IS NULL");
			return this.class14_0.vWorkerGroup.Copy();
		}

		private DataTable method_7()
		{
			base.SelectSqlData(this.class14_0, this.class14_0.vWorkerGroup, true, "WHERE ParentKey = ';GroupWorker;EngPTS;'  AND DateEnd IS NULL");
			return this.class14_0.vWorkerGroup.Copy();
		}

		private DataTable method_8()
		{
			base.SelectSqlData(this.class14_0, this.class14_0.vWorkerGroup, true, "WHERE ParentKey = ';GroupWorker;HeadPL;'  AND DateEnd IS NULL");
			return this.class14_0.vWorkerGroup.Copy();
		}

		private DataTable method_9()
		{
			base.SelectSqlData(this.class14_0, this.class14_0.vWorkerGroup, true, "WHERE ParentKey = ';GroupWorker;HeadRegion;'  AND DateEnd IS NULL");
			return this.class14_0.vWorkerGroup.Copy();
		}
		...
		{
			new DataTable();
			base.SelectSqlData(this.class14_0, this.class14_0.tP_ValueLists, true, "WHERE ParentKey = ';Cable;Protocol;Survey;CauseDamage;' AND isGroup = 0");
			return this.class14_0.tP_ValueLists.Copy();
		}

		private DataTable method_11(int int_3)
		{
			new DataTable();
			base.SelectSqlData(this.class14_0, this.class14_0.tP_ValueLists, true, "WHERE ParentId = " + int_3.ToString() + " AND isGroup = 0");
			if (this.class14_0.tP_ValueLists.Rows.Count > 0)
			{
				this.comboBoxReadOnly_19.Enabled = true;
			}
			else
			{
				this.comboBoxReadOnly_19.Enabled = false;
				this.comboBoxReadOnly_19.SelectedValue = -1;
			}
			return this.class14_0.tP_ValueLists.Copy();
		}

		private void comboBoxReadOnly_20_SelectedIndexChanged(object sender, EventArgs e)
		{
			int num = 0;
			if (this.comboBoxReadOnly_20.SelectedValue != null && int.TryParse(this.comboBoxReadOnly_20.SelectedValue.ToString(), out num))
			{
				DataTable dataSource = this.method_11(num);
				this.comboBoxReadOnly_19.DataSource = dataSource;
		...
		{
			this.class14_0.tP_CabProtocol.Rows[0].EndEdit();
			this.int_0 = base.InsertSqlDataOneRow(this.class14_0, this.class14_0.tP_CabProtocol);
			return this.int_0 > 0;
		}
		...
		{
			this.class14_0.tP_CabProtocol.Rows[0].EndEdit();
			return base.UpdateSqlData(this.class14_0, this.class14_0.tP_CabProtocol);
		}

		private void comboBoxReadOnly_27_TextChanged(object sender, EventArgs e)
		{
			DataRowCollection rows = Clutch.GetData(this.SqlSettings, this.int_1, this.comboBoxReadOnly_27.Text, TypeObjList.ClutchConnecting, false).Rows;
			if (rows.Count > 0)
			{
		...
		private void comboBoxReadOnly_26_TextChanged(object sender, EventArgs e)
		{
			DataRow[] array = this.class14_0.tP_CabSection.Select("Number = '" + this.comboBoxReadOnly_26.Text + "'");
			if (array.Count<DataRow>() > 0)
			{
				((DataRowView)this.bindingSource_0.Current)["KabelMarka"] = Class317.smethod_4(this.SqlSettings, (int)array[0]["id"]);
		...
		private void method_15()
		{
			...
			this.NkimJvVkguV = new ToolStripSeparator();
			this.toolStripButton_4 = new ToolStripButton();
			this.toolStripButton_5 = new ToolStripButton();
			this.rkymOfuPeBU = new TabControl();
			...
			this.MhfmOcaixk2 = new ComboBoxReadOnly();
			...
			this.rkymOfuPeBU.SuspendLayout();
			...
			this.tableLayoutPanel_0.Controls.Add(this.rkymOfuPeBU, 0, 0);
			...
			this.NkimJvVkguV.Name = "bindingNavigatorSeparator2";
			this.NkimJvVkguV.Size = new Size(6, 25);
			...
			this.tableLayoutPanel_0.SetColumnSpan(this.rkymOfuPeBU, 4);
			this.rkymOfuPeBU.Controls.Add(this.tabPage_0);
			this.rkymOfuPeBU.Controls.Add(this.tabPage_1);
			this.rkymOfuPeBU.Dock = DockStyle.Fill;
			this.rkymOfuPeBU.Location = new Point(3, 3);
			this.rkymOfuPeBU.Name = "tcGeneral";
			this.rkymOfuPeBU.SelectedIndex = 0;
			this.rkymOfuPeBU.Size = new Size(716, 486);
			this.rkymOfuPeBU.TabIndex = 0;
			this.tabPage_0.Controls.Add(this.comboBoxReadOnly_28);
			...
			this.tabPage_0.Controls.Add(this.MhfmOcaixk2);
			...
			this.comboBoxReadOnly_28.DataBindings.Add(new Binding("Text", this.bindingSource_0, "ProtocolTip", true));
			this.comboBoxReadOnly_28.FormattingEnabled = true;
			this.comboBoxReadOnly_28.Items.AddRange(new object[]
			{
				"муфты",
				"кабеля",
				"образца кабеля"
			});
			this.comboBoxReadOnly_28.Location = new Point(112, 52);
			this.comboBoxReadOnly_28.Name = "cbSurvey";
			this.comboBoxReadOnly_28.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_28.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_28.Size = new Size(166, 21);
			this.comboBoxReadOnly_28.TabIndex = 2;
			...
			this.MhfmOcaixk2.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
			this.MhfmOcaixk2.AutoCompleteSource = AutoCompleteSource.ListItems;
			this.MhfmOcaixk2.DataBindings.Add(new Binding("Text", this.bindingSource_0, "MestoPovreg", true));
			this.MhfmOcaixk2.FormattingEnabled = true;
			this.MhfmOcaixk2.Items.AddRange(new object[]
			{
				"на прямой линии",
				"на изгибе",
				"сверху",
			...
			this.MhfmOcaixk2.Location = new Point(537, 351);
			this.MhfmOcaixk2.Name = "cbDamagedCable";
			this.MhfmOcaixk2.ReadOnlyBackColor = Color.White;
			this.MhfmOcaixk2.ReadOnlyForeColor = SystemColors.WindowText;
			this.MhfmOcaixk2.Size = new Size(159, 21);
			this.MhfmOcaixk2.TabIndex = 22;
			this.MhfmOcaixk2.Tag = "Место повреждения";
			...
			this.comboBoxReadOnly_3.DataBindings.Add(new Binding("Text", this.bindingSource_0, "SostGrunt", true));
			...
			this.comboBoxReadOnly_3.Location = new Point(267, 351);
			this.comboBoxReadOnly_3.Name = "cbGroundCondition";
			this.comboBoxReadOnly_3.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_3.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_3.Size = new Size(146, 21);
			this.comboBoxReadOnly_3.TabIndex = 21;
			this.comboBoxReadOnly_3.Tag = "Состояние грунта";
			...
			this.comboBoxReadOnly_4.DataBindings.Add(new Binding("Text", this.bindingSource_0, "VidProkl", true));
			...
			this.comboBoxReadOnly_4.Location = new Point(496, 318);
			this.comboBoxReadOnly_4.Name = "cbInstallationView";
			this.comboBoxReadOnly_4.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_4.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_4.Size = new Size(200, 21);
			this.comboBoxReadOnly_4.TabIndex = 19;
			this.comboBoxReadOnly_4.Tag = "Вид прокладки в месте повреджения";
			...
			this.groupBox_0.Controls.Add(this.comboBoxReadOnly_27);
			this.groupBox_0.Controls.Add(this.label_16);
			this.groupBox_0.Controls.Add(this.label_17);
			this.groupBox_0.Controls.Add(this.sQvmOzSanms);
			...
			this.comboBoxReadOnly_27.DataBindings.Add(new Binding("Text", this.bindingSource_0, "MuftaN", true));
			this.comboBoxReadOnly_27.DataSource = this.class14_0;
			this.comboBoxReadOnly_27.DisplayMember = "tSchm_ObjList.Name";
			this.comboBoxReadOnly_27.FormattingEnabled = true;
			this.comboBoxReadOnly_27.Location = new Point(30, 15);
			this.comboBoxReadOnly_27.Name = "cbClutchNumber";
			...
			this.comboBoxReadOnly_27.Size = new Size(49, 21);
			this.comboBoxReadOnly_27.TabIndex = 14;
			this.comboBoxReadOnly_27.ValueMember = "tSchm_ObjList.Id";
			...
			this.sQvmOzSanms.AutoSize = true;
			this.sQvmOzSanms.Location = new Point(220, 19);
			this.sQvmOzSanms.Name = "label13";
			this.sQvmOzSanms.Size = new Size(81, 13);
			this.sQvmOzSanms.TabIndex = 24;
			this.sQvmOzSanms.Text = "Дата монтажа";
			this.label_18.AutoSize = true;
			this.label_18.Location = new Point(437, 19);
			this.label_18.Name = "label14";
			this.label_18.Size = new Size(105, 13);
			this.label_18.TabIndex = 25;
			this.label_18.Text = "Монтер-кабельщик";
			...
			this.groupBox_1.Controls.Add(this.comboBoxReadOnly_26);
			...
			this.comboBoxReadOnly_26.DataBindings.Add(new Binding("Text", this.bindingSource_0, "UchN", true));
			this.comboBoxReadOnly_26.DataSource = this.class14_0;
			this.comboBoxReadOnly_26.DisplayMember = "tP_CabSection.Number";
			this.comboBoxReadOnly_26.FormattingEnabled = true;
			this.comboBoxReadOnly_26.Location = new Point(33, 51);
			this.comboBoxReadOnly_26.Name = "cbSectionNumber";
			...
			this.comboBoxReadOnly_26.Size = new Size(46, 21);
			this.comboBoxReadOnly_26.TabIndex = 10;
			this.comboBoxReadOnly_26.ValueMember = "tP_CabSection.Number";
			this.comboBoxReadOnly_26.TextChanged += this.comboBoxReadOnly_26_TextChanged;
			...
			this.label_19.Location = new Point(458, 54);
			this.label_19.Name = "label8";
			this.label_19.Size = new Size(90, 13);
			this.label_19.TabIndex = 19;
			this.label_19.Text = "Дата прокладки";
			this.label_20.AutoSize = true;
			this.label_20.Location = new Point(280, 54);
			this.label_20.Name = "label9";
			this.label_20.Size = new Size(133, 13);
			this.label_20.TabIndex = 20;
			this.label_20.Text = "Рабочее напряжение, кВ";
			this.label_21.AutoSize = true;
			this.label_21.Location = new Point(85, 54);
			this.label_21.Name = "label10";
			this.label_21.Size = new Size(40, 13);
			this.label_21.TabIndex = 21;
			this.label_21.Text = "Марка";
			this.label_22.AutoSize = true;
			this.label_22.Location = new Point(9, 54);
			this.label_22.Name = "label15";
			this.label_22.Size = new Size(18, 13);
			...
			this.comboBoxReadOnly_5.DataBindings.Add(new Binding("Text", this.bindingSource_0, "PovregAdress", true));
			this.comboBoxReadOnly_5.FormattingEnabled = true;
			this.comboBoxReadOnly_5.Location = new Point(427, 120);
			this.comboBoxReadOnly_5.Name = "cbStreet";
			this.comboBoxReadOnly_5.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_5.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_5.Size = new Size(121, 21);
			...
			this.comboBoxReadOnly_6.DataBindings.Add(new Binding("Text", this.bindingSource_0, "PovregVid", true));
			this.comboBoxReadOnly_6.FormattingEnabled = true;
			this.comboBoxReadOnly_6.Items.AddRange(new object[]
			{
				"в целом месте",
				"в муфте",
				"в разделке",
			...
			this.comboBoxReadOnly_6.Location = new Point(112, 86);
			this.comboBoxReadOnly_6.Name = "cbTypeDamage";
			...
			this.comboBoxReadOnly_7.DataBindings.Add(new Binding("Text", this.bindingSource_0, "PovregTip", true));
			...
			this.comboBoxReadOnly_7.Location = new Point(427, 52);
			this.comboBoxReadOnly_7.Name = "cbDamage";
			this.comboBoxReadOnly_7.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_7.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_7.Size = new Size(269, 21);
			...
			this.tabPage_1.Controls.Add(this.iNdmJaaqUxk);
			...
			this.tabPage_1.Controls.Add(this.XimmXuOxowj);
			...
			this.tabPage_1.Controls.Add(this.label_23);
			...
			this.tabPage_1.Controls.Add(this.comboBoxReadOnly_8);
			...
			this.label_49.Location = new Point(384, 37);
			this.label_49.Name = "label53";
			this.label_49.Size = new Size(91, 13);
			this.label_49.TabIndex = 54;
			this.label_49.Text = "Дефекты пайки:";
			this.label_44.AutoSize = true;
			this.label_44.Location = new Point(384, 187);
			this.label_44.Name = "label52";
			this.label_44.Size = new Size(70, 13);
			this.label_44.TabIndex = 53;
			this.label_44.Text = "Заземлений";
			this.label_45.AutoSize = true;
			this.label_45.Location = new Point(384, 160);
			this.label_45.Name = "label51";
			this.label_45.Size = new Size(123, 13);
			this.label_45.TabIndex = 52;
			this.label_45.Text = "Заливочных отверстий";
			this.label_46.AutoSize = true;
			this.label_46.Location = new Point(384, 133);
			this.label_46.Name = "label50";
			this.label_46.Size = new Size(63, 13);
			this.label_46.TabIndex = 51;
			this.label_46.Text = "Горловины";
			this.label_47.AutoSize = true;
			this.label_47.Location = new Point(384, 106);
			this.label_47.Name = "label49";
			this.label_47.Size = new Size(121, 13);
			this.label_47.TabIndex = 50;
			this.label_47.Text = "Уход массы из муфты";
			this.label_48.AutoSize = true;
			this.label_48.Location = new Point(384, 79);
			this.label_48.Name = "label48";
			this.label_48.Size = new Size(120, 13);
			this.label_48.TabIndex = 49;
			this.label_48.Text = "Перерождение массы";
			this.label_39.AutoSize = true;
			this.label_39.Location = new Point(366, 378);
			this.label_39.Name = "label47";
			this.label_39.Size = new Size(148, 13);
			this.label_39.TabIndex = 48;
			this.label_39.Text = "Начальник эл. лаборатории";
			...
			this.comboBoxReadOnly_21.DataBindings.Add(new Binding("SelectedValue", this.bindingSource_0, "NachSR", true));
			this.comboBoxReadOnly_21.FormattingEnabled = true;
			this.comboBoxReadOnly_21.Location = new Point(525, 405);
			this.comboBoxReadOnly_21.Name = "cbChiefNetRegion";
			this.comboBoxReadOnly_21.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_21.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_21.Size = new Size(146, 21);
			this.comboBoxReadOnly_21.TabIndex = 48;
			this.label_40.AutoSize = true;
			this.label_40.Location = new Point(88, 378);
			this.label_40.Name = "label46";
			this.label_40.Size = new Size(133, 13);
			this.label_40.TabIndex = 47;
			this.label_40.Text = "Председатель комиссии";
			this.label_41.AutoSize = true;
			this.label_41.Location = new Point(62, 405);
			this.label_41.Name = "label45";
			this.label_41.Size = new Size(160, 13);
			this.label_41.TabIndex = 46;
			this.label_41.Text = "Начальник службы каб. сетей";
			this.label_42.AutoSize = true;
			this.label_42.Location = new Point(366, 408);
			this.label_42.Name = "label44";
			this.label_42.Size = new Size(150, 13);
			this.label_42.TabIndex = 45;
			this.label_42.Text = "Начальник сетевого района";
			this.label_43.AutoSize = true;
			this.label_43.Location = new Point(143, 435);
			this.label_43.Name = "label43";
			this.label_43.Size = new Size(78, 13);
			this.label_43.TabIndex = 44;
			this.label_43.Text = "Инженер ПТС";
			...
			this.comboBoxReadOnly_22.DataBindings.Add(new Binding("SelectedValue", this.bindingSource_0, "PredsKomiss", true));
			this.comboBoxReadOnly_22.FormattingEnabled = true;
			this.comboBoxReadOnly_22.Location = new Point(228, 375);
			this.comboBoxReadOnly_22.Name = "cbChairman";
			this.comboBoxReadOnly_22.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_22.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_22.Size = new Size(121, 21);
			this.comboBoxReadOnly_22.TabIndex = 44;
			...
			this.comboBoxReadOnly_23.DataBindings.Add(new Binding("SelectedValue", this.bindingSource_0, "EngPTS", true));
			this.comboBoxReadOnly_23.FormattingEnabled = true;
			this.comboBoxReadOnly_23.Location = new Point(228, 432);
			this.comboBoxReadOnly_23.Name = "cbIngenerPTS";
			...
			this.comboBoxReadOnly_23.TabIndex = 46;
			...
			this.comboBoxReadOnly_24.DataBindings.Add(new Binding("SelectedValue", this.bindingSource_0, "NachKS", true));
			this.comboBoxReadOnly_24.FormattingEnabled = true;
			this.comboBoxReadOnly_24.Location = new Point(228, 405);
			this.comboBoxReadOnly_24.Name = "cbChiefCable";
			...
			this.comboBoxReadOnly_24.TabIndex = 45;
			...
			this.comboBoxReadOnly_25.DataBindings.Add(new Binding("SelectedValue", this.bindingSource_0, "NachLab", true));
			this.comboBoxReadOnly_25.FormattingEnabled = true;
			this.comboBoxReadOnly_25.Location = new Point(525, 375);
			this.comboBoxReadOnly_25.Name = "cbChiefLab";
			this.comboBoxReadOnly_25.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_25.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_25.Size = new Size(146, 21);
			this.comboBoxReadOnly_25.TabIndex = 47;
			...
			this.iNdmJaaqUxk.AutoSize = true;
			this.iNdmJaaqUxk.Location = new Point(10, 347);
			this.iNdmJaaqUxk.Name = "label42";
			this.iNdmJaaqUxk.Size = new Size(130, 13);
			this.iNdmJaaqUxk.TabIndex = 36;
			this.iNdmJaaqUxk.Text = "Предложение комиссии";
			this.label_36.AutoSize = true;
			this.label_36.Location = new Point(12, 321);
			this.label_36.Name = "label41";
			this.label_36.Size = new Size(100, 13);
			this.label_36.TabIndex = 35;
			this.label_36.Text = "Виновная сторона";
			...
			this.comboBoxReadOnly_19.DataBindings.Add(new Binding("SelectedValue", this.bindingSource_0, "ZPrichinaDop", true));
			this.comboBoxReadOnly_19.Enabled = false;
			this.comboBoxReadOnly_19.FormattingEnabled = true;
			this.comboBoxReadOnly_19.Location = new Point(424, 291);
			this.comboBoxReadOnly_19.Name = "cbViewDamage";
			this.comboBoxReadOnly_19.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_19.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_19.Size = new Size(272, 21);
			this.comboBoxReadOnly_19.TabIndex = 41;
			this.label_37.AutoSize = true;
			this.label_37.Location = new Point(321, 294);
			this.label_37.Name = "label40";
			this.label_37.Size = new Size(97, 13);
			this.label_37.TabIndex = 30;
			this.label_37.Text = "Вид повреждения";
			this.label_38.AutoSize = true;
			this.label_38.Location = new Point(10, 294);
			this.label_38.Name = "label39";
			this.label_38.Size = new Size(121, 13);
			this.label_38.TabIndex = 29;
			...
			this.comboBoxReadOnly_20.DataBindings.Add(new Binding("SelectedValue", this.bindingSource_0, "ZPrichina", true));
			this.comboBoxReadOnly_20.FormattingEnabled = true;
			this.comboBoxReadOnly_20.Location = new Point(137, 291);
			this.comboBoxReadOnly_20.Name = "cbCauseDamage2";
			this.comboBoxReadOnly_20.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_20.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_20.Size = new Size(167, 21);
			this.comboBoxReadOnly_20.TabIndex = 40;
			this.comboBoxReadOnly_20.SelectedIndexChanged += this.comboBoxReadOnly_20_SelectedIndexChanged;
			this.label_30.AutoSize = true;
			this.label_30.Location = new Point(384, 268);
			this.label_30.Name = "label32";
			this.label_30.Size = new Size(102, 13);
			this.label_30.TabIndex = 27;
			this.label_30.Text = "Прочие замечания";
			this.label_31.AutoSize = true;
			this.label_31.Location = new Point(384, 241);
			this.label_31.Name = "label33";
			this.label_31.Size = new Size(187, 13);
			this.label_31.TabIndex = 26;
			this.label_31.Text = "Состояние изоляции жил, качества";
			this.label_32.AutoSize = true;
			this.label_32.Location = new Point(384, 214);
			this.label_32.Name = "label34";
			this.label_32.Size = new Size(147, 13);
			this.label_32.TabIndex = 25;
			this.label_32.Text = "Состояние соединения жил";
			this.XimmXuOxowj.AutoSize = true;
			this.XimmXuOxowj.Location = new Point(384, 52);
			this.XimmXuOxowj.Name = "label35";
			this.XimmXuOxowj.Size = new Size(91, 13);
			this.XimmXuOxowj.TabIndex = 24;
			this.XimmXuOxowj.Text = "Наличие трещин";
			this.label_33.AutoSize = true;
			this.label_33.Location = new Point(384, 20);
			this.label_33.Name = "label36";
			this.label_33.Size = new Size(160, 13);
			this.label_33.TabIndex = 23;
			this.label_33.Text = "Состояние заливочной массы";
			this.label_34.AutoSize = true;
			this.label_34.Location = new Point(12, 241);
			this.label_34.Name = "label37";
			this.label_34.Size = new Size(122, 13);
			this.label_34.TabIndex = 22;
			this.label_34.Text = "Состояние уплотнений";
			this.label_35.AutoSize = true;
			this.label_35.Location = new Point(10, 214);
			this.label_35.Name = "label38";
			this.label_35.Size = new Size(142, 13);
			this.label_35.TabIndex = 21;
			this.label_35.Text = "Состояние корпуса муфты";
			...
			this.comboBoxReadOnly_14.DataBindings.Add(new Binding("Text", this.bindingSource_0, "MIzolGila", true));
			...
			this.comboBoxReadOnly_14.Location = new Point(577, 238);
			this.comboBoxReadOnly_14.Name = "cbClutchIsolationState";
			this.comboBoxReadOnly_14.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_14.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_14.Size = new Size(119, 21);
			this.comboBoxReadOnly_14.TabIndex = 38;
			...
			this.comboBoxReadOnly_15.DataBindings.Add(new Binding("Text", this.bindingSource_0, "MSoedGila", true));
			...
			this.comboBoxReadOnly_15.Location = new Point(537, 211);
			this.comboBoxReadOnly_15.Name = "cbInsulationConnectionState";
			this.comboBoxReadOnly_15.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_15.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_15.Size = new Size(159, 21);
			this.comboBoxReadOnly_15.TabIndex = 37;
			...
			this.comboBoxReadOnly_16.DataBindings.Add(new Binding("Text", this.bindingSource_0, "MZalivMassa", true));
			...
			this.comboBoxReadOnly_16.Location = new Point(550, 17);
			this.comboBoxReadOnly_16.Name = "cbSealingCompound";
			this.comboBoxReadOnly_16.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_16.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_16.Size = new Size(146, 21);
			this.comboBoxReadOnly_16.TabIndex = 35;
			...
			this.comboBoxReadOnly_17.DataBindings.Add(new Binding("Text", this.bindingSource_0, "MUplot", true));
			...
			this.comboBoxReadOnly_17.Location = new Point(140, 238);
			this.comboBoxReadOnly_17.Name = "cbSealsState";
			this.comboBoxReadOnly_17.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_17.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_17.Size = new Size(238, 21);
			this.comboBoxReadOnly_17.TabIndex = 34;
			...
			this.comboBoxReadOnly_18.DataBindings.Add(new Binding("Text", this.bindingSource_0, "MKorpus", true));
			this.comboBoxReadOnly_18.FormattingEnabled = true;
			this.comboBoxReadOnly_18.Location = new Point(158, 211);
			this.comboBoxReadOnly_18.Name = "cbClutchHousing";
			this.comboBoxReadOnly_18.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_18.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_18.Size = new Size(220, 21);
			this.comboBoxReadOnly_18.TabIndex = 33;
			this.label_23.AutoSize = true;
			this.label_23.Location = new Point(10, 187);
			this.label_23.Name = "label31";
			this.label_23.Size = new Size(102, 13);
			this.label_23.TabIndex = 13;
			this.label_23.Text = "Прочие замечания";
			this.label_24.AutoSize = true;
			this.label_24.Location = new Point(10, 160);
			this.label_24.Name = "label30";
			this.label_24.Size = new Size(216, 13);
			this.label_24.TabIndex = 12;
			this.label_24.Text = "Количество лент изоляции жил, толщина";
			this.label_25.AutoSize = true;
			this.label_25.Location = new Point(10, 133);
			this.label_25.Name = "label29";
			this.label_25.Size = new Size(135, 13);
			this.label_25.TabIndex = 11;
			this.label_25.Text = "Состояние изоляции жил";
			this.label_26.AutoSize = true;
			this.label_26.Location = new Point(10, 106);
			this.label_26.Name = "label28";
			this.label_26.Size = new Size(238, 13);
			this.label_26.TabIndex = 10;
			this.label_26.Text = "Количество лент поясной изоляции, толщина";
			this.label_27.AutoSize = true;
			this.label_27.Location = new Point(10, 79);
			this.label_27.Name = "label27";
			this.label_27.Size = new Size(157, 13);
			this.label_27.TabIndex = 9;
			this.label_27.Text = "Состояние поясной изоляции";
			this.label_28.AutoSize = true;
			this.label_28.Location = new Point(10, 52);
			this.label_28.Name = "label26";
			this.label_28.Size = new Size(206, 13);
			this.label_28.TabIndex = 8;
			this.label_28.Text = "Состояние оболдочки кабеля, толщина";
			this.label_29.AutoSize = true;
			this.label_29.Location = new Point(10, 20);
			this.label_29.Name = "label25";
			this.label_29.Size = new Size(167, 13);
			this.label_29.TabIndex = 7;
			this.label_29.Text = "Состояние защитных покрытий";
			...
			this.comboBoxReadOnly_8.DataBindings.Add(new Binding("Text", this.bindingSource_0, "KKolLentGila", true));
			...
			this.comboBoxReadOnly_8.Location = new Point(253, 157);
			this.comboBoxReadOnly_8.Name = "cbQualityTapes";
			this.comboBoxReadOnly_8.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_8.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_8.Size = new Size(125, 21);
			this.comboBoxReadOnly_8.TabIndex = 31;
			...
			this.comboBoxReadOnly_9.DataBindings.Add(new Binding("Text", this.bindingSource_0, "KGila", true));
			...
			this.comboBoxReadOnly_9.Location = new Point(151, 130);
			this.comboBoxReadOnly_9.Name = "cbIsolationState";
			this.comboBoxReadOnly_9.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_9.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_9.Size = new Size(227, 21);
			this.comboBoxReadOnly_9.TabIndex = 30;
			...
			this.comboBoxReadOnly_10.DataBindings.Add(new Binding("Text", this.bindingSource_0, "KKolLentPoyas", true));
			...
			this.comboBoxReadOnly_10.Location = new Point(253, 103);
			this.comboBoxReadOnly_10.Name = "cbQualityInsulationState";
			this.comboBoxReadOnly_10.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_10.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_10.Size = new Size(125, 21);
			this.comboBoxReadOnly_10.TabIndex = 29;
			...
			this.comboBoxReadOnly_11.DataBindings.Add(new Binding("Text", this.bindingSource_0, "KPoyasIzol", true));
			...
			this.comboBoxReadOnly_11.Location = new Point(173, 76);
			this.comboBoxReadOnly_11.Name = "cbCableWrappingState";
			this.comboBoxReadOnly_11.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_11.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_11.Size = new Size(205, 21);
			this.comboBoxReadOnly_11.TabIndex = 28;
			...
			this.comboBoxReadOnly_12.DataBindings.Add(new Binding("Text", this.bindingSource_0, "KObolochka", true));
			...
			this.comboBoxReadOnly_12.Location = new Point(222, 49);
			this.comboBoxReadOnly_12.Name = "cbCableSheathState";
			this.comboBoxReadOnly_12.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_12.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_12.Size = new Size(156, 21);
			this.comboBoxReadOnly_12.TabIndex = 27;
			...
			this.comboBoxReadOnly_13.DataBindings.Add(new Binding("Text", this.bindingSource_0, "KZashPokr", true));
			...
			this.comboBoxReadOnly_13.Location = new Point(183, 17);
			this.comboBoxReadOnly_13.Name = "cbCableSheetingState";
			this.comboBoxReadOnly_13.ReadOnlyBackColor = Color.White;
			this.comboBoxReadOnly_13.ReadOnlyForeColor = SystemColors.WindowText;
			this.comboBoxReadOnly_13.Size = new Size(195, 21);
			this.comboBoxReadOnly_13.TabIndex = 26;
			...
			this.bindingSource_1.DataSource = this.class14_0;
			...
			this.rkymOfuPeBU.ResumeLayout(false);
		...
		private TabControl rkymOfuPeBU;
		...
		private ComboBoxReadOnly MhfmOcaixk2;
		...
		private ToolStripSeparator NkimJvVkguV;
