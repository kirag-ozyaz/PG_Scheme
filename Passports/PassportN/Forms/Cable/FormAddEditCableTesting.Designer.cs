...
namespace Passport.Forms.Cable
{
	public class FormAddEditCableTesting : FormBase
	{
		...
		public FormAddEditCableTesting(SQLSettings settings, int id, StateFormCreate state)
		{
			...
			if (state != null)
			{
				if (state == 1)
				{
					...
					base.SelectSqlData(this.class107_0, this.class107_0.tP_CabTesting, true, string.Format("WHERE id = {0} AND Deleted = ((0))", this.int_0));
					base.SelectSqlData(this.class107_0, this.class107_0.tP_ValueLists, true, string.Format("WHERE ParentId = {0} AND Deleted = ((0))", 389));
				}
			}
			else
			{
				...
				this.class107_0.tP_CabTesting.method_0(this.class107_0.tP_CabTesting.method_5());
				base.SelectSqlData(this.class107_0, this.class107_0.tP_ValueLists, true, string.Format("WHERE ParentId = {0} AND Deleted = ((0))", 389));
			}
		...
		{
			this.class107_0.tP_CabTesting.Rows[0]["idObjList"] = this.int_1;
			this.class107_0.tP_CabTesting.Rows[0]["Deleted"] = false;
			this.class107_0.tP_CabTesting.Rows[0].EndEdit();
			this.int_0 = base.InsertSqlDataOneRow(this.class107_0, this.class107_0.tP_CabTesting);
			return this.int_0 > 0;
		}
		...
		{
			this.class107_0.tP_CabTesting.Rows[0].EndEdit();
			return base.UpdateSqlData(this.class107_0, this.class107_0.tP_CabTesting);
		}
