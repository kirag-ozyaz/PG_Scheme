...
namespace Passport.Forms.Cable.Report
{
	public class FormCableTestingAfterRepair : FormBase
	{
		...
		{
			base.SelectSqlData(this.class14_0, this.class14_0.vP_PR_CableTestingAfterRepair, true, " ORDER BY RowNum");
		...
		private void method_0()
		{
			...
			this.HyYmsukIxEo = new DataGridViewFilterTextBoxColumn();
			...
			this.omimsifdfZx = new DataGridViewFilterTextBoxColumn();
			...
			this.HyYmsukIxEo.DataPropertyName = "id";
			this.HyYmsukIxEo.HeaderText = "id";
			this.HyYmsukIxEo.Name = "id";
			this.HyYmsukIxEo.ReadOnly = true;
			this.HyYmsukIxEo.Resizable = DataGridViewTriState.True;
			this.HyYmsukIxEo.Visible = false;
			this.dataGridViewFilterTextBoxColumn_1.DataPropertyName = "Name";
			this.dataGridViewFilterTextBoxColumn_1.HeaderText = "Наименование кабельной линии";
			this.dataGridViewFilterTextBoxColumn_1.Name = "cableName";
			this.dataGridViewFilterTextBoxColumn_1.ReadOnly = true;
			this.dataGridViewFilterTextBoxColumn_1.Resizable = DataGridViewTriState.True;
			this.dataGridViewFilterTextBoxColumn_1.Width = 200;
			...
			this.dataGridViewFilterTextBoxColumn_2.DataPropertyName = "Reason";
			this.dataGridViewFilterTextBoxColumn_2.HeaderText = "Причина повреждения";
			this.dataGridViewFilterTextBoxColumn_2.Name = "reason";
			...
			this.omimsifdfZx.DataPropertyName = "Period";
			this.omimsifdfZx.HeaderText = "Продолжительность эксплуатации";
			this.omimsifdfZx.Name = "period";
			this.omimsifdfZx.ReadOnly = true;
			this.omimsifdfZx.Resizable = DataGridViewTriState.True;
			this.omimsifdfZx.Width = 130;
			...
			this.dataGridViewFilterTextBoxColumn_3.DataPropertyName = "ReasonTesting";
			this.dataGridViewFilterTextBoxColumn_3.HeaderText = "Причина испытания";
			this.dataGridViewFilterTextBoxColumn_3.Name = "reasonTesting";
			...
			this.dataGridViewFilterTextBoxColumn_4.DataPropertyName = "Voltage";
			this.dataGridViewFilterTextBoxColumn_4.HeaderText = "Испытательное напряжение, кВ";
			this.dataGridViewFilterTextBoxColumn_4.Name = "voltage";
			...
			this.dataGridViewFilterTextBoxColumn_4.Width = 120;
			this.dataGridViewFilterTextBoxColumn_5.DataPropertyName = "Duration";
			this.dataGridViewFilterTextBoxColumn_5.HeaderText = "Продолжительность испытания, мин.";
			this.dataGridViewFilterTextBoxColumn_5.Name = "duration";
			...
			this.dataGridViewFilterTextBoxColumn_5.Width = 130;
			this.dataGridViewFilterTextBoxColumn_6.DataPropertyName = "Conclusion";
			this.dataGridViewFilterTextBoxColumn_6.HeaderText = "Заключение";
			this.dataGridViewFilterTextBoxColumn_6.Name = "conclusion";
		...
		private DataGridViewFilterTextBoxColumn HyYmsukIxEo;
		...
		private DataGridViewFilterTextBoxColumn omimsifdfZx;
