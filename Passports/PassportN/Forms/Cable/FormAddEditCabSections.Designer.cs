...
namespace Passport.Forms.Cable
{
	public class FormAddEditCabSections : FormBase
	{
		...
		private void JhImJzvUwoK(int int_4)
		{
			this.method_1();
			this.comboBox_0.SelectedValue = int_4;
		}
		...
		{
			this.method_3();
			this.comboBox_1.SelectedValue = int_4;
		}
		...
		private void method_5(int int_4)
		{
			...
			base.SelectSqlData(this.class107_0, this.class107_0.tP_CabSection, true, text);
			int.TryParse(this.class107_0.tP_CabSection.Rows[0]["idClutchFirst"].ToString(), out num);
			int.TryParse(this.class107_0.tP_CabSection.Rows[0]["idClutchSecond"].ToString(), out num2);
			this.comboBox_0.SelectedValue = num;
			this.comboBox_1.SelectedValue = num2;
			this.numericUpDown_0.Value = (int.TryParse(this.class107_0.tP_CabSection.Rows[0]["Number"].ToString(), out num3) ? num3 : 0);
			this.comboBox_2.SelectedValue = (int.TryParse(this.class107_0.tP_CabSection.Rows[0]["CableMakeup"].ToString(), out num4) ? num4 : -1);
			this.textBox_0.Text = this.class107_0.tP_CabSection.Rows[0]["Voltage"].ToString();
			this.textBox_1.Text = this.class107_0.tP_CabSection.Rows[0]["Wires"].ToString();
			this.textBox_2.Text = this.class107_0.tP_CabSection.Rows[0]["CrossSection"].ToString();
			this.textBox_3.Text = this.class107_0.tP_CabSection.Rows[0]["Length"].ToString();
			this.comboBox_3.SelectedValue = ((this.class107_0.tP_CabSection.Rows[0]["Conditions"] != DBNull.Value) ? ((int)this.class107_0.tP_CabSection.Rows[0]["Conditions"]) : -1);
			this.numericUpDown_1.Text = this.class107_0.tP_CabSection.Rows[0]["Count"].ToString();
			this.nullableDateTimePicker_2.Value = this.class107_0.tP_CabSection.Rows[0]["YearLaying"];
			this.nullableDateTimePicker_1.Value = this.class107_0.tP_CabSection.Rows[0]["YearCommissioning"];
			this.nullableDateTimePicker_0.Value = this.class107_0.tP_CabSection.Rows[0]["YearRenovation"];
			this.textBox_4.Text = this.class107_0.tP_CabSection.Rows[0]["Comment"].ToString();
		}

		private bool method_6()
		{
			if (this.method_9(this.int_0))
			{
				return false;
			}
			...
			@class["Count"] = (int.TryParse(this.numericUpDown_1.Text, out this.frvmvyddvwM) ? this.frvmvyddvwM : 0);
			...
			return base.UpdateSqlData(this.class107_0, this.class107_0.tP_CabSection);
		}
		...
		private bool method_7()
		{
			...
			this.int_0 = base.InsertSqlDataOneRow(this.class107_0, this.class107_0.tP_CabSection);
			if (this.int_0 > 0)
			{
				return true;
			}
		...
		{
			return this.method_9(-1);
		}

		private bool method_9(int int_4)
		{
			if (Clutch.isExistIntoCabSection(this.SqlSettings, this.int_1, int_4, (int)this.comboBox_0.SelectedValue, SectionClutch.First))
			{
			...
			if (Clutch.isExistIntoCabSection(this.SqlSettings, this.int_1, int_4, (int)this.comboBox_1.SelectedValue, SectionClutch.Second))
			{
				MessageBox.Show("Невозможно выбрать данную муфту.", "Ошибка!", MessageBoxButtons.OK, MessageBoxIcon.Hand);
		...
		{
			Form3 form = new Form3(this.SqlSettings, this.int_1, 0);
			form.method_3(TypeClutch.End);
			if (form.ShowDialog() == DialogResult.OK)
			{
				this.JhImJzvUwoK(form.Id);
			}
		}
		...
		private void button_4_Click(object sender, EventArgs e)
		{
			...
			formReferValueLists.FormClosed += this.method_11;
		...
		private void method_10()
		{
			...
			if (sqlDataCommand.SelectSqlData("SELECT * FROM tP_ValueLists WHERE ParentKey = ';Param;CableSection;Laying;' AND isGroup = ((1)) AND Deleted = ((0))").Rows.Count <= 0)
			{
				...
				sqlDataCommand.InsertSqlData(this.class107_0, this.class107_0.tP_ValueLists);
			}
		}
		...
		{
			base.SelectSqlDataTableOther(this.class107_0, this.class107_0.tP_ValueList, "tP_ValueLists", true, "WHERE ParentKey = ';Param;CableSection;Laying;' AND Deleted = ((0)) AND isGroup = ((0))");
		}
		...
		private void method_13()
		{
			...
			this.KslmvofXgwt.AutoSize = true;
			this.KslmvofXgwt.Location = new Point(262, 168);
			this.KslmvofXgwt.Name = "label13";
			this.KslmvofXgwt.Size = new Size(112, 13);
			this.KslmvofXgwt.TabIndex = 18;
			this.KslmvofXgwt.Text = "Дата реконструкции";
			this.label_12.AutoSize = true;
			this.label_12.Location = new Point(262, 194);
			this.label_12.Name = "label14";
			this.label_12.Size = new Size(77, 13);
			this.label_12.TabIndex = 18;
			this.label_12.Text = "Комментарий";
			...
			this.button_3.Image = Resources.smethod_0();
			...
			this.button_2.Image = Resources.smethod_0();
			...
			base.Controls.Add(this.KslmvofXgwt);
