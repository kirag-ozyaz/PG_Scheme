...
namespace Passport.Forms.Cable
{
	public class FormLoadOldCablePassport : FormBase
	{
		...
		private void iUomGcleiCX_Click(object sender, EventArgs e)
		{
		...
		private void method_1()
		{
			...
			this.WpfmGwduofV = new DataGridViewTextBoxColumn();
			...
			this.tableLayoutPanel_0.Controls.Add(this.iUomGcleiCX, 1, 2);
			...
			this.iUomGcleiCX.Dock = DockStyle.Right;
			this.iUomGcleiCX.Location = new Point(497, 351);
			this.iUomGcleiCX.Margin = new Padding(3, 10, 10, 10);
			this.iUomGcleiCX.Name = "btnAccept";
			this.iUomGcleiCX.Size = new Size(100, 23);
			this.iUomGcleiCX.TabIndex = 1;
			this.iUomGcleiCX.Text = "Применить";
			this.iUomGcleiCX.UseVisualStyleBackColor = true;
			this.iUomGcleiCX.Click += this.iUomGcleiCX_Click;
			this.button_0.Dock = DockStyle.Left;
			this.button_0.Location = new Point(617, 351);
			this.button_0.Margin = new Padding(10, 10, 3, 10);
			...
			this.button_1.Location = new Point(617, 8);
			this.button_1.Margin = new Padding(10, 8, 10, 3);
			this.button_1.Name = "btnFind";
			...
			this.WpfmGwduofV.DataPropertyName = "Type2";
			this.WpfmGwduofV.HeaderText = "ТП/РП/П";
			this.WpfmGwduofV.Name = "dataGridViewTextBoxColumn6";
			this.WpfmGwduofV.Width = 60;
			this.dataGridViewTextBoxColumn_14.DataPropertyName = "SS2";
			this.dataGridViewTextBoxColumn_14.HeaderText = "ТП2";
			this.dataGridViewTextBoxColumn_14.Name = "dataGridViewTextBoxColumn7";
			this.dataGridViewTextBoxColumn_15.DataPropertyName = "PrimVL";
			this.dataGridViewTextBoxColumn_15.HeaderText = "Прим. ВЛ";
			this.dataGridViewTextBoxColumn_15.Name = "dataGridViewTextBoxColumn8";
			this.dataGridViewTextBoxColumn_16.DataPropertyName = "Cell2";
			this.dataGridViewTextBoxColumn_16.HeaderText = "Ячейка";
			this.dataGridViewTextBoxColumn_16.Name = "dataGridViewTextBoxColumn9";
			this.dataGridViewTextBoxColumn_16.Width = 50;
		...
		private DataGridViewTextBoxColumn WpfmGwduofV;
