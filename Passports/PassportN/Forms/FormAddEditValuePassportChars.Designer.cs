...
namespace Passport.Forms
{
	public class FormAddEditValuePassportChars : DockContentBase
	{
		...
		public FormAddEditValuePassportChars(SQLSettings SqlSettings, StateFormCreate State, int idObj = -1, int idPassport = -1)
		{
			...
			new Dictionary<string, string>().Add(this.class107_0.tAbn.TableName, "");
			this.dataGridViewPassport_0.EnableDragDrop = true;
			this.dataGridViewPassport_0.DragDropComplite = true;
			base.SelectSqlData(this.class107_0.tSchm_ObjList, true, "where id = " + idObj.ToString(), null, false, 0);
			...
			base.SelectSqlData(this.class107_0, this.class107_0.tP_Passport, true, string.Format("where id = '{0}'", idPassport));
		...
		private void toolStripButton_1_Click(object sender, EventArgs e)
		{
			if (this.dataGridViewPassport_0.CurrentRow != null)
			{
				if ((bool)this.dataGridViewPassport_0.CurrentRow.Cells["isGroupChar"].Value)
				{
					...
					{
						base.SelectSqlData(this.class107_0.tP_CharList, true, string.Format("where id = {0} or ParentId = {0}", (int)this.dataGridViewPassport_0.CurrentRow.Cells["idChar"].Value), null, true, 0);
				...
				{
					base.SelectSqlData(this.class107_0.tP_CharList, true, "where id = " + (int)this.dataGridViewPassport_0.CurrentRow.Cells["idChar"].Value, null, true, 0);
		...
		private void toolStripMenuItem_1_Click(object sender, EventArgs e)
		{
			if (this.dataGridViewPassport_0.CurrentRow != null)
			{
				...
				if ((bool)this.dataGridViewPassport_0.CurrentRow.Cells["isGroupChar"].Value)
				{
					id = (int)this.dataGridViewPassport_0.CurrentRow.Cells["idChar"].Value;
				}
				else
				{
					id = (int)this.dataGridViewPassport_0.CurrentRow.Cells["ParentIdChar"].Value;
				}
				if (new FormAddEditPassportChar(this.SqlSettings, 4, id, this.dataGridViewPassport_0.RowCount + 1)
				{
		...
		private void button_0_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					this.dataGridViewPassport_0.SaveInsertedData(this.dateTimePicker_0.Value, Convert.ToInt32(this.class107_0.tP_Passport[0]["Number"]));
				}
				if (this.stateFormCreate_0 == 1)
				{
					this.dataGridViewPassport_0.SaveUpdatedData(this.dateTimePicker_0.Value, this.int_1, Convert.ToInt32(this.class107_0.tP_Passport[0]["Number"]));
				}
		...
		private void method_1()
		{
			...
			this.xvwjkweeES = new DataGridViewTextBoxColumn();
			...
			this.OgSjbxfqtu = new DataGridViewTextBoxColumn();
			...
			this.PrwjoHnciK = new DataGridViewTextBoxColumn();
			...
			this.YgfjYlvTuc = new DataGridViewTextBoxColumn();
			...
			this.gKkWbavYtE = new DataGridViewTextBoxColumn();
			...
			this.textBox_0.DataBindings.Add(new Binding("Text", this.class107_0, "tSchm_ObjList.Name", true));
			...
			this.numericUpDown_0.DataBindings.Add(new Binding("Value", this.class107_0, "tP_Passport.Number", true));
			...
			this.dataGridViewTextBoxColumn_100.Name = "dataGridViewTextBoxColumn106";
			...
			this.dataGridViewTextBoxColumn_101.Name = "dataGridViewTextBoxColumn107";
			...
			this.dataGridViewTextBoxColumn_102.Name = "dataGridViewTextBoxColumn108";
			...
			this.dataGridViewTextBoxColumn_103.Name = "dataGridViewTextBoxColumn109";
			...
			this.dataGridViewTextBoxColumn_104.Name = "dataGridViewTextBoxColumn110";
			...
			this.dataGridViewTextBoxColumn_95.Name = "dataGridViewTextBoxColumn101";
			...
			this.dataGridViewTextBoxColumn_96.Name = "dataGridViewTextBoxColumn102";
			...
			this.dataGridViewTextBoxColumn_97.Name = "dataGridViewTextBoxColumn103";
			...
			this.dataGridViewTextBoxColumn_98.Name = "dataGridViewTextBoxColumn104";
			...
			this.dataGridViewTextBoxColumn_99.Name = "dataGridViewTextBoxColumn105";
			...
			this.dataGridViewTextBoxColumn_90.Name = "dataGridViewTextBoxColumn96";
			...
			this.dataGridViewTextBoxColumn_91.Name = "dataGridViewTextBoxColumn97";
			...
			this.dataGridViewTextBoxColumn_92.Name = "dataGridViewTextBoxColumn98";
			...
			this.dataGridViewTextBoxColumn_93.Name = "dataGridViewTextBoxColumn99";
			...
			this.dataGridViewTextBoxColumn_94.Name = "dataGridViewTextBoxColumn100";
			...
			this.dataGridViewTextBoxColumn_85.Name = "dataGridViewTextBoxColumn91";
			...
			this.dataGridViewTextBoxColumn_86.Name = "dataGridViewTextBoxColumn92";
			...
			this.dataGridViewTextBoxColumn_87.Name = "dataGridViewTextBoxColumn93";
			...
			this.dataGridViewTextBoxColumn_88.Name = "dataGridViewTextBoxColumn94";
			...
			this.dataGridViewTextBoxColumn_89.Name = "dataGridViewTextBoxColumn95";
			...
			this.dataGridViewTextBoxColumn_80.Name = "dataGridViewTextBoxColumn86";
			...
			this.dataGridViewTextBoxColumn_81.Name = "dataGridViewTextBoxColumn87";
			...
			this.dataGridViewTextBoxColumn_82.Name = "dataGridViewTextBoxColumn88";
			...
			this.dataGridViewTextBoxColumn_83.Name = "dataGridViewTextBoxColumn89";
			...
			this.dataGridViewTextBoxColumn_84.Name = "dataGridViewTextBoxColumn90";
			...
			this.dataGridViewTextBoxColumn_75.Name = "dataGridViewTextBoxColumn81";
			...
			this.dataGridViewTextBoxColumn_76.Name = "dataGridViewTextBoxColumn82";
			...
			this.dataGridViewTextBoxColumn_77.Name = "dataGridViewTextBoxColumn83";
			...
			this.dataGridViewTextBoxColumn_78.Name = "dataGridViewTextBoxColumn84";
			...
			this.dataGridViewTextBoxColumn_79.Name = "dataGridViewTextBoxColumn85";
			...
			this.xvwjkweeES.HeaderText = "idChar";
			this.xvwjkweeES.Name = "dataGridViewTextBoxColumn76";
			this.xvwjkweeES.ReadOnly = true;
			this.xvwjkweeES.SortMode = DataGridViewColumnSortMode.Programmatic;
			this.xvwjkweeES.Visible = false;
			this.dataGridViewTextBoxColumn_71.HeaderText = "ParentIdChar";
			this.dataGridViewTextBoxColumn_71.Name = "dataGridViewTextBoxColumn77";
			...
			this.dataGridViewTextBoxColumn_72.Name = "dataGridViewTextBoxColumn78";
			...
			this.dataGridViewTextBoxColumn_73.Name = "dataGridViewTextBoxColumn79";
			...
			this.dataGridViewTextBoxColumn_74.Name = "dataGridViewTextBoxColumn80";
			...
			this.dataGridViewTextBoxColumn_67.HeaderText = "idChar";
			this.dataGridViewTextBoxColumn_67.Name = "dataGridViewTextBoxColumn71";
			...
			this.OgSjbxfqtu.HeaderText = "ParentIdChar";
			this.OgSjbxfqtu.Name = "dataGridViewTextBoxColumn72";
			this.OgSjbxfqtu.ReadOnly = true;
			this.OgSjbxfqtu.SortMode = DataGridViewColumnSortMode.Programmatic;
			this.OgSjbxfqtu.Visible = false;
			this.dataGridViewTextBoxColumn_68.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_68.Name = "dataGridViewTextBoxColumn73";
			this.dataGridViewTextBoxColumn_68.ReadOnly = true;
			this.dataGridViewTextBoxColumn_68.Visible = false;
			this.dataGridViewTextBoxColumn_69.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
			this.dataGridViewTextBoxColumn_69.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_69.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_69.Name = "dataGridViewTextBoxColumn74";
			...
			this.dataGridViewTextBoxColumn_70.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			this.dataGridViewTextBoxColumn_70.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_70.Name = "dataGridViewTextBoxColumn75";
			...
			this.dataGridViewTextBoxColumn_63.Name = "dataGridViewTextBoxColumn66";
			...
			this.dataGridViewTextBoxColumn_64.Name = "dataGridViewTextBoxColumn67";
			...
			this.dataGridViewTextBoxColumn_65.Name = "dataGridViewTextBoxColumn68";
			this.dataGridViewTextBoxColumn_65.ReadOnly = true;
			this.dataGridViewTextBoxColumn_65.Visible = false;
			this.PrwjoHnciK.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
			this.PrwjoHnciK.FillWeight = 150f;
			this.PrwjoHnciK.HeaderText = "Характеристика";
			this.PrwjoHnciK.Name = "dataGridViewTextBoxColumn69";
			this.PrwjoHnciK.ReadOnly = true;
			this.PrwjoHnciK.Resizable = DataGridViewTriState.True;
			this.PrwjoHnciK.SortMode = DataGridViewColumnSortMode.Programmatic;
			this.dataGridViewTextBoxColumn_66.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			this.dataGridViewTextBoxColumn_66.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_66.Name = "dataGridViewTextBoxColumn70";
			...
			this.dataGridViewTextBoxColumn_58.Name = "dataGridViewTextBoxColumn61";
			...
			this.dataGridViewTextBoxColumn_59.Name = "dataGridViewTextBoxColumn62";
			...
			this.dataGridViewTextBoxColumn_60.Name = "dataGridViewTextBoxColumn63";
			...
			this.dataGridViewTextBoxColumn_61.Name = "dataGridViewTextBoxColumn64";
			...
			this.dataGridViewTextBoxColumn_62.Name = "dataGridViewTextBoxColumn65";
			...
			this.dataGridViewTextBoxColumn_54.HeaderText = "idChar";
			this.dataGridViewTextBoxColumn_54.Name = "dataGridViewTextBoxColumn56";
			...
			this.YgfjYlvTuc.HeaderText = "ParentIdChar";
			this.YgfjYlvTuc.Name = "dataGridViewTextBoxColumn57";
			this.YgfjYlvTuc.ReadOnly = true;
			this.YgfjYlvTuc.SortMode = DataGridViewColumnSortMode.Programmatic;
			this.YgfjYlvTuc.Visible = false;
			this.dataGridViewTextBoxColumn_55.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_55.Name = "dataGridViewTextBoxColumn58";
			...
			this.dataGridViewTextBoxColumn_56.Name = "dataGridViewTextBoxColumn59";
			...
			this.dataGridViewTextBoxColumn_57.Name = "dataGridViewTextBoxColumn60";
			...
			this.dataGridViewTextBoxColumn_49.Name = "dataGridViewTextBoxColumn51";
			...
			this.dataGridViewTextBoxColumn_50.Name = "dataGridViewTextBoxColumn52";
			...
			this.dataGridViewTextBoxColumn_51.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_51.Name = "dataGridViewTextBoxColumn53";
			this.dataGridViewTextBoxColumn_51.ReadOnly = true;
			this.dataGridViewTextBoxColumn_51.Visible = false;
			this.dataGridViewTextBoxColumn_52.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCellsExceptHeader;
			this.dataGridViewTextBoxColumn_52.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_52.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_52.Name = "dataGridViewTextBoxColumn54";
			...
			this.dataGridViewTextBoxColumn_53.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_53.Name = "dataGridViewTextBoxColumn55";
			...
			this.dataGridViewTextBoxColumn_44.Name = "dataGridViewTextBoxColumn46";
			...
			this.dataGridViewTextBoxColumn_45.Name = "dataGridViewTextBoxColumn47";
			...
			this.dataGridViewTextBoxColumn_46.Name = "dataGridViewTextBoxColumn48";
			...
			this.dataGridViewTextBoxColumn_47.Name = "dataGridViewTextBoxColumn49";
			...
			this.dataGridViewTextBoxColumn_48.Name = "dataGridViewTextBoxColumn50";
			...
			this.dataGridViewTextBoxColumn_39.Name = "dataGridViewTextBoxColumn41";
			...
			this.dataGridViewTextBoxColumn_40.Name = "dataGridViewTextBoxColumn42";
			...
			this.dataGridViewTextBoxColumn_41.Name = "dataGridViewTextBoxColumn43";
			...
			this.dataGridViewTextBoxColumn_42.Name = "dataGridViewTextBoxColumn44";
			...
			this.dataGridViewTextBoxColumn_43.Name = "dataGridViewTextBoxColumn45";
			...
			this.dataGridViewTextBoxColumn_34.Name = "dataGridViewTextBoxColumn36";
			...
			this.dataGridViewTextBoxColumn_35.Name = "dataGridViewTextBoxColumn37";
			...
			this.dataGridViewTextBoxColumn_36.Name = "dataGridViewTextBoxColumn38";
			...
			this.dataGridViewTextBoxColumn_37.FillWeight = 150f;
			this.dataGridViewTextBoxColumn_37.HeaderText = "Характеристика";
			this.dataGridViewTextBoxColumn_37.Name = "dataGridViewTextBoxColumn39";
			...
			this.dataGridViewTextBoxColumn_38.HeaderText = "Значение";
			this.dataGridViewTextBoxColumn_38.Name = "dataGridViewTextBoxColumn40";
			...
			this.dataGridViewTextBoxColumn_29.Name = "dataGridViewTextBoxColumn31";
			...
			this.dataGridViewTextBoxColumn_30.Name = "dataGridViewTextBoxColumn32";
			...
			this.dataGridViewTextBoxColumn_31.Name = "dataGridViewTextBoxColumn33";
			...
			this.dataGridViewTextBoxColumn_32.Name = "dataGridViewTextBoxColumn34";
			...
			this.dataGridViewTextBoxColumn_33.Name = "dataGridViewTextBoxColumn35";
			...
			this.dataGridViewTextBoxColumn_24.HeaderText = "idChar";
			...
			this.dataGridViewTextBoxColumn_25.HeaderText = "ParentIdChar";
			this.dataGridViewTextBoxColumn_25.Name = "dataGridViewTextBoxColumn27";
			...
			this.dataGridViewTextBoxColumn_26.HeaderText = "TabIndexChar";
			this.dataGridViewTextBoxColumn_26.Name = "dataGridViewTextBoxColumn28";
			...
			this.dataGridViewTextBoxColumn_27.Name = "dataGridViewTextBoxColumn29";
			...
			this.dataGridViewTextBoxColumn_28.Name = "dataGridViewTextBoxColumn30";
			...
			this.gKkWbavYtE.HeaderText = "idChar";
			this.gKkWbavYtE.Name = "dataGridViewTextBoxColumn21";
			this.gKkWbavYtE.ReadOnly = true;
			this.gKkWbavYtE.SortMode = DataGridViewColumnSortMode.Programmatic;
			this.gKkWbavYtE.Visible = false;
			this.dataGridViewTextBoxColumn_20.HeaderText = "ParentIdChar";
			...
			this.dataGridViewTextBoxColumn_21.HeaderText = "TabIndexChar";
			...
			this.dataGridViewTextBoxColumn_22.HeaderText = "Характеристика";
			...
			this.dataGridViewTextBoxColumn_23.HeaderText = "Значение";
		...
		private DataGridViewTextBoxColumn gKkWbavYtE;
		...
		private DataGridViewTextBoxColumn YgfjYlvTuc;
		...
		private DataGridViewTextBoxColumn PrwjoHnciK;
		...
		private DataGridViewTextBoxColumn OgSjbxfqtu;
		...
		private DataGridViewTextBoxColumn xvwjkweeES;
