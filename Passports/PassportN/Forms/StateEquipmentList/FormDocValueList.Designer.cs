...
namespace Passport.Forms.StateEquipmentList
{
	public class FormDocValueList : DockContentBase
	{
		...
		{
			base.SelectSqlData(this.class14_0, this.class14_0.vP_GetDocGroupState, true, "where not (isGroup = 0 and level = 1) order by level, isGroup, Name");
			DataRow[] array = this.class14_0.vP_GetDocGroupState.Select("ParentId = " + 682.ToString());
		...
		{
			foreach (DataRow dataRow in this.class14_0.vP_GetDocGroupState.Select("ParentId = " + treeNode_0.Tag.ToString()))
			{
				TreeNode treeNode = new TreeNode(dataRow["Name"].ToString());
				treeNode.Name = dataRow["Name"].ToString();
				treeNode.Tag = dataRow["Id"];
		...
		{
			this.method_7((int)this.treeView_0.SelectedNode.Tag);
		}
		...
		private void toolStripMenuItem_0_Click(object sender, EventArgs e)
		{
			if (this.treeView_0.SelectedNode != null && this.treeView_0.SelectedNode.Parent != null)
			{
				...
				if (selectedNode.ImageIndex == this.imageList_0.Images.IndexOfKey("Document"))
				{
					...
					formAddEditGroupValue.method_1(0);
				}
				...
				if (formAddEditGroupValue.method_0() == null && formAddEditGroupValue.ShowDialog() != DialogResult.Cancel)
				{
					this.method_9(formAddEditGroupValue.Id);
				}
		...
		private void WbOwfAuSnB_Click(object sender, EventArgs e)
		{
			if (this.treeView_0.SelectedNode != null)
			{
				...
				{
					base.SelectSqlDataTableOther(this.class14_0, this.class14_0.tR_DocValueListDeleted, "tR_DocValueList", true, string.Format("where id = {0} or parentId = {0}", this.treeView_0.SelectedNode.Tag));
					foreach (Class14.Class64 @class in this.class14_0.tR_DocValueListDeleted)
					{
						@class.Deleted = true;
					}
					base.UpdateSqlDataTableOther(this.class14_0, this.class14_0.tR_DocValueListDeleted, "tR_DocValueList");
					this.method_0(";TypeDoc;tPassport;");
					this.method_9(int_);
					return;
				}
		...
		private void toolStripButton_0_Click(object sender, EventArgs e)
		{
			...
			{
				Form0 form = new Form0(this.SqlSettings, (int)this.treeView_0.SelectedNode.Tag, this.method_4(this.treeView_0.SelectedNode));
				form.ShowDialog();
				this.method_8((int)this.treeView_0.SelectedNode.Tag, form.Id);
				form.Dispose();
			}
		}
		...
		private void toolStripButton_1_Click(object sender, EventArgs e)
		{
			...
			{
				Form0 form = new Form0(this.SqlSettings, (int)this.dataGridView_0.CurrentRow.Cells["id"].Value);
				form.ShowDialog();
				form.Dispose();
				this.method_8((int)this.treeView_0.SelectedNode.Tag, (int)this.dataGridView_0.CurrentRow.Cells["id"].Value);
			}
		}
		...
		private void toolStripButton_2_Click(object sender, EventArgs e)
		{
			...
			{
				this.class14_0.tR_DocValueList.Select("id = " + this.dataGridView_0.CurrentRow.Cells["id"].Value.ToString())[0]["Deleted"] = true;
		...
		private TreeNode method_5(TreeNodeCollection treeNodeCollection_0, int int_1)
		{
			foreach (object obj in treeNodeCollection_0)
			{
				TreeNode treeNode = (TreeNode)obj;
				if ((int)treeNode.Tag == int_1)
				{
					return treeNode;
				}
			}
		...
		private void toolStripButton_5_Click(object sender, EventArgs e)
		{
			...
			list_ = this.mEqkPyNwWk(this.treeView_0.Nodes, list_);
			TreeNode treeNode = this.method_6(list_, this.treeView_0.SelectedNode, this.toolStripTextBox_0.Text);
			if (treeNode != null)
			{
		...
		private List<TreeNode> mEqkPyNwWk(TreeNodeCollection treeNodeCollection_0, List<TreeNode> list_1)
		{
			foreach (object obj in treeNodeCollection_0)
			{
				TreeNode treeNode = (TreeNode)obj;
				list_1.Add(treeNode);
				list_1 = this.mEqkPyNwWk(treeNode.Nodes, list_1);
			}
			return list_1;
		}

		private TreeNode method_6(List<TreeNode> list_1, TreeNode treeNode_0, string string_0)
		{
			bool flag = false;
		...
		private void method_7(int int_1)
		{
			...
			{
				base.SelectSqlData(this.class14_0.tR_DocValueList, true, "where ParentId = " + int_1.ToString() + " and isGroup = 0 and deleted = 0  order by Name", null, true, 0);
				this.dataGridView_0.DataSource = this.class14_0.tR_DocValueList;
			...
			{
				this.class14_0.tR_DocValueList.Rows.Clear();
			}
		}
		...
		private void method_8(int int_1, int int_2)
		{
			if (this.treeView_0.SelectedNode != null && this.treeView_0.SelectedNode.ImageIndex == this.imageList_0.Images.IndexOfKey("Group"))
			{
				...
				{
					if ((int)this.dataGridView_0.Rows[i].Cells["id"].Value == int_2)
					{
		...
		private void method_9(int int_1)
		{
			...
			list = this.mEqkPyNwWk(this.treeView_0.Nodes, list);
		...
		private void method_10()
		{
			...
			foreach (TreeNode treeNode2 in list)
			{
				...
				continue;
				IL_125:
				if ((int)treeNode2.Tag == this.int_0)
				{
					goto IL_117;
				}
			}
		...
		private void method_11()
		{
			...
			this.WbOwfAuSnB = new ToolStripMenuItem();
			...
			this.toolStripButton_0.Image = Resources.smethod_1();
			...
			this.toolStripButton_1.Image = Resources.smethod_2();
			...
			this.toolStripButton_6.Image = Resources.smethod_24();
			...
			this.toolStripButton_3.Image = Resources.smethod_26();
			...
			this.toolStripButton_4.Image = Resources.smethod_25();
			...
			this.toolStripButton_4.Click += this.WbOwfAuSnB_Click;
			...
			this.toolStripButton_5.Image = Resources.smethod_30();
			...
			this.toolStripButton_7.Image = Resources.smethod_45();
			...
			this.WbOwfAuSnB.Image = Resources.smethod_25();
			this.WbOwfAuSnB.Name = "tscmiDeleteGroup";
			this.WbOwfAuSnB.Size = new Size(154, 22);
			this.WbOwfAuSnB.Text = "Удалить";
			this.WbOwfAuSnB.Click += this.WbOwfAuSnB_Click;
		...
		private ToolStripMenuItem WbOwfAuSnB;
