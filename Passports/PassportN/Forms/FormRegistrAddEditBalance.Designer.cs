...
namespace Passport.Forms
{
	public class FormRegistrAddEditBalance : FormBase
	{
		...
		public FormRegistrAddEditBalance(SQLSettings settings, int id, StateFormCreate state)
		{
			Class330.Mus9JxKz1CNxy();
			base..ctor();
			this.method_3();
		...
		{
			base.SelectSqlData(this.class107_0, this.class107_0.tAbn, true, "WHERE Deleted = ((0)) AND TypeAbn IN (207, 230, 231, 614, 683)");
		...
		{
			base.SelectSqlData(this.class107_0, this.class107_0.tP_DocList, true, "WHERE Id = " + this.int_0.ToString());
			this.class248_0 = (Class107.Class248)this.class107_0.tP_DocList.Rows[0];
			this.textBox_0.Text = this.class248_0.NumberDoc;
			this.comboBox_0.SelectedText = this.class248_0.Comment;
			this.dateTimePicker_0.Value = this.class248_0.DateDoc;
			this.textBox_1.Text = this.class248_0.Comment2;
		}
		...
		private void method_2()
		{
			...
			if (stateFormCreate == null)
			{
				...
				@class.Comment2 = this.textBox_1.Text;
				@class.TypeDoc = 960;
				@class.isActive = true;
				@class.Deleted = false;
				this.class107_0.tP_DocList.method_0(@class);
				this.int_0 = base.InsertSqlDataOneRow(this.class107_0, this.class107_0.tP_DocList);
				return;
			}
			...
			this.class248_0.DateDoc = this.dateTimePicker_0.Value;
			this.class248_0.NumberDoc = this.textBox_0.Text;
			this.class248_0.Comment = this.comboBox_0.Text;
			this.class248_0.Comment2 = this.textBox_1.Text;
		...
		private Class107.Class248 class248_0;
