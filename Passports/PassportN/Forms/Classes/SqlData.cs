...
namespace Passport.Forms.Classes
{
	...
	{
		public static bool SelectSqlData(SQLSettings SqlSettings, DataSet ds, DataTable dt, bool withGetSqlPermission, string where, bool distinct)
		{
			return SqlData.SelectSqlData(SqlSettings, ds, dt.TableName, withGetSqlPermission, where, distinct);
		}

		public static bool SelectSqlData(SQLSettings SqlSettings, DataSet ds, string tableName, bool withGetSqlPermission, string where, bool distinct)
		{
			DataTable dataTable;
			...
			try
			{
				...
				new SqlDataAdapter(text, sqlDataConnect.Connection).Fill(ds, tableName);
				return true;
			}
			catch (Exception ex)
			{
		...
		public static bool SelectSqlDataTableOther(SQLSettings SqlSettings, DataSet ds, DataTable dt, string tableNameSql, bool withGetSqlPermission, string where)
		{
			return SqlData.SelectSqlDataTableOther(SqlSettings, ds, dt.TableName, tableNameSql, withGetSqlPermission, where, -1);
		}

		public static bool SelectSqlDataTableOther(SQLSettings SqlSettings, DataSet ds, string tableName, string tableNameSql, bool withGetSqlPermission, string where, int countRows)
		{
			DataTable dataTable;
			if (withGetSqlPermission)
			{
		...
		public static bool UpdateSqlData(SQLSettings SqlSettings, DataSet ds, DataTable dt)
		{
			SqlDataConnect sqlDataConnect = new SqlDataConnect();
			try
			{
		...
		public static bool UpdateSqlData(SQLSettings SqlSettings, DataSet ds, DataTable dt, ref SqlTransaction transaction)
		{
			if (transaction == null)
			{
				SqlData.UpdateSqlData(SqlSettings, ds, dt);
			}
		...
		public static bool UpdateSqlDataTableOther(SQLSettings SqlSettings, DataSet ds, DataTable dt, string tableNameSql)
		{
			SqlDataConnect sqlDataConnect = new SqlDataConnect();
			try
			{
		...
		public static bool UpdateSqlDataTableOther(SQLSettings SqlSettings, DataSet ds, DataTable dt, string tableNameSql, ref SqlTransaction transaction)
		{
			if (transaction == null)
			{
				SqlData.UpdateSqlDataTableOther(SqlSettings, ds, dt, tableNameSql);
			}
			SqlDataConnect sqlDataConnect = new SqlDataConnect(transaction.Connection);
			try
			{
		...
		public static bool InsertSqlData(SQLSettings SqlSettings, DataSet ds, DataTable dt)
		{
			SqlDataConnect sqlDataConnect = new SqlDataConnect();
			try
			{
		...
		public static int InsertSqlDataOneRow(SQLSettings SqlSettings, DataSet ds, DataTable dt)
		{
			SqlDataConnect sqlDataConnect = new SqlDataConnect();
			int result = -1;
			try
			{
				...
				sqlCommand.ExecuteNonQuery();
				sqlCommand.CommandText = "select IDENT_CURRENT('" + dt.TableName + "')";
