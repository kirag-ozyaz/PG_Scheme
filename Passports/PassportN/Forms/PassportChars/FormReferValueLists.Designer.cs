...
namespace Passport.Forms.PassportChars
{
	public class FormReferValueLists : FormBase
	{
		...
		{
			base.SelectSqlDataTableOther(this.NfdmmyvrKue, this.NfdmmyvrKue.vP_GetGroupList, "vP_GetValueList", true, "WHERE Deleted = ((0)) AND isGroup = ((1)) AND ParentKey = '" + this.GroupKey + "' ORDER BY Name");
		...
		{
			base.SelectSqlDataTableOther(this.NfdmmyvrKue, this.NfdmmyvrKue.tP_ValueList, "tP_Valuelists", true, "WHERE Id = " + int_1.ToString());
			if (this.NfdmmyvrKue.tP_ValueList.Rows.Count == 0)
			{
				return false;
			}
			((Class107.Class229)this.NfdmmyvrKue.tP_ValueList.Rows[0]).Deleted = true;
			return base.UpdateSqlDataTableOther(this.NfdmmyvrKue, this.NfdmmyvrKue.tP_ValueList, "tP_Valuelists");
		}
		...
		private void method_9()
		{
			...
			base.SelectSqlDataTableOther(this.NfdmmyvrKue, this.NfdmmyvrKue.vP_GetGroupList, "vP_GetValueList", true, "WHERE Deleted = ((0))" + ((this.GroupKey == null || this.GroupKey.Length <= 0) ? "" : (" AND ParentKey LIKE '" + this.GroupKey + "'")) + " AND isGroup = ((1)) ORDER BY Name");
			this.bindingSource_0.ResetBindings(true);
		...
		{
			int firstDisplayedScrollingRowIndex = this.dataGridView_0.FirstDisplayedScrollingRowIndex;
			base.SelectSqlDataTableOther(this.NfdmmyvrKue, this.NfdmmyvrKue.vP_GetGroupList, "vP_GetValueList", true, "WHERE Deleted = ((0)) AND isGroup = ((1)) ORDER BY Name");
		...
		private void method_11(int int_1)
		{
			...
			base.SelectSqlData(this.NfdmmyvrKue, this.NfdmmyvrKue.vP_GetValueList, true, "WHERE Deleted = ((0)) AND isGroup = ((0)) AND ParentId = " + int_1.ToString() + " ORDER BY Name");
		...
		private void method_12(int int_1, int int_2)
		{
			int firstDisplayedScrollingRowIndex = this.dataGridView_1.FirstDisplayedScrollingRowIndex;
			base.SelectSqlData(this.NfdmmyvrKue, this.NfdmmyvrKue.vP_GetValueList, true, "WHERE Deleted = ((0)) AND isGroup = ((0)) AND ParentId = " + int_1.ToString() + " ORDER BY Name");
			this.bindingSource_1.Position = this.bindingSource_1.Find("Id", int_2);
			if (this.dataGridView_1.RowCount > 0 && firstDisplayedScrollingRowIndex != -1)
			{
				this.dataGridView_1.FirstDisplayedScrollingRowIndex = firstDisplayedScrollingRowIndex;
			}
		...
		private void PoxmmPrSmvt_VisibleChanged(object sender, EventArgs e)
		{
			this.toolStripSeparator_1.Visible = this.PoxmmPrSmvt.Visible;
		}
		...
		private void PoxmmPrSmvt_Click(object sender, EventArgs e)
		{
			if (this.dataGridView_1.CurrentRow != null)
			{
		...
		private void method_14()
		{
			...
			this.PoxmmPrSmvt = new ToolStripButton();
			...
			((ISupportInitialize)this.NfdmmyvrKue).BeginInit();
			...
			base.SuspendLayout();
			this.NfdmmyvrKue.DataSetName = "dsPassport";
			this.NfdmmyvrKue.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
			...
			this.bindingSource_0.DataSource = this.NfdmmyvrKue;
			...
			this.bindingSource_1.DataSource = this.NfdmmyvrKue;
			...
			this.toolStripButton_0.Image = Resources.smethod_5();
			...
			this.toolStripButton_1.Image = Resources.smethod_34();
			...
			this.toolStripButton_2.Image = Resources.smethod_6();
			...
			this.toolStripButton_4.Image = Resources.smethod_24();
			...
			this.toolStripButton_5.Image = Resources.smethod_26();
			...
			this.toolStripButton_6.Image = Resources.smethod_25();
			...
			this.PoxmmPrSmvt.DisplayStyle = ToolStripItemDisplayStyle.Image;
			this.PoxmmPrSmvt.Image = Resources.smethod_45();
			this.PoxmmPrSmvt.ImageTransparentColor = Color.Magenta;
			this.PoxmmPrSmvt.Name = "tsbRefreshValue";
			this.PoxmmPrSmvt.Size = new Size(23, 22);
			this.PoxmmPrSmvt.Text = "Обновить";
			this.PoxmmPrSmvt.Click += this.PoxmmPrSmvt_Click;
			this.PoxmmPrSmvt.VisibleChanged += this.PoxmmPrSmvt_VisibleChanged;
			...
			((ISupportInitialize)this.NfdmmyvrKue).EndInit();
		...
		private ToolStripButton PoxmmPrSmvt;
