...
namespace Passport.Controls
{
	public class PanelMoveTransf : Panel
	{
		...
		public void DeleteMove(int idObjList)
		{
			...
			{
				this.sqlDataCommand_0.SelectSqlData(this.mUcamtpiNkh.tSchm_Move, true, string.Format("where id = {0}", (int)this.dgvMoveTrans.SelectedRows[0].Cells["IdMove"].Value), null, false, 0);
				this.mUcamtpiNkh.tSchm_Move.Rows[0]["Deleted"] = true;
				this.sqlDataCommand_0.UpdateSqlData(this.mUcamtpiNkh, this.mUcamtpiNkh.tSchm_Move);
				this.RefreshMove(idObjList);
			}
		}
		...
		private void method_1()
		{
			...
			this.tsbAddMove.Image = Resources.smethod_24();
			...
			this.tsbEditMove.Image = Resources.smethod_26();
			...
			this.tsbDeleteMove.Image = Resources.smethod_25();
			...
			this.tsbRefreshMove.Image = Resources.smethod_45();
			...
			this.mUcamtpiNkh.DataSetName = "dsPassport";
			this.mUcamtpiNkh.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
			...
			((ISupportInitialize)this.mUcamtpiNkh).EndInit();
