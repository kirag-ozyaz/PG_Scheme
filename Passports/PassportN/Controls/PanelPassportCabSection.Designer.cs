...
namespace Passport.Controls
{
	public class PanelPassportCabSection : Panel
	{
		...
		internal DataRow ogFmzrxChvd()
		{
			this.class107_0.tP_CabSection.Rows[0]["idObjList"] = this.int_1;
			this.class107_0.tP_CabSection.Rows[0]["idClutchFirst"] = this.int_2;
			this.class107_0.tP_CabSection.Rows[0]["idClutchSecond"] = this.int_3;
			this.class107_0.tP_CabSection.Rows[0]["Deleted"] = false;
			this.bindingSource_0.EndEdit();
			Class107.Class253 @class = this.class107_0.tP_CabSection.method_5();
			@class.ItemArray = (this.class107_0.tP_CabSection.Rows[0].ItemArray.Clone() as object[]);
			this.class107_0.tP_CabSection.Rows.Clear();
			return @class;
		}
		...
		{
			this.Fill(settings, id, this.int_2, this.int_3, state);
		}

		public void Fill(SQLSettings settings, int id, int idClutchFirst, int idClutchSecond, StateFormCreate state)
		{
		...
		public bool Save(int idClutchFirst, int idClutchSecond)
		{
			if (this.stateFormCreate_0 == null)
			{
				...
				this.bindingSource_0.EndEdit();
				this.int_0 = this.sqlDataCommand_0.InsertSqlDataOneRow(this.class107_0.tP_CabSection);
				return this.int_0 > 0;
			}
			if (this.stateFormCreate_0 == 1)
			{
				this.sqlDataCommand_0 = new SqlDataCommand(this.sqlsettings_0);
				this.bindingSource_0.EndEdit();
				return this.sqlDataCommand_0.UpdateSqlData(this.class107_0, this.class107_0.tP_CabSection);
			}
			return false;
		}
		...
		private void method_1(int int_4)
		{
			...
			this.sqlDataCommand_0.SelectSqlData(this.class107_0.tP_CabSection, true, text, null, false, 0);
			this.bindingSource_0.ResetBindings(false);
		}

		protected override void Dispose(bool disposing)
		{
			if (disposing && this.itGmzeFjFat != null)
			{
				this.itGmzeFjFat.Dispose();
			}
		...
		{
			this.itGmzeFjFat = new Container();
			this.nudCount = new NumericUpDown();
			this.bindingSource_0 = new BindingSource(this.itGmzeFjFat);
			...
			this.vvUanmHmhd8.AutoSize = true;
			this.vvUanmHmhd8.Location = new Point(17, 187);
			this.vvUanmHmhd8.Name = "label8";
			this.vvUanmHmhd8.Size = new Size(40, 13);
			this.vvUanmHmhd8.TabIndex = 47;
			this.vvUanmHmhd8.Text = "Длина";
			...
			base.Controls.Add(this.vvUanmHmhd8);
		...
		private IContainer itGmzeFjFat;
