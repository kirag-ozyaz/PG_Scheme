...
namespace Passport.Controls
{
	public class PanelPassportSettings : Panel
	{
		...
		private void method_1(string string_2)
		{
			...
			this.zGranpwyOv3 = new DataTable();
			this.sqlDataAdapter_1.Fill(this.zGranpwyOv3);
			this.zGranpwyOv3.PrimaryKey = new DataColumn[]
			{
				this.zGranpwyOv3.Columns["id"]
			};
			this.chlbChar.DataSource = this.zGranpwyOv3;
			if (this.sqlConnection_0.State != ConnectionState.Closed)
			{
				this.sqlConnection_0.Close();
			}
		...
		{
			this.rqRanslYqDg(this.sqlConnection_0, this.sqlDataAdapter_1, this.zGranpwyOv3);
			this.method_0();
		}

		private void rqRanslYqDg(SqlConnection sqlConnection_1, SqlDataAdapter sqlDataAdapter_2, DataTable dataTable_1)
		{
			...
			sqlDataAdapter_2.Update(dataTable_1);
		...
		private void HnfanKrnvep(object sender, EventArgs e)
		{
			this.OnValidated(e);
		}
		...
		private void InitializeComponent()
		{
			...
			this.gbSettings.Controls.Add(this.OiDancLhQoR);
			...
			this.chlbChar.Leave += this.HnfanKrnvep;
			this.Panel.DataPropertyName = "Panel";
			this.Panel.HeaderText = "Panel";
			this.Panel.Name = "Panel";
			this.Panel.Width = 40;
			this.OiDancLhQoR.AutoSize = true;
			this.OiDancLhQoR.Location = new Point(15, 42);
			this.OiDancLhQoR.Name = "lbTypeEquipment";
			this.OiDancLhQoR.Size = new Size(100, 13);
			this.OiDancLhQoR.TabIndex = 0;
			this.OiDancLhQoR.Text = "Тип оборудования";
