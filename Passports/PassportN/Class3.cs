...
internal class Class3
{
		...
		if (dataTable2.Rows.Count > 0)
		{
			...
			for (int i = 1; i < dataTable2.Rows.Count; i++)
			{
				try
				{
					...
					int int_16 = Class317.smethod_16(sqlsettings_0, string_4);
	...
	public int method_3(int int_0, SQLSettings sqlsettings_0, int int_1, DateTime dateTime_0, string string_0, string string_1, int int_2, string string_2, int int_3, string string_3, int int_4, int int_5, int int_6, decimal decimal_0, decimal decimal_1, decimal decimal_2, int int_7, int int_8, int int_9, int int_10, int int_11)
	{
		...
		sqlDataCommand.SelectSqlData(@class.tSchm_ObjList, true, "WHERE id = " + int_1.ToString(), null, false, 0);
		@class.tSchm_ObjList.Rows[0]["Name"] = string_1;
	...
	public int method_6(SQLSettings sqlsettings_0, string string_0, int int_0)
	{
		...
		class2.TypeCodeId = 926;
		class2.IdParent = int_0;
		class2.Deleted = false;
		class2.idParentAddl = int_0;
	...
	private int method_7(SQLSettings sqlsettings_0, string string_0, int int_0, DataTable dataTable_0)
	{
		SqlDataCommand sqlDataCommand = new SqlDataCommand(sqlsettings_0);
		Class107 @class = new Class107();
		@class.tSchm_ObjList.Rows.Clear();
		Class107.Class244 class2 = @class.tSchm_ObjList.method_5();
		class2.Name = this.method_8(sqlsettings_0, int_0, string_0, dataTable_0);
		class2.TypeCodeId = 612;
		class2.IdParent = int_0;
		class2.Deleted = false;
		class2.idParentAddl = int_0;
		@class.tSchm_ObjList.method_0(class2);
	...
	private int method_10(SQLSettings sqlsettings_0, int int_0, DateTime dateTime_0, bool bool_0, bool bool_1, int int_1)
	{
		SqlDataCommand sqlDataCommand = new SqlDataCommand(sqlsettings_0);
		Class107 @class = new Class107();
		Class107.Class257 class2 = @class.tP_Passport.method_5();
		class2.idObjList = int_0;
		class2.idEquipment = -1;
		class2.Number = 0;
		class2.Date = dateTime_0;
		class2.DateIn = DateTime.Now;
		class2.isActive = bool_0;
		class2.Deleted = bool_1;
		class2.idOldPassport = int_1;
		@class.tP_Passport.method_0(class2);
		return sqlDataCommand.InsertSqlDataOneRow(@class.tP_Passport);
	}
	...
	private bool method_11(SQLSettings sqlsettings_0, int int_0, int int_1)
	{
		SqlDataCommand sqlDataCommand = new SqlDataCommand(sqlsettings_0);
		Class107 @class = new Class107();
		sqlDataCommand.SelectSqlData(@class.tP_Passport, true, "WHERE id = " + int_0.ToString(), null, false, 0);
		if (@class.tP_Passport.Rows.Count == 0)
		{
			return false;
		}
		@class.tP_Passport.Rows[0]["idOldPassport"] = int_1;
	...
	private static bool smethod_0(SQLSettings sqlsettings_0, int int_0, List<Parameter> list_0, bool bool_0)
	{
		...
		foreach (Parameter parameter in list_0)
		{
			...
			class2.idPassport = int_0;
			class2.idObjChar = parameter.IdParameter;
			class2.Value = parameter.Value;
			class2.Deleted = bool_0;
			@class.tP_ObjectChar.method_0(class2);
		}
		return sqlDataCommand.InsertSqlData(@class, @class.tP_ObjectChar);
	}
	...
	private static bool smethod_1(SQLSettings sqlsettings_0, int int_0, List<Parameter> list_0, bool bool_0)
	{
		...
		foreach (Parameter parameter in list_0)
		{
			sqlDataCommand.SelectSqlData(@class.tP_ObjectChar, true, string.Format("WHERE idPassport = {0} AND idObjChar = {1} AND Deleted = ((0))", int_0, parameter.IdParameter), null, false, 0);
			if (@class.tP_ObjectChar.Rows.Count != 0)
			{
				@class.tP_ObjectChar.Rows[0]["Value"] = parameter.Value;
				if (!flag)
				{
					flag = sqlDataCommand.UpdateSqlData(@class, @class.tP_ObjectChar);
				}
				else
				{
		...
		if (!flag)
		{
			flag = sqlDataCommand.InsertSqlData(@class, @class.tP_ObjectChar);
		}
		else
		{
			sqlDataCommand.InsertSqlData(@class, @class.tP_ObjectChar);
		}
		return flag;
	}
	...
	{
		int num = Class317.smethod_15(sqlsettings_0, int_0, int_1, int_2);
		if (num == -1)
		{
			SqlDataCommand sqlDataCommand = new SqlDataCommand(sqlsettings_0);
			Class107 @class = new Class107();
			@class.tP_CabSection.Clear();
			Class107.Class253 class2 = @class.tP_CabSection.method_5();
			class2.idObjList = int_0;
			class2.idClutchFirst = int_1;
			class2.idClutchSecond = int_2;
			class2.Number = int_3.ToString();
			class2.CableMakeup = int_4;
			class2.Voltage = decimal_0;
			class2.Wires = int_5;
			class2.CrossSection = decimal_1;
			class2.Length = decimal_2;
			class2.Conditions = int_6;
			class2.Count = int_7;
			if (dateTime_0 > new DateTime(1901, 1, 1))
			{
				class2.YearLaying = dateTime_0;
			}
			class2.Comment = string_0;
			class2.Deleted = bool_0;
			@class.tP_CabSection.method_0(class2);
			num = sqlDataCommand.InsertSqlDataOneRow(@class.tP_CabSection);
		}
		return num;
	}
