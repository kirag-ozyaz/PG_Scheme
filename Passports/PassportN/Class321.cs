...
internal class Class321 : IDisposable
{
	[CompilerGenerated]
	...
	public Class321(string string_4, DataSet dataSet_0, DataTable dataTable_1)
	{
	...
	public Class321(string string_4, DataSet dataSet_0, DataTable dataTable_1, string string_5)
	{
		Class330.Mus9JxKz1CNxy();
		base..ctor();
	...
	public Class321(string string_4, DataSet dataSet_0, DataTable dataTable_1, string string_5, string string_6, int int_2)
	{
		Class330.Mus9JxKz1CNxy();
		base..ctor();
		this.dataTable_0 = dataTable_1;
	...
	public Class321(string string_4, ref DataTable dataTable_1, string string_5, string string_6, string string_7, int int_2)
	{
		Class330.Mus9JxKz1CNxy();
		base..ctor();
		this.dataTable_0 = dataTable_1;
	...
	public DataTable method_3(bool bool_1)
	{
		try
		{
			SqlConnection sqlConnection = new SqlConnection(this.string_2);
			SqlCommand sqlCommand = new SqlCommand(this.method_5(), sqlConnection);
			sqlCommand.CommandType = CommandType.Text;
			sqlCommand.Notification = null;
			((this.string_1 == "") ? new SqlDependency(sqlCommand) : new SqlDependency(sqlCommand, this.string_1, this.int_1)).OnChange += this.method_6;
	...
	private void method_6(object sender, SqlNotificationEventArgs e)
	{
		SqlDependency sqlDependency = sender as SqlDependency;
		this.int_0++;
		sqlDependency.OnChange -= this.method_6;
