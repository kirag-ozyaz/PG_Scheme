...
{
	internal Form2(int int_1, int? nullable_1 = null)
	{
	...
	private void method_0()
	{
		...
		base.SelectSqlData(dataTable, true, " where dateEnd is null order by fio ", null, true, 0);
	...
	private void toolStripButton_0_Click(object sender, EventArgs e)
	{
		...
		if (form.ShowDialog() == DialogResult.OK)
		{
			...
			{
				form.DocReason.string_0,
				form.DocReason.dateTime_0,
				((Enum2)form.DocReason.int_0).smethod_0(),
				form.DocReason.int_0,
				form.DocReason.nullable_0
			});
		}
	}
	...
	private void toolStripButton_1_Click(object sender, EventArgs e)
	{
		if (this.dataGridView_0.CurrentRow != null)
		{
			...
			Form1 form = new Form1(new Struct0?(value));
			form.SqlSettings = this.SqlSettings;
			if (form.ShowDialog() == DialogResult.OK)
			{
				this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_4.Name].Value = form.DocReason.nullable_0;
				this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_3.Name].Value = form.DocReason.int_0;
				this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_2.Name].Value = ((Enum2)form.DocReason.int_0).smethod_0();
				this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_1.Name].Value = form.DocReason.dateTime_0;
				this.dataGridView_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_0.Name].Value = form.DocReason.string_0;
			}
		}
	}
	...
	private bool method_2()
	{
		if (this.nullable_0 == null)
		{
			this.class14_0.tP_DocList.Rows[0]["DataXml"] = this.method_3().InnerXml;
		...
		else
		{
			this.class14_0.tP_DocList.Rows[0]["DataXml"] = this.method_3().InnerXml;
			this.class14_0.tP_DocList.Rows[0].EndEdit();
			if (!base.UpdateSqlData(this.class14_0.tP_DocList))
			{
				return false;
			}
		}
	...
	private void method_4()
	{
		try
		{
			...
			{
				if (this.class14_0.tP_DocList.Rows[0]["DataXml"] != DBNull.Value)
				{
					XmlDocument xmlDocument = new XmlDocument();
					xmlDocument.LoadXml(this.class14_0.tP_DocList.Rows[0]["DataXml"].ToString());
					...
					if (xmlNode != null)
					{
						...
						foreach (object obj in xmlNode.SelectNodes("DocReason"))
						{
							...
							if (@struct.int_0 == 891 && @struct.nullable_0 != null)
							{
								...
								base.SelectSqlData(dataTable, true, "where id = " + @struct.nullable_0.ToString(), null, false, 0);
							...
							if (@struct != Struct0.struct0_0)
							{
								this.dataGridView_0.Rows.Add(new object[]
								{
									@struct.string_0,
									@struct.dateTime_0,
									((Enum2)@struct.int_0).smethod_0(),
									@struct.int_0,
									@struct.nullable_0
								});
							}
	...
	private string method_5(string string_1, int? nullable_1 = null, byte[] byte_0 = null)
	{
		...
		while (this.dictionary_0.ContainsKey(fileName))
		{
			...
			else
			{
				...
				FileWatcherArgsAddl value = new FileWatcherArgsAddl(nullable_1, fileName, null, 2);
				this.dictionary_0.Add(fileName, value);
				Class14.Class98 @class = this.class14_0.tP_DocFile.method_4();
				@class.idDoc = -1;
				...
				this.class14_0.tP_DocFile.oqfaxnIfanF(@class);
				return fileName;
			}
		}
		goto IL_57;
	...
	private void toolStripButton_5_Click(object sender, EventArgs e)
	{
		...
		{
			Class14.Class98 @class = (Class14.Class98)((DataRowView)this.bindingSource_0.Current).Row;
	...
	private void method_8(object sender, FileSystemEventArgs e)
	{
		...
		if (fwargs.Count<KeyValuePair<string, FileWatcherArgsAddl>>() > 0)
		{
			...
			EnumerableRowCollection<Class14.Class98> source = from rowFiles in this.class14_0.tP_DocFile
			...
			select rowFiles;
			if (source.Count<Class14.Class98>() == 0)
			{
				Class14.Class98 @class = this.class14_0.tP_DocFile.method_4();
				if (this.nullable_0 != null)
				{
				...
				this.class14_0.tP_DocFile.Rows.Add(@class);
			}
			else
			{
				source.First<Class14.Class98>().File = fileBinary.ByteArray;
				source.First<Class14.Class98>().dateChange = fileBinary.LastChanged;
				source.First<Class14.Class98>().EndEdit();
			}
		}
		this.method_10();
	}
	...
	private void method_11()
	{
		if (this.nullable_0 == null)
		{
			this.class14_0.tP_DocFile.Clear();
			return;
		}
		try
		{
	...
	{
		foreach (DataRow dataRow in this.class14_0.tP_DocFile)
		{
		...
		if (base.InsertSqlData(this.class14_0, this.class14_0.tP_DocFile) && base.UpdateSqlDataOnlyChange(this.class14_0.tP_DocFile) && base.DeleteSqlData(this.class14_0, this.class14_0.tP_DocFile))
		{
			this.class14_0.tP_DocFile.AcceptChanges();
			return true;
		}
		return false;
	}
	...
	protected override void Dispose(bool bool_0)
	{
		...
		Form2.baZZ9VpkAeqr1xTjGJw(this, bool_0);
	}
	...
	private void method_13()
	{
		...
		this.toolStripButton_8.Image = Resources.smethod_24();
		...
		this.toolStripButton_4.Image = Resources.smethod_28();
		...
		this.toolStripButton_6.Image = Resources.smethod_47();
		...
		this.toolStripButton_7.Image = Resources.lWbBovpdWu();
	...
	internal static void baZZ9VpkAeqr1xTjGJw(Form form_0, bool bool_0)
	{
