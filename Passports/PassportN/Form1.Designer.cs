...
internal class Form1 : FormBase
{
	...
	internal Form1(Struct0? nullable_0 = null)
	{
	...
	{
		this.method_0();
		if (this.struct0_0 != Struct0.struct0_0)
		{
	...
	private void method_0()
	{
		...
		foreach (object obj in Enum.GetValues(typeof(Enum2)))
		{
			Enum2 @enum = (Enum2)obj;
	...
	private void Form1_FormClosing(object sender, FormClosingEventArgs e)
	{
		if (base.DialogResult == DialogResult.OK)
		{
			...
			base.SelectSqlData(dataTable, true, "where id = " + this.struct0_0.nullable_0.ToString(), null, false, 0);
