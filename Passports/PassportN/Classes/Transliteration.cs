...
namespace Passport.Classes
{
	public static class Transliteration
	{
		...
		static Transliteration()
		{
			...
			Transliteration.dictionary_0 = new Dictionary<string, string>();
			Transliteration.dictionary_1 = new Dictionary<string, string>();
			Transliteration.dictionary_2 = new Dictionary<string, string>();
