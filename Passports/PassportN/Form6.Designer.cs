...
internal class Form6 : FormBase
{
	...
	[CompilerGenerated]
	internal TensionType fobmKoqiQu4()
	{
		return this.tensionType_0;
	}

	[CompilerGenerated]
	internal void method_0(TensionType tensionType_1)
	{
		this.tensionType_0 = tensionType_1;
	}
	...
	internal Form6(int int_2)
	{
		...
		this.method_51();
		this.int_0 = int_2;
		if (this.formatReport_0 != FormatReport.A3)
		{
	...
	private void Form6_Load(object sender, EventArgs e)
	{
		...
		this.equipmentType_0 = this.method_5(this.int_0);
		this.method_1();
		for (int i = 0; i < 1; i++)
		{
			this.class14_0.tP_CurrentCarrying.Rows.Add(new object[]
			{
				"",
				"",
				""
		...
		this.class14_0.tP_Report.Rows.Add(new object[]
		{
			"",
			"",
			"",
	...
	private void method_2()
	{
		...
		string value = (this.fobmKoqiQu4() == 229) ? "Low" : "Middle";
		...
		this.reportViewer_0.LocalReport.SetParameters(new ReportParameter("kontragent", this.method_4()));
	...
	private string method_4()
	{
		...
		base.SelectSqlData(dataTable, true, string.Format("where typeKontragent = '{0}' and deleted = '0'", Convert.ToInt32(1115)), null, false, 0);
	...
	private EquipmentType method_5(int int_2)
	{
	...
	private void method_6(ItemCheckEventArgs itemCheckEventArgs_0)
	{
		...
		{
			this.method_12(itemCheckEventArgs_0.NewValue);
		}
	}

	private void method_7(CheckState checkState_0)
	{
		this.class9_0.tCableLinePassport.Rows.Clear();
		if (checkState_0 == CheckState.Checked)
		{
			...
			foreach (object obj in equipmentData.Rows)
			{
				...
				this.class9_0.tCableLinePassport.ImportRow(row);
			}
	...
	{
		this.class14_0.dtCondition.Rows.Clear();
		this.class14_0.dtCabSectionMakeups.Rows.Clear();
		if (checkState_0 == CheckState.Checked)
		{
			...
			this.class14_0.dtCondition.Rows.Add(new object[]
			{
				text2
			});
			if (this.class9_0.tCableLinePassport.Rows.Count == 1 && this.class9_0.tCableLinePassport.Rows[0]["Сечение"].ToString().Length > 0)
			{
				string text3 = "";
				string text4 = "";
				int num = Convert.ToString(this.class9_0.tCableLinePassport.Rows[0]["Сечение"]).LastIndexOf('х');
				if (num == -1)
				{
					num = Convert.ToString(this.class9_0.tCableLinePassport.Rows[0]["Сечение"]).LastIndexOf('x');
				}
				string str = Convert.ToString(this.class9_0.tCableLinePassport.Rows[0]["Сечение"]).Substring(num + 1);
				base.SelectSqlData(this.class14_0, this.class14_0.vP_PRG_CableMakeup, true, "WHERE idObjList = " + this.int_0.ToString() + " AND CrossSection != " + str);
				for (int i = 0; i < this.class14_0.vP_PRG_CableMakeup.Rows.Count; i++)
				{
					if (i == 0)
					{
						text3 += this.class14_0.vP_PRG_CableMakeup.Rows[i]["CableMakeup"].ToString();
					}
					else
					{
						text4 = text4 + ", " + this.class14_0.vP_PRG_CableMakeup.Rows[i]["CableMakeup"].ToString();
					}
				}
				text4 = ((text4.Length > 0) ? text4.Remove(0, 2) : "");
				this.class14_0.dtCabSectionMakeups.Rows.Add(new object[]
				{
					text3,
					text4
				});
		...
		try
		{
			this.reportViewer_0.LocalReport.SetParameters(new ReportParameter("cableCount", this.method_13(checkState_0)));
			this.reportViewer_0.LocalReport.SetParameters(new ReportParameter("limitI", this.method_14(checkState_0)));
		}
		catch (Exception ex)
		{
	...
	{
		this.class14_0.fn_PRGCableClutches.Rows.Clear();
		if (checkState_0 == CheckState.Checked)
		{
			base.CallSQLTableValuedFunction(this.class14_0, this.class14_0.fn_PRGCableClutches, "", new string[]
			{
				this.int_0.ToString(),
				"1",
				"65"
		...
		for (int i = 1; i < 66; i++)
		{
			this.class14_0.fn_PRGCableClutches.method_1(i, -1, -1, "", "", "", "", "", "");
		}
	}

	private void method_10(CheckState checkState_0)
	{
		this.class14_0.fn_PRGCableTesting.Rows.Clear();
		if (checkState_0 == CheckState.Checked)
		{
			base.CallSQLTableValuedFunction(this.class14_0, this.class14_0.fn_PRGCableTesting, "", new string[]
			{
				this.int_0.ToString(),
				"1",
				"38"
		...
		for (int i = 1; i < 39; i++)
		{
			this.class14_0.fn_PRGCableTesting.method_1(i, -1, -1, "", "", "", "", "");
		}
	}

	private void method_11(CheckState checkState_0)
	{
		this.class14_0.fn_PRGCableRepair.Rows.Clear();
		if (checkState_0 == CheckState.Checked)
		{
			base.CallSQLTableValuedFunction(this.class14_0, this.class14_0.fn_PRGCableRepair, "", new string[]
			{
				this.int_0.ToString(),
				"1",
				"34"
		...
		for (int i = 1; i < 35; i++)
		{
			this.class14_0.fn_PRGCableRepair.method_1(i, -1, -1, "", "", "", "", "");
		}
	}

	private void method_12(CheckState checkState_0)
	{
		this.class14_0.fn_PRGCableDamage.Rows.Clear();
		if (checkState_0 == CheckState.Checked)
		{
			base.CallSQLTableValuedFunction(this.class14_0, this.class14_0.fn_PRGCableDamage, "", new string[]
			{
				this.int_0.ToString(),
				"1",
				"71"
		...
		for (int i = 1; i < 72; i++)
		{
			this.class14_0.fn_PRGCableDamage.method_0(i, -1, -1, "", "", "", "");
		}
	}
	...
	private string method_14(CheckState checkState_0)
	{
		double num = 0.0;
		if (checkState_0 == CheckState.Unchecked)
		{
		...
		foreach (DataRow dataRow in this.class9_0.tCableLinePassport.Rows)
		{
			if (dataRow["idEquipment"] != DBNull.Value)
			{
				if (Convert.ToInt32(dataRow["idEquipment"]) != -1)
				{
					num = this.method_16(Convert.ToInt32(dataRow["idEquipment"]));
					continue;
				}
			}
			...
			string string_3 = this.method_17(Convert.ToString(dataRow["Рабочее_напряжение"]));
			num = this.method_15(Convert.ToString(dataRow["Марка_кабеля"]), string_, string_2, string_3);
		}
		DataTable dataTable = new DataTable("vP_CabSections");
		base.SelectSqlData(dataTable, true, "where deleted = '0' and idObjlist = " + this.int_0.ToString(), null, false, 0);
		foreach (object obj in dataTable.Rows)
		{
			...
			if (dataRow2["idEquipment"] != DBNull.Value)
			{
				...
				{
					num3 = this.method_16(Convert.ToInt32(dataRow2["idEquipment"]));
			...
			string string_4 = this.method_17(Convert.ToString(dataRow2["Voltage"]));
			num3 = this.method_15(Convert.ToString(dataRow2["Makeup"]), Convert.ToString(dataRow2["CrossSection"]), Convert.ToString(dataRow2["Wires"]), string_4);
			if (num3 != 0.0 && num3 < num)
			{
				num = num3;
			}
	...
	private double method_15(string string_1, string string_2, string string_3, string string_4)
	{
	...
	private double method_16(int int_2)
	{
		double result = -1.0;
		using (SqlConnection sqlConnection = new SqlConnection(this.SqlSettings.GetConnectionString()))
		{
	...
	private void method_18()
	{
		...
		this.reportViewer_0.LocalReport.DataSources.Add(new ReportDataSource("dsEquipment", this.method_19()));
		...
		this.reportViewer_0.LocalReport.SetParameters(new ReportParameter("company", this.method_4()));
	...
	private void method_20()
	{
		...
		{
			DataRow dataRow = (DataRow)obj;
			dataRow["Номинальное_напряжение"] = (string.IsNullOrEmpty(dataRow["Номин._напр._обмотки_ВН,_кВ"].ToString()) ? "" : (dataRow["Номин._напр._обмотки_ВН,_кВ"] + "/")) + dataRow["Номин._напр._обмотки_НН,_кВ"];
			dataRow["GroupName"] = "Трансформатор";
		}
		this.method_29(this.dataSetReportSubstation_0.dtEquipment, equipmentData);
	}

	private void TyemKtYixGb()
	{
	...
	private DataTable method_43()
	{
		...
		foreach (ElectricObject electricObject in from o in electricModel.GetElectricObjectById(this.int_0).ChildObjects
		where o.GetType() == typeof(ElectricBus)
		select o)
		{
	...
	private Form6.Enum3 method_44(int int_2)
	{
		...
		if (dataTable.Rows.Count == 0)
		{
			return (Form6.Enum3)0;
		}
		if (Convert.ToDouble(dataTable.Rows[0]["Value"]) > 0.4)
		{
			return (Form6.Enum3)3;
		}
		return (Form6.Enum3)1;
	}
	...
	private void qZomKhvhfAt(object sender, ItemCheckEventArgs e)
	{
	...
	{
		this.formatReport_0 = (this.radioButton_1.Checked ? FormatReport.A3 : FormatReport.A4);
		EquipmentType equipmentType = this.equipmentType_0;
		if (equipmentType <= 546)
		{
			if (equipmentType != -1)
	...
	protected override void Dispose(bool bool_2)
	{
		...
		Form6.HvxYXI9vTkULZa84f1b4(this, bool_2);
	}
	...
	private void method_51()
	{
		...
		((ISupportInitialize)this.class9_0).BeginInit();
		...
		this.bindingSource_8.DataSource = this.class9_0;
		this.class9_0.DataSetName = "DataSetReportCableLine";
		this.class9_0.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
		this.bindingSource_10.DataMember = "dtCondition";
		this.bindingSource_10.DataSource = this.class14_0;
		...
		this.checkedListBox_0.ItemCheck += this.qZomKhvhfAt;
		...
		((ISupportInitialize)this.class9_0).EndInit();
	...
	internal static void HvxYXI9vTkULZa84f1b4(Form form_0, bool bool_2)
	{
